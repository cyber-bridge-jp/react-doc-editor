...
import { H as V, Q as D, U as P, V as x, W as k, aU as b, Z as $, a3 as E, a1 as v, a4 as W, a6 as j, ai as R, aV as T, aW as O } from "./index-B1XK6w54.js";
import { useMemo as U, useState as y, useRef as S, useCallback as A, useEffect as L } from "react";
function M(n) {
...
function Z({
  ...
  const [c] = V(), p = U(() => M(a), [a]), [r, _, m] = D(o), [C, f] = y(null), i = S(null), h = A(
    (e) => {
      if (r && P(x())) {
        e.preventDefault();
        const l = k(o);
  ...
  return /* @__PURE__ */ t(
    "div",
    {
      ...
      children: /* @__PURE__ */ g("div", { className: "PollNode__inner", children: [
        ...
        /* @__PURE__ */ t("div", { className: "PollNode__footer", children: /* @__PURE__ */ t(R, { onClick: u, small: !0, children: "Add Option" }) })
      ] })
    }
  );
}
