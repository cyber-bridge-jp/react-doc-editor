import { G as R } from "./graph-Bk4gW_oC.js";
import { a8 as G, a9 as F, aa as j, ab as U, ac as H, a6 as K, l as g, g as S, d as $, u as W, Y as X, _ as A, $ as E, a0 as L, V as z, j as V, t as Y } from "./index-BU3ShsPI.js";
import { r as J } from "./index-3862675e-CUotvNHw.js";
import { c as Q } from "./channel-DxmcptI2.js";
function Z(e) {
...
const P = {}, re = function(e) {
  ...
  for (const p of n) {
    ...
    else if (Y(S().flowchart.htmlLabels))
      s = te(u, {
        label: t
...
`), S()), n.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + y + " " + w, l.setEdge(n.start, n.end, t, a);
  ...
  if (await J(C, t, ["point", "circle", "cross"], "flowchart", l), W.insertTitle(_, "flowchartTitleText", u.titleTopMargin, a.db.getDiagramTitle()), X(t, _, u.diagramPadding, u.useMaxWidth), a.db.indexNodes("subGraph" + k), !u.htmlLabels) {
