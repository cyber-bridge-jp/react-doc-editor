...
var o1 = (r, e, t) => e in r ? s1(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var ne = (r, e, t) => o1(r, typeof e != "symbol" ? e + "" : e, t);
import * as mt from "react";
import en, { createContext as ao, useContext as Qu, useMemo as it, useLayoutEffect as Br, useEffect as $, useState as H, useCallback as ie, Suspense as jr, useRef as Oe, forwardRef as ec } from "react";
import { createEditor as pa, $getRoot as Ot, $createParagraphNode as xe, $getSelection as B, $isElementNode as pe, $isRangeSelection as U, $isTextNode as _e, $isTokenOrSegmented as qi, $getAdjacentNode as _s, $isDecoratorNode as wr, $isRootNode as io, $getCharacterOffsets as l1, $isRootOrShadowRoot as zt, $isLineBreakNode as ga, $getPreviousSelection as so, $splitNode as u1, TextNode as hn, $applyNodeReplacement as ut, ElementNode as xt, $isTabNode as tc, $createTabNode as oo, $createLineBreakNode as ii, isHTMLElement as Cr, isHTMLAnchorElement as c1, createCommand as Ue, $isLeafNode as rc, $isParagraphNode as $r, $createTextNode as Ir, INSERT_PARAGRAPH_COMMAND as la, COMMAND_PRIORITY_LOW as ye, $isNodeSelection as gt, $createNodeSelection as d1, $setSelection as yt, $getNodeByKey as At, DecoratorNode as ur, KEY_BACKSPACE_COMMAND as va, KEY_DELETE_COMMAND as ba, CLICK_COMMAND as ya, $cloneWithProperties as nc, isDocumentFragment as F0, ArtificialNode__DO_NOT_USE as ac, $isBlockElementNode as si, isBlockDomNode as L0, isInlineDomNode as z0, SELECTION_INSERT_CLIPBOARD_NODES_COMMAND as ic, $parseSerializedNode as h1, COPY_COMMAND as sc, COMMAND_PRIORITY_CRITICAL as pt, isSelectionWithinEditor as m1, $getEditor as f1, PASTE_COMMAND as oc, isSelectionCapturedInDecoratorInput as p1, COMMAND_PRIORITY_EDITOR as be, CUT_COMMAND as lc, SELECT_ALL_COMMAND as g1, $selectAll as v1, DRAGOVER_COMMAND as yi, $getNearestNodeFromDOMNode as Qe, DRAGSTART_COMMAND as lo, DROP_COMMAND as xi, $createRangeSelection as xa, $normalizeSelection__EXPERIMENTAL as uo, KEY_ESCAPE_COMMAND as Dn, KEY_ENTER_COMMAND as co, INSERT_LINE_BREAK_COMMAND as P0, DELETE_CHARACTER_COMMAND as na, OUTDENT_CONTENT_COMMAND as oi, KEY_ARROW_RIGHT_COMMAND as wi, KEY_ARROW_LEFT_COMMAND as wa, KEY_ARROW_DOWN_COMMAND as mn, KEY_ARROW_UP_COMMAND as fn, INDENT_CONTENT_COMMAND as _i, INSERT_TAB_COMMAND as uc, $insertNodes as Rn, FORMAT_ELEMENT_COMMAND as er, FORMAT_TEXT_COMMAND as bt, REMOVE_TEXT_COMMAND as b1, CONTROLLED_TEXT_INSERTION_COMMAND as cc, DELETE_LINE_COMMAND as Ss, DELETE_WORD_COMMAND as dc, setNodeIndentFromDOM as hc, COMMAND_PRIORITY_HIGH as Lt, KEY_TAB_COMMAND as Si, FOCUS_COMMAND as mc, SELECTION_CHANGE_COMMAND as yr, $createRangeSelectionFromDom as y1, TEXT_TYPE_TO_FORMAT as Rr, isCurrentlyReadOnlyMode as x1, $createPoint as B0, CAN_REDO_COMMAND as Zn, CAN_UNDO_COMMAND as Qn, CLEAR_HISTORY_COMMAND as w1, CLEAR_EDITOR_COMMAND as _1, REDO_COMMAND as fc, UNDO_COMMAND as pc, IS_CODE as S1, IS_HIGHLIGHT as C1, IS_SUBSCRIPT as k1, IS_SUPERSCRIPT as N1, IS_BOLD as E1, IS_ITALIC as T1, IS_UNDERLINE as j0, IS_STRIKETHROUGH as $0, KEY_MODIFIER_COMMAND as A1, COMMAND_PRIORITY_NORMAL as M1, KEY_SPACE_COMMAND as O1, getNearestEditorFromDOMNode as D1, $nodesOfType as R1 } from "lexical";
import * as ua from "react-dom";
import { createPortal as Zt, flushSync as I1 } from "react-dom";
...
function L1() {
  return U0 || (U0 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var J = Object.assign, V = 0, ee, ce, X, de, le, Ne, se;
    function Pe() {
    }
    ...
    function Be() {
      {
        if (V === 0) {
          ee = console.log, ce = console.info, X = console.warn, de = console.error, le = console.group, Ne = console.groupCollapsed, se = console.groupEnd;
          var O = {
            configurable: !0,
            enumerable: !0,
            value: Pe,
    ...
    var dt = _.ReactCurrentDispatcher, Xe;
    function Ge(O, W, Q) {
      {
        if (Xe === void 0)
          try {
...
` + Ee[rt].replace(" at new ", " at ");
    ...
    function k0(O) {
      if ($h(O))
        return w("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", jh(O)), C0(O);
    }
    var Kn = _.ReactCurrentOwner, qh = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    var Vh = function(O, W, Q, ve, Ie, Le, Te) {
      var Ee = {
    ...
    function Yh(O, W, Q, ve, Ie) {
      {
        ...
        Q !== void 0 && (k0(Q), Ee = "" + Q), Uh(W) && (k0(W.key), Ee = "" + W.key), Hh(W) && (St = W.ref, Wh(W, Ie));
        for (Le in W)
          tt.call(W, Le) && !qh.hasOwnProperty(Le) && (Te[Le] = W[Le]);
        if (O && O.defaultProps) {
        ...
        if (Ee || St) {
          ...
          Ee && Kh(Te, st), St && Gh(Te, st);
        }
        return Vh(O, Ee, St, Ie, ve, Kn.current, Te);
      }
    }
    ...
    function I0(O, W, Q, ve, Ie, Le) {
      {
        ...
        if (tt.call(W, "key")) {
          var Ur = P(O), Et = Object.keys(W).filter(function(i1) {
            return i1 !== "key";
          }), $i = Et.length > 0 ? "{key: someKey, " + Et.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!R0[Ur + $i]) {
            var a1 = Et.length > 0 ? "{" + Et.join(": ..., ") + ": ...}" : "{}";
            w(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, $i, Ur, a1, Ur), R0[Ur + $i] = !0;
          }
        }
        return O === n ? Qh(st) : Zh(st), st;
      }
    }
    function e1(O, W, Q) {
      return I0(O, W, Q, !0);
    ...
    var r1 = t1, n1 = e1;
    Vn.Fragment = n, Vn.jsx = r1, Vn.jsxs = n1;
  }()), Vn;
}
process.env.NODE_ENV === "production" ? Cs.exports = F1() : Cs.exports = L1();
var p = Cs.exports;
function z1(r) {
  return r && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
}
var P1 = z1(function(r) {
...
function oe() {
  const r = Qu(gc);
  return r == null && P1(8), r;
}
const vc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, j1 = vc ? Br : $, za = { tag: "history-merge" };
function $1({ initialConfig: r, children: e }) {
  const t = it(() => {
    const { theme: n, namespace: a, nodes: i, onError: s, editorState: o, html: l } = r, u = B1(null, n), c = pa({ editable: r.editable, html: l, namespace: a, nodes: i, onError: (d) => s(d, c), theme: n });
    return function(d, m) {
      if (m !== null) {
        if (m === void 0) d.update(() => {
          ...
          if (g.isEmpty()) {
            const v = xe();
            g.append(v);
            const y = vc ? document.activeElement : null;
  ...
  }, []), p.jsx(gc.Provider, { value: t, children: e });
}
const q1 = {
...
function ho(r) {
  let e = li.get(r);
  return e === void 0 && (e = yc(r), li.set(r, e)), e;
}
function U1(r) {
  let e = "";
...
function xc(r, e) {
  ...
  if (e.isSelected(r) && !e.isSegmented() && !e.isToken() && t !== null) {
    ...
    if (l || u) {
      const [c, d] = l1(r), m = s.is(o), g = e.is(i ? o : s), v = e.is(i ? s : o);
      let y, x = 0;
...
function W0(r) {
  ...
  const e = r.getNode();
  return pe(e) || bc(177), r.offset === e.getChildrenSize();
}
function W1(r) {
  const e = r.getStyle(), t = yc(e);
  li.set(e, t);
}
function xn(r, e) {
  const t = ho("getStyle" in r ? r.getStyle() : r.style), n = Object.entries(e).reduce((i, [s, o]) => (typeof o == "function" ? i[s] = o(t[s], r) : o === null ? delete i[s] : i[s] = o, i), { ...t }), a = U1(n);
...
var Y1 = V1(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
const fo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, J1 = fo && "documentMode" in document ? document.documentMode : null, X1 = fo && /^(?!.*Seamonkey)(?=.*Firefox).*/i.test(navigator.userAgent);
!(!fo || !("InputEvent" in window) || J1) && "getTargetRanges" in new window.InputEvent("input");
function _c(...r) {
  const e = [];
      ...
      for (var D in T)
        if (!(!T.hasOwnProperty(D) || !T[D])) {
          ...
          for (var F = 0; F < M.length; ++F) {
            if (I && I.cause == D + "," + F)
              return;
            var z = M[F], j = z.inside, P = !!z.lookbehind, J = !!z.greedy, V = z.alias;
            if (J && !z.pattern.global) {
              var ee = z.pattern.toString().match(/[imsuy]*$/)[0];
              z.pattern = RegExp(z.pattern.source, ee + "g");
            }
            for (var ce = z.pattern || z, X = k.next, de = N; X !== C.tail && !(I && de >= I.reach); de += X.value.length, X = X.next) {
              var le = X.value;
              ...
              if (!(le instanceof l)) {
                ...
                if (J) {
                  ...
                  for (Be += X.value.length; dt >= Be; )
                    X = X.next, Be += X.value.length;
                  if (Be -= X.value.length, de = Be, X.value instanceof l)
                    continue;
                  for (var je = X; je !== C.tail && (Be < Pe || typeof je.value == "string"); je = je.next)
                    Ne++, Be += je.value.length;
                  Ne--, le = w.slice(de, Be), se.index -= de;
                } else if (se = u(ce, 0, le, P), !se)
                  continue;
                var dt = se.index, Xe = se[0], Ge = le.slice(0, dt), Rt = le.slice(dt + Xe.length), wt = de + le.length;
                I && wt > I.reach && (I.reach = wt);
                var Qt = X.prev;
                Ge && (Qt = m(C, Qt, Ge), de += Ge.length), g(C, Qt, Ne);
                var te = new l(D, j ? o.tokenize(Xe, j) : Xe, V, Xe);
                if (X = m(C, Qt, te), Rt && m(C, X, Rt), Ne > 1) {
                  var we = {
                    cause: D + "," + F,
                    reach: wt
                  };
                  c(w, C, T, X.prev, de, we), I && we.reach > I.reach && (I.reach = we.reach);
                }
              }
            }
          }
...
const am = globalThis.Prism || window.Prism, Y0 = (r) => {
  try {
    return !!r && am.languages.hasOwnProperty(r);
  } catch {
    return !1;
  }
};
...
let po = class Nc extends xt {
  static getType() {
    return "code";
  }
  static clone(e) {
    return new Nc(e.__language, e.__key);
  }
  constructor(e, t) {
    super(t), this.__language = e, this.__isSyntaxHighlightSupported = Y0(e);
  }
  createDOM(e) {
  ...
  static importDOM() {
    return { code: (e) => e.textContent != null && (/\r?\n/.test(e.textContent) || kc(e, "BR")) ? { conversion: J0, priority: 1 } : null, div: () => ({ conversion: sm, priority: 1 }), pre: () => ({ conversion: J0, priority: 0 }), table: (e) => Hi(e) ? { conversion: om, priority: 3 } : null, td: (e) => {
      const t = e, n = t.closest("table");
      return t.classList.contains("js-file-line") || n && Hi(n) ? { conversion: X0, priority: 3 } : null;
    }, tr: (e) => {
      const t = e.closest("table");
      return t && Hi(t) ? { conversion: X0, priority: 3 } : null;
    } };
  }
  static importJSON(e) {
...
` && e.isCollapsed() && e.anchor.key === this.__key && e.anchor.offset === a) {
    ...
    if (_e(o)) {
      let l = lm(o);
      const u = [];
      for (; ; ) if (tc(l)) u.push(oo()), l = l.getNextSibling();
      else {
        if (!go(l)) break;
        {
          let x = 0;
          ...
          for (; x < w && _[x] === " "; ) x++;
          if (x !== 0 && u.push(Ac(" ".repeat(x))), x !== w) break;
          l = l.getNextSibling();
        }
      }
  ...
  setLanguage(e) {
    ...
    t.__language = e, t.__isSyntaxHighlightSupported = Y0(e);
  }
  getLanguage() {
...
let Ec = class Tc extends hn {
  ...
  static clone(e) {
    return new Tc(e.__text, e.__highlightType || void 0, e.__key);
  }
  getHighlightType() {
  ...
  static importJSON(e) {
    const t = Ac(e.text, e.highlightType);
...
function Ac(r, e) {
  return ut(new Ec(r, e));
}
function go(r) {
  return r instanceof Ec;
}
function lm(r) {
  let e = r, t = r;
  for (; go(t) || tc(t); ) e = t, t = t.getPreviousSibling();
  return e;
}
let Mc = class Oc extends hn {
  static getType() {
    return "hashtag";
  }
  static clone(e) {
    return new Oc(e.__text, e.__key);
  }
  constructor(e, t) {
    super(e, t);
  }
...
const cm = /* @__PURE__ */ new Set(["http:", "https:", "mailto:", "sms:", "tel:"]);
let In = class Dc extends xt {
  static getType() {
    return "link";
  }
  static clone(e) {
    return new Dc(e.__url, { rel: e.__rel, target: e.__target, title: e.__title }, e.__key);
  }
  constructor(e, t = {}, n) {
    super(n);
  ...
  static importDOM() {
    return { a: (e) => ({ conversion: dm, priority: 1 }) };
  }
  static importJSON(e) {
  ...
  sanitizeUrl(e) {
    try {
      const t = new URL(e);
      if (!cm.has(t.protocol)) return "about:blank";
    } catch {
      return e;
    }
    return e;
...
let Sa = class Rc extends In {
  ...
  static clone(e) {
    return new Rc(e.__url, { isUnlinked: e.__isUnlinked, rel: e.__rel, target: e.__target, title: e.__title }, e.__key);
  }
  getIsUnlinked() {
...
let Ca = class Lc extends xt {
  static getType() {
    return "listitem";
  }
  static clone(e) {
    return new Lc(e.__value, e.__checked, e.__key);
  }
  constructor(e, t, n) {
  ...
  static importDOM() {
    return { li: () => ({ conversion: vm, priority: 0 }) };
  }
  static importJSON(e) {
    const t = Pt();
  ...
  setIndent(e) {
    ...
    for (; t !== e; ) t < e ? (fm(this), t++) : (pm(this), t--);
    return this;
  }
  canInsertAfter(e) {
    return Fe(e);
...
function vm(r) {
  if (r.classList.contains("task-list-item")) {
    for (const t of r.children) if (t.tagName === "INPUT") return bm(t);
  }
...
let ka = class zc extends xt {
  static getType() {
    return "list";
  }
  static clone(e) {
    const t = e.__listType || il[e.__tag];
    return new zc(t, e.__start, e.__key);
  }
  constructor(e, t, n) {
    super(n);
    const a = il[e] || e;
...
function al(r) {
  ...
  return e === "ol" ? t = Mt("number", r.start) : e === "ul" && (t = function(n) {
    ...
    return !1;
  }(r) ? Mt("check") : Mt("bullet")), { after: ym, node: t };
}
...
const bo = Ue("INSERT_UNORDERED_LIST_COMMAND"), yo = Ue("INSERT_ORDERED_LIST_COMMAND"), xo = Ue("INSERT_CHECK_LIST_COMMAND"), xm = Ue("REMOVE_LIST_COMMAND");
function wm(r) {
  return Re(r.registerCommand(yo, () => (As(r, "number"), !0), ye), r.registerCommand(bo, () => (As(r, "bullet"), !0), ye), r.registerCommand(xm, () => (mm(r), !0), ye), r.registerCommand(la, () => !!gm(), ye));
}
let wo = class Pc extends xt {
  static getType() {
    return "mark";
  }
  static clone(e) {
    return new Pc(Array.from(e.__ids), e.__key);
  }
  static importDOM() {
    return null;
  }
...
var Sm = _m(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
let _o = class Bc extends xt {
  static getType() {
    return "overflow";
  }
  static clone(e) {
  ...
  static transform() {
    return (e) => {
      km(e) || Sm(204), e.isEmpty() && e.remove();
    };
  }
};
function Cm() {
...
function So(r) {
  ...
  return $(() => {
    ...
    e.update(() => {
      let i = B();
      gt(i) || (i = d1(), yt(i)), gt(i) && (a ? i.add(r) : i.delete(r));
    });
  }, [e, r]), ie(() => {
    e.update(() => {
      const a = B();
...
let ko = class jc extends ur {
  static getType() {
    return "horizontalrule";
  }
  static clone(e) {
    return new jc(e.__key);
  }
  static importJSON(e) {
    return No();
  }
  static importDOM() {
    return { hr: () => ({ conversion: Em, priority: 0 }) };
  }
  exportJSON() {
...
`;
  ...
  decorate() {
    return p.jsx(Nm, { nodeKey: this.__key });
  }
};
function Em() {
  return { node: No() };
...
function Am(r, e) {
  ...
  for (let i = 0; i < t.length; i++) {
    const s = t[i];
    if (!Hc.has(s.nodeName)) {
      const o = Uc(s, r, a, !1);
      o !== null && (n = n.concat(o));
    }
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof ac && s.insertAfter(ii());
    for (const s of i) {
...
const Hc = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Uc(r, e, t, n, a = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (Hc.has(r.nodeName)) return s;
  let o = null;
  ...
  for (let v = 0; v < d.length; v++) m.push(...Uc(d[v], e, t, g, new Map(a), o));
  return c != null && (m = c(m)), L0(r) && (m = Mm(r, m, g ? () => {
    const v = new ac();
    return t.push(v), v;
...
var ci = Om(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
const Dm = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Wc = (r) => Dm ? (r || window).getSelection() : null;
function Rm(r, e = B()) {
  return e == null && ci(166), U(e) && e.isCollapsed() || e.getNodes().length === 0 ? "" : $c(r, e);
}
function Im(r, e = B()) {
  return e == null && ci(166), U(e) && e.isCollapsed() || e.getNodes().length === 0 ? null : JSON.stringify(Fm(r, e));
}
function n6(r, e) {
...
function ul(r, e, t) {
  r.dispatchCommand(ic, { nodes: e, selection: t }) || t.insertNodes(e);
}
function Kc(r, e, t, n = []) {
  ...
  for (let u = 0; u < o.length; u++) {
    const c = o[u], d = Kc(r, e, c, l.children);
...
async function Ms(r, e, t) {
  ...
  const n = r.getRootElement(), a = r._window == null ? window.document : r._window.document, i = Wc(r._window);
  ...
  return o.setStart(s, 0), o.setEnd(s, 1), i.removeAllRanges(), i.addRange(o), new Promise((l, u) => {
    const c = r.registerCommand(sc, (d) => (xr(d, ClipboardEvent) && (c(), wn !== null && (window.clearTimeout(wn), wn = null), l(cl(r, d, t))), !0), pt);
...
function cl(r, e, t) {
  if (t === void 0) {
    const a = Wc(r._window);
    if (!a) return !1;
    const i = a.anchorNode, s = a.focusNode;
    if (i !== null && s !== null && !m1(r, i, s)) return !1;
    const o = B();
    if (o === null) return !1;
    t = Gc(o);
  }
  ...
  return n !== null && (Pm(n, t), !0);
}
const zm = [["text/html", Rm], ["application/x-lexical-editor", Im]];
function Gc(r = B()) {
...
const Fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Bm = Fn && "documentMode" in document ? document.documentMode : null, jm = !(!Fn || !("InputEvent" in window) || Bm) && "getTargetRanges" in new window.InputEvent("input"), $m = Fn && /Version\/[\d.]+.*Safari/.test(navigator.userAgent), qm = Fn && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, Hm = Fn && /^(?=.*Chrome).*/i.test(navigator.userAgent), Um = Fn && /AppleWebKit\/[\d.]+/.test(navigator.userAgent) && !Hm, Os = Ue("DRAG_DROP_PASTE_FILE");
class Na extends xt {
  static getType() {
    return "quote";
  }
  ...
  static importDOM() {
    return { blockquote: (e) => ({ conversion: Km, priority: 0 }) };
  }
  exportDOM(e) {
...
function _n(r) {
  const e = r.nodeName.toLowerCase();
  let t = null;
  return e !== "h1" && e !== "h2" && e !== "h3" && e !== "h4" && e !== "h5" && e !== "h6" || (t = Qr(e), r.style !== null && (hc(r, t), t.setFormat(r.style.textAlign))), { node: t };
}
function Km(r) {
  const e = ki();
  return r.style !== null && (e.setFormat(r.style.textAlign), hc(r, e)), { node: e };
}
function Qr(r) {
  return ut(new Ea(r));
}
...
function Gm(r) {
  return Re(r.registerCommand(ya, (e) => {
  ...
  }, be), r.registerCommand(uc, () => (Rn([oo()]), !0), be), r.registerCommand(_i, () => fl((e) => {
    const t = e.getIndent();
    e.setIndent(t + 1);
    ...
    return !0;
  }, be), r.registerCommand(g1, () => (v1(), !0), be), r.registerCommand(sc, (e) => (Ms(r, xr(e, ClipboardEvent) ? e : null), !0), be), r.registerCommand(lc, (e) => (async function(t, n) {
    await Ms(n, xr(t, ClipboardEvent) ? t : null), n.update(() => {
      const a = B();
      U(a) ? a.removeText() : gt(a) && a.getNodes().forEach((i) => i.remove());
    });
  }(e, r), !0), be), r.registerCommand(oc, (e) => {
    const [, t, n] = kn(e);
    return t.length > 0 && !n ? (r.dispatchCommand(Os, t), !0) : p1(e.target) ? !1 : B() !== null && (function(a, i) {
...
class sr extends xt {
  ...
  static importJSON(e) {
    ...
    return Xt(e.headerState, t, e.width || void 0).setRowSpan(n).setBackgroundColor(e.backgroundColor || null);
  }
...
function pl(r) {
  ...
  const a = Xt(t === "th" ? qe.ROW : qe.NO_STATUS, e.colSpan, n);
...
class Ln extends xt {
  ...
  static importDOM() {
    return { tr: (e) => ({ conversion: Jm, priority: 0 }) };
  }
  static importJSON(e) {
    return da(e.height);
  }
...
function Yc(r) {
  return Vc(r).getChildren().findIndex((e) => e.is(r));
}
...
function tf() {
  ...
  if (i > 1) {
    for (let y = 1; y < i; y++) t.insertAfter(Xt(m[y] | v[0]).append(xe()));
    t.setColSpan(1);
  }
  if (s > 1) {
    let y;
    for (let x = 1; x < s; x++) {
      ...
      if (C === null) for (let T = i - 1; T >= 0; T--) Mo(y, Xt(m[T] | v[x]).append(xe()));
      else for (let T = i - 1; T >= 0; T--) C.insertAfter(Xt(m[T] | v[x]).append(xe()));
    }
    t.setRowSpan(1);
  }
}
...
class Ni {
  ...
  getNodes() {
    ...
    for (let D = g; D <= y; D++) for (let M = m; M <= v; M++) {
      ...
      for (const j of rf(F)) k.set(j.getKey(), j);
      N = z;
    }
    const I = Array.from(k.values());
    return x1() || (this._cachedNodes = I), I;
  }
  getTextContent() {
...
const Rs = "__lexicalTableSelection", Zc = (r) => Ym ? (r || window).getSelection() : null;
function af(r, e, t, n) {
  const a = t.getRootElement();
  if (a === null) throw new Error("No root element.");
  const i = new nf(t, r.getKey()), s = t._window || window;
  (function(c, d) {
  ...
  return i.listenersToRemove.add(t.registerCommand(va, l, pt)), i.listenersToRemove.add(t.registerCommand(ba, l, pt)), i.listenersToRemove.add(t.registerCommand(lc, (c) => {
    const d = B();
    if (d) {
      if (!Me(d) && !U(d)) return !1;
      Ms(t, xr(c, ClipboardEvent) ? c : null, Gc(d));
      const m = l(c);
    ...
    return !0;
  }, pt)), i.listenersToRemove.add(t.registerCommand(cc, (c) => {
    const d = B();
    if (!Yr(d, r)) return !1;
    ...
    const d = B();
    if (!U(d) || !d.isCollapsed() || !Yr(d, r)) return !1;
    const m = Vi(d.anchor.getNode());
    if (m === null) return !1;
    pr(c);
    const g = r.getCordsFromCellNode(m, i.table);
    return Qc(i, r, g.x, g.y, c.shiftKey ? "backward" : "forward"), !0;
  }, pt)), i.listenersToRemove.add(t.registerCommand(mc, (c) => r.isSelected(), Lt)), i.listenersToRemove.add(t.registerCommand(ic, (c) => {
    const { nodes: d, selection: m } = c, g = m.getStartEndPoints(), v = Me(m), y = U(m) && he(m.anchor.getNode(), (X) => ae(X)) !== null && he(m.focus.getNode(), (X) => ae(X)) !== null || v;
    if (d.length !== 1 || !Ke(d[0]) || !y || g === null) return !1;
    const [x] = g, _ = d[0], w = _.getChildren(), C = _.getFirstChildOrThrow().getChildrenSize(), T = _.getChildrenSize(), k = he(x.getNode(), (X) => ae(X)), N = k && he(k, (X) => nt(X)), I = N && he(N, (X) => Ke(X));
    if (!ae(k) || !nt(N) || !Ke(I)) return !1;
    const D = N.getIndexWithinParent(), M = Math.min(I.getChildrenSize() - 1, D + T - 1), F = k.getIndexWithinParent(), z = Math.min(N.getChildrenSize() - 1, F + C - 1), j = Math.min(F, z), P = Math.min(D, M), J = Math.max(F, z), V = Math.max(D, M), ee = I.getChildren();
    let ce = 0;
    for (let X = P; X <= V; X++) {
      const de = ee[X];
      if (!nt(de)) return !1;
      ...
      let Pe = 0;
      for (let Be = j; Be <= J; Be++) {
        const je = Ne[Be];
        if (!ae(je)) return !1;
        const dt = se[Pe];
        if (!ae(dt)) return !1;
        const Xe = je.getChildren();
        dt.getChildren().forEach((Ge) => {
          _e(Ge) && xe().append(Ge), je.append(Ge);
        }), Xe.forEach((Ge) => Ge.remove()), Pe++;
      }
      ce++;
    }
    return !0;
    ...
    const c = B(), d = so();
    if (U(c)) {
      const { anchor: m, focus: g } = c, v = m.getNode(), y = g.getNode(), x = Vi(v), _ = Vi(y), w = !(!x || !r.is(Nn(x))), C = !(!_ || !r.is(Nn(_))), T = w !== C, k = w && C, N = c.isBackward();
      if (T) {
        const I = c.clone();
        if (C) {
    ...
    return c && !c.is(d) && (Me(c) || Me(d)) && i.tableSelection && !i.tableSelection.is(d) ? (Me(c) && c.tableKey === i.tableNodeKey ? i.updateTableTableSelection(c) : !Me(c) && Me(d) && d.tableKey === i.tableNodeKey && i.updateTableTableSelection(null), !1) : (i.hasHijackedSelectionStyles && !r.isSelected() ? function(m, g) {
      g.enableHighlightStyle(), Do(g.table, (v) => {
        const y = v.elem;
        v.highlighted = !1, td(m, v), y.getAttribute("style") || y.removeAttribute("style");
      });
    }(t, i) : !i.hasHijackedSelectionStyles && r.isSelected() && bl(t, i), !1);
  }, pt)), i.listenersToRemove.add(t.registerCommand(la, () => {
    const c = B();
    if (!U(c) || !c.isCollapsed() || !Yr(c, r)) return !1;
    const d = xl(t, c, r);
    return !!d && (yl(d, r), !0);
  }, pt)), i;
}
...
function $a(r, e, t) {
  ...
  Do(e, (a, i) => {
    const s = a.elem;
    n.has(i) ? (a.highlighted = !0, ed(r, a)) : (a.highlighted = !1, td(r, a), s.getAttribute("style") || s.removeAttribute("style"));
  });
}
function Do(r, e) {
  const { domRows: t } = r;
...
function ta(r, e, t, n, a) {
  ...
  if (U(i) && i.isCollapsed()) {
    ...
    if (t === "backward" || t === "forward") {
      ...
      return (T.length !== 1 || !wr(T[0])) && !!function(k, N, I, D) {
        return function(M, F, z) {
          ...
          const P = he(z, (V) => pe(V) && !V.isInline());
          if (!P) return !1;
          const J = j === "backward" ? F === 0 : F === z.getTextContentSize();
          return M === "text" && J && (j === "backward" ? P.getPreviousSibling() === null : P.getNextSibling() === null);
        }(k, N, I, D);
        ...
        const [F, z] = Wt(I, M, M);
        if (!function(P, J, V) {
          const ee = P[0][0], ce = P[P.length - 1][P[0].length - 1], { startColumn: X, startRow: de } = J;
          return V === "backward" ? X === ee.startColumn && de === ee.startRow : X === ce.startColumn && de === ce.startRow;
        }(F, z, D)) return !1;
        const j = function(P, J, V) {
          const ee = he(P, (X) => pe(X) && !X.isInline());
          if (!ee) return;
          const ce = J === "backward" ? ee.getPreviousSibling() : ee.getNextSibling();
          return ce && Ke(ce) ? ce : J === "backward" ? V.getPreviousSibling() : V.getNextSibling();
        }(N, D, I);
    ...
    if (t === "up" ? x.top > g.top - g.height : g.bottom + g.height > x.bottom) {
      ...
      if (!e.shiftKey) return Qc(a, n, _.x, _.y, t);
      {
...
class or extends xt {
  ...
  static importDOM() {
    return { table: (e) => ({ conversion: of, priority: 1 }) };
  }
  static importJSON(e) {
    const t = Ro();
...
`;
  ...
  decorate() {
    return /* @__PURE__ */ p.jsx(lf, { nodeKey: this.__key });
  }
}
function uf() {
  return { node: Io() };
...
const df = mt.lazy(() => import("./ImageComponent-C-1V_ETG.js"));
function hf(r) {
  const e = r;
...
const pf = "https://platform.twitter.com/widgets.js";
function gf(r) {
  ...
  return $(() => {
    ...
    if (s !== l.current) {
      if (c(!0), Sl) {
        ...
        g.src = pf, g.async = !0, (m = document.body) == null || m.appendChild(g), g.onload = d, a && (g.onerror = a);
      } else
        d();
      l && (l.current = s);
    }
...
var Sf = function(e, t) {
  ...
  return e === void 0 ? t : e;
}, kf = /([A-Z])/g, Nf = function(e) {
  return e.replace(kf, "-$1").toLowerCase();
}, Ef = {
  "&": "&amp;",
  ">": "&gt;",
  "<": "&lt;",
...
function Af(r) {
  return String(r).replace(Tf, (e) => Ef[e]);
}
var sd = function r(e) {
  ...
  constructor(e) {
    ...
    for (var t in ti)
      if (ti.hasOwnProperty(t)) {
        var n = ti[t];
        this[t] = e[t] !== void 0 ? n.processor ? n.processor(e[t]) : e[t] : Rf(n);
      }
  }
  /**
...
var Ho = 0, di = 1, En = 2, _r = 3, ma = 4, Ut = 5, An = 6, kt = 7, tr = [new Ar(Ho, 0, !1), new Ar(di, 0, !0), new Ar(En, 1, !1), new Ar(_r, 1, !0), new Ar(ma, 2, !1), new Ar(Ut, 2, !0), new Ar(An, 3, !1), new Ar(kt, 3, !0)], If = [ma, Ut, ma, Ut, An, kt, An, kt], Ff = [Ut, Ut, Ut, Ut, kt, kt, kt, kt], Lf = [En, _r, ma, Ut, An, kt, An, kt], zf = [_r, _r, Ut, Ut, kt, kt, kt, kt], Pf = [di, di, _r, _r, Ut, Ut, kt, kt], Bf = [Ho, di, En, _r, En, _r, En, _r], fe = {
  DISPLAY: tr[Ho],
  TEXT: tr[En],
  SCRIPT: tr[ma],
  SCRIPTSCRIPT: tr[An]
...
function Uo(r, e, t) {
  ...
  if (!a && r[0] in Nl && (n = Nl[r[0]].charCodeAt(0), a = ar[e][n]), !a && t === "text" && od(n) && (a = ar[e][77]), a)
    return {
      depth: a[0],
      height: a[1],
      italic: a[2],
...
var Qf = [
  ...
  return t.size < 2 ? e : Qf[e - 1][t.size - 1];
};
class gr {
...
var Ps = {
  ...
  return typeof e != "string" && (e = e.unit), e in Ps || e in ep || e === "ex";
}, Je = function(e, t) {
  var n;
  if (e.unit in Ps)
...
class Ra {
  constructor(e, t, n, a) {
    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, ud.call(this, e, n, a), this.children = t || [];
  }
  /**
...
class Wo {
  constructor(e, t, n, a) {
    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, ud.call(this, t, a), this.children = n || [], this.setAttribute("href", e);
  }
  setAttribute(e, t) {
    this.attributes[e] = t;
  }
...
class Gt {
  constructor(e, t, n, a, i, s, o, l) {
    ...
    var u = jf(this.text.charCodeAt(0));
    u && this.classes.push(u + "_fallback"), /[îïíì]/.test(this.text) && (this.text = rp[this.text]);
  }
  hasClass(e) {
    return ue.contains(this.classes, e);
  }
  ...
  toNode() {
    ...
    this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = Y(this.italic)), this.classes.length > 0 && (t = t || document.createElement("span"), t.className = Fr(this.classes));
    for (var n in this.style)
...
var f = "math", q = "text", b = "main", E = "ams", Ve = "accent-token", re = "bin", Nt = "close", Bn = "inner", me = "mathord", ct = "op-token", Bt = "open", Ti = "punct", A = "rel", Tr = "spacing", R = "textord";
h(f, b, A, "≡", "\\equiv", !0);
h(f, b, A, "≺", "\\prec", !0);
h(f, b, A, "≻", "\\succ", !0);
h(f, b, A, "∼", "\\sim", !0);
...
h(q, E, R, "✠", "\\maltese");
var Ml = '0123456789/@."';
for (var Ji = 0; Ji < Ml.length; Ji++) {
  var Ol = Ml.charAt(Ji);
  h(f, b, R, Ol, Ol);
}
var Dl = '0123456789!@*()-=+";:?/.,';
for (var Xi = 0; Xi < Dl.length; Xi++) {
  var Rl = Dl.charAt(Xi);
  h(q, b, R, Rl, Rl);
}
...
var Ka = [
  ...
  return a === void 0 && (a = []), n.font === "boldsymbol" && Ai(e, "Main-Bold", t).metrics ? Jt(e, "Main-Bold", t, n, a.concat(["mathbf"])) : e === "\\" || He[t][e].font === "main" ? Jt(e, "Main-Regular", t, n, a) : Jt(e, "AMS-Regular", t, n, a.concat(["amsrm"]));
}, lp = function(e, t, n, a, i) {
  ...
  if (i.charCodeAt(0) === 55349 && ([u, c] = sp(i, a)), u.length > 0)
    return Jt(i, u, a, t, s.concat(c));
  if (l) {
    var d, m;
    if (l === "boldsymbol") {
      var g = lp(i, a, t, s, n);
      d = g.fontName, m = [g.fontClass];
    } else o ? (d = pd[l].fontName, m = [l]) : (d = Ga(l, t.fontWeight, t.fontShape), m = [l, t.fontWeight, t.fontShape]);
    if (Ai(i, d, a).metrics)
      return Jt(i, d, a, t, s.concat(m));
    if (hd.hasOwnProperty(i) && d.slice(0, 10) === "Typewriter") {
      for (var v = [], y = 0; y < i.length; y++)
        v.push(Jt(i[y], d, a, t, s.concat(m)));
      return fd(v);
    }
  }
  if (n === "mathord")
    return Jt(i, "Math-Italic", a, t, s.concat(["mathnormal"]));
  if (n === "textord") {
    var x = He[a][i] && He[a][i].font;
    if (x === "ams") {
      var _ = Ga("amsrm", t.fontWeight, t.fontShape);
      return Jt(i, _, a, t, s.concat("amsrm", t.fontWeight, t.fontShape));
    } else if (x === "main" || !x) {
      var w = Ga("textrm", t.fontWeight, t.fontShape);
      return Jt(i, w, a, t, s.concat(t.fontWeight, t.fontShape));
    } else {
      var C = Ga(x, t.fontWeight, t.fontShape);
      return Jt(i, C, a, t, s.concat(C, t.fontWeight, t.fontShape));
    }
  } else
  ...
  for (var e = 0; e < r.length - 1; e++) {
    var t = r[e], n = r[e + 1];
    t instanceof Gt && n instanceof Gt && cp(t, n) && (t.text += n.text, t.height = Math.max(t.height, n.height), t.depth = Math.max(t.depth, n.depth), t.italic = n.italic, r.splice(e + 1, 1), e--);
  }
  return r;
}, Ko = function(e) {
  ...
  return Ko(i), i;
}, md = (r, e, t, n) => new Ra(r, e, t, n), hp = function(e, t, n) {
  var a = Tt([e], [], t);
  return a.height = Math.max(n || t.fontMetrics().defaultRuleThickness, t.minRuleThickness), a.style.borderBottomWidth = Y(a.height), a.maxFontSize = 1, a;
}, mp = function(e, t, n, a) {
  ...
  for (var c = [], d = a, m = a, g = a, v = 0; v < n.length; v++) {
    ...
    if (y.type === "kern")
      ...
      C.style.top = Y(-i - g - x.depth), y.marginLeft && (C.style.marginLeft = y.marginLeft), y.marginRight && (C.style.marginRight = y.marginRight), c.push(C), g += x.height + x.depth;
    }
  ...
  var t = Tt(["mspace"], [], e), n = Je(r, e);
  return t.style.marginRight = Y(n), t;
}, Ga = function(e, t, n) {
  var a = "";
  switch (e) {
    case "amsrm":
  ...
  var [n, a, i] = gd[e], s = new Lr(n), o = new kr([s], {
    width: Y(a),
    height: Y(i),
...
var pi = function(e) {
...
}, Nr = L.makeSpan, wp = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], _p = ["rightmost", "mrel", "mclose", "mpunct"], Sp = {
  display: fe.DISPLAY,
  text: fe.TEXT,
  script: fe.SCRIPT,
  ...
  if (e.length === 1) {
    var c = e[0];
    c.type === "sizing" ? u = t.havingSize(c.size) : c.type === "styling" && (u = t.havingStyle(Sp[c.style]));
  }
  var d = Nr([a[0] || "leftmost"], [], t), m = Nr([a[1] || "rightmost"], [], t), g = n === "root";
  return Fl(i, (v, y) => {
    var x = y.classes[0], _ = v.classes[0];
    x === "mbin" && ue.contains(_p, _) ? y.classes[0] = "mord" : _ === "mbin" && ue.contains(wp, x) && (v.classes[0] = "mord");
  }, {
    node: d
  }, m, g), Fl(i, (v, y) => {
    var x = $s(y), _ = $s(v), w = x && _ ? v.hasClass("mtight") ? xp[x][_] : yp[x][_] : null;
    if (w)
  ...
  return e ? (t && (e = kp(e, t)), Cp[e.classes[0]] || null) : null;
}, fa = function(e, t) {
...
function Va(r, e) {
  ...
  return n.style.height = Y(t.height + t.depth), t.depth && (n.style.verticalAlign = Y(-t.depth)), t.children.unshift(n), t;
}
function qs(r, e) {
  var t = null;
  ...
  var u;
  t ? (u = Va(ft(t, e, !0)), u.classes = ["tag"], i.push(u)) : a && i.push(a);
...
var K = {
  ...
  return He[t][e] && He[t][e].replace && e.charCodeAt(0) !== 55349 && !(hd.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = He[t][e].replace), new K.TextNode(e);
}, Go = function(e) {
...
var xd = function(e) {
  ...
  var a = xd(n), i = qs(e, a), s = L.makeSpan(["katex"], [i]);
  return wd(s, n);
}, Ap = {
  widehat: "^",
  widecheck: "ˇ",
  ...
  var t = new K.MathNode("mo", [new K.TextNode(Ap[e.replace(/^\\/, "")])]);
  ...
  function n() {
    ...
    if (ue.contains(["widehat", "widecheck", "widetilde", "utilde"], l)) {
      ...
      var _ = [], w = Op[l], [C, T, k] = w, N = k / 1e3, I = C.length, D, M;
      if (I === 1) {
        var F = w[3];
        D = ["hide-tail"], M = [F];
      } else if (I === 2)
  ...
  return a.height = s, a.style.height = Y(s), i > 0 && (a.style.minWidth = Y(i)), a;
}, Ip = function(e, t, n, a, i) {
  ...
  return s.height = o, s.style.height = Y(o), s;
}, Er = {
  encloseSpan: Ip,
  mathMLnode: Mp,
  svgSpan: Rp
...
function Mi(r) {
  return r && (r.type === "atom" || ip.hasOwnProperty(r.type)) ? r : null;
}
var Jo = (r, e) => {
  var t, n, a;
  r && r.type === "supsub" ? (n = Se(r.base, "accent"), t = n.base, r.base = t, a = np(De(r, e)), r.base = n) : (n = Se(r, "accent"), t = n.base);
  ...
  if (n.isStretchy)
    ...
    var x = o;
    y || (x -= v / 2), m.style.left = Y(x), n.label === "\\textcircled" && (m.style.top = ".2em"), m = L.makeVList({
      positionType: "firstBaseline",
      children: [{
        type: "elem",
        elem: i
  ...
  var t = r.isStretchy ? Er.mathMLnode(r.label) : new K.MathNode("mo", [Vt(r.label, r.mode)]), n = new K.MathNode("mover", [ze(r.base, e), t]);
  return n.setAttribute("accent", "true"), n;
}, Fp = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r) => "\\" + r).join("|"));
Z({
  type: "accent",
  ...
  handler: (r, e) => {
    var t = pi(e[0]), n = !Fp.test(r.funcName), a = !n || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: r.parser.mode,
      label: r.funcName,
...
Z({
  ...
  mathmlBuilder(r, e) {
    ...
    var n;
    if (r.body) {
      var a = Ya(ze(r.body, e));
      if (r.below) {
        var i = Ya(ze(r.below, e));
        n = new K.MathNode("munderover", [t, i, a]);
      } else
        n = new K.MathNode("mover", [t, a]);
    } else if (r.below) {
      var s = Ya(ze(r.below, e));
      n = new K.MathNode("munder", [t, s]);
    } else
      n = Ya(), n = new K.MathNode("mover", [t, n]);
    return n;
  }
});
var Lp = L.makeSpan;
...
var zp = {
  ...
  mode: "math",
  style: "display"
}), Pl = (r) => r.type === "textord" && r.text === "@", Pp = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function Bp(r, e, t) {
  var n = zp[r];
  switch (n) {
    case "\\\\cdrightarrow":
  ...
  for (var n = [], a = [n], i = 0; i < e.length; i++) {
    for (var s = e[i], o = zl(), l = 0; l < s.length; l++)
      if (!Pl(s[l]))
        ...
        n.push(o), l += 1;
        var u = Yo(s[l]).text, c = new Array(2);
        if (c[0] = {
          type: "ordgroup",
          mode: "math",
          body: []
...
Z({
  ...
  htmlBuilder(r, e) {
    ...
    return n.classes.push("cd-label-" + r.side), n.style.bottom = Y(0.8 - n.depth), n.height = 0, n.depth = 0, n;
  },
  mathmlBuilder(r, e) {
...
Z({
  ...
  htmlBuilder(r, e) {
    ...
    return r.newLine && (t.classes.push("newline"), r.size && (t.style.marginTop = Y(Je(r.size, e)))), t;
  },
  mathmlBuilder(r, e) {
    var t = new K.MathNode("mspace");
    return r.newLine && (t.setAttribute("linebreak", "newline"), r.size && t.setAttribute("height", Y(Je(r.size, e)))), t;
  }
});
var Hs = {
  "\\global": "\\global",
...
Z({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, n = Ed(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var a = $p(e);
    return Td(e, n, a, t === "\\\\globallet"), {
      type: "internal",
      mode: e.mode
    };
  }
...
Z({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, n = Ed(e.gullet.popToken()), a = e.gullet.popToken(), i = e.gullet.popToken();
    return Td(e, n, i, t === "\\\\globalfuture"), e.gullet.pushToken(i), e.gullet.pushToken(a), {
      type: "internal",
      mode: e.mode
    };
  }
...
var ra = function(e, t, n) {
...
}, qp = function(e, t, n, a, i, s) {
  var o = L.makeSymbol(e, "Main-Regular", i, a), l = Xo(o, t, a, s);
  return n && Ad(l, a, t), l;
}, Hp = function(e, t, n, a) {
  return L.makeSymbol(e, "Size" + t + "-Regular", n, a);
}, Md = function(e, t, n, a, i, s) {
  var o = Hp(e, t, i, a), l = Xo(L.makeSpan(["delimsizing", "size" + t], [o], a), fe.TEXT, a, s);
  return n && Ad(l, a, fe.TEXT), l;
}, es = function(e, t, n) {
  var a;
  ...
  return o.height = t, o.style.height = Y(t), o.style.width = Y(a), {
    type: "elem",
    elem: o
  };
}, Us = 8e-3, Ja = {
  ...
  var z = M / 2 - F, j = [];
  if (d.length > 0) {
    var P = M - y - C, J = Math.round(M * 1e3), V = Jf(d, Math.round(P * 1e3)), ee = new Lr(d, V), ce = (m / 1e3).toFixed(3) + "em", X = (J / 1e3).toFixed(3) + "em", de = new kr([ee], {
      width: ce,
      height: X,
      viewBox: "0 0 " + m + " " + J
    }), le = L.makeSvgSpan([], [de], a);
    le.height = J / 1e3, le.style.width = ce, le.style.height = X, j.push({
      type: "elem",
      elem: le
    });
  } else {
    if (j.push(es(c, g, i)), j.push(Ja), l === null) {
      var Ne = M - y - C + 2 * Us;
      j.push(ts(u, Ne, a));
    } else {
      var se = (M - y - C - T) / 2 + 2 * Us;
      j.push(ts(u, se, a)), j.push(Ja), j.push(es(l, g, i)), j.push(Ja), j.push(ts(u, se, a));
    }
    j.push(Ja), j.push(es(o, g, i));
  }
  ...
  return Xo(L.makeSpan(["delimsizing", "mult"], [Be], Pe), fe.TEXT, a, s);
}, rs = 80, ns = 0.08, as = function(e, t, n, a, i) {
  var s = Vf(e, a, n), o = new Lr(e, s), l = new kr([o], {
  ...
  var n = t.havingBaseSizing(), a = Fd("\\surd", e * n.sizeMultiplier, Id, n), i = n.sizeMultiplier, s = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), o, l = 0, u = 0, c = 0, d;
  return a.type === "small" ? (c = 1e3 + 1e3 * s + rs, e < 1 ? i = 1 : e < 1.4 && (i = 0.7), l = (1 + s + ns) / i, u = (1 + s) / i, o = as("sqrtMain", l, c, s, t), o.style.minWidth = "0.853em", d = 0.833 / i) : a.type === "large" ? (c = (1e3 + rs) * sa[a.size], u = (sa[a.size] + s) / i, l = (sa[a.size] + s + ns) / i, o = as("sqrtSize" + a.size, l, c, s, t), o.style.minWidth = "1.02em", d = 1 / i) : (l = e + s + ns, u = e + s, c = Math.floor(1e3 * e + s) + rs, o = as("sqrtTall", l, c, s, t), o.style.minWidth = "0.742em", d = 1.056), o.height = u, o.style.height = Y(l), {
    span: o,
    advanceWidth: d,
...
}, Dd = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"], Gp = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"], Rd = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], sa = [0, 1.2, 1.8, 2.4, 3], Vp = function(e, t, n, a, i) {
  if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), ue.contains(Dd, e) || ue.contains(Rd, e))
    return Md(e, t, !1, n, a, i);
  if (ue.contains(Gp, e))
    return Od(e, sa[t], !1, n, a, i);
  ...
  return n[n.length - 1];
}, Ld = function(e, t, n, a, i, s) {
  e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
  var o;
  ue.contains(Rd, e) ? o = Yp : ue.contains(Dd, e) ? o = Id : o = Jp;
  var l = Fd(e, t, o, a);
  return l.type === "small" ? qp(e, l.style, n, a, i, s) : l.type === "large" ? Md(e, l.size, n, a, i, s) : Od(e, t, n, a, i, s);
}, Zp = function(e, t, n, a, i, s) {
...
}, Qp = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
function Di(r, e) {
  var t = Mi(r);
  if (t && ue.contains(Qp, t.text))
    return t;
...
Z({
  ...
  mathmlBuilder: (r) => {
    var e = [];
    r.delim !== "." && e.push(Vt(r.delim, r.mode));
    ...
    var n = Y(Sr.sizeToMaxHeight[r.size]);
...
Z({
  ...
  mathmlBuilder: (r, e) => {
    ...
    var t = Dt(r.body, e);
    if (r.left !== ".") {
      var n = new K.MathNode("mo", [Vt(r.left, r.mode)]);
      n.setAttribute("fence", "true"), t.unshift(n);
    }
    if (r.right !== ".") {
      var a = new K.MathNode("mo", [Vt(r.right, r.mode)]);
...
Z({
  ...
  mathmlBuilder: (r, e) => {
    var t = r.delim === "\\vert" || r.delim === "|" ? Vt("|", "text") : Vt(r.delim, r.mode), n = new K.MathNode("mo", [t]);
...
var Zo = (r, e) => {
  ...
  if (n === "sout")
    ...
    t.style.paddingLeft = Y(d / 2 + l);
    var m = Math.floor(1e3 * d * a), g = Kf(m), v = new kr([new Lr("phase", g)], {
      width: "400em",
      height: Y(m / 1e3),
      viewBox: "0 0 400000 " + m,
      preserveAspectRatio: "xMinYMin slice"
    });
    i = L.makeSvgSpan(["hide-tail"], [v], e), i.style.height = Y(d), s = t.depth + l + u;
  } else {
...
var dr = function(e, t) {
  ...
  var v = e.colSeparationType === "CD" ? Je({
    number: 3,
    unit: "ex"
  ...
  for (T(s[0]), n = 0; n < e.body.length; ++n) {
    ...
    F && (z = Je(F, t), z > 0 && (z += w, I < z && (I = z), z = 0)), e.addJot && (I += y), D.height = N, D.depth = I, C += N, D.pos = C, C += I + z, l[n] = D, T(s[n + 1]);
  }
  var j = C / 2 + t.fontMetrics().axisHeight, P = e.cols || [], J = [], V, ee, ce = [];
  if (e.tags && e.tags.some(($e) => $e))
    for (n = 0; n < i; ++n) {
      var X = l[n], de = X.pos - j, le = e.tags[n], Ne = void 0;
      le === !0 ? Ne = L.makeSpan(["eqn-num"], [], t) : le === !1 ? Ne = L.makeSpan([], [], t) : Ne = L.makeSpan([], ft(le, t, !0), t), Ne.depth = X.depth, Ne.height = X.height, ce.push({
        type: "elem",
        elem: Ne,
        shift: de
      });
  ...
  for (
    ...
    for (var se = P[ee] || {}, Pe = !0; se.type === "separator"; ) {
      if (Pe || (V = L.makeSpan(["arraycolsep"], []), V.style.width = Y(t.fontMetrics().doubleRuleSep), J.push(V)), se.separator === "|" || se.separator === ":") {
        var Be = se.separator === "|" ? "solid" : "dashed", je = L.makeSpan(["vertical-separator"], [], t);
        je.style.height = Y(C), je.style.borderRightWidth = Y(c), je.style.borderRightStyle = Be, je.style.margin = "0 " + Y(-c / 2);
        var dt = C - j;
        dt && (je.style.verticalAlign = Y(-dt)), J.push(je);
      } else
    ...
    if (!(a >= o)) {
      var Xe = void 0;
      (a > 0 || e.hskipBeforeAndAfter) && (Xe = ue.deflt(se.pregap, m), Xe !== 0 && (V = L.makeSpan(["arraycolsep"], []), V.style.width = Y(Xe), J.push(V)));
      var Ge = [];
      for (n = 0; n < i; ++n) {
        var Rt = l[n], wt = Rt[a];
        if (wt) {
      ...
      Ge = L.makeVList({
        positionType: "individualShift",
        children: Ge
      }, t), Ge = L.makeSpan(["col-align-" + (se.align || "c")], [Ge]), J.push(Ge), (a < o - 1 || e.hskipBeforeAndAfter) && (Xe = ue.deflt(se.postgap, m), Xe !== 0 && (V = L.makeSpan(["arraycolsep"], []), V.style.width = Y(Xe), J.push(V)));
    }
  }
  ...
  if (e.cols && e.cols.length > 0) {
    ...
    for (var C = _; C < w; C++)
      v[C].type === "align" ? (g += e4[v[C].align], x && (y += "none "), x = !0) : v[C].type === "separator" && x && (y += v[C].separator === "|" ? "solid " : "dashed ", x = !1);
...
var qd = (r, e) => {
  ...
  var t = qd(r.size, e.style), n = t.fracNum(), a = t.fracDen(), i;
  i = e.havingStyle(n);
  ...
  r.hasBarLine ? (r.barSize ? (d = Je(r.barSize, e), c = L.makeLineSpan("frac-line", e, d)) : c = L.makeLineSpan("frac-line", e), d = c.height, m = c.height) : (c = null, d = 0, m = e.fontMetrics().defaultRuleThickness);
  var g, v, y;
  ...
  if (!r.hasBarLine)
    ...
    var n = Je(r.barSize, e);
    t.setAttribute("linethickness", Y(n));
  }
  var a = qd(r.size, e.style);
...
Z({
  ...
  handler: (r, e) => {
    var {
      parser: t,
      funcName: n
    } = r, a = e[0], i = Of(Se(e[1], "infix").size), s = e[2], o = i.number > 0;
    return {
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
Z({
  ...
  htmlBuilder: (r, e) => {
    var t = Je(r.height, e), n = 0;
    r.totalheight.number > 0 && (n = Je(r.totalheight, e) - t);
    var a = 0;
    r.width.number > 0 && (a = Je(r.width, e));
    var i = {
      height: Y(t + n)
    };
    a > 0 && (i.width = Y(a)), n > 0 && (i.verticalAlign = Y(-n));
    var s = new tp(r.src, r.alt, i);
    return s.height = t, s.depth = n, s;
  },
  mathmlBuilder: (r, e) => {
    var t = new K.MathNode("mglyph", []);
    t.setAttribute("alt", r.alt);
    var n = Je(r.height, e), a = 0;
    if (r.totalheight.number > 0 && (a = Je(r.totalheight, e) - n, t.setAttribute("valign", Y(-a))), t.setAttribute("height", Y(n + a)), r.width.number > 0) {
      var i = Je(r.width, e);
...
var Ud = (r, e, t, n, a, i, s) => {
  ...
  if (l && i !== 0 && !o) {
    ...
    _.style.marginRight = Y(i), x.unshift(_);
  }
  ...
  var s = e.style, o = !1;
  s.size === fe.DISPLAY.size && i.symbol && !ue.contains(Wd, i.name) && (o = !0);
  var l;
  if (i.symbol) {
  ...
  var x = 0, _ = 0;
  return (l instanceof Gt || i.name === "\\oiint" || i.name === "\\oiiint") && !i.suppressBaseShift && (x = (l.height - l.depth) / 2 - e.fontMetrics().axisHeight, _ = l.italic), a ? Ud(l, t, n, e, s, _, x) : (x && (l.style.position = "relative", l.style.top = Y(x)), l);
}, Ia = (r, e) => {
  var t;
  if (r.symbol)
    t = new Ht("mo", [Vt(r.name, r.mode)]), ue.contains(Wd, r.name) && t.setAttribute("largeop", "false");
  else if (r.body)
    t = new Ht("mo", Dt(r.body, e));
  else {
    t = new Ht("mi", [new ia(r.name.slice(1))]);
    var n = new Ht("mo", [Vt("⁡", "text")]);
    r.parentIsSupSub ? t = new Ht("mrow", [t, n]) : t = yd([t, n]);
  }
  return t;
}, r4 = {
  "∏": "\\prod",
...
var Kd = (r, e) => {
  ...
  if (i.body.length > 0) {
    ...
    s = L.makeSpan(["mop"], [], e);
  return a ? Ud(s, t, n, e, e.style, 0, 0) : s;
}, a4 = (r, e) => {
  ...
  var u = new K.MathNode("mo", [Vt("⁡", "text")]);
...
Z({
  ...
  htmlBuilder(r, e) {
    var t = L.makeSpan(["mord", "rule"], [], e), n = Je(r.width, e), a = Je(r.height, e), i = r.shift ? Je(r.shift, e) : 0;
    return t.style.borderRightWidth = Y(n), t.style.borderTopWidth = Y(a), t.style.bottom = Y(i), t.width = n, t.height = a + i, t.depth = -i, t.maxFontSize = a * 1.125 * e.sizeMultiplier, t;
  },
  mathmlBuilder(r, e) {
    var t = Je(r.width, e), n = Je(r.height, e), a = r.shift ? Je(r.shift, e) : 0, i = e.color && e.getColor() || "black", s = new K.MathNode("mspace");
    s.setAttribute("mathbackground", i), s.setAttribute("width", Y(t)), s.setAttribute("height", Y(n));
    var o = new K.MathNode("mpadded", [s]);
    return a >= 0 ? o.setAttribute("height", Y(a)) : (o.setAttribute("height", Y(a)), o.setAttribute("depth", Y(-a))), o.setAttribute("voffset", Y(a)), o;
  }
});
function Gd(r, e, t) {
...
Z({
  ...
  htmlBuilder(r, e) {
    var t = Vl[r.style], n = e.havingStyle(t).withFont("");
    return Gd(r.body, n, e);
  },
  mathmlBuilder(r, e) {
    var t = Vl[r.style], n = e.havingStyle(t), a = Dt(r.body, n), i = new K.MathNode("mstyle", a), s = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
...
var s4 = function(e, t) {
  ...
  if (n)
    if (n.type === "op") {
      ...
      if (n.type === "accent")
        return ue.isCharacterBox(n.base) ? Jo : null;
      if (n.type === "horizBrace") {
        var s = !e.sub;
        return s === n.isOver ? Hd : null;
      } else
        return null;
    }
  else return null;
...
gn({
  ...
  htmlBuilder(r, e) {
    ...
    var x = e.sizeMultiplier, _ = Y(0.5 / u.ptPerEm / x), w = null;
    if (l) {
      var C = r.base && r.base.type === "op" && r.base.name && (r.base.name === "\\oiint" || r.base.name === "\\oiiint");
      (s instanceof Gt || C) && (w = Y(-s.italic));
    }
    var T;
    if (o && l) {
...
gn({
  ...
  mathmlBuilder(r, e) {
    var t = new K.MathNode("mo", [Vt(r.text, r.mode)]);
    if (r.family === "bin") {
      var n = Vo(r, e);
...
gn({
  ...
  mathmlBuilder(r, e) {
    var t = new K.MathNode("mi", [Vt(r.text, r.mode, e)]), n = Vo(r, e) || "italic";
...
gn({
  ...
  mathmlBuilder(r, e) {
    var t = Vt(r.text, r.mode, e), n = Vo(r, e) || "normal", a;
    return r.mode === "text" ? a = new K.MathNode("mtext", [t]) : /[0-9]/.test(r.text) ? a = new K.MathNode("mn", [t]) : r.text === "\\prime" ? a = new K.MathNode("mo", [t]) : a = new K.MathNode("mi", [t]), n !== Vd[a.type] && a.setAttribute("mathvariant", n), a;
  }
});
var ss = {
  "\\nobreak": "nobreak",
...
gn({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new K.MathNode("mtable", [new K.MathNode("mtr", [Yl(), new K.MathNode("mtd", [zr(r.body, e)]), Yl(), new K.MathNode("mtd", [zr(r.tag, e)])])]);
...
var Jl = {
  ...
  return e.withTextFontShape(o4[t]);
};
Z({
  type: "text",
  names: [
...
var Ql = (r) => r.body.replace(/ /g, r.star ? "␣" : " "), Dr = vd, Yd = `[ \r
	]`, l4 = "\\\\[a-zA-Z@]+", u4 = "\\\\[^\uD800-\uDFFF]", c4 = "(" + l4 + ")" + Yd + "*", d4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, Ws = "[̀-ͯ]", h4 = new RegExp(Ws + "+$"), m4 = "(" + Yd + "+)|" + // whitespace
(d4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(Ws + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
class eu {
  ...
  constructor(e, t) {
    this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = new RegExp(m4, "g"), this.catcodes = {
      "%": 14,
      // comment character
      "~": 13
      // active character
...
var Jd = Y(ar["Main-Regular"][84][1] - 0.7 * ar["Main-Regular"][65][1]);
S("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + Jd + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
S("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + Jd + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
...
class g4 {
   ...
   */
  isDefined(e) {
    return this.macros.has(e) || Dr.hasOwnProperty(e) || He.math.hasOwnProperty(e) || He.text.hasOwnProperty(e) || Zd.hasOwnProperty(e);
  }
  /**
...
var nu = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, Xa = Object.freeze({
  "₊": "+",
  "₋": "-",
  "₌": "=",
  "₍": "(",
...
class Ii {
  constructor(e, t) {
    this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new g4(e, t, this.mode), this.settings = t, this.leftrightDepth = 0;
  }
  /**
  ...
  parseAtom(e) {
    ...
    for (var n, a; ; ) {
      ...
      if (i.text === "\\limits" || i.text === "\\nolimits") {
        ...
        for (c.push(new Kt(Xa[i.text])), this.consume(); ; ) {
          var d = this.fetch().text;
          if (!Xa[d] || nu.test(d) !== u)
            break;
          c.unshift(new Kt(Xa[d])), this.consume();
        }
  ...
  parseSymbol() {
    ...
    if (He[this.mode][t]) {
      ...
      this.settings.strict && (od(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '"' + (" (" + t.charCodeAt(0) + ")"), e)), s = {
        type: "textord",
        mode: "text",
        loc: Ft.range(e),
        text: t
...
typeof document < "u" && document.compatMode !== "CSS1Compat" && (typeof console < "u" && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), Qd = function() {
...
const x4 = mt.lazy(() => import("./EquationComponent-cRQkT1N0.js"));
function iu(r) {
...
class $n extends ur {
  ...
  exportDOM() {
    ...
    return t.setAttribute("data-lexical-equation", n), t.setAttribute("data-lexical-inline", `${this.__inline}`), th.render(this.__equation, t, {
...
const w4 = mt.lazy(() => import("./ExcalidrawComponent-BqU_sDGN.js"));
function _4(r) {
...
class on extends ur {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  decorate(t, n) {
    return /* @__PURE__ */ p.jsx(jr, { fallback: null, children: /* @__PURE__ */ p.jsx(w4, { nodeKey: this.getKey(), data: this.__data }) });
  }
}
function rh() {
  return new on();
...
const S4 = mt.lazy(() => import("./PollComponent-BbQEpcr6.js"));
function C4() {
...
const N4 = mt.lazy(() => import("./InlineImageComponent-CXHgcQe5.js"));
function E4(r) {
...
const A4 = mt.lazy(() => import("./StickyComponent-CdqOMjxd.js"));
class Mn extends ur {
...
const O4 = [
  ...
  Mn,
  _o
], Qa = 0, Gs = 1, Vs = 2, Yt = 0, D4 = 1, uu = 2, R4 = 3, I4 = 4;
function F4(r, e, t, n, a) {
  if (r === null || t.size === 0 && n.size === 0 && !a) return Yt;
  const i = e._selection, s = r._selection;
  if (a) return D4;
  if (!(U(i) && U(s) && s.isCollapsed() && i.isCollapsed())) return Yt;
  ...
  if (o.length === 0) return Yt;
  if (o.length > 1) {
    const _ = e._nodeMap, w = _.get(i.anchor.key), C = _.get(s.anchor.key);
    return w && C && !r._nodeMap.has(w.__key) && _e(w) && w.__text.length === 1 && i.anchor.offset === 1 ? uu : Yt;
  }
  const l = o[0], u = r._nodeMap.get(l.__key);
  if (!_e(u) || !_e(l) || u.__mode !== l.__mode) return Yt;
  const c = u.__text, d = l.__text;
  if (c === d) return Yt;
  const m = i.anchor, g = s.anchor;
  if (m.key !== g.key || m.type !== "text") return Yt;
  const v = m.offset, y = g.offset, x = d.length - c.length;
  return x === 1 && y === v - 1 ? uu : x === -1 && y === v + 1 ? R4 : x === -1 && y === v ? I4 : Yt;
}
function L4(r, e) {
  let t = Date.now(), n = Yt;
  return (a, i, s, o, l, u) => {
    const c = Date.now();
    if (u.has("historic")) return n = Yt, t = c, Vs;
    const d = F4(a, i, o, l, r.isComposing()), m = (() => {
      const g = s === null || s.editor === r, v = u.has("history-push");
      if (!v && g && u.has("history-merge")) return Qa;
      if (a === null) return Gs;
      const y = i._selection;
      return o.size > 0 || l.size > 0 ? v === !1 && d !== Yt && d === n && c < t + e && g || o.size === 1 && function(x, _, w) {
      ...
      }(Array.from(o)[0], a, i) ? Qa : Gs : y !== null ? Qa : Vs;
    })();
    return t = c, n = d, m;
  };
}
...
function z4(r, e, t) {
  const n = L4(r, t);
  return Re(r.registerCommand(pc, () => (function(i, s) {
  ...
  }(r, e), !0), be), r.registerCommand(fc, () => (function(i, s) {
    const o = s.redoStack, l = s.undoStack;
    if (o.length !== 0) {
      const u = s.current;
  ...
  }(r, e), !0), be), r.registerCommand(_1, () => (cu(e), !1), be), r.registerCommand(w1, () => (cu(e), r.dispatchCommand(Zn, !1), r.dispatchCommand(Qn, !1), !0), be), r.registerUpdateListener(({ editorState: i, prevEditorState: s, dirtyLeaves: o, dirtyElements: l, tags: u }) => {
...
function P4({ delay: r, externalHistoryState: e }) {
  const [t] = oe();
...
const ih = ao({}), B4 = ({
  ...
  return /* @__PURE__ */ p.jsx(ih.Provider, { value: t, children: r });
}, j4 = () => Qu(ih), $4 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : $;
function q4(r) {
...
function V4(r, e, t, n) {
  ...
  return [r.registerNodeTransform(hn, (s) => {
    ...
    for (; ; ) {
      ...
      o.start === 0 ? [m, c] = c.splitText(o.end) : [, m, c] = c.splitText(o.start + d, o.end + d), m === void 0 && G4(165, "nodeToReplace");
      const v = n(m);
...
const Ys = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : $;
function du(r) {
  return r.getEditorState().read(sh(r.isComposing()));
}
function J4({ contentEditable: r, placeholder: e = null, ErrorBoundary: t }) {
  const [n] = oe(), a = function(i, s) {
    const [o, l] = H(() => i.getDecorators());
    return Ys(() => i.registerDecoratorListener((u) => {
      I1(() => {
        l(u);
      });
    }), [i]), $(() => {
...
function Js(r, e) {
  return Js = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t, n) {
    return t.__proto__ = n, t;
  }, Js(r, e);
}
var hu = { error: null }, Z4 = function(r) {
  var e, t;
  function n() {
  ...
  t = r, (e = n).prototype = Object.create(t.prototype), e.prototype.constructor = e, Js(e, t), n.getDerivedStateFromError = function(i) {
    return { error: i };
  };
  var a = n.prototype;
...
function Q4({ children: r, onError: e }) {
  return p.jsx(Z4, { fallback: p.jsx("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: r });
}
function eg({ defaultSelection: r }) {
  const [e] = oe();
  return $(() => {
    e.focus(() => {
...
function tg(r) {
  return r.registerCommand(Si, (e) => {
    ...
    const n = function(a) {
      const i = a.getNodes();
      if (em(i, (d) => si(d) && d.canIndent() ? d : null).length > 0) return !0;
...
function ig({ editor: r, ariaActiveDescendant: e, ariaAutoComplete: t, ariaControls: n, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: o, ariaLabel: l, ariaLabelledBy: u, ariaMultiline: c, ariaOwns: d, ariaRequired: m, autoCapitalize: g, className: v, id: y, role: x = "textbox", spellCheck: _ = !0, style: w, tabIndex: C, "data-testid": T, ...k }, N) {
  ...
  return oh(() => (D(r.isEditable()), r.registerEditableListener((z) => {
    D(z);
...
function lg(r, e) {
  ...
  return p.jsxs(p.Fragment, { children: [p.jsx(sg, { editor: a, ...n, ref: e }), t != null && p.jsx(ug, { editor: a, content: t })] });
}
function ug({ content: r, editor: e }) {
  const t = function(s) {
    const [o, l] = H(() => mu(s));
    return oh(() => {
      function u() {
...
function cg({
  ...
  return /* @__PURE__ */ p.jsx(og, { className: r || "content-editable__root" });
}
const Un = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", dg = Un && "documentMode" in document ? document.documentMode : null, Or = Un && /Mac|iPod|iPhone|iPad/.test(navigator.platform);
Un && "InputEvent" in window && !dg && "getTargetRanges" in new window.InputEvent("input");
const lh = mt.createContext(null), fu = 4;
function Ae({
  children: r,
  className: e,
  onClick: t,
  ...
  const a = Oe(null), i = mt.useContext(lh);
  if (i === null)
...
function hg({
  ...
  }, [n, i]), /* @__PURE__ */ p.jsx(lh.Provider, { value: u, children: /* @__PURE__ */ p.jsx("div", { className: "dropdown", ref: e, onKeyDown: l, children: r }) });
}
function cn({
  disabled: r = !1,
  buttonLabel: e,
  ...
  return $(() => {
    ...
    u && Zt(
      /* @__PURE__ */ p.jsx(hg, { dropDownRef: o, onClose: d, children: i }),
      document.body
    )
  ] });
}
...
const pg = en.lazy(() => import("./DataMentionComponent-BE4DbxEv.js"));
function gg(r) {
...
function cs(r) {
  return r & S1 ? "code" : r & C1 ? "mark" : r & k1 ? "sub" : r & N1 ? "sup" : null;
}
function ds(r) {
  return r & E1 ? "strong" : r & T1 ? "em" : "span";
}
function uh(r, e, t, n) {
  const a = t.classList;
  let i = us(n, "base");
...
class dn extends ur {
  ...
  toggleFormat(t) {
    if (this.isInput())
      return this;
    const n = this.getFormat(), a = fg(n, t);
  ...
  remove(t) {
    this.__data !== "input" && this.__decoratorSpan && vg(this.__decoratorSpan), super.remove(t);
  }
}
const d0 = ({
  dataMention: r,
  ...
  return ut(l);
}, bg = (r) => r instanceof dn, oa = (r) => r === null || r.getNodes().length !== 1 ? !1 : bg(r.getNodes()[0]), Gr = 8, Vr = 72, yg = 15;
function xg({
  selectionFontSize: r,
  disabled: e = !1,
  editor: t
  ...
  const [n, a] = mt.useState(r), i = (u, c) => {
    ...
    (u, c) => {
      const d = (m) => (m || (m = `${yg}px`), m = m.slice(0, -2), `${i(
        Number(m),
        c
      )}px`);
      t.update(() => {
    ...
    if (u.key === "Enter") {
      u.preventDefault();
      let d = c;
      c > Vr ? d = Vr : c < Gr && (d = Gr), a(String(d)), s(String(d) + "px", null);
    }
  }, l = (u) => {
    if (n !== "") {
      const c = i(
...
function ch({
  ...
  const [t, n] = H(Cn("hex", r)), [a, i] = H(r), s = Oe(null), o = it(
    ...
    const g = { ...t.hsv, h: m / Yn * 360 }, v = Cn("hsv", g);
    n(v), i(v.hex);
  };
  return $(() => {
    s.current !== null && e && (e(t.hex, Xs), i(t.hex));
  }, [t, e]), $(() => {
    if (r === void 0)
      return;
    const m = Cn("hex", r);
...
function bu({ className: r, style: e, onChange: t, children: n }) {
  const a = Oe(null), i = Oe(!1), s = (l) => {
    ...
    s(l);
    const u = (d) => {
      i.current = !0, Xs = !0, s(d);
    }, c = (d) => {
      i.current && (Xs = !1), document.removeEventListener("mousemove", u, !1), document.removeEventListener("mouseup", c, !1), s(d), i.current = !1;
    };
...
function Cn(r, e) {
  ...
  return r === "hex" ? (t = xu(e), n = wu(t), a = hs(n)) : r === "rgb" ? (n = e, t = _u(n), a = hs(n)) : r === "hsv" && (a = e, n = kg(a), t = _u(n)), { hex: t, hsv: a, rgb: n };
}
function Su({
  disabled: r = !1,
  ...
  return /* @__PURE__ */ p.jsx(
    cn,
    {
      ...
      children: /* @__PURE__ */ p.jsx(ch, { color: t, onChange: n })
    }
  );
}
const h0 = Ue();
...
const Ag = (r) => Un ? (r || window).getSelection() : null, La = Ue("INSERT_IMAGE_COMMAND");
function Mg({
  onClick: r
}) {
...
function hh({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    ...
    t === "url" && /* @__PURE__ */ p.jsx(Mg, { onClick: i }),
    t === "file" && /* @__PURE__ */ p.jsx(Og, { onClick: i })
  ] });
}
function Dg({
  captionsEnabled: r
...
const Rg = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", mh = document.createElement("img");
mh.src = Rg;
function Ig(r) {
  const e = m0();
  if (!e)
  ...
  return t ? (t.setData("text/plain", "_"), t.setDragImage(mh, 0, 0), t.setData(
...
function Fg(r) {
  return m0() ? (fh(r) || r.preventDefault(), !0) : !1;
}
function Lg(r, e) {
  const t = m0();
  if (!t)
...
function Pg(r) {
  let e;
  const t = r.target, n = t == null ? null : t.nodeType === 9 ? t.defaultView : t.ownerDocument.defaultView, a = Ag(n);
...
const qg = (r) => Un ? (r || window).getSelection() : null, f0 = Ue("INSERT_INLINE_IMAGE_COMMAND");
function Hg({
  activeEditor: r,
  onClose: e
}) {
...
const Wg = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", ph = document.createElement("img");
ph.src = Wg;
function Kg(r) {
  const e = p0();
  if (!e)
    return !1;
  const t = r.dataTransfer;
  return t ? (t.setData("text/plain", "_"), t.setDragImage(ph, 0, 0), t.setData(
    "application/x-lexical-drag",
    JSON.stringify({
      data: {
        altText: e.__altText,
...
function Gg(r) {
  return p0() ? (gh(r) || r.preventDefault(), !0) : !1;
}
function Vg(r, e) {
  const t = p0();
  if (!t)
...
function Jg(r) {
  let e;
  const t = r.target, n = t == null ? null : t.nodeType === 9 ? t.defaultView : t.ownerDocument.defaultView, a = qg(n);
  if (document.caretRangeFromPoint)
    e = document.caretRangeFromPoint(r.clientX, r.clientY);
  else if (r.rangeParent && a !== null)
    a.collapse(r.rangeParent, r.rangeOffset || 0), e = a.getRangeAt(0);
...
var r2 = function(e, t) {
  ...
  return t.reset = function() {
    ...
    if (s !== null && i.error !== null && r2(a.resetKeys, o)) {
      var l, u;
...
function i2({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    ...
    /* @__PURE__ */ p.jsx("div", { className: "KatexEquationAlterer_centerRow", children: /* @__PURE__ */ p.jsx(n2, { onError: (u) => t._onError(u), fallback: null, children: /* @__PURE__ */ p.jsx(
      a2,
      {
        equation: n,
        inline: !1,
...
const _h = Ue("INSERT_EQUATION_COMMAND");
function Sh({
  activeEditor: r,
  onClose: e
}) {
  const t = ie(
    (n, a) => {
      r.dispatchCommand(_h, { equation: n, inline: a }), e();
    },
    [r, e]
  );
  return /* @__PURE__ */ p.jsx(i2, { onConfirm: t });
}
function s2() {
  const [r] = oe();
  return $(() => {
...
const ku = "startTransition", l2 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : $;
let u2 = class {
  constructor(e) {
...
function d2({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ye }) {
...
function h2({ options: r, nodeKey: e, onClose: t, onOpen: n, onSelectOption: a, menuRenderFn: i, anchorClassName: s, commandPriority: o = ye, parent: l }) {
  const [u] = oe(), [c, d] = H(null), m = function(x, _, w, C = document.body, T = !0) {
    const [k] = oe(), N = Oe(document.createElement("div")), I = ie(() => {
      ...
      if (M !== null && x !== null) {
        const { left: j, top: P, width: J, height: V } = x.getRect(), ee = N.current.offsetHeight;
        if (F.style.top = `${P + ee + 3 + (T ? window.pageYOffset : 0)}px`, F.style.left = `${j + window.pageXOffset}px`, F.style.height = `${V}px`, F.style.width = `${J}px`, z !== null) {
          z.style.top = `${P}`;
          const ce = z.getBoundingClientRect(), X = ce.height, de = ce.width, le = M.getBoundingClientRect();
          j + de > le.right && (F.style.left = `${le.right - de + window.pageXOffset}px`), (P + X > window.innerHeight || P + X > le.bottom) && P - le.top > X + V && (F.style.top = `${P - X - V + (T ? window.pageYOffset : 0)}px`);
        }
  ...
  }, [u, y, e]), c === null || u === null ? null : p.jsx(d2, { close: g, resolution: c, editor: u, anchorElementRef: m, options: r, menuRenderFn: i, onSelectOption: a, commandPriority: o });
}
const m2 = /((https?:\/\/(www\.)?)|(www\.))[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)/, b0 = Ue("INSERT_EMBED_COMMAND");
let Au = class extends u2 {
  constructor(e, t) {
    super(e), this.title = e, this.onSelect = t.onSelect.bind(this);
  }
};
function f2({ embedConfigs: r, onOpenEmbedModalForConfig: e, getMenuOptions: t, menuRenderFn: n, menuCommandPriority: a = ye }) {
  ...
  return s != null ? p.jsx(h2, { nodeKey: s, onClose: c, onSelectOption: v, options: g, menuRenderFn: n, commandPriority: a }) : null;
}
const Ch = Ue(
...
function T2({
  ...
  const a = ie(
    (o) => {
      r.update(() => {
        const l = B();
        l !== null && (oa(l) ? l.getNodes()[0].patchStyle({ [t]: o }) : mo(l, {
          [t]: o
        }));
      });
    },
  ...
  return /* @__PURE__ */ p.jsx(
    cn,
    {
      ...
      buttonLabel: ((s = Mu.find(([o]) => o === e)) == null ? void 0 : s[1]) || e,
      buttonIconClassName: t === "font-family" ? "icon block-type font-family" : "",
      buttonAriaLabel: i,
      children: (t === "font-family" ? Mu : N2).map(
        ([o, l]) => /* @__PURE__ */ p.jsx(
          Ae,
          {
            className: `item ${qt(e === o)} ${t === "font-size" ? "fontsize-item" : ""}`,
            onClick: () => a(o),
          ...
          Ae,
          {
            ...
            children: [
              /* @__PURE__ */ p.jsx(
                "i",
                {
                  className: `icon ${t ? Jn.start.iconRTL : Jn.start.icon}`
                }
              ),
          ...
          Ae,
          {
            ...
            children: [
              /* @__PURE__ */ p.jsx(
                "i",
                {
                  className: `icon ${t ? Jn.end.iconRTL : Jn.end.icon}`
                }
              ),
...
function M2({ setIsLinkEditMode: r }) {
  const [e] = oe(), [t, n] = H("paragraph"), [a, i] = H(e), [s, o] = H("15px"), [l, u] = H("#000"), [c, d] = H("#fff"), [m, g] = H('"Noto Sans JP", serif'), [v, y] = H("left"), [x, _] = H(!1), [w, C] = H(!1), [T, k] = H(!1), [N, I] = H(!1), [D, M] = H(!1), [F, z] = H(!1), [j, P] = H(!1), [J, V] = H(!1), [ee, ce] = H(!1), [X, de] = H(!1), [le, Ne] = H(!1), [se, Pe] = H(() => e.isEditable()), [Be, je] = Fi(), dt = ie(() => {
    const te = B();
    if (te && oa(te)) {
      const we = te.getNodes()[0];
      C(we.hasFormat("bold")), k(we.hasFormat("italic")), I(we.hasFormat("underline")), M(we.hasFormat("strikethrough")), z(we.hasFormat("subscript")), P(we.hasFormat("superscript")), V(we.hasFormat("code")), o(we.getStyleValue("font-size", "15px")), u(we.getStyleValue("color", "#000")), d(we.getStyleValue("background-color", "#fff")), g(we.getStyleValue("font-family", '"Noto Sans JP", serif'));
    } else if (U(te)) {
      ...
      C(te.hasFormat("bold")), k(te.hasFormat("italic")), I(te.hasFormat("underline")), M(te.hasFormat("strikethrough")), z(te.hasFormat("subscript")), P(te.hasFormat("superscript")), V(te.hasFormat("code")), ce(wc(te));
      ...
      o(
        ...
        Pa(te, "font-family", '"Noto Sans JP", serif')
      );
      let It;
      lt($e) && (It = he(
        ht,
    ...
    a.update(() => {
      ...
      if (te && oa(te))
        ...
        _t.forEach((tt, ht) => {
          ...
          } else ml(tt) || Wm(tt) ? tt.replace(xe(), !0) : Ls(tt) && tt.setFormat("");
        });
      }
    });
  }, [a]), Rt = ie(
  ...
  return /* @__PURE__ */ p.jsxs("div", { className: "toolbar", children: [
    ...
    /* @__PURE__ */ p.jsx(Jr, {}),
    /* @__PURE__ */ p.jsx(xg, { selectionFontSize: s.slice(0, -2), editor: e, disabled: !se }),
    /* @__PURE__ */ p.jsx(Jr, {}),
    /* @__PURE__ */ p.jsx(
      "button",
      {
...
function D2() {
  const [r] = oe();
  return $(() => Re(r.registerCommand(xo, () => (As(r, "check"), !0), ye), r.registerCommand(mn, (e) => Ru(e, r, !1), ye), r.registerCommand(fn, (e) => Ru(e, r, !0), ye), r.registerCommand(Dn, (e) => {
    if (eo() != null) {
      const t = r.getRootElement();
      return t != null && t.focus(), !0;
    }
    return !1;
  }, ye), r.registerCommand(O1, (e) => {
    const t = eo();
    ...
    e !== null && (e.addEventListener("click", Ou), e.addEventListener("pointerdown", Du)), t !== null && (t.removeEventListener("click", Ou), t.removeEventListener("pointerdown", Du));
  }))), null;
}
function Eh(r, e) {
  const t = r.target;
...
function B2() {
  const [r] = oe();
  return $(() => (Iu || (P2(), Iu = !0), r.registerCommand(
    mc,
    (e) => {
      const t = B();
      return U(t) && Th + z2 > e.timeStamp && yt(t.clone()), !1;
    },
    L2
  )), [r]), null;
}
const j2 = 10, $2 = 5;
function Fu(r, e, t, n = j2, a = $2) {
...
function q2({
  ...
  const s = Oe(null), o = Oe(null), [l, u] = H(""), [c, d] = H("https://"), [m, g] = H(
    ...
    if (_ !== null && C !== null && k !== null && k.contains(C.anchorNode) && r.isEditable()) {
      ...
      D && (D.y += 40, Fu(D, w, n)), g(_);
    } else (!T || T.className !== "link-input") && (k !== null && Fu(null, w, n), g(null), i(!1), u(""));
    return !0;
  }, [n, r, i, a, l]);
  $(() => {
...
function Oh(r) {
  ...
  return pe(e) && (e = e.getLastDescendant()), e === null || ga(e) || _e(e) && Mh(e.getTextContent());
}
function Dh(r) {
...
function V2(r, e, t, n) {
  return (r > 0 ? vi(t[r - 1]) : Oh(n[0])) ? e < t.length ? vi(t[e]) : Dh(n[n.length - 1]) : !1;
}
function Y2(r, e, t) {
  const n = [], a = [], i = [];
  let s = 0, o = 0;
...
function ps(r, e, t) {
  ...
  const i = r.getTextContent(), s = Ah(i, e);
  if (s === null || s.text !== i || !Oh(r) || !Dh(r)) return ni(r), void t(null, r.getURL());
  const o = r.getURL();
    ...
    return Re(r.registerNodeTransform(hn, (a) => {
      ...
      if (vr(i) && !i.getIsUnlinked()) ps(i, e, n);
        ...
        if (a.isSimpleText() && (to(a.getTextContent()) || !vr(s))) {
          ...
          (function(l, u, c) {
            ...
            for (; (g = Ah(v, u)) && g !== null; ) {
              ...
              if (V2(y + x, y + _, m, d)) {
                const [w, , C, T] = Y2(d, y + x, y + _), k = J2(C, y + x - w, y + _ - w, g);
        ...
        (function(o, l, u) {
          ...
          var g;
          !vr(c) || c.getIsUnlinked() || to(m) && (g = m, !(c.isEmailURI() ? /^\.[a-zA-Z]{2,}/.test(g) : /^\.[a-zA-Z0-9]{1,}/.test(g))) || (c.append(o), ps(c, l, u), u(null, c.getURL())), !vr(d) || d.getIsUnlinked() || Mh(m) || (ni(d), ps(d, l, u), u(null, d.getURL()));
        })(a, e, n);
      }
...
const Q2 = /((https?:\/\/(www\.)?)|(www\.))[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)/, e5 = /(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))/, t5 = [
  Lu(Q2, (r) => r.startsWith("http") ? r : `https://${r}`),
  Lu(e5, (r) => `mailto:${r}`)
];
function r5() {
...
function n5({ validateUrl: r, attributes: e }) {
  ...
  return $(() => {
    ...
    }, ye), r !== void 0 ? t.registerCommand(oc, (n) => {
      const a = B();
...
function a5() {
  return /* @__PURE__ */ p.jsx(n5, { validateUrl: Sg });
}
function i5(r, e, t) {
  const [n] = oe();
  $(() => Re(...V4(n, r, e, t)), [t, n, r, e]);
}
...
function o5() {
  ...
  const e = ie((n) => nd(n.getTextContent()), []), t = ie((n) => {
    const a = s5.exec(n);
    if (a === null)
      return null;
...
function l5(r) {
  ...
  for (let t = 0; t < e.length; t++) {
    const n = zu.get(e[t]) || zu.get(e.slice(t, t + 2));
    if (n !== void 0) {
      const [a, i] = n;
      let s;
...
const Pu = "startTransition", h5 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : $;
class x0 {
  constructor(e) {
    this.key = e, this.ref = { current: null }, this.setRefElement = this.setRefElement.bind(this);
  }
...
const $u = Ue("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
function f5({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ye }) {
  ...
  return $(() => () => {
    ...
    a === null ? c(null) : u === null && g(0);
  }, [a, u, g]), $(() => Re(e.registerCommand($u, ({ option: v }) => !(!v.ref || v.ref.current == null) && (Bu(v.ref.current), !0), l)), [e, g, l]), $(() => Re(e.registerCommand(mn, (v) => {
    const y = v;
    if (a !== null && a.length && u !== null) {
      const x = u !== a.length - 1 ? u + 1 : 0;
      g(x);
      const _ = a[x];
      _.ref != null && _.ref.current && e.dispatchCommand($u, { index: x, option: _ }), y.preventDefault(), y.stopImmediatePropagation();
    }
    return !0;
  }, l), e.registerCommand(fn, (v) => {
    const y = v;
    if (a !== null && a.length && u !== null) {
      ...
      g(x);
      const _ = a[x];
      _.ref != null && _.ref.current && Bu(_.ref.current), y.preventDefault(), y.stopImmediatePropagation();
    }
    return !0;
  }, l), e.registerCommand(Dn, (v) => {
    const y = v;
    ...
    const x = c.registerUpdateListener(() => {
      c.getEditorState().read(() => {
        ...
        if (e(k ? k.matchingString : null), k !== null && !function(I, D) {
          ...
          const j = z.anchorNode, P = D, J = z.anchorOffset;
          if (j == null || J == null) return !1;
          try {
            M.setStart(j, P), M.setEnd(j, J);
          } catch {
            return !1;
          }
          return !0;
        }(k.leadOffset, w, _) !== null)
          return N = () => y({ getRect: () => w.getBoundingClientRect(), match: k }), void (Pu in en ? en[Pu](N) : N());
        var N;
        v();
      });
    });
...
function b5(r, e) {
  return [
    ...
    new ot("Table", {
      ...
      onSelect: () => e("Insert Table", (t) => /* @__PURE__ */ p.jsx(vh, { activeEditor: r, onClose: t }))
    }),
    ...
    new ot("Poll", {
      ...
      keywords: ["poll", "vote"],
      onSelect: () => e("Insert Poll", (t) => /* @__PURE__ */ p.jsx(yh, { activeEditor: r, onClose: t }))
    }),
    ...y0.map(
    ...
    new ot("Equation", {
      ...
      onSelect: () => e("Insert Equation", (t) => /* @__PURE__ */ p.jsx(Sh, { activeEditor: r, onClose: t }))
    }),
    new ot("GIF", {
    ...
    new ot("Image", {
      ...
      onSelect: () => e("Insert Image", (t) => /* @__PURE__ */ p.jsx(hh, { activeEditor: r, onClose: t }))
    }),
    new ot("Collapsible", {
    ...
    new ot("Columns Layout", {
      ...
      onSelect: () => e("Insert Columns Layout", (t) => /* @__PURE__ */ p.jsx(wh, { activeEditor: r, onClose: t }))
    }),
        ...
        for (let d = 0; d < o; d++) {
          ...
          for (let g = 0; g < l; g++) {
            ...
            if (v.startRow === d && v.startColumn === g) m = y, c.push(y);
              ...
              ae(y) || ei(176);
              const x = Xt(y.__headerState);
              m !== null ? m.insertAfter(x) : tm(u, x);
            }
          }
        }
...
function M5({ editor: r }) {
      ...
      setTimeout(() => {
        ...
        if (c(v(j)), !(t.current && t.current.contains(P)) && e.current !== P) {
          ...
          J && o !== J ? r.update(() => {
            ...
            const ee = br(V), ce = r.getElementByKey(ee.getKey());
            if (!ce)
              throw new Error("TableCellResizer: Table element not found.");
            e.current = P, n.current = ce.getBoundingClientRect(), l(J);
          }) : J == null && g();
        }
      }, 0);
    }, M = () => {
  ...
  const y = (D) => D === "bottom", x = ie(
    ...
    (D) => {
      ...
      r.update(
        () => {
          ...
          if (J === void 0)
            return;
          const V = [...P], ee = Math.max(J + D, qu);
          V[j] = ee, F.setColWidths(V);
        },
        { tag: "skip-scroll-into-view" }
      );
    },
    ...
    (D) => {
      const M = (F) => {
        ...
        if (a.current) {
          ...
          const P = ks(F.target);
          if (y(D)) {
            const J = (F.clientY - j) / P;
            x(J);
          } else {
            const J = (F.clientX - z) / P;
            C(J);
          }
    ...
    if (o) {
      const { height: D, width: M, top: F, left: z } = o.elem.getBoundingClientRect(), j = ks(o.elem), P = 10, J = {
        bottom: {
      ...
      return d && i && V && (y(d) ? (J[d].left = `${window.pageXOffset + V.left}px`, J[d].top = `${window.pageYOffset + i.y / j}px`, J[d].height = "3px", J[d].width = `${V.width}px`) : (J[d].top = `${window.pageYOffset + V.top}px`, J[d].left = `${window.pageXOffset + i.x / j}px`, J[d].width = "3px", J[d].height = `${V.height}px`), J[d].backgroundColor = "#adf"), J;
    }
    return {
      bottom: null,
      left: null,
...
function I5({
  ...
  $(() => s.registerMutationListener(
    sr,
    (V) => {
      V.get(l.getKey()) === "updated" && (s.getEditorState().read(() => {
        u(l.getLatest());
      }), _(Uu(s) || ""));
    },
    ...
    const V = n.current, ee = o.current, ce = s.getRootElement();
    if (V != null && ee != null && ce != null) {
      const X = ce.getBoundingClientRect(), de = V.getBoundingClientRect();
      ee.style.opacity = "1";
      const le = ee.getBoundingClientRect(), Ne = 5;
      let se = de.right + Ne;
      if (se + le.width > window.innerWidth || se + le.width > X.right) {
  ...
  const w = ie(() => {
    s.update(() => {
      if (l.isAttached()) {
        ...
        const X = Is(ce);
        X !== null && X.clearHighlight(), ee.markDirty(), u(l.getLatest());
      }
      Ot().selectStart();
    });
  }, [s, l]), C = () => {
    s.update(() => {
      const V = B();
      if (Me(V)) {
        const { columns: ee, rows: ce } = gs(V), X = V.getNodes();
        let de = null;
        for (let le = 0; le < X.length; le++) {
          ...
          if (ae(Ne))
            ...
            } else ae(de) && (Hu(Ne) || de.append(...Ne.getChildren()), Ne.remove());
        }
    ...
    s.update(() => {
      const V = br(l), ee = Ao(l), ce = V.getChildren();
    ...
    s.update(() => {
      const V = br(l), ee = Yc(l), ce = V.getChildren(), X = Math.max(
    ...
    s.update(() => {
      if (l.isAttached()) {
        const V = br(l);
        V && V.setRowStriping(!V.getRowStriping());
      }
      w(), r();
    });
  }, [s, l, w, r]), P = ie(
    (V) => {
      s.update(() => {
        ...
        if (U(ee) || Me(ee)) {
          ...
          if (ae(ce) && ce.setBackgroundColor(V), Me(ee)) {
            const X = ee.getNodes();
            for (let de = 0; de < X.length; de++) {
              const le = X[de];
              ae(le) && le.setBackgroundColor(V);
            }
          }
        }
      });
...
class Xr {
  ...
  generateNewRect({
    ...
    return new Xr(e, t, n, a);
  }
  static fromLTRB(e, t, n, a) {
    return new Xr(e, t, n, a);
  }
  static fromLWTH(e, t, n, a) {
    return new Xr(e, n, e + t, n + a);
  }
  static fromPoints(e, t) {
    const { y: n, x: a } = e, { y: i, x: s } = t;
    return Xr.fromLTRB(a, n, s, i);
  }
  static fromDOM(e) {
    const { top: t, width: n, left: a, height: i } = e.getBoundingClientRect();
    return Xr.fromLWTH(a, n, t, i);
  }
}
const ro = 4, H5 = 2, U5 = "draggable-block-menu", Ku = "application/x-lexical-drag-block", Gu = 28, W5 = 1, K5 = -1, Vu = 0;
let ai = 1 / 0;
function G5(r) {
...
function bs(r, e, t, n = !1) {
  const a = r.getBoundingClientRect(), i = V5(e);
  let s = null;
  return e.getEditorState().read(() => {
    ...
    let o = G5(i.length), l = Vu;
    for (; o >= 0 && o < i.length; ) {
      const u = i[o], c = e.getElementByKey(u);
      if (c === null)
        break;
      const d = new Rh(t.x, t.y), m = Xr.fromDOM(c), { marginTop: g, marginBottom: v } = Ih(c), y = m.generateNewRect({
        bottom: m.bottom + v,
        left: a.left,
        right: a.right,
        top: m.top - g
...
function Z5(r, e, t, n) {
  const { top: a, height: i } = e.getBoundingClientRect(), { top: s, width: o } = n.getBoundingClientRect(), { marginTop: l, marginBottom: u } = Ih(e);
  let c = a;
  t >= a ? c += i + u / 2 : c -= l / 2;
  const d = c - s - H5, m = Gu - ro;
  r.style.transform = `translate(${m}px, ${d}px)`, r.style.width = `${o - (Gu - ro) * 2}px`, r.style.opacity = ".4";
}
function Q5(r) {
...
function e3(r, e, t) {
  ...
  $(() => {
    ...
    function m(g) {
      ...
      if (v)
        return !1;
      const { target: y, dataTransfer: x, pageY: _ } = g, w = (x == null ? void 0 : x.getData(Ku)) || "", C = At(w);
      if (!C || !vs(y))
        return !1;
      const T = bs(e, r, g, !0);
      if (!T)
...
const Fh = `\\.,\\+\\*\\?\\$\\@\\|#{}\\(\\)\\^\\-\\[\\]\\\\/!%'"~=<>_:;`, r3 = "\\b[A-Z][^\\s" + Fh + "]", n3 = {
  NAME: r3,
  PUNCTUATION: Fh
}, Lh = n3.PUNCTUATION, S0 = ["=\\$a", "=\\$i", "=\\$f"].join("|"), ys = "=$a", a3 = "=$i", i3 = "=$f", zh = "^(" + S0 + ")\\s|[^" + Lh + "\\s]", s3 = "(?:\\.[ |$]| |[" + Lh + "]|)", o3 = 75, l3 = new RegExp(
  "((" + S0 + ")((?:" + zh + s3 + "){0," + o3 + "}))"
), u3 = 50, c3 = new RegExp(
  "((" + S0 + ")((?:" + zh + "){0," + u3 + "}))"
), d3 = [
...
var w3 = typeof global == "object" && global && global.Object === Object && global, _3 = typeof self == "object" && self && self.Object === Object && self, Ph = w3 || _3 || Function("return this")(), bi = Ph.Symbol, Bh = Object.prototype, S3 = Bh.hasOwnProperty, C3 = Bh.toString, Xn = bi ? bi.toStringTag : void 0;
function k3(r) {
  var e = S3.call(r, Xn), t = r[Xn];
  try {
    r[Xn] = void 0;
    var n = !0;
  } catch {
  ...
  var a = C3.call(r);
  return n && (e ? r[Xn] = t : delete r[Xn]), a;
}
...
var Ju = NaN, B3 = /^[-+]0x[0-9a-f]+$/i, j3 = /^0b[01]+$/i, $3 = /^0o[0-7]+$/i, q3 = parseInt;
function Xu(r) {
  if (typeof r == "number")
    return r;
  if (I3(r))
  ...
  r = P3(r);
  var t = j3.test(r);
  return t || $3.test(r) ? q3(r.slice(2), t ? 2 : 8) : B3.test(r) ? Ju : +r;
}
var ws = function() {
  return Ph.Date.now();
  ...
  const y = (x) => {
    e.update(() => {
      if (m.current) {
        ...
        _ == null || _.selectEnd(), x ? (Jc(), a(!1)) : (Xc(), s(!1));
      }
    });
  };
...
function J3({
  ...
  return Fa() ? Zt(
    /* @__PURE__ */ p.jsx(V3, { anchorElem: r }),
    r
  ) : null;
}
function X3(r) {
  const { step: e, autoMentionData: t, autoAfterMentionData: n, onChange: a = () => {
  } } = r, { historyState: i } = j4(), s = /* @__PURE__ */ p.jsx(ag, { children: "Enter text..." }), [o, l] = H(null), [u, c] = H(!1), [d, m] = H(!1), g = (v) => {
    v !== null && l(v);
  };
  return $(() => {
    const v = () => {
    ...
    /* @__PURE__ */ p.jsxs("div", { className: "editor-container", children: [
      ...
      /* @__PURE__ */ p.jsx(P4, { externalHistoryState: i }),
      /* @__PURE__ */ p.jsx(r5, {}),
      /* @__PURE__ */ p.jsx(
        J4,
        {
          contentEditable: /* @__PURE__ */ p.jsx("div", { className: "editor-scroller", children: /* @__PURE__ */ p.jsx("div", { className: "editor", ref: g, children: /* @__PURE__ */ p.jsx(cg, {}) }) }),
          placeholder: s,
          ErrorBoundary: Q4
        }
      ),
      ...
      o && !u && /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
        ...
        /* @__PURE__ */ p.jsx(J3, { anchorElem: o }),
        /* @__PURE__ */ p.jsx(
          N5,
          {
            anchorElem: o
...
function d6(r) {
  ...
  return /* @__PURE__ */ p.jsxs($1, { initialConfig: l, children: [
    /* @__PURE__ */ p.jsx(Z3, { editorRef: o }),
    /* @__PURE__ */ p.jsx(B4, { initHistoryState: t, children: /* @__PURE__ */ p.jsx("div", { className: "editor-shell", children: /* @__PURE__ */ p.jsx(X3, { step: s, autoAfterMentionData: a, autoMentionData: i, onChange: n }) }) })
  ] });
}
export {
  bg as $,
