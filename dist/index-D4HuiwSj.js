...
const yf = mt.lazy(() => import("./ImageComponent-Dinp-cVS.js"));
function xf(r) {
  const e = r;
...
const Ng = mt.lazy(() => import("./EquationComponent-D_ctCgRa.js"));
function du(r) {
...
const Ag = mt.lazy(() => import("./ExcalidrawComponent-DOdzVjsS.js"));
function Mg(r) {
...
const Og = mt.lazy(() => import("./PollComponent-BKEyjuua.js"));
function Dg() {
...
const Ig = mt.lazy(() => import("./InlineImageComponent-BWOSq-K5.js"));
function Fg(r) {
...
const zg = mt.lazy(() => import("./StickyComponent-B6moBnuX.js"));
class On extends ur {
...
const _4 = tn.lazy(() => import("./DataMentionComponent-C9o35sMD.js"));
function C4(r) {
  ...
  function l(u, d) {
    s.getEditorState().read(() => {
      ...
      m !== null && (a.current ? (g = a.current) == null || g.scrollTo({
        top: m.offsetTop - a.current.offsetTop,
        behavior: "smooth"
