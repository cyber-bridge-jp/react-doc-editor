import { l as k } from "./LexicalCollaborationContext.prod-BooDYVUZ.js";
import { aj as u, ak as y } from "./index-B1XK6w54.js";
...
function W({ initialEditor: e, children: r, initialNodes: n, initialTheme: g, skipCollabChecks: _ }) {
  ...
  }, []), { isCollabActive: x, yjsDocMap: M } = k(), c = _ || p.current || M.has(e.getKey());
  return m(() => {
    c && (p.current = !0);
