...
import rn, { createContext as uo, useContext as sc, useMemo as it, useLayoutEffect as jr, useEffect as B, useState as q, useCallback as ie, Suspense as $r, useRef as Te, forwardRef as oc } from "react";
import { createEditor as va, $getRoot as wt, $createParagraphNode as xe, $getSelection as j, $isElementNode as ue, $isRangeSelection as U, $isTextNode as _e, $isTokenOrSegmented as Ki, $getAdjacentNode as Ts, $isDecoratorNode as wr, $isRootNode as co, $getCharacterOffsets as g1, $isRootOrShadowRoot as Pt, $isLineBreakNode as ba, $getPreviousSelection as ho, $splitNode as v1, TextNode as Hr, $applyNodeReplacement as ut, ElementNode as _t, $isTabNode as lc, $createTabNode as mo, $createLineBreakNode as oi, isHTMLElement as Cr, isHTMLAnchorElement as b1, createCommand as ze, $isParagraphNode as qr, $createTextNode as Ir, INSERT_PARAGRAPH_COMMAND as ca, COMMAND_PRIORITY_LOW as ye, $isLeafNode as uc, $isNodeSelection as gt, $createNodeSelection as y1, $setSelection as xt, $getNodeByKey as bt, DecoratorNode as ur, KEY_BACKSPACE_COMMAND as ya, KEY_DELETE_COMMAND as xa, CLICK_COMMAND as wa, $cloneWithProperties as cc, isDocumentFragment as $0, ArtificialNode__DO_NOT_USE as dc, $isBlockElementNode as li, isBlockDomNode as H0, isInlineDomNode as q0, SELECTION_INSERT_CLIPBOARD_NODES_COMMAND as hc, $parseSerializedNode as x1, COPY_COMMAND as mc, COMMAND_PRIORITY_CRITICAL as pt, isSelectionWithinEditor as w1, $getEditor as _1, PASTE_COMMAND as fc, isSelectionCapturedInDecoratorInput as S1, COMMAND_PRIORITY_EDITOR as ve, CUT_COMMAND as pc, SELECT_ALL_COMMAND as C1, $selectAll as k1, DRAGOVER_COMMAND as _i, $getNearestNodeFromDOMNode as Qe, DRAGSTART_COMMAND as fo, DROP_COMMAND as Si, $createRangeSelection as _a, $normalizeSelection__EXPERIMENTAL as po, KEY_ESCAPE_COMMAND as Rn, KEY_ENTER_COMMAND as go, INSERT_LINE_BREAK_COMMAND as U0, DELETE_CHARACTER_COMMAND as ia, OUTDENT_CONTENT_COMMAND as ui, KEY_ARROW_RIGHT_COMMAND as Ci, KEY_ARROW_LEFT_COMMAND as Sa, KEY_ARROW_DOWN_COMMAND as mn, KEY_ARROW_UP_COMMAND as fn, INDENT_CONTENT_COMMAND as ki, INSERT_TAB_COMMAND as gc, $insertNodes as In, FORMAT_ELEMENT_COMMAND as er, FORMAT_TEXT_COMMAND as yt, REMOVE_TEXT_COMMAND as E1, CONTROLLED_TEXT_INSERTION_COMMAND as vc, DELETE_LINE_COMMAND as Ns, DELETE_WORD_COMMAND as bc, setNodeIndentFromDOM as yc, COMMAND_PRIORITY_HIGH as Lt, KEY_TAB_COMMAND as Ei, FOCUS_COMMAND as xc, SELECTION_CHANGE_COMMAND as yr, $createRangeSelectionFromDom as T1, TEXT_TYPE_TO_FORMAT as Rr, isCurrentlyReadOnlyMode as N1, $createPoint as K0, CAN_REDO_COMMAND as ea, CAN_UNDO_COMMAND as ta, CLEAR_HISTORY_COMMAND as A1, CLEAR_EDITOR_COMMAND as M1, REDO_COMMAND as wc, UNDO_COMMAND as _c, IS_CODE as O1, IS_HIGHLIGHT as D1, IS_SUBSCRIPT as R1, IS_SUPERSCRIPT as I1, IS_BOLD as F1, IS_ITALIC as L1, IS_UNDERLINE as W0, IS_STRIKETHROUGH as G0, KEY_MODIFIER_COMMAND as P1, COMMAND_PRIORITY_NORMAL as z1, KEY_SPACE_COMMAND as B1, getNearestEditorFromDOMNode as j1, $nodesOfType as $1 } from "lexical";
...
function q1() {
  if (V0) return Vn;
  V0 = 1;
  var r = rn, e = Symbol.for("react.element"), t = Symbol.for("react.fragment"), n = Object.prototype.hasOwnProperty, a = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, i = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(o, l, c) {
...
function U1() {
  return X0 || (X0 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(O) {
      {
        for (var K = arguments.length, Q = new Array(K > 1 ? K - 1 : 0), be = 1; be < K; be++)
          Q[be - 1] = arguments[be];
        C("error", O, Q);
      }
    }
    ...
    var k = !1, E = !1, T = !1, I = !1, D = !1, M;
    M = Symbol.for("react.module.reference");
    function F(O) {
      return !!(typeof O == "string" || typeof O == "function" || O === n || O === i || D || O === a || O === c || O === u || I || O === g || k || E || T || typeof O == "object" && O !== null && (O.$$typeof === m || O.$$typeof === d || O.$$typeof === s || O.$$typeof === o || O.$$typeof === l || // This needs to include all possible module reference object
      ...
      if (typeof O == "object")
        switch (O.$$typeof) {
          ...
          case d:
            ...
            return be !== null ? be : z(O.type) || "Memo";
          case m: {
...
` + Je + O;
    ...
    function ee(O, K) {
      ...
      var Le;
      Le = dt.current, dt.current = null, je();
      try {
        if (K) {
          var Ae = function() {
            throw Error();
        ...
        if (At && be && typeof At.stack == "string") {
...
` + Ne[rt].replace(" at new ", " at ");
                    return O.displayName && $t.includes("<anonymous>") && ($t = $t.replace("<anonymous>", O.displayName)), typeof O == "function" && St.set(O, $t), $t;
                  }
                while (rt >= 1 && st >= 0);
              break;
            }
        ...
        Rt = !1, dt.current = Le, $e(), Error.prepareStackTrace = Ie;
      }
      var yn = O ? O.displayName || O.name : "", Wr = yn ? Ge(yn) : "";
      return typeof O == "function" && St.set(O, Wr), Wr;
    }
    function we(O, K, Q) {
      return ee(O, !1);
    }
    ...
    var tt = Object.prototype.hasOwnProperty, ht = {}, He = _.ReactDebugCurrentFrame;
    function It(O) {
      if (O) {
          ...
          if (Le(O, Ae)) {
            ...
            try {
              if (typeof O[Ae] != "function") {
                var kt = Error((be || "React class") + ": " + Q + " type `" + Ae + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof O[Ae] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw kt.name = "Invariant Violation", kt;
              }
              Ne = O[Ae](K, Ae, be, Q, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (rt) {
              Ne = rt;
            }
            Ne && !(Ne instanceof Error) && (It(Ie), w("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", be || "React class", Q, Ae, typeof Ne), It(null)), Ne instanceof Error && !(Ne.message in ht) && (ht[Ne.message] = !0, It(Ie), w("Failed %s type: %s", Q, Ne.message), It(null));
          }
      }
    }
    ...
    var r1 = function(O, K, Q, be, Ie, Le, Ae) {
      var Ne = {
    ...
    function n1(O, K, Q, be, Ie) {
      {
        ...
        return r1(O, Ne, kt, Ie, be, Yn.current, Ae);
      }
    }
    var $i = _.ReactCurrentOwner, I0 = _.ReactDebugCurrentFrame;
    function bn(O) {
      if (O) {
        var K = O._owner, Q = Ct(O.type, O._source, K ? K.type : null);
    ...
    function P0(O, K) {
      {
        ...
        L0[Q] = !0;
        var be = "";
        O && O._owner && O._owner !== $i.current && (be = " It was passed a child from " + z(O._owner.type) + "."), bn(O), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', Q, be), bn(null);
      }
    }
    function z0(O, K) {
      {
    ...
    function j0(O, K, Q, be, Ie, Le) {
      {
        ...
        if (!Ae) {
          ...
          kt ? Ne += kt : Ne += F0();
          var rt;
          O === null ? rt = "null" : Bi(O) ? rt = "array" : O !== void 0 && O.$$typeof === e ? (rt = "<" + (z(O.type) || "Unknown") + " />", Ne = " Did you accidentally export a JSX literal instead of a component?") : rt = typeof O, w("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", rt, Ne);
        }
        ...
        if (tt.call(K, "key")) {
          var Wr = z(O), At = Object.keys(K).filter(function(m1) {
            return m1 !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Ui, Wr, h1, Wr), B0[Wr + Ui] = !0;
          }
        }
...
const Cc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Y1 = Cc ? jr : B, za = { tag: "history-merge" };
function V1({ initialConfig: r, children: e }) {
  ...
  }, []), p.jsx(Sc.Provider, { value: t, children: e });
}
const X1 = {
...
function bo(r, e) {
  ...
  if (t.length === 1) {
    if (_e(l) && l.canHaveFormat()) {
      if (v = x === "element" ? 0 : m > d ? d : m, b = _ === "element" ? u : m > d ? m : d, v === b) return;
      if (Ki(l) || v === 0 && b === u) xn(l, e), l.select(v, b);
      else {
        const C = l.splitText(v, b), k = v === 0 ? C[0] : C[1];
        xn(k, e), k.select(0, b - v);
      }
    }
  } else {
    if (_e(l) && v < l.getTextContentSize() && l.canHaveFormat() && (v === 0 || Ki(l) || (l = l.splitText(v)[1], v = 0, g ? i.set(l.getKey(), v, "text") : s.set(l.getKey(), v, "text")), xn(l, e)), _e(c) && c.canHaveFormat()) {
      const C = c.getTextContent().length;
      c.__key !== w && b !== 0 && (b = C), b === C || Ki(c) || ([c] = c.splitText(b)), b === 0 && _ !== "element" || xn(c, e);
    }
    for (let C = 1; C < o; C++) {
      const k = t[C], E = k.getKey();
      _e(k) && k.canHaveFormat() && E !== l.getKey() && E !== c.getKey() && !k.isToken() && xn(k, e);
    }
  }
}
function en(r, e) {
...
function el(r) {
  if (wr(r) || !ue(r) || Pt(r)) return !1;
  const e = r.getFirstChild(), t = e === null || ba(e) || _e(e) || e.isInline();
...
(function(r) {
  ...
  var t = function(n) {
    var a = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, i = 0, s = {}, o = {
      ...
      util: {
        ...
        clone: function w(C, k) {
          ...
          switch (o.util.type(C)) {
            case "Object":
              if (T = o.util.objId(C), k[T])
                return k[T];
              E = /** @type {Record<string, any>} */
              {}, k[T] = E;
              for (var I in C)
                C.hasOwnProperty(I) && (E[I] = w(C[I], k));
              return (
                /** @type {any} */
                E
              );
            case "Array":
              return T = o.util.objId(C), k[T] ? k[T] : (E = [], k[T] = E, /** @type {Array} */
              /** @type {any} */
      ...
      languages: {
        ...
        insertBefore: function(w, C, k, E) {
          ...
          var F = E[w];
          return E[w] = I, o.languages.DFS(o.languages, function(P, $) {
            $ === F && P != w && (this[P] = I);
          }), I;
        },
        // Traverse a language definition with Depth First Search
        DFS: function w(C, k, E, T) {
          T = T || {};
          var I = o.util.objId;
          for (var D in C)
            if (C.hasOwnProperty(D)) {
              ...
              F === "Object" && !T[I(M)] ? (T[I(M)] = !0, w(M, k, null, T)) : F === "Array" && !T[I(M)] && (T[I(M)] = !0, w(M, k, D, T));
            }
        }
      },
      plugins: {},
      ...
      highlightAllUnder: function(w, C, k) {
        ...
        for (var T = 0, I; I = E.elements[T++]; )
          o.highlightElement(I, C === !0, E.callback);
      },
      /**
      ...
      highlightElement: function(w, C, k) {
        var E = o.util.getLanguage(w), T = o.languages[E];
        o.util.setLanguage(w, E);
        var I = w.parentElement;
        I && I.nodeName.toLowerCase() === "pre" && o.util.setLanguage(I, E);
        ...
        function F($) {
          M.highlightedCode = $, o.hooks.run("before-insert", M), M.element.innerHTML = M.highlightedCode, o.hooks.run("after-highlight", M), o.hooks.run("complete", M), k && k.call(M.element);
        }
      ...
      tokenize: function(w, C) {
        ...
        var T = new d();
        return m(T, T.head, w), u(w, T, C, T.head, 0), v(T);
      },
      /**
       * @namespace
       * @memberof Prism
    ...
    n.Prism = o;
    function l(w, C, k, E) {
      this.type = w, this.content = C, this.alias = k, this.length = (E || "").length | 0;
    }
    l.stringify = function w(C, k) {
      ...
      I && (Array.isArray(I) ? Array.prototype.push.apply(T.classes, I) : T.classes.push(I)), o.hooks.run("wrap", T);
      var D = "";
      for (var M in T.attributes)
        D += " " + M + '="' + (T.attributes[M] || "").replace(/"/g, "&quot;") + '"';
      ...
      for (var D in k)
        if (!(!k.hasOwnProperty(D) || !k[D])) {
          ...
          for (var F = 0; F < M.length; ++F) {
            if (I && I.cause == D + "," + F)
              return;
            var P = M[F], $ = P.inside, z = !!P.lookbehind, X = !!P.greedy, Y = P.alias;
            if (X && !P.pattern.global) {
              var re = P.pattern.toString().match(/[imsuy]*$/)[0];
              P.pattern = RegExp(P.pattern.source, re + "g");
            }
            for (var de = P.pattern || P, J = E.next, he = T; J !== C.tail && !(I && he >= I.reach); he += J.value.length, J = J.next) {
              var le = J.value;
              ...
              if (!(le instanceof l)) {
                var Ee = 1, oe;
                if (X) {
                  if (oe = c(de, he, w, z), !oe || oe.index >= w.length)
                    break;
                  var dt = oe.index, Be = oe.index + oe[0].length, je = he;
                  for (je += J.value.length; dt >= je; )
                    J = J.next, je += J.value.length;
                  if (je -= J.value.length, he = je, J.value instanceof l)
                    continue;
                  for (var $e = J; $e !== C.tail && (je < Be || typeof $e.value == "string"); $e = $e.next)
                    Ee++, je += $e.value.length;
                  Ee--, le = w.slice(he, je), oe.index -= he;
                } else if (oe = c(de, 0, le, z), !oe)
                  continue;
                var dt = oe.index, Je = oe[0], Ge = le.slice(0, dt), Rt = le.slice(dt + Je.length), St = he + le.length;
                I && St > I.reach && (I.reach = St);
                var Qt = J.prev;
                ...
                if (J = m(C, Qt, ee), Rt && m(C, J, Rt), Ee > 1) {
                  ...
                  u(w, C, k, J.prev, he, we), I && we.reach > I.reach && (I.reach = we.reach);
                }
              }
            }
          }
    ...
    function m(w, C, k) {
      var E = C.next, T = { value: k, prev: C, next: E };
      return C.next = T, E.prev = T, w.length++, T;
    }
    function g(w, C, k) {
      for (var E = C.next, T = 0; T < k && E !== w.tail; T++)
        E = E.next;
      C.next = E, E.prev = C, w.length -= T;
    }
    function v(w) {
    ...
    if (!n.document)
      return n.addEventListener && (o.disableWorkerMessageHandler || n.addEventListener("message", function(w) {
        var C = JSON.parse(w.data), k = C.language, E = C.code, T = C.immediateClose;
        n.postMessage(o.highlight(E, o.languages[k], k)), T && n.close();
      }, !1)), o;
        ...
        E && E.loadLanguages(C), m(
          ...
          function(T) {
            ...
            if (I) {
              ...
              M < 0 && (M += D.length), M = Math.max(0, Math.min(M - 1, D.length)), F < 0 && (F += D.length), F = Math.max(0, Math.min(F, D.length)), T = D.slice(M, F).join(`
`), x.hasAttribute("data-start") || x.setAttribute("data-start", String(M + 1));
            }
            _.textContent = T, t.highlightElement(_);
          },
          function(T) {
            x.setAttribute(o, u), _.textContent = T;
          }
        );
      }
  ...
  r.languages.markdown = r.languages.extend("markup", {}), r.languages.insertBefore("markdown", "prolog", {
    ...
    function d(m) {
      if (!(!m || typeof m == "string"))
        for (var g = 0, v = m.length; g < v; g++) {
          ...
          var x = b.content[1], _ = b.content[3];
    ...
    if (u.type === "code-block") {
      ...
      if (x)
        ...
        u.attributes.id = _, r.plugins.autoloader.loadLanguages(d, function() {
...
function nl(r) {
  return { node: nn(r.getAttribute(ra)) };
}
function fm(r) {
  const e = r, t = il(e);
  return t || function(n) {
...
let Pc = class zc extends Hr {
  static getType() {
    return "hashtag";
  }
  static clone(e) {
    return new zc(e.__text, e.__key);
  }
  constructor(e, t) {
    super(e, t);
  }
...
const ir = ze("TOGGLE_LINK_COMMAND");
function Yi(r, e = {}) {
      ...
      if (U(t)) {
        ...
        if (Hc(o, n)) {
          ...
          if (Pt(l)) {
            ...
            an(c, u.getChildren()), u.replace(c);
          }
          return;
        }
      }
          ...
          if (uc(s)) {
            ...
            for (; o != null; ) {
              ...
              if (ke(o)) {
                if (!a.has(l)) {
                  const c = Ot(e);
                  an(c, o.getChildren()), o.replace(c), a.add(l);
                }
                break;
              }
              {
...
function ol(r, e) {
  if (ke(r)) return r;
  const t = r.getPreviousSibling(), n = r.getNextSibling(), a = zt();
  let i;
  if (an(a, r.getChildren()), ke(t) && e === t.getListType()) t.append(a), ke(n) && e === n.getListType() && (an(t, n.getChildren()), n.remove()), i = t;
...
function _o(r, e) {
  ...
  t && n && nr(t) && nr(n) && (_o(t.getFirstChild(), n.getFirstChild()), n.remove());
  ...
  r.update(() => {
    ...
    if (U(e)) {
      ...
      for (const i of t) {
        ...
        for (const l of o) {
          const c = xe();
          an(c, l.getChildren()), s.insertAfter(c), s = c, l.__key === e.anchor.key && e.anchor.set(c.getKey(), 0, "element"), l.__key === e.focus.key && e.focus.set(c.getKey(), 0, "element"), l.remove();
        }
        i.remove();
      }
    }
...
function _m(r) {
  ...
  if (nr(n) && nr(a)) {
    ...
    if (ke(i)) {
      ...
      ke(s) && (an(i, s.getChildren()), n.remove(), e.add(n.getKey()));
    }
  } else if (nr(n)) {
...
function Sm(r) {
  ...
  if (ke(t ? t.getParent() : void 0) && Fe(t) && ke(e)) {
    ...
    if (r.is(n)) t.insertBefore(r), e.isEmpty() && t.remove();
      ...
      const i = e.getListType(), s = zt(), o = Ot(i);
      s.append(o), r.getPreviousSiblings().forEach((u) => o.append(u));
      const l = zt(), c = Ot(i);
      l.append(c), an(c, r.getNextSiblings()), t.insertBefore(s), t.insertAfter(l), t.replace(r);
    }
  }
}
function Cm() {
  ...
  const a = n.getParent();
  let i;
  if (Pt(a)) i = xe(), t.insertAfter(i);
  else {
    if (!Fe(a)) return !1;
    i = zt(), a.insertAfter(i);
  }
  i.select();
...
let Ea = class qc extends _t {
  ...
  remove(e) {
    ...
    super.remove(e), t && n && nr(t) && nr(n) && (_o(t.getFirstChild(), n.getFirstChild()), n.remove());
  }
  insertNewAfter(e, t = !0) {
    const n = zt(this.__checked == null && void 0);
    return this.insertAfter(n, t), n;
  }
  collapseAtStart(e) {
    const t = xe();
  ...
  setIndent(e) {
    ...
    for (; t !== e; ) t < e ? (_m(this), t++) : (Sm(this), t--);
    return this;
  }
  canInsertAfter(e) {
    return Fe(e);
...
function km(r) {
  ...
  return { node: zt(e === "true" || e !== "false" && void 0) };
}
function Em(r) {
  return r.getAttribute("type") !== "checkbox" ? { node: null } : { node: zt(r.hasAttribute("checked")) };
}
function zt(r) {
  ...
  static transform() {
    return (e) => {
      ke(e) || rr(163), function(t) {
        ...
        ke(n) && t.getListType() === n.getListType() && _o(t, n);
      }(e), function(t) {
...
const So = ze("INSERT_UNORDERED_LIST_COMMAND"), Co = ze("INSERT_ORDERED_LIST_COMMAND"), ko = ze("INSERT_CHECK_LIST_COMMAND"), Nm = ze("REMOVE_LIST_COMMAND");
function Am(r) {
  return Re(r.registerCommand(Co, () => (Is(r, "number"), !0), ye), r.registerCommand(So, () => (Is(r, "bullet"), !0), ye), r.registerCommand(Nm, () => (wm(r), !0), ye), r.registerCommand(ca, () => !!Cm(), ye));
}
let Eo = class Kc extends _t {
  static getType() {
    return "mark";
  }
  static clone(e) {
...
const Ao = ze("INSERT_HORIZONTAL_RULE_COMMAND");
...
function Jc(r, e, t, n, a = /* @__PURE__ */ new Map(), i) {
  ...
  const l = function(v, b) {
    const { nodeName: x } = v, _ = b._htmlConversions.get(x.toLowerCase());
    let w = null;
  ...
  let m = [];
  const g = (o == null || !Pt(o)) && (o != null && li(o) || n);
  for (let v = 0; v < d.length; v++) m.push(...Jc(d[v], e, t, g, new Map(a), o));
  return u != null && (m = u(m)), H0(r) && (m = zm(r, m, g ? () => {
    const v = new dc();
    return t.push(v), v;
...
class Pn extends _t {
  ...
  static importDOM() {
    ...
    }, span: (e) => yl(e) ? { conversion: (t) => ({ node: tn("h1") }), priority: 3 } : null };
  }
  exportDOM(e) {
    const { element: t } = super.exportDOM(e);
    if (t && Cr(t)) {
  ...
  insertNewAfter(e, t = !0) {
    const n = e ? e.anchor.offset : 0, a = this.getLastDescendant(), i = !a || e && e.anchor.key === a.getKey() && n === a.getTextContentSize() || !e ? xe() : tn(this.getTag()), s = this.getDirection();
  ...
  collapseAtStart() {
    const e = this.isEmpty() ? xe() : tn(this.getTag());
    return this.getChildren().forEach((t) => e.append(t)), this.replace(e), !0;
  }
  extractWithChild() {
    return !0;
...
function _n(r) {
  const e = r.nodeName.toLowerCase();
  let t = null;
  return e !== "h1" && e !== "h2" && e !== "h3" && e !== "h4" && e !== "h5" && e !== "h6" || (t = tn(e), r.style !== null && (yc(r, t), t.setFormat(r.style.textAlign))), { node: t };
}
function ef(r) {
  const e = Ni();
...
function tf(r) {
  return Re(r.registerCommand(wa, (e) => {
  ...
  }, ve), r.registerCommand(bc, (e) => {
    const t = j();
    return !!U(t) && (t.deleteWord(e), !0);
  }, ve), r.registerCommand(Ns, (e) => {
    const t = j();
    return !!U(t) && (t.deleteLine(e), !0);
  }, ve), r.registerCommand(vc, (e) => {
    const t = j();
    ...
    return !0;
  }, ve), r.registerCommand(E1, () => {
    const e = j();
    return !!U(e) && (e.removeText(), !0);
  }, ve), r.registerCommand(yt, (e) => {
    const t = j();
    return !!U(t) && (t.formatText(e), !0);
  }, ve), r.registerCommand(er, (e) => {
    const t = j();
    ...
    return !0;
  }, ve), r.registerCommand(U0, (e) => {
    const t = j();
    return !!U(t) && (t.insertLineBreak(e), !0);
  }, ve), r.registerCommand(ca, () => {
    const e = j();
    return !!U(e) && (e.insertParagraph(), !0);
  }, ve), r.registerCommand(gc, () => (In([mo()]), !0), ve), r.registerCommand(ki, () => xl((e) => {
    const t = e.getIndent();
    e.setIndent(t + 1);
  }), ve), r.registerCommand(ui, () => xl((e) => {
    const t = e.getIndent();
    t > 0 && e.setIndent(t - 1);
  }), ve), r.registerCommand(fn, (e) => {
    const t = j();
    if (gt(t) && !$a(e.target)) {
      const n = t.getNodes();
  ...
  }, ve), r.registerCommand(xa, (e) => {
    if ($a(e.target)) return !1;
    const t = j();
    return !!U(t) && (e.preventDefault(), r.dispatchCommand(ia, !1));
  }, ve), r.registerCommand(go, (e) => {
    const t = j();
    if (!U(t)) return !1;
    if (e !== null) {
  ...
  }, ve), r.registerCommand(Rn, () => {
    const e = j();
    return !!U(e) && (r.blur(), !0);
  }, ve), r.registerCommand(Si, (e) => {
    const [, t] = kn(e);
    if (t.length > 0) {
    ...
    const n = j();
    return !!U(n);
  }, ve), r.registerCommand(fo, (e) => {
    const [t] = kn(e), n = j();
    return !(t && !U(n));
  }, ve), r.registerCommand(_i, (e) => {
    const [t] = kn(e), n = j();
    if (t && !U(n)) return !1;
    const a = bl(e.clientX, e.clientY);
    if (a !== null) {
    ...
    return !0;
  }, ve), r.registerCommand(C1, () => (k1(), !0), ve), r.registerCommand(mc, (e) => (Fs(r, xr(e, ClipboardEvent) ? e : null), !0), ve), r.registerCommand(pc, (e) => (async function(t, n) {
    await Fs(n, xr(t, ClipboardEvent) ? t : null), n.update(() => {
      const a = j();
      U(a) ? a.removeText() : gt(a) && a.getNodes().forEach((i) => i.remove());
    });
  }(e, r), !0), ve), r.registerCommand(fc, (e) => {
    const [, t, n] = kn(e);
    return t.length > 0 && !n ? (r.dispatchCommand(Ls, t), !0) : S1(e.target) ? !1 : j() !== null && (function(a, i) {
...
const Do = /^(\d+(?:\.\d+)?)px$/, qe = { BOTH: 3, COLUMN: 2, NO_STATUS: 0, ROW: 1 };
class sr extends _t {
  static getType() {
    return "tablecell";
  }
...
` ? null : (_e(m) && (l && m.toggleFormat("bold"), c && m.toggleFormat("strikethrough"), u && m.toggleFormat("italic"), d && m.toggleFormat("underline")), v.append(m), v);
    }
    return m;
  }, node: a };
}
...
const Ro = ze("INSERT_TABLE_COMMAND");
function rf(r) {
  return r && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
}
...
class zn extends _t {
  ...
  static clone(e) {
    return new zn(e.__height, e.__key);
  }
  static importDOM() {
...
const Ps = (r, e) => r === qe.BOTH || r === e ? e : qe.NO_STATUS;
function nd(r = !0) {
  const e = j();
  U(e) || Oe(e) || Ce(188);
  ...
  if (r) {
    ...
    for (let v = 0; v < o; v++) {
      ...
      if (x + b.__rowSpan - 1 <= u) {
        const _ = d[v].cell.__headerState, w = Ps(_, qe.COLUMN);
    ...
    for (let g = 0; g < o; g++) {
      ...
      if (b === l) {
        const x = u[g].cell.__headerState, _ = Ps(x, qe.COLUMN);
...
function ad(r = !0) {
  ...
  e: for (let w = 0; w < u; w++) {
    ...
    const C = o[w], k = C[m < 0 ? 0 : m].cell.__headerState, E = Ps(k, qe.ROW);
    if (m < 0) {
      Fo(x, b(E));
      continue;
    }
    const { cell: T, startColumn: I, startRow: D } = C[m];
    if (I + T.__colSpan - 1 <= m) {
      let M = T, F = D, P = m;
      for (; F !== w && M.__rowSpan > 1; ) {
        if (P -= T.__colSpan, !(P >= 0)) {
          x.append(b(E));
          continue e;
        }
        {
          const { cell: $, startRow: z } = C[P];
          M = $, F = z;
        }
      }
      M.insertAfter(b(E));
    } else T.setColSpan(T.__colSpan + 1);
  }
  v !== null && fa(v);
...
function lf() {
  ...
  for (let b = d; b >= c; b--) {
    for (let _ = m - 1; _ >= 0; _--) {
      const { cell: w, startRow: C, startColumn: k } = s[b][_];
      if (k === _ && (b === c && C < c && w.setRowSpan(w.__rowSpan - (C - c)), C >= c && C + w.__rowSpan - 1 > d)) if (w.setRowSpan(w.__rowSpan - (d - C + 1)), v === null && Ce(122), _ === 0) Fo(v, w);
      else {
        const { cell: E } = g[_ - 1];
        E.insertAfter(w);
      }
...
function uf() {
  ...
  const b = s.length;
  for (let C = 0; C < b; C++) for (let k = m; k <= g; k++) {
    const { cell: E, startColumn: T } = s[C][k];
    if (T < m) {
      if (k === m) {
        const I = m - T;
        E.setColSpan(E.__colSpan - Math.min(v, E.__colSpan - I));
      }
    } else if (T + E.__colSpan - 1 > g) {
      if (k === g) {
        const I = g - T + 1;
        E.setColSpan(E.__colSpan - I);
      }
    } else E.remove();
  }
  const x = s[u], _ = c > d ? x[c + n.__colSpan] : x[d + i.__colSpan];
  if (_ !== void 0) {
    const { cell: C } = _;
    fa(C);
  } else {
    const C = d < c ? x[d - 1] : x[c - 1], { cell: k } = C;
    fa(k);
  }
...
function cf() {
  ...
  if (i === 1 && s === 1) return;
  const [o, l] = Kt(a, t, t), { startColumn: c, startRow: u } = l, d = t.__headerState & qe.COLUMN, m = Array.from({ length: i }, (b, x) => {
    let _ = d;
    for (let w = 0; _ !== 0 && w < o.length; w++) _ &= o[w][x + c].cell.__headerState;
    return _;
  }), g = t.__headerState & qe.ROW, v = Array.from({ length: s }, (b, x) => {
    let _ = g;
    for (let w = 0; _ !== 0 && w < o[0].length; w++) _ &= o[x + u][w].cell.__headerState;
    return _;
  });
  if (i > 1) {
  ...
  if (s > 1) {
    ...
    for (let x = 1; x < s; x++) {
      ...
      let C = null;
      for (let k = 0; k < c; k++) {
        const E = w[k], T = E.cell;
        E.startRow === _ && (C = T), T.__colSpan > 1 && (k += T.__colSpan - 1);
      }
      if (C === null) for (let k = i - 1; k >= 0; k--) Fo(b, Jt(m[k] | v[x]).append(xe()));
...
class Ai {
  ...
  getNodes() {
    ...
    let m = Math.min(u.startColumn, d.startColumn), g = Math.min(u.startRow, d.startRow), v = Math.max(u.startColumn + u.cell.__colSpan - 1, d.startColumn + d.cell.__colSpan - 1), b = Math.max(u.startRow + u.cell.__rowSpan - 1, d.startRow + d.cell.__rowSpan - 1), x = m, _ = g, w = m, C = g;
    function k(D) {
      const { cell: M, startColumn: F, startRow: P } = D;
      m = Math.min(m, F), g = Math.min(g, P), v = Math.max(v, F + M.__colSpan - 1), b = Math.max(b, P + M.__rowSpan - 1);
    }
    for (; m < x || g < _ || v > w || b > C; ) {
      if (m < x) {
        const D = C - _, M = x - 1;
        for (let F = 0; F <= D; F++) k(c[_ + F][M]);
        x = M;
      }
      if (g < _) {
        const D = w - x, M = _ - 1;
        for (let F = 0; F <= D; F++) k(c[M][x + F]);
        _ = M;
      }
      if (v > w) {
        const D = C - _, M = w + 1;
    ...
    const E = /* @__PURE__ */ new Map([[o.getKey(), o]]);
    let T = null;
    for (let D = g; D <= b; D++) for (let M = m; M <= v; M++) {
      const { cell: F } = c[D][M], P = F.getParent();
      nt(P) || Ce(160), P !== T && E.set(P.getKey(), P), E.set(F.getKey(), F);
      for (const $ of df(F)) E.set($.getKey(), $);
      T = P;
    }
...
class hf {
    ...
    n.update(() => {
      ...
      if (this.focusX = i, this.focusY = s, this.isHighlightingCells) {
        ...
        if (this.tableSelection != null && this.anchorCellNodeKey != null && ae(o) && a.is(En(o))) {
          const l = o.getKey();
          this.tableSelection = this.tableSelection.clone() || Sl(), this.focusCellNodeKey = l, this.tableSelection.set(this.tableNodeKey, this.anchorCellNodeKey, this.focusCellNodeKey), xt(this.tableSelection), n.dispatchCommand(yr, void 0), Ha(n, this.table, this.tableSelection);
        }
      }
    });
  }
  setAnchorCellForSelection(e) {
    this.isHighlightingCells = !1, this.anchorCell = e, this.anchorX = e.x, this.anchorY = e.y, this.editor.update(() => {
      ...
      if (ae(t)) {
        const n = t.getKey();
        this.tableSelection = this.tableSelection != null ? this.tableSelection.clone() : Sl(), this.anchorCellNodeKey = n;
      }
    });
  }
  formatCells(e) {
    this.editor.update(() => {
      const t = j();
      Oe(t) || Ce(11);
      const n = _a(), a = n.anchor, i = n.focus, s = t.getNodes().filter(ae), o = s[0].getFirstChild(), l = qr(o) ? o.getFormatFlags(e, null) : null;
      s.forEach((c) => {
...
function mf(r, e, t, n) {
  ...
  e.addEventListener("mousedown", (u) => {
    ...
    i.listenersToRemove.add(t.registerCommand(u, /* @__PURE__ */ ((d) => () => {
      ...
      if (U(m)) {
        const g = me(m.anchor.getNode(), (k) => ae(k));
        if (!ae(g)) return !1;
        const v = m.anchor.getNode(), b = m.focus.getNode(), x = r.isParentOf(v), _ = r.isParentOf(b);
        if (x && !_ || _ && !x) return i.clearText(), !0;
        const w = me(m.anchor.getNode(), (k) => ue(k)), C = w && me(w, (k) => ue(k) && ae(k.getParent()));
  ...
  const l = (u) => {
    ...
    if (m !== r.isParentOf(d.focus.getNode())) {
      const g = m ? "anchor" : "focus", v = m ? "focus" : "anchor", { key: b, offset: x, type: _ } = d[v];
      return r[d[g].isBefore(d[v]) ? "selectPrevious" : "selectNext"]()[v].set(b, x, _), !1;
    }
  ...
  return i.listenersToRemove.add(t.registerCommand(ya, l, pt)), i.listenersToRemove.add(t.registerCommand(xa, l, pt)), i.listenersToRemove.add(t.registerCommand(pc, (u) => {
    ...
    const d = j();
    if (!Oe(d) || !Jr(d, r)) return !1;
    const m = d.anchor.getNode(), g = d.focus.getNode();
    if (!ae(m) || !ae(g)) return !1;
    const [v, b, x] = Kt(r, m, g), _ = Math.max(b.startRow, x.startRow), w = Math.max(b.startColumn, x.startColumn), C = Math.min(b.startRow, x.startRow), k = Math.min(b.startColumn, x.startColumn);
    for (let E = C; E <= _; E++) for (let T = k; T <= w; T++) {
      const I = v[E][T].cell;
      I.setFormat(u);
    ...
    const d = j();
    if (!U(d) || !d.isCollapsed() || !Jr(d, r)) return !1;
    ...
    const [x] = g, _ = d[0], w = _.getChildren(), C = _.getFirstChildOrThrow().getChildrenSize(), k = _.getChildrenSize(), E = me(x.getNode(), (J) => ae(J)), T = E && me(E, (J) => nt(J)), I = T && me(T, (J) => We(J));
    if (!ae(E) || !nt(T) || !We(I)) return !1;
    const D = T.getIndexWithinParent(), M = Math.min(I.getChildrenSize() - 1, D + k - 1), F = E.getIndexWithinParent(), P = Math.min(T.getChildrenSize() - 1, F + C - 1), $ = Math.min(F, P), z = Math.min(D, M), X = Math.max(F, P), Y = Math.max(D, M), re = I.getChildren();
    let de = 0;
    for (let J = z; J <= Y; J++) {
      const he = re[J];
      if (!nt(he)) return !1;
      ...
      for (let je = $; je <= X; je++) {
        ...
        const dt = oe[Be];
        if (!ae(dt)) return !1;
        const Je = $e.getChildren();
        dt.getChildren().forEach((Ge) => {
          _e(Ge) && xe().append(Ge), $e.append(Ge);
        }), Je.forEach((Ge) => Ge.remove()), Be++;
      }
      de++;
    }
    return !0;
    ...
    const u = j(), d = ho();
    if (U(u)) {
      const { anchor: m, focus: g } = u, v = m.getNode(), b = g.getNode(), x = Ji(v), _ = Ji(b), w = !(!x || !r.is(En(x))), C = !(!_ || !r.is(En(_))), k = w !== C, E = w && C, T = u.isBackward();
      if (k) {
        const I = u.clone();
        if (C) {
          const [D] = Kt(r, _, _), M = D[0][0].cell, F = D[D.length - 1].at(-1).cell;
          I.focus.set(T ? M.getKey() : F.getKey(), T ? M.getChildrenSize() : F.getChildrenSize(), "element");
        } else if (w) {
          const [D] = Kt(r, x, x), M = D[0][0].cell, F = D[D.length - 1].at(-1).cell;
          I.anchor.set(T ? F.getKey() : M.getKey(), T ? F.getChildrenSize() : 0, "element");
        }
        xt(I), Cl(t, i);
      } else E && (x.is(_) || (i.setAnchorCellForSelection(c(x)), i.setFocusCellForSelection(c(_), !0), i.isSelecting || setTimeout(() => {
      ...
      if (m && m.anchorNode && m.focusNode) {
        ...
        if (v && x && m.rangeCount > 0) {
          const _ = T1(m, t);
          _ && (_.anchor.set(r.getKey(), u.isBackward() ? r.getChildrenSize() : 0, "element"), m.removeAllRanges(), xt(_));
        }
      }
    }
    return u && !u.is(d) && (Oe(u) || Oe(d)) && i.tableSelection && !i.tableSelection.is(d) ? (Oe(u) && u.tableKey === i.tableNodeKey ? i.updateTableTableSelection(u) : !Oe(u) && Oe(d) && d.tableKey === i.tableNodeKey && i.updateTableTableSelection(null), !1) : (i.hasHijackedSelectionStyles && !r.isSelected() ? function(m, g) {
      g.enableHighlightStyle(), Po(g.table, (v) => {
        const b = v.elem;
    ...
    const u = j();
    if (!U(u) || !u.isCollapsed() || !Jr(u, r)) return !1;
    const d = El(t, u, r);
    return !!d && (kl(d, r), !0);
  }, pt)), i;
}
...
function Cl(r, e) {
  e.disableHighlightStyle(), Po(e.table, (t) => {
...
function na(r, e, t, n, a) {
    ...
    if (U(i)) {
      ...
      if (e.shiftKey && (t === "up" || t === "down")) {
        ...
        if (!i.isCollapsed() && (t === "up" && !i.isBackward() || t === "down" && i.isBackward())) {
          ...
          let u = l;
          t === "up" && ue(l) && (u = l.getLastChild() || l, c = _e(u) ? u.getTextContentSize() : 0);
          const d = i.clone();
          return d.focus.set(u.getKey(), c, _e(u) ? "text" : "element"), xt(d), pr(e), !0;
        }
        if (Pt(s)) {
  ...
  if (U(i) && i.isCollapsed()) {
    ...
    const u = En(l);
    if (u !== n && u != null) {
      const _ = r.getElementByKey(u.getKey());
      if (_ != null) return a.table = sa(_), na(r, e, t, u, a);
    }
    if (t === "backward" || t === "forward") {
      const _ = s.type, w = s.offset, C = s.getNode();
      if (!C) return !1;
      const k = i.getNodes();
      return (k.length !== 1 || !wr(k[0])) && !!function(E, T, I, D) {
        return function(M, F, P) {
          return M === "element" && (P === "backward" ? F.getPreviousSibling() === null : F.getNextSibling() === null);
        }(E, I, D) || function(M, F, P, $) {
          const z = me(P, (Y) => ue(Y) && !Y.isInline());
          if (!z) return !1;
          const X = $ === "backward" ? F === 0 : F === P.getTextContentSize();
          return M === "text" && X && ($ === "backward" ? z.getPreviousSibling() === null : z.getNextSibling() === null);
        }(E, T, I, D);
      }(_, w, C, t) && function(E, T, I, D) {
        const M = me(T, ae);
        if (!ae(M)) return !1;
        const [F, P] = Kt(I, M, M);
        if (!function(z, X, Y) {
          const re = z[0][0], de = z[z.length - 1][z[0].length - 1], { startColumn: J, startRow: he } = X;
          return Y === "backward" ? J === re.startColumn && he === re.startRow : J === de.startColumn && he === de.startRow;
        }(F, P, D)) return !1;
        const $ = function(z, X, Y) {
          const re = me(z, (J) => ue(J) && !J.isInline());
          if (!re) return;
        ...
        return !$ || We($) ? !1 : (pr(E), D === "backward" ? $.selectEnd() : $.selectStart(), !0);
      }(e, C, n, t);
    }
    ...
    if (t === "up" ? x.top > g.top - g.height : g.bottom + g.height > x.bottom) {
      ...
      if (!e.shiftKey) return sd(a, n, _.x, _.y, t);
      {
...
const yf = ft.lazy(() => import("./ImageComponent-u0w7uy68.js"));
function xf(r) {
  const e = r;
...
const Sf = "https://platform.twitter.com/widgets.js";
function Cf(r) {
  ...
  return B(() => {
    ...
    if (s !== l.current) {
      if (u(!0), Al) {
        ...
        g.src = Sf, g.async = !0, (m = document.body) == null || m.appendChild(g), g.onload = d, a && (g.onerror = a);
      } else
        d();
      l && (l.current = s);
    }
...
class sn extends _t {
  ...
  static clone(t) {
    return new sn(t.__open, t.__key);
  }
  createDOM(t, n) {
...
var Yo = 0, mi = 1, Nn = 2, _r = 3, pa = 4, Ut = 5, Mn = 6, Tt = 7, tr = [new Ar(Yo, 0, !1), new Ar(mi, 0, !0), new Ar(Nn, 1, !1), new Ar(_r, 1, !0), new Ar(pa, 2, !1), new Ar(Ut, 2, !0), new Ar(Mn, 3, !1), new Ar(Tt, 3, !0)], Hf = [pa, Ut, pa, Ut, Mn, Tt, Mn, Tt], qf = [Ut, Ut, Ut, Ut, Tt, Tt, Tt, Tt], Uf = [Nn, _r, pa, Ut, Mn, Tt, Mn, Tt], Kf = [_r, _r, Ut, Ut, Tt, Tt, Tt, Tt], Wf = [mi, mi, _r, _r, Ut, Ut, Tt, Tt], Gf = [Yo, mi, Nn, _r, Nn, _r, Nn, _r], pe = {
  DISPLAY: tr[Yo],
  TEXT: tr[Nn],
  SCRIPT: tr[pa],
  SCRIPTSCRIPT: tr[Mn]
...
var f = "math", H = "text", y = "main", N = "ams", Ye = "accent-token", te = "bin", Nt = "close", $n = "inner", fe = "mathord", ct = "op-token", Bt = "open", Oi = "punct", A = "rel", Nr = "spacing", R = "textord";
h(f, y, A, "≡", "\\equiv", !0);
h(f, y, A, "≺", "\\prec", !0);
h(f, y, A, "≻", "\\succ", !0);
h(f, y, A, "∼", "\\sim", !0);
...
h(f, N, A, "⋬", "\\ntrianglelefteq", !0);
h(f, N, A, "⊊", "\\subsetneq", !0);
h(f, N, A, "", "\\@varsubsetneq");
h(f, N, A, "⫋", "\\subsetneqq", !0);
h(f, N, A, "", "\\@varsubsetneqq");
h(f, N, A, "≯", "\\ngtr", !0);
h(f, N, A, "", "\\@ngeqslant");
h(f, N, A, "", "\\@ngeqq");
h(f, N, A, "⪈", "\\gneq", !0);
...
h(f, N, A, "⋡", "\\nsucceq", !0);
h(f, N, A, "⋩", "\\succnsim", !0);
h(f, N, A, "⪺", "\\succnapprox", !0);
h(f, N, A, "≆", "\\ncong", !0);
h(f, N, A, "", "\\@nshortparallel");
h(f, N, A, "∦", "\\nparallel", !0);
h(f, N, A, "⊯", "\\nVDash", !0);
h(f, N, A, "⋫", "\\ntriangleright");
h(f, N, A, "⋭", "\\ntrianglerighteq", !0);
h(f, N, A, "", "\\@nsupseteqq");
h(f, N, A, "⊋", "\\supsetneq", !0);
h(f, N, A, "", "\\@varsupsetneq");
h(f, N, A, "⫌", "\\supsetneqq", !0);
h(f, N, A, "", "\\@varsupsetneqq");
h(f, N, A, "⊮", "\\nVdash", !0);
h(f, N, A, "⪵", "\\precneqq", !0);
h(f, N, A, "⪶", "\\succneqq", !0);
h(f, N, A, "", "\\@nsubseteqq");
...
h(f, N, R, "®", "\\circledR");
h(H, N, R, "®", "\\circledR");
h(f, N, R, "∡", "\\measuredangle", !0);
h(f, N, R, "∄", "\\nexists");
h(f, N, R, "℧", "\\mho");
h(f, N, R, "Ⅎ", "\\Finv", !0);
h(f, N, R, "⅁", "\\Game", !0);
h(f, N, R, "‵", "\\backprime");
h(f, N, R, "▲", "\\blacktriangle");
h(f, N, R, "▼", "\\blacktriangledown");
h(f, N, R, "■", "\\blacksquare");
h(f, N, R, "⧫", "\\blacklozenge");
h(f, N, R, "★", "\\bigstar");
h(f, N, R, "∢", "\\sphericalangle", !0);
h(f, N, R, "∁", "\\complement", !0);
h(f, N, R, "ð", "\\eth", !0);
h(H, y, R, "ð", "ð");
h(f, N, R, "╱", "\\diagup");
h(f, N, R, "╲", "\\diagdown");
...
h(f, N, A, "≦", "\\leqq", !0);
h(f, N, A, "⩽", "\\leqslant", !0);
h(f, N, A, "⪕", "\\eqslantless", !0);
h(f, N, A, "≲", "\\lesssim", !0);
h(f, N, A, "⪅", "\\lessapprox", !0);
h(f, N, A, "≊", "\\approxeq", !0);
h(f, N, te, "⋖", "\\lessdot");
h(f, N, A, "⋘", "\\lll", !0);
h(f, N, A, "≶", "\\lessgtr", !0);
h(f, N, A, "⋚", "\\lesseqgtr", !0);
h(f, N, A, "⪋", "\\lesseqqgtr", !0);
h(f, N, A, "≑", "\\doteqdot");
h(f, N, A, "≓", "\\risingdotseq", !0);
h(f, N, A, "≒", "\\fallingdotseq", !0);
h(f, N, A, "∽", "\\backsim", !0);
h(f, N, A, "⋍", "\\backsimeq", !0);
h(f, N, A, "⫅", "\\subseteqq", !0);
h(f, N, A, "⋐", "\\Subset", !0);
h(f, N, A, "⊏", "\\sqsubset", !0);
h(f, N, A, "≼", "\\preccurlyeq", !0);
h(f, N, A, "⋞", "\\curlyeqprec", !0);
h(f, N, A, "≾", "\\precsim", !0);
h(f, N, A, "⪷", "\\precapprox", !0);
h(f, N, A, "⊲", "\\vartriangleleft");
h(f, N, A, "⊴", "\\trianglelefteq");
h(f, N, A, "⊨", "\\vDash", !0);
h(f, N, A, "⊪", "\\Vvdash", !0);
h(f, N, A, "⌣", "\\smallsmile");
h(f, N, A, "⌢", "\\smallfrown");
...
h(f, N, A, "⋑", "\\Supset", !0);
h(f, N, A, "⊐", "\\sqsupset", !0);
h(f, N, A, "≽", "\\succcurlyeq", !0);
h(f, N, A, "⋟", "\\curlyeqsucc", !0);
h(f, N, A, "≿", "\\succsim", !0);
h(f, N, A, "⪸", "\\succapprox", !0);
h(f, N, A, "⊳", "\\vartriangleright");
h(f, N, A, "⊵", "\\trianglerighteq");
h(f, N, A, "⊩", "\\Vdash", !0);
h(f, N, A, "∣", "\\shortmid");
h(f, N, A, "∥", "\\shortparallel");
h(f, N, A, "≬", "\\between", !0);
h(f, N, A, "⋔", "\\pitchfork", !0);
h(f, N, A, "∝", "\\varpropto");
h(f, N, A, "◀", "\\blacktriangleleft");
h(f, N, A, "∴", "\\therefore", !0);
h(f, N, A, "∍", "\\backepsilon");
h(f, N, A, "▶", "\\blacktriangleright");
h(f, N, A, "∵", "\\because", !0);
h(f, N, A, "⋘", "\\llless");
h(f, N, A, "⋙", "\\gggtr");
h(f, N, te, "⊲", "\\lhd");
...
h(f, N, A, "≑", "\\Doteq", !0);
h(f, N, te, "∔", "\\dotplus", !0);
h(f, N, te, "∖", "\\smallsetminus");
h(f, N, te, "⋒", "\\Cap", !0);
h(f, N, te, "⋓", "\\Cup", !0);
h(f, N, te, "⩞", "\\doublebarwedge", !0);
h(f, N, te, "⊟", "\\boxminus", !0);
h(f, N, te, "⊞", "\\boxplus", !0);
h(f, N, te, "⋇", "\\divideontimes", !0);
h(f, N, te, "⋉", "\\ltimes", !0);
h(f, N, te, "⋊", "\\rtimes", !0);
h(f, N, te, "⋋", "\\leftthreetimes", !0);
h(f, N, te, "⋌", "\\rightthreetimes", !0);
h(f, N, te, "⋏", "\\curlywedge", !0);
h(f, N, te, "⋎", "\\curlyvee", !0);
h(f, N, te, "⊝", "\\circleddash", !0);
h(f, N, te, "⊛", "\\circledast", !0);
h(f, N, te, "⋅", "\\centerdot");
h(f, N, te, "⊺", "\\intercal", !0);
h(f, N, te, "⋒", "\\doublecap");
h(f, N, te, "⋓", "\\doublecup");
h(f, N, te, "⊠", "\\boxtimes", !0);
h(f, N, A, "⇢", "\\dashrightarrow", !0);
h(f, N, A, "⇠", "\\dashleftarrow", !0);
h(f, N, A, "⇇", "\\leftleftarrows", !0);
h(f, N, A, "⇆", "\\leftrightarrows", !0);
h(f, N, A, "⇚", "\\Lleftarrow", !0);
h(f, N, A, "↞", "\\twoheadleftarrow", !0);
h(f, N, A, "↢", "\\leftarrowtail", !0);
h(f, N, A, "↫", "\\looparrowleft", !0);
h(f, N, A, "⇋", "\\leftrightharpoons", !0);
h(f, N, A, "↶", "\\curvearrowleft", !0);
h(f, N, A, "↺", "\\circlearrowleft", !0);
h(f, N, A, "↰", "\\Lsh", !0);
h(f, N, A, "⇈", "\\upuparrows", !0);
h(f, N, A, "↿", "\\upharpoonleft", !0);
h(f, N, A, "⇃", "\\downharpoonleft", !0);
h(f, y, A, "⊶", "\\origof", !0);
h(f, y, A, "⊷", "\\imageof", !0);
h(f, N, A, "⊸", "\\multimap", !0);
h(f, N, A, "↭", "\\leftrightsquigarrow", !0);
h(f, N, A, "⇉", "\\rightrightarrows", !0);
h(f, N, A, "⇄", "\\rightleftarrows", !0);
h(f, N, A, "↠", "\\twoheadrightarrow", !0);
h(f, N, A, "↣", "\\rightarrowtail", !0);
h(f, N, A, "↬", "\\looparrowright", !0);
h(f, N, A, "↷", "\\curvearrowright", !0);
h(f, N, A, "↻", "\\circlearrowright", !0);
h(f, N, A, "↱", "\\Rsh", !0);
h(f, N, A, "⇊", "\\downdownarrows", !0);
h(f, N, A, "↾", "\\upharpoonright", !0);
h(f, N, A, "⇂", "\\downharpoonright", !0);
h(f, N, A, "⇝", "\\rightsquigarrow", !0);
h(f, N, A, "⇝", "\\leadsto");
h(f, N, A, "⇛", "\\Rrightarrow", !0);
h(f, N, A, "↾", "\\restriction");
h(f, y, R, "‘", "`");
h(f, y, R, "$", "\\$");
h(H, y, R, "$", "\\$");
...
for (var Gr = 0; Gr < 10; Gr++) {
  var Mr = Gr.toString();
  ge = String.fromCharCode(55349, 57294 + Gr), h(f, y, fe, Mr, ge), h(H, y, R, Mr, ge), ge = String.fromCharCode(55349, 57314 + Gr), h(f, y, fe, Mr, ge), h(H, y, R, Mr, ge), ge = String.fromCharCode(55349, 57324 + Gr), h(f, y, fe, Mr, ge), h(H, y, R, Mr, ge), ge = String.fromCharCode(55349, 57334 + Gr), h(f, y, fe, Mr, ge), h(H, y, R, Mr, ge);
}
var Ks = "ÐÞþ";
...
var Ga = [
  ...
  return a === void 0 && (a = []), n.font === "boldsymbol" && Di(e, "Main-Bold", t).metrics ? Xt(e, "Main-Bold", t, n, a.concat(["mathbf"])) : e === "\\" || Ue[t][e].font === "main" ? Xt(e, "Main-Regular", t, n, a) : Xt(e, "AMS-Regular", t, n, a.concat(["amsrm"]));
  ...
  if (l) {
    ...
    } else o ? (d = _d[l].fontName, m = [l]) : (d = Ya(l, t.fontWeight, t.fontShape), m = [l, t.fontWeight, t.fontShape]);
    if (Di(i, d, a).metrics)
  ...
  if (n === "textord") {
    var x = Ue[a][i] && Ue[a][i].font;
    if (x === "ams") {
      var _ = Ya("amsrm", t.fontWeight, t.fontShape);
  ...
  for (var u = [], d = a, m = a, g = a, v = 0; v < n.length; v++) {
    ...
    if (b.type === "kern")
      ...
      var x = b.elem, _ = b.wrapperClasses || [], w = b.wrapperStyle || {}, C = Mt(_, [c, x], void 0, w);
  ...
  var E;
  if (d < 0) {
    var T = Mt([], []), I = Mt(["vlist"], [T]);
    I.style.height = V(-d);
    var D = Mt(["vlist-s"], [new Gt("​")]);
    E = [Mt(["vlist-r"], [k, D]), Mt(["vlist-r"], [I])];
  } else
    E = [Mt(["vlist-r"], [k])];
  var M = Mt(["vlist-t"], E);
  return E.length === 2 && M.classes.push("vlist-t2"), M.height = m, M.depth = -d, M;
}, kp = (r, e) => {
  ...
  var [n, a, i] = Sd[e], s = new Lr(n), o = new kr([s], {
    width: V(a),
    height: V(i),
...
var vi = function(e) {
  ...
  return $l(i, (v, b) => {
    var x = b.classes[0], _ = v.classes[0];
    x === "mbin" && ce.contains(Mp, _) ? b.classes[0] = "mord" : _ === "mbin" && ce.contains(Ap, x) && (v.classes[0] = "mord");
  }, {
    node: d
  }, m, g), $l(i, (v, b) => {
    var x = Ws(b), _ = Ws(v), w = x && _ ? v.hasClass("mtight") ? Np[x][_] : Tp[x][_] : null;
    if (w)
...
function Gs(r, e) {
  ...
  var c;
  t ? (c = Va(mt(t, e, !0)), c.classes = ["tag"], i.push(c)) : a && i.push(a);
...
var W = {
  ...
  return Ue[t][e] && Ue[t][e].replace && e.charCodeAt(0) !== 55349 && !(yd.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = Ue[t][e].replace), new W.TextNode(e);
}, Zo = function(e) {
...
var Td = function(e) {
  ...
  var t = new W.MathNode("mo", [new W.TextNode(Pp[e.replace(/^\\/, "")])]);
  ...
  function n() {
    ...
    if (ce.contains(["widehat", "widecheck", "widetilde", "utilde"], l)) {
      ...
      var _ = [], w = Bp[l], [C, k, E] = w, T = E / 1e3, I = C.length, D, M;
      if (I === 1) {
        var F = w[3];
        D = ["hide-tail"], M = [F];
      } else if (I === 2)
        ...
        throw new Error(`Correct katexImagesData or update code here to support
                    ` + I + " children.");
      for (var P = 0; P < I; P++) {
        var $ = new Lr(C[P]), z = new kr([$], {
          width: "400em",
          height: V(T),
          viewBox: "0 0 " + o + " " + E,
          preserveAspectRatio: M[P] + " slice"
        }), X = L.makeSvgSpan([D[P]], [z], t);
        if (I === 1)
          return {
            span: X,
            minWidth: k,
...
var t0 = (r, e) => {
  var t, n, a;
  r && r.type === "supsub" ? (n = Se(r.base, "accent"), t = n.base, r.base = t, a = dp(De(r, e)), r.base = n) : (n = Se(r, "accent"), t = n.base);
  ...
  var t = r.isStretchy ? Tr.mathMLnode(r.label) : new W.MathNode("mo", [Yt(r.label, r.mode)]), n = new W.MathNode("mover", [Pe(r.base, e), t]);
...
Z({
  ...
  mathmlBuilder: (r, e) => {
    var t = Tr.mathMLnode(r.label), n = new W.MathNode("munder", [Pe(r.base, e), t]);
...
Z({
  ...
  mathmlBuilder(r, e) {
    ...
    var n;
    if (r.body) {
      var a = Xa(Pe(r.body, e));
      if (r.below) {
        var i = Xa(Pe(r.below, e));
        n = new W.MathNode("munderover", [t, i, a]);
      } else
        n = new W.MathNode("mover", [t, a]);
    } else if (r.below) {
      var s = Xa(Pe(r.below, e));
...
Z({
  ...
  mathmlBuilder(r, e) {
    var t = new W.MathNode("mrow", [Pe(r.label, e)]);
...
Z({
  ...
  mathmlBuilder(r, e) {
    return new W.MathNode("mrow", [Pe(r.fragment, e)]);
  }
});
Z({
  type: "textord",
...
Z({
  ...
  handler(r) {
    ...
    var n = e.fetch();
    if (Ys[n.text])
      return (t === "\\global" || t === "\\\\globallong") && (n.text = Ys[n.text]), Se(e.parseFunction(), "internal");
...
var aa = function(e, t, n) {
  var a = Ue.math[e] && Ue.math[e].replace, i = Vo(a || e, t, n);
  if (!i)
  ...
  type: "kern",
  size: -1 * Vs
}, Zp = ["|", "\\lvert", "\\rvert", "\\vert"], Qp = ["\\|", "\\lVert", "\\rVert", "\\Vert"], zd = function(e, t, n, a, i, s) {
  var o, l, c, u, d = "", m = 0;
  o = c = u = e, l = null;
  var g = "Size1-Regular";
  ...
  var v = aa(o, g, i), b = v.height + v.depth, x = aa(c, g, i), _ = x.height + x.depth, w = aa(u, g, i), C = w.height + w.depth, k = 0, E = 1;
  if (l !== null) {
    var T = aa(l, g, i);
    k = T.height + T.depth, E = 2;
  }
  var I = b + C + k, D = Math.max(0, Math.ceil((t - I) / (E * _))), M = I + D * E * _, F = a.fontMetrics().axisHeight;
  n && (F *= a.sizeMultiplier);
  var P = M / 2 - F, $ = [];
  if (d.length > 0) {
    var z = M - b - C, X = Math.round(M * 1e3), Y = ap(d, Math.round(z * 1e3)), re = new Lr(d, Y), de = (m / 1e3).toFixed(3) + "em", J = (X / 1e3).toFixed(3) + "em", he = new kr([re], {
      width: de,
      height: J,
      viewBox: "0 0 " + m + " " + X
    ...
    if ($.push(ns(u, g, i)), $.push(Ja), l === null) {
      ...
      var oe = (M - b - C - k) / 2 + 2 * Vs;
      $.push(as(c, oe, a)), $.push(Ja), $.push(ns(l, g, i)), $.push(Ja), $.push(as(c, oe, a));
    }
    $.push(Ja), $.push(ns(o, g, i));
  }
  var Be = a.havingBaseStyle(pe.TEXT), je = L.makeVList({
    positionType: "bottom",
    positionData: P,
    children: $
  }, Be);
  return r0(L.makeSpan(["delimsizing", "mult"], [je], Be), pe.TEXT, a, s);
  ...
  var l = Hd(e, t, o, a);
  return l.type === "small" ? Xp(e, l.style, n, a, i, s) : l.type === "large" ? Pd(e, l.size, n, a, i, s) : zd(e, t, n, a, i, s);
...
Z({
  ...
  htmlBuilder: (r, e) => {
    ...
    var o;
    if (r.left === "." ? o = ga(e, ["mopen"]) : o = Sr.leftRightDelim(r.left, n, a, e, r.mode, ["mopen"]), t.unshift(o), i)
      for (var l = 1; l < t.length; l++) {
        var c = t[l], u = c.isMiddle;
        u && (t[l] = Sr.leftRightDelim(u.delim, n, a, u.options, r.mode, []));
      }
    var d;
    if (r.right === ".")
      d = ga(e, ["mclose"]);
...
var n0 = (r, e) => {
  ...
  if (n === "sout")
    ...
    /box/.test(n) ? (_ = Math.max(
      ...
      e.minRuleThickness
      // User override.
    ), b = e.fontMetrics().fboxsep + (n === "colorbox" ? 0 : _), x = b) : n === "angl" ? (_ = Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness), b = 4 * _, x = Math.max(0, 0.25 - t.depth)) : (b = o ? 0.2 : 0, x = b), i = Tr.encloseSpan(t, n, b, x, e), /fbox|boxed|fcolorbox/.test(n) ? (i.style.borderStyle = "solid", i.style.borderWidth = V(_)) : n === "angl" && _ !== 0.049 && (i.style.borderTopWidth = V(_), i.style.borderRightWidth = V(_)), s = t.depth + x, r.backgroundColor && (i.style.backgroundColor = r.backgroundColor, r.borderColor && (i.style.borderColor = r.borderColor));
  }
  var w;
  ...
  var t = 0, n = new W.MathNode(r.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [Pe(r.body, e)]);
  switch (r.label) {
    case "\\cancel":
...
function Kr(r, e, t) {
  ...
  for (C(), _.push(Gl(r)); ; ) {
    var E = r.parseExpression(!1, c ? "\\end" : "\\\\");
    ...
    if (T === "&") {
      ...
      k(), v.length === 1 && E.type === "styling" && E.body[0].body.length === 0 && (b.length > 1 || !u) && b.pop(), _.length < b.length + 1 && _.push([]);
      break;
    } else if (T === "\\\\") {
      r.consume();
      var I = void 0;
      r.gullet.future().text !== " " && (I = r.parseSizeGroup(!0)), x.push(I ? I.value : null), k(), _.push(Gl(r)), v = [], b.push(v), C();
    } else
...
var dr = function(e, t) {
  ...
  var v = e.colSeparationType === "CD" ? Xe({
    number: 3,
    unit: "ex"
  }, t) : 12 * d, b = 3 * d, x = e.arraystretch * v, _ = 0.7 * x, w = 0.3 * x, C = 0;
  function k(He) {
  ...
  for (k(s[0]), n = 0; n < e.body.length; ++n) {
    var E = e.body[n], T = _, I = w;
    o < E.length && (o = E.length);
    var D = new Array(E.length);
    for (a = 0; a < E.length; ++a) {
      var M = De(E[a], t);
      I < M.depth && (I = M.depth), T < M.height && (T = M.height), D[a] = M;
    }
    var F = e.rowGaps[n], P = 0;
    F && (P = Xe(F, t), P > 0 && (P += w, I < P && (I = P), P = 0)), e.addJot && (I += b), D.height = T, D.depth = I, C += T, D.pos = C, C += I + P, l[n] = D, k(s[n + 1]);
  }
  var $ = C / 2 + t.fontMetrics().axisHeight, z = e.cols || [], X = [], Y, re, de = [];
  if (e.tags && e.tags.some((He) => He))
    for (n = 0; n < i; ++n) {
      var J = l[n], he = J.pos - $, le = e.tags[n], Ee = void 0;
      le === !0 ? Ee = L.makeSpan(["eqn-num"], [], t) : le === !1 ? Ee = L.makeSpan([], [], t) : Ee = L.makeSpan([], mt(le, t, !0), t), Ee.depth = J.depth, Ee.height = J.height, de.push({
        type: "elem",
        elem: Ee,
        shift: he
      });
  ...
  for (
    ...
    for (var oe = z[re] || {}, Be = !0; oe.type === "separator"; ) {
      if (Be || (Y = L.makeSpan(["arraycolsep"], []), Y.style.width = V(t.fontMetrics().doubleRuleSep), X.push(Y)), oe.separator === "|" || oe.separator === ":") {
        var je = oe.separator === "|" ? "solid" : "dashed", $e = L.makeSpan(["vertical-separator"], [], t);
        $e.style.height = V(C), $e.style.borderRightWidth = V(u), $e.style.borderRightStyle = je, $e.style.margin = "0 " + V(-u / 2);
        var dt = C - $;
        dt && ($e.style.verticalAlign = V(-dt)), X.push($e);
      } else
    ...
    if (!(a >= o)) {
      ...
      for (n = 0; n < i; ++n) {
        ...
        if (St) {
          var Qt = Rt.pos - $;
          St.depth = Rt.depth, St.height = Rt.height, Ge.push({
            type: "elem",
            elem: St,
            shift: Qt
          });
  ...
  for (var n = [], a = new W.MathNode("mtd", [], ["mtr-glue"]), i = new W.MathNode("mtd", [], ["mml-eqn-num"]), s = 0; s < e.body.length; s++) {
    for (var o = e.body[s], l = [], c = 0; c < o.length; c++)
      l.push(new W.MathNode("mtd", [Pe(o[c], t)]));
  ...
  if (e.cols && e.cols.length > 0) {
    var v = e.cols, b = "", x = !1, _ = 0, w = v.length;
  ...
  if (e.colSeparationType === "align") {
    for (var k = e.cols || [], E = "", T = 1; T < k.length; T++)
      E += T % 2 ? "0em " : "1em ";
    u.setAttribute("columnspacing", E.trim());
  ...
  var n = [], a = e.envName.indexOf("at") > -1 ? "alignat" : "align", i = e.envName === "split", s = Kr(e.parser, {
    cols: n,
    addJot: !0,
  ...
  s.body.forEach(function(_) {
    ...
    if (g)
      ...
      var E = _.length / 2;
      if (o < E)
        throw new G("Too many math in a row: " + ("expected " + o + ", but got " + E), _[0]);
    }
  });
  for (var v = 0; v < l; ++v) {
    var b = "r", x = 0;
...
cr({
  ...
  handler(r, e) {
    var t = Ri(e[0]), n = t ? [e[0]] : Se(e[0], "ordgroup").body, a = n.map(function(s) {
      var o = e0(s), l = o.text;
      if ("lcr".indexOf(l) !== -1)
        return {
          type: "align",
    ...
    return Kr(r.parser, i, s0(r.envName));
  },
  htmlBuilder: dr,
  mathmlBuilder: hr
});
cr({
  ...
  handler(r) {
    ...
    var i = Kr(r.parser, n, s0(r.envName)), s = Math.max(0, ...i.body.map((o) => o.length));
...
cr({
  ...
  handler(r, e) {
    ...
    if (i = Kr(r.parser, i, "script"), i.body.length > 0 && i.body[0].length > 1)
      throw new G("{subarray} can contain only one column");
    return i;
  },
  htmlBuilder: dr,
...
var Vd = (r, e) => {
  ...
  if (u) {
    ...
    var _ = g - s.depth - (c.height - b);
    _ < v && (g += 0.5 * (v - _), b += 0.5 * (v - _)), x = L.makeVList({
      positionType: "individualShift",
      children: [{
        type: "elem",
        elem: c,
  ...
  var k;
  t.size === pe.DISPLAY.size ? k = e.fontMetrics().delim1 : t.size === pe.SCRIPTSCRIPT.size ? k = e.havingStyle(pe.SCRIPT).fontMetrics().delim2 : k = e.fontMetrics().delim2;
  var E, T;
  return r.leftDelim == null ? E = ga(e, ["mopen"]) : E = Sr.customSizedDelim(r.leftDelim, k, !0, e.havingStyle(t), r.mode, ["mopen"]), r.continued ? T = L.makeSpan([]) : r.rightDelim == null ? T = ga(e, ["mclose"]) : T = Sr.customSizedDelim(r.rightDelim, k, !0, e.havingStyle(t), r.mode, ["mclose"]), L.makeSpan(["mord"].concat(i.sizingClasses(e)), [E, L.makeSpan(["mfrac"], [x]), T], e);
}, l0 = (r, e) => {
  var t = new W.MathNode("mfrac", [Pe(r.numer, e), Pe(r.denom, e)]);
  if (!r.hasBarLine)
...
Z({
  ...
  handler(r, e) {
    var {
      parser: t
    } = r, n = e[4], a = e[5], i = vi(e[0]), s = i.type === "atom" && i.family === "open" ? Jl(i.text) : null, o = vi(e[1]), l = o.type === "atom" && o.family === "close" ? Jl(o.text) : null, c = Se(e[2], "size"), u, d = null;
    ...
    if (g.type === "ordgroup") {
      ...
      g = Se(g, "textord"), m = Xl[Number(g.text)];
    return {
      type: "genfrac",
      mode: t.mode,
      numer: n,
...
Z({
  ...
  handler: (r, e) => {
    var {
      parser: t,
      funcName: n
    } = r, a = e[0], i = Bf(Se(e[1], "infix").size), s = e[2], o = i.number > 0;
    return {
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
var Xd = (r, e) => {
  ...
  var t = Tr.mathMLnode(r.label);
  return new W.MathNode(r.isOver ? "mover" : "munder", [Pe(r.base, e), t]);
};
Z({
  type: "horizBrace",
...
Z({
  ...
  handler: (r, e, t) => {
    ...
    if (t[0])
      for (var l = Se(t[0], "raw").string, c = l.split(","), u = 0; u < c.length; u++) {
        var d = c[u].split("=");
        if (d.length === 2) {
          var m = d[1].trim();
          switch (d[0].trim()) {
...
Z({
  ...
  mathmlBuilder: (r, e) => {
    var t = new W.MathNode("mpadded", [Pe(r.body, e)]);
    if (r.alignment !== "rlap") {
...
var Jd = (r, e, t, n, a, i, s) => {
  ...
  var x = 0, _ = 0;
  return (l instanceof Gt || i.name === "\\oiint" || i.name === "\\oiiint") && !i.suppressBaseShift && (x = (l.height - l.depth) / 2 - e.fontMetrics().axisHeight, _ = l.italic), a ? Jd(l, t, n, e, s, _, x) : (x && (l.style.position = "relative", l.style.top = V(x)), l);
}, Fa = (r, e) => {
  var t;
  if (r.symbol)
...
var Qd = (r, e) => {
  ...
  if (i.body.length > 0) {
    ...
    }), l = mt(o, e.withFont("mathrm"), !0), c = 0; c < l.length; c++) {
      var u = l[c];
...
Z({
  ...
  mathmlBuilder(r, e) {
    ...
    var n = new W.MathNode("mover", [Pe(r.body, e), t]);
    return n.setAttribute("accent", "true"), n;
  }
});
Z({
...
Z({
  ...
  mathmlBuilder(r, e) {
    var t = new W.MathNode("mpadded", [Pe(r.body, e)]), n = r.dy.number + r.dy.unit;
...
Z({
  ...
  htmlBuilder(r, e) {
    ...
    if (r.index) {
      var v = e.havingStyle(pe.SCRIPTSCRIPT), b = De(r.index, v, e), x = 0.6 * (g.height - g.depth), _ = L.makeVList({
        positionType: "shift",
        positionData: -x,
        children: [{
          type: "elem",
  ...
  mathmlBuilder(r, e) {
    ...
    return n ? new W.MathNode("mroot", [Pe(t, e), Pe(n, e)]) : new W.MathNode("msqrt", [Pe(t, e)]);
  }
});
var eu = {
  display: pe.DISPLAY,
...
gn({
  ...
  htmlBuilder(r, e) {
    ...
    var x = e.sizeMultiplier, _ = V(0.5 / c.ptPerEm / x), w = null;
    if (l) {
    ...
    if (o && l) {
      ...
      var E = c.defaultRuleThickness, T = 4 * E;
      if (u - o.depth - (l.height - d) < T) {
        d = T - (u - o.depth) + l.height;
      ...
      u = Math.max(u, b, o.depth + 0.25 * c.xHeight), k = L.makeVList({
        positionType: "shift",
        positionData: -u,
        children: [{
          type: "elem",
...
gn({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new W.MathNode("mtable", [new W.MathNode("mtr", [tu(), new W.MathNode("mtd", [Pr(r.body, e)]), tu(), new W.MathNode("mtd", [Pr(r.tag, e)])])]);
...
Z({
  ...
  mathmlBuilder(r, e) {
    var t = new W.MathNode("mo", [new W.TextNode("‾")]);
    t.setAttribute("stretchy", "true");
    var n = new W.MathNode("munder", [Pe(r.body, e), t]);
    return n.setAttribute("accentunder", "true"), n;
  }
});
Z({
  ...
  mathmlBuilder(r, e) {
    return new W.MathNode("mpadded", [Pe(r.body, e)], ["vcenter"]);
  }
});
Z({
  type: "verb",
...
S("\\renewcommand", (r) => u0(r, !0, !1));
S("\\providecommand", (r) => u0(r, !0, !0));
S("\\message", (r) => {
...
S("\\show", (r) => {
  ...
  return console.log(e, r.macros.get(t), Dr[t], Ue.math[t], Ue.text[t]), "";
});
S("\\bgroup", "{");
S("\\egroup", "}");
S("~", "\\nobreakspace");
...
S("\\dots", function(r) {
  ...
  return t in lu ? e = lu[t] : (t.slice(0, 4) === "\\not" || t in Ue.math && ce.contains(["bin", "rel"], Ue.math[t].group)) && (e = "\\dotsb"), e;
});
var c0 = {
...
S("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + nh + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
S("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + nh + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
...
class Cg {
  constructor(e, t, n) {
    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new _g(Sg, t.macros), this.mode = n, this.stack = [];
  }
  /**
   ...
   */
  isDefined(e) {
    return this.macros.has(e) || Dr.hasOwnProperty(e) || Ue.math.hasOwnProperty(e) || Ue.text.hasOwnProperty(e) || ih.hasOwnProperty(e);
  }
  /**
...
class Pi {
  ...
  parseExpression(e, t) {
    for (var n = []; ; ) {
      ...
      var a = this.fetch();
      if (Pi.endOfExpression.indexOf(a.text) !== -1 || t && a.text === t || e && Dr[a.text] && Dr[a.text].infix)
        break;
  ...
  parseSymbol() {
    ...
    cu.hasOwnProperty(t[0]) && !Ue[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = cu[t[0]] + t.slice(1));
    var i = xg.exec(t);
    ...
    if (Ue[this.mode][t]) {
      ...
      var o = Ue[this.mode][t].group, l = Ft.range(e), c;
...
Pi.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"];
var d0 = function(e, t) {
...
const Ng = ft.lazy(() => import("./EquationComponent-wTNGL1of.js"));
function du(r) {
...
const Ag = ft.lazy(() => import("./ExcalidrawComponent-BUs71uev.js"));
function Mg(r) {
...
class un extends ur {
  ...
  static clone(t) {
    return new un(t.__data, t.__width, t.__height, t.__key);
  }
  static importJSON(t) {
    return new un(t.data, t.width, t.height);
  }
  exportJSON() {
    return {
      data: this.__data,
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  decorate(t, n) {
    return /* @__PURE__ */ p.jsx($r, { fallback: null, children: /* @__PURE__ */ p.jsx(Ag, { nodeKey: this.getKey(), data: this.__data }) });
  }
}
function uh() {
  return new un();
...
class cn extends _t {
  ...
  static clone(t) {
    return new cn(t.__templateColumns, t.__key);
  }
  createDOM(t) {
...
const Og = ft.lazy(() => import("./PollComponent-CzCNBIAR.js"));
function Dg() {
...
const Ig = ft.lazy(() => import("./InlineImageComponent-jkosLvWB.js"));
function Fg(r) {
...
const Pg = ft.lazy(() => import("./StickyComponent-lCBW4jrz.js"));
class On extends ur {
...
function qg(r, e, t, n, a) {
  ...
  if (o.length > 1) {
    ...
    return w && C && !r._nodeMap.has(w.__key) && _e(w) && w.__text.length === 1 && i.anchor.offset === 1 ? pu : Vt;
  }
  const l = o[0], c = r._nodeMap.get(l.__key);
  if (!_e(c) || !_e(l) || c.__mode !== l.__mode) return Vt;
...
function Ug(r, e) {
  ...
  return (a, i, s, o, l, c) => {
    ...
    const d = qg(a, i, o, l, r.isComposing()), m = (() => {
      ...
      return o.size > 0 || l.size > 0 ? v === !1 && d !== Vt && d === n && u < t + e && g || o.size === 1 && function(x, _, w) {
        const C = _._nodeMap.get(x), k = w._nodeMap.get(x), E = _._selection, T = w._selection;
        return !(U(E) && U(T) && E.anchor.type === "element" && E.focus.type === "element" && T.anchor.type === "text" && T.focus.type === "text" || !_e(C) || !_e(k) || C.__parent !== k.__parent) && JSON.stringify(_.read(() => C.exportJSON())) === JSON.stringify(w.read(() => k.exportJSON()));
...
function Kg(r, e, t) {
  const n = Ug(r, t);
  return Re(r.registerCommand(_c, () => (function(i, s) {
  ...
  }(r, e), !0), ve), r.registerCommand(wc, () => (function(i, s) {
    const o = s.redoStack, l = s.undoStack;
    if (o.length !== 0) {
      const c = s.current;
  ...
  }(r, e), !0), ve), r.registerCommand(M1, () => (gu(e), !1), ve), r.registerCommand(A1, () => (gu(e), r.dispatchCommand(ea, !1), r.dispatchCommand(ta, !1), !0), ve), r.registerUpdateListener(({ editorState: i, prevEditorState: s, dirtyLeaves: o, dirtyElements: l, tags: c }) => {
...
}, Yg = () => sc(hh), Vg = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : B;
function Xg(r) {
...
function r4(r, e, t, n) {
  ...
  return [r.registerNodeTransform(Hr, (s) => {
    ...
    _e(c) && c.isTextEntity() && (i(c), i(s));
    const u = s.getNextSibling();
    _e(u) && u.isTextEntity() && (i(u), a(s) && i(s));
  })];
}
function n4(r) {
          ...
          if (l) {
            ...
            r.update(() => {
              ...
              if (U(b)) {
                ...
                if (_e(_) && c >= 0 && u >= 0 && (w = c, C = c + u, b.setTextNodeRange(_, w, _, C)), w === C && d === "" || (b.insertRawText(d), _ = x.getNode()), _e(_)) {
                  w = m, C = m + g;
                  const k = _.getTextContentSize();
                  w = w > k ? k : w, C = C > k ? k : C, b.setTextNodeRange(_, w, _, C);
                }
...
const eo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : B;
function vu(r) {
  ...
  const [n] = se(), a = function(i, s) {
    ...
    return eo(() => i.registerDecoratorListener((c) => {
      ...
      for (let d = 0; d < u.length; d++) {
        const m = u[d], g = p.jsx(s, { onError: (b) => i._onError(b), children: p.jsx($r, { fallback: null, children: o[m] }) }), v = i.getElementByKey(m);
...
var bu = { error: null }, s4 = function(r) {
  ...
  return a.reset = function() {
    ...
    if (i !== null) {
      ...
      if (ft.isValidElement(c)) return c;
      if (typeof o == "function") return o(u);
      if (l) return ft.createElement(l, u);
...
const fh = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : B;
function m4({ editor: r, ariaActiveDescendant: e, ariaAutoComplete: t, ariaControls: n, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: o, ariaLabel: l, ariaLabelledBy: c, ariaMultiline: u, ariaOwns: d, ariaRequired: m, autoCapitalize: g, className: v, id: b, role: x = "textbox", spellCheck: _ = !0, style: w, tabIndex: C, "data-testid": k, ...E }, T) {
  const [I, D] = q(r.isEditable()), M = ie((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? r.setRootElement(P) : r.setRootElement(null);
  }, [r]), F = it(() => /* @__PURE__ */ function(...P) {
    return ($) => {
      P.forEach((z) => {
        typeof z == "function" ? z($) : z != null && (z.current = $);
      });
    };
  }(T, M), [M, T]);
  return fh(() => (D(r.isEditable()), r.registerEditableListener((P) => {
    D(P);
  })), [r]), p.jsx("div", { ...E, "aria-activedescendant": I ? e : void 0, "aria-autocomplete": I ? t : "none", "aria-controls": I ? n : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": I && x === "combobox" ? !!s : void 0, ...o != null ? { "aria-invalid": o } : {}, "aria-label": l, "aria-labelledby": c, "aria-multiline": u, "aria-owns": I ? d : void 0, "aria-readonly": !I || void 0, "aria-required": m, autoCapitalize: g, className: v, contentEditable: I, "data-testid": k, id: b, ref: F, role: I ? x : void 0, spellCheck: _, style: w, tabIndex: C });
}
const f4 = oc(m4);
function yu(r) {
  return r.getEditorState().read(mh(r.isComposing()));
...
const ph = ft.createContext(null), xu = 4;
function Me({
  children: r,
  className: e,
  onClick: t,
  ...
  const a = Te(null), i = ft.useContext(ph);
  if (i === null)
...
const S4 = rn.lazy(() => import("./DataMentionComponent-BPyox78U.js"));
function C4(r) {
...
class zr extends ur {
  ...
  createDOM(t) {
    ...
    if (l.setAttribute("data-mention-type", this.__dataMention), l.setAttribute("data-mention-field", this.__fieldName), l.setAttribute("data-mention-label", this.__label), l.setAttribute("data-lexical-data-mention", "true"), l.setAttribute("data-mention-data", ((g = this.__data) == null ? void 0 : g.toString()) || ""), u !== void 0 && (l.className = u), n)
      return l;
    let d = l;
    this.hasFormat("code") && l.setAttribute("spellcheck", "false"), i !== null && (d = document.createElement(s), l.appendChild(d)), _u(d, a, t);
  ...
  updateDOM(t, n, a) {
    ...
    if (o === l && c !== u) {
      ...
      k == null && wu(!1, "updateDOM: prevInnerDOM is null or undefined");
      const E = document.createElement(u);
      return _u(
        E,
        s,
        a
      ), n.replaceChild(E, k), v && E.appendChild(v), !1;
    }
    let b = n;
  ...
  toggleFormat(t) {
    if (this.isInput())
      return this;
    const n = this.getFormat(), a = _4(n, t);
...
const g0 = ({
  ...
  !a && r === "input" && (a = va());
  const l = new zr(r, e, t, n, a, i, s, o);
  return ut(l);
}, E4 = (r) => r instanceof zr, ua = (r) => r === null || r.getNodes().length !== 1 ? !1 : E4(r.getNodes()[0]), Vr = 8, Xr = 72, T4 = 15;
function N4({
  selectionFontSize: r,
  disabled: e = !1,
  editor: t
}) {
  const [n, a] = ft.useState(r), i = (c, u) => {
    if (!u)
      return c;
    let d = c;
    switch (u) {
    ...
    if (c.key === "Enter") {
      c.preventDefault();
      let d = u;
      u > Xr ? d = Xr : u < Vr && (d = Vr), a(String(d)), s(String(d) + "px", null);
    }
  }, l = (c) => {
    if (n !== "") {
      const u = i(
...
function vh({
  ...
  return B(() => {
    ...
    "div",
    {
      ...
      ref: s,
      children: [
        /* @__PURE__ */ p.jsx(Br, { label: "Hex", onChange: c, value: a }),
...
const P4 = (r) => Wn ? (r || window).getSelection() : null, Pa = ze("INSERT_IMAGE_COMMAND");
function z4({
  onClick: r
}) {
...
function yh({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    ...
    t === "url" && /* @__PURE__ */ p.jsx(z4, { onClick: i }),
  ...
  return B(() => {
    ...
    return Re(
      e.registerCommand(
        ...
        (t) => {
          const n = jo(t);
          return In([n]), Pt(n.getParentOrThrow()) && Ca(n, xe).selectEnd(), !0;
        },
        ve
      ),
      e.registerCommand(
...
function U4(r, e) {
  ...
  if (r.preventDefault(), wh(r)) {
    ...
    t.remove();
    const i = _a();
    a != null && i.applyDOMRange(a), xt(i), e.dispatchCommand(Pa, n);
  }
  return !0;
}
function b0() {
...
function W4(r) {
  let e;
  const t = r.target, n = t == null ? null : t.nodeType === 9 ? t.defaultView : t.ownerDocument.defaultView, a = P4(n);
...
const X4 = (r) => Wn ? (r || window).getSelection() : null, y0 = ze("INSERT_INLINE_IMAGE_COMMAND");
function J4({
  activeEditor: r,
  onClose: e
}) {
  ...
  return B(() => {
    ...
    return Re(
      r.registerCommand(
        ...
        (e) => {
          const t = p0(e);
          return In([t]), Pt(t.getParentOrThrow()) && Ca(t, xe).selectEnd(), !0;
        },
        ve
      ),
      r.registerCommand(
...
const Q4 = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", _h = document.createElement("img");
_h.src = Q4;
function e2(r) {
  const e = x0();
  if (!e)
    return !1;
  const t = r.dataTransfer;
  return t ? (t.setData("text/plain", "_"), t.setDragImage(_h, 0, 0), t.setData(
    "application/x-lexical-drag",
    JSON.stringify({
      data: {
        altText: e.__altText,
...
function t2(r) {
  return x0() ? (Sh(r) || r.preventDefault(), !0) : !1;
}
function r2(r, e) {
  const t = x0();
  if (!t)
...
function i2() {
  ...
  return B(() => {
    ...
    return r.registerCommand(
      ...
      () => {
        const e = uh();
        return In([e]), Pt(e.getParentOrThrow()) && Ca(e, xe).selectEnd(), !0;
      },
      ve
    );
  }, [r]), null;
}
ze("INSERT_NEW_TABLE_COMMAND");
uo({
  ...
  return t.reset = function() {
    ...
    if (a !== null) {
      ...
      if (typeof s == "function")
        return s(c);
      if (o)
        return /* @__PURE__ */ ft.createElement(o, c);
      throw new Error("react-error-boundary requires either a fallback, fallbackRender, or FallbackComponent prop");
    }
    return this.props.children;
  }, e;
...
const Ah = ze("INSERT_EQUATION_COMMAND");
function Mh({
  activeEditor: r,
  onClose: e
}) {
  ...
  return B(() => {
    ...
    return r.registerCommand(
      ...
      (e) => {
        ...
        return In([a]), Pt(a.getParentOrThrow()) && Ca(a, xe).selectEnd(), !0;
      },
      ve
    );
  }, [r]), null;
...
const Ou = "startTransition", g2 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : B;
let v2 = class {
  constructor(e) {
...
const Iu = ze("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
function y2({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ye }) {
  ...
  const m = ie((v) => {
    e.update(() => {
      const b = n.match != null && o ? function(x) {
        ...
        const k = w.offset, E = C.getTextContent().slice(0, k), T = x.replaceableString.length, I = k - function(M, F, P) {
          let $ = P;
          for (let z = $; z <= F.length; z++) M.substr(-z) === F.substr(0, z) && ($ = z);
          return $;
        }(E, x.matchingString, T);
        if (I < 0) return null;
        let D;
  ...
  return B(() => () => {
    ...
    if (a !== null && a.length && c !== null) {
      ...
      g(x);
      const _ = a[x];
      _.ref != null && _.ref.current && e.dispatchCommand(Iu, { index: x, option: _ }), b.preventDefault(), b.stopImmediatePropagation();
    }
    return !0;
    ...
    if (a !== null && a.length && c !== null) {
      ...
      g(x);
      const _ = a[x];
      _.ref != null && _.ref.current && Du(_.ref.current), b.preventDefault(), b.stopImmediatePropagation();
    }
    return !0;
...
function x2({ options: r, nodeKey: e, onClose: t, onOpen: n, onSelectOption: a, menuRenderFn: i, anchorClassName: s, commandPriority: o = ye, parent: l }) {
  const [c] = se(), [u, d] = q(null), m = function(x, _, w, C = document.body, k = !0) {
    const [E] = se(), T = Te(document.createElement("div")), I = ie(() => {
      T.current.style.top = T.current.style.bottom;
      const M = E.getRootElement(), F = T.current, P = F.firstChild;
      if (M !== null && x !== null) {
        const { left: $, top: z, width: X, height: Y } = x.getRect(), re = T.current.offsetHeight;
        if (F.style.top = `${z + re + 3 + (k ? window.pageYOffset : 0)}px`, F.style.left = `${$ + window.pageXOffset}px`, F.style.height = `${Y}px`, F.style.width = `${X}px`, P !== null) {
          P.style.top = `${z}`;
          const de = P.getBoundingClientRect(), J = de.height, he = de.width, le = M.getBoundingClientRect();
          $ + he > le.right && (F.style.left = `${le.right - he + window.pageXOffset}px`), (z + J > window.innerHeight || z + J > le.bottom) && z - le.top > J + Y && (F.style.top = `${z - J - Y + (k ? window.pageYOffset : 0)}px`);
        }
        F.isConnected || (w != null && (F.className = w), F.setAttribute("aria-label", "Typeahead menu"), F.setAttribute("id", "typeahead-menu"), F.setAttribute("role", "listbox"), F.style.display = "block", F.style.position = "absolute", C.append(F)), T.current = F, M.setAttribute("aria-controls", "typeahead-menu");
      }
    }, [E, x, k, w, C]);
    B(() => {
    ...
    e ? c.update(() => {
      const x = bt(e), _ = c.getElementByKey(e);
      var w;
      x != null && _ != null && u == null && (w = () => v({ getRect: () => _.getBoundingClientRect() }), Ou in rn ? rn[Ou](w) : w());
    }) : e == null && u != null && g();
  }, [g, c, e, v, u]);
  return B(() => {
    b();
...
const w2 = /((https?:\/\/(www\.)?)|(www\.))[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)/, S0 = ze("INSERT_EMBED_COMMAND");
let Fu = class extends v2 {
  constructor(e, t) {
    super(e), this.title = e, this.onSelect = t.onSelect.bind(this);
  }
};
function _2({ embedConfigs: r, onOpenEmbedModalForConfig: e, getMenuOptions: t, menuRenderFn: n, menuCommandPriority: a = ye }) {
  const [i] = se(), [s, o] = q(null), [l, c] = q(null), u = ie(() => {
    ...
    if (x !== void 0) for (const _ of r)
      await Promise.resolve(_.parseUrl(x)) != null && (c(_), o(b));
  }, [i, r]);
  B(() => Re(...[Fn, ka].map((b) => i.registerMutationListener(b, (...x) => ((_, { updateTags: w, dirtyLeaves: C }) => {
    for (const [k, E] of _) E === "created" && w.has("paste") && C.size <= 3 ? d(k) : k === s && u();
  })(...x), { skipInitialization: !0 }))), [d, i, r, s, u]), B(() => i.registerCommand(S0, (b) => {
    const x = r.find(({ type: _ }) => _ === b);
    return !!x && (e(x), !0);
  }, ve), [i, r, e]);
  ...
  }, [l, i, s]), g = it(() => l != null && s != null ? t(l, m, u) : [], [l, m, t, s, u]), v = ie((b, x, _) => {
    i.update(() => {
      b.onSelect(x), _();
    });
  }, [i]);
...
function F2({
  ...
  const n = () => {
    ...
    e !== "bullet" ? r.dispatchCommand(So, void 0) : n();
  }, s = () => {
...
function z2({ setIsLinkEditMode: r }) {
  const [e] = se(), [t, n] = q("paragraph"), [a, i] = q(e), [s, o] = q("15px"), [l, c] = q("#000"), [u, d] = q("#fff"), [m, g] = q('"Noto Sans JP", serif'), [v, b] = q("left"), [x, _] = q(!1), [w, C] = q(!1), [k, E] = q(!1), [T, I] = q(!1), [D, M] = q(!1), [F, P] = q(!1), [$, z] = q(!1), [X, Y] = q(!1), [re, de] = q(!1), [J, he] = q(!1), [le, Ee] = q(!1), [oe, Be] = q(() => e.isEditable()), [je, $e] = zi(), dt = ie(() => {
    const ee = j();
    if (ee && ua(ee)) {
      const we = ee.getNodes()[0];
      C(we.hasFormat("bold")), E(we.hasFormat("italic")), I(we.hasFormat("underline")), M(we.hasFormat("strikethrough")), P(we.hasFormat("subscript")), z(we.hasFormat("superscript")), Y(we.hasFormat("code")), o(we.getStyleValue("font-size", "15px")), c(we.getStyleValue("color", "#000")), d(we.getStyleValue("background-color", "#fff")), g(we.getStyleValue("font-family", '"Noto Sans JP", serif'));
    } else if (U(ee)) {
      const we = ee.anchor.getNode();
      let Ke = we.getKey() === "root" ? we : me(we, (jt) => {
        const vn = jt.getParent();
        return vn !== null && Pt(vn);
      });
      Ke === null && (Ke = we.getTopLevelElementOrThrow());
      const Ct = Ke.getKey(), tt = a.getElementByKey(Ct);
      C(ee.hasFormat("bold")), E(ee.hasFormat("italic")), I(ee.hasFormat("underline")), M(ee.hasFormat("strikethrough")), P(ee.hasFormat("subscript")), z(ee.hasFormat("superscript")), Y(ee.hasFormat("code")), de(Nc(ee));
      const ht = Dn(ee), He = ht.getParent();
      if (lt(He) || lt(ht) ? _(!0) : _(!1), tt !== null)
        if (ke(Ke)) {
          const jt = Oc(
            we,
            Ta
      ...
      lt(He) && (It = me(
        ...
        ue(It) ? It.getFormatType() : ue(ht) ? ht.getFormatType() : (He == null ? void 0 : He.getFormatType()) || "left"
      );
    }
  }, [a]);
  B(() => e.registerCommand(
    yr,
    (ee, we) => (dt(), i(we), Be(we.isEditable()), !1),
    pt
  ), [e, dt]), B(() => Re(
    ...
    a.update(() => {
      ...
      if (ee && ua(ee))
        ...
        Ct.forEach((tt, ht) => {
          if (_e(tt)) {
            let He = tt;
            ht === 0 && we.offset !== 0 && (He = He.splitText(we.offset)[1] || He), ht === Ct.length - 1 && (He = He.splitText(Ke.offset)[0] || He), He.__style !== "" && He.setStyle(""), He.__format !== 0 && (He.setFormat(0), Ti(He).setFormat("")), tt = He;
      ...
      hn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                $e("Insert Image", (ee) => /* @__PURE__ */ p.jsx(
                  yh,
                  {
                    activeEditor: a,
                    onClose: ee
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                $e("Insert Inline Image", (ee) => /* @__PURE__ */ p.jsx(
                  J4,
                  {
                    activeEditor: a,
                    onClose: ee
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                $e("Insert Table", (ee) => /* @__PURE__ */ p.jsx(
                  Ch,
                  {
                    activeEditor: a,
                    onClose: ee
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                $e("Insert Poll", (ee) => /* @__PURE__ */ p.jsx(
                  Eh,
                  {
                    activeEditor: a,
                    onClose: ee
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                $e("Insert Columns Layout", (ee) => /* @__PURE__ */ p.jsx(
                  Nh,
                  {
                    activeEditor: a,
                    onClose: ee
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                $e("Insert Equation", (ee) => /* @__PURE__ */ p.jsx(
                  Mh,
                  {
                    activeEditor: a,
                    onClose: ee
...
function j2() {
  ...
  return B(() => Re(r.registerCommand(ko, () => (Is(r, "check"), !0), ye), r.registerCommand(mn, (e) => Bu(e, r, !1), ye), r.registerCommand(fn, (e) => Bu(e, r, !0), ye), r.registerCommand(Rn, (e) => {
  ...
  }, ye), r.registerCommand(Sa, (e) => r.getEditorState().read(() => {
    const t = j();
    ...
    e !== null && (e.addEventListener("click", Pu), e.addEventListener("pointerdown", zu)), t !== null && (t.removeEventListener("click", Pu), t.removeEventListener("pointerdown", zu));
  }))), null;
}
function Ih(r, e) {
  const t = r.target;
...
function X2({
  ...
  const s = Te(null), o = Te(null), [l, c] = q(""), [u, d] = q("https://"), [m, g] = q(
    ...
    if (_ !== null && C !== null && E !== null && E.contains(C.anchorNode) && r.isEditable()) {
      const D = (I = (T = C.focusNode) == null ? void 0 : T.parentElement) == null ? void 0 : I.getBoundingClientRect();
      D && (D.y += 40, $u(D, w, n)), g(_);
    } else (!k || k.className !== "link-input") && (E !== null && $u(null, w, n), g(null), i(!1), c(""));
    return !0;
  }, [n, r, i, a, l]);
  B(() => {
...
function zh(r) {
  ...
  return ue(e) && (e = e.getLastDescendant()), e === null || ba(e) || _e(e) && Ph(e.getTextContent());
}
function Bh(r) {
  let e = r.getNextSibling();
  return ue(e) && (e = e.getFirstDescendant()), e === null || ba(e) || _e(e) && so(e.getTextContent());
}
function r5(r, e, t, n) {
  return (r > 0 ? yi(t[r - 1]) : zh(n[0])) ? e < t.length ? yi(t[e]) : Bh(n[n.length - 1]) : !1;
}
function n5(r, e, t) {
  const n = [], a = [], i = [];
  let s = 0, o = 0;
...
function a5(r, e, t, n) {
  ...
  if (r.length > 1) {
    ...
    const u = j(), d = u ? u.getNodes().find(_e) : void 0, m = Ir(s.getTextContent());
...
function bs(r, e, t) {
  ...
  for (let l = 0; l < a; l++) {
    const c = n[l];
    if (!_e(c) || !c.isSimpleText()) return ii(r), void t(null, r.getURL());
  }
  const i = r.getTextContent(), s = Lh(i, e);
  if (s === null || s.text !== i || !zh(r) || !Bh(r)) return ii(r), void t(null, r.getURL());
  const o = r.getURL();
...
function i5(r, e, t) {
  B(() => {
    ...
    return Re(r.registerNodeTransform(Hr, (a) => {
      ...
      if (vr(i) && !i.getIsUnlinked()) bs(i, e, n);
        ...
        if (a.isSimpleText() && (so(a.getTextContent()) || !vr(s))) {
          const o = function(l) {
            ...
            for (; u !== null && _e(u) && u.isSimpleText() && (c.push(u), !/[\s]/.test(u.getTextContent())); ) u = u.getNextSibling();
            return c;
          }(a);
          (function(l, c, u) {
            let d = [...l];
            ...
            for (; (g = Lh(v, c)) && g !== null; ) {
              ...
              if (r5(b + x, b + _, m, d)) {
                const [w, , C, k] = n5(d, b + x, b + _), E = a5(C, b + x - w, b + _ - w, g);
                d = E ? [E, ...k] : k, u(g.url, null), b = 0;
              } else b += _;
              v = v.substring(_);
            }
          })(o, e, n);
        ...
        (function(o, l, c) {
          ...
          var g;
          !vr(u) || u.getIsUnlinked() || so(m) && (g = m, !(u.isEmailURI() ? /^\.[a-zA-Z]{2,}/.test(g) : /^\.[a-zA-Z0-9]{1,}/.test(g))) || (u.append(o), bs(u, l, c), c(null, u.getURL())), !vr(d) || d.getIsUnlinked() || Ph(m) || (ii(d), bs(d, l, c), c(null, d.getURL()));
        })(a, e, n);
      }
...
function b5(r) {
  B(() => {
    ...
    return r.registerNodeTransform(Hr, v5);
  }, [r]);
}
function y5() {
  const [r] = se();
...
const Uu = "startTransition", x5 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : B;
class k0 {
  constructor(e) {
    this.key = e, this.ref = { current: null }, this.setRefElement = this.setRefElement.bind(this);
  }
...
const Gu = ze("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
function _5({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ye }) {
  const [c, u] = q(null), d = n.match && n.match.matchingString;
  B(() => {
    u(0);
  }, [d]);
  ...
  return B(() => () => {
    ...
    if (a !== null && a.length && c !== null) {
      ...
      g(x);
      const _ = a[x];
      _.ref != null && _.ref.current && e.dispatchCommand(Gu, { index: x, option: _ }), b.preventDefault(), b.stopImmediatePropagation();
    }
    return !0;
  }, l), e.registerCommand(fn, (v) => {
    const b = v;
    if (a !== null && a.length && c !== null) {
      ...
      g(x);
      const _ = a[x];
      _.ref != null && _.ref.current && Ku(_.ref.current), b.preventDefault(), b.stopImmediatePropagation();
    }
    return !0;
  }, l), e.registerCommand(Rn, (v) => {
    const b = v;
...
const S5 = `\\.,\\+\\*\\?\\$\\@\\|#{}\\(\\)\\^\\-\\[\\]\\\\/!%'"~=<>_:;`;
ze("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
function E0(r, { minLength: e = 1, maxLength: t = 75 }) {
  return ie((n) => {
    const a = new RegExp("(^|\\s|\\()([" + r + "]((?:" + ("[^" + r + S5 + "\\s]") + "){0," + t + "}))$").exec(n);
    if (a !== null) {
      const i = a[1], s = a[3];
...
function T0({ options: r, onQueryChange: e, onSelectOption: t, onOpen: n, onClose: a, menuRenderFn: i, triggerFn: s, anchorClassName: o, commandPriority: l = ye, parent: c }) {
  const [u] = se(), [d, m] = q(null), g = function(x, _, w, C = document.body, k = !0) {
    const [E] = se(), T = Te(document.createElement("div")), I = ie(() => {
      T.current.style.top = T.current.style.bottom;
      const M = E.getRootElement(), F = T.current, P = F.firstChild;
      if (M !== null && x !== null) {
  ...
  return B(() => {
    const x = u.registerUpdateListener(() => {
      u.getEditorState().read(() => {
        const _ = u._window || window, w = _.document.createRange(), C = j(), k = function(I) {
          let D = null;
          return I.getEditorState().read(() => {
            ...
            U(M) && (D = function(F) {
              ...
              const z = P.offset;
              return $.getTextContent().slice(0, z);
            }(M));
          }), D;
        }(u);
        if (!U(C) || !C.isCollapsed() || k === null || w === null) return void v();
        const E = s(k, u);
        if (e(E ? E.matchingString : null), E !== null && !function(I, D) {
        ...
        }(u, E.leadOffset) && function(D, M, F) {
          const P = F.getSelection();
          if (P === null || !P.isCollapsed) return !1;
          const $ = P.anchorNode, z = D, X = P.anchorOffset;
          if ($ == null || X == null) return !1;
          try {
            M.setStart($, z), M.setEnd($, X);
          } catch {
            return !1;
          }
          return !0;
        }(E.leadOffset, w, _) !== null)
          return T = () => b({ getRect: () => w.getBoundingClientRect(), match: E }), void (Uu in rn ? rn[Uu](T) : T());
        var T;
        v();
      });
    });
  ...
  }, [u, s, e, d, v, b]), d === null || u === null ? null : p.jsx(_5, { close: v, resolution: d, editor: u, anchorElementRef: g, options: r, menuRenderFn: i, shouldSplitNodeWithQuery: !0, onSelectOption: t, commandPriority: l });
}
class ot extends k0 {
  constructor(t, n) {
    super(t);
...
function E5(r, e) {
  return [
    ...
    new ot("Bulleted List", {
      ...
      onSelect: () => r.dispatchCommand(So, void 0)
    }),
    new ot("Check List", {
    ...
    ...C0.map(
      (t) => new ot(`Embed ${t.contentName}`, {
        ...
        onSelect: () => r.dispatchCommand(S0, t.type)
      })
    ),
    new ot("Equation", {
    ...
    new ot("Collapsible", {
      ...
      onSelect: () => r.dispatchCommand(_0, void 0)
    }),
...
function T5() {
  const [r] = se(), [e, t] = zi(), [n, a] = q(null), i = E0("/", {
    minLength: 0
  }), s = it(() => {
    const l = E5(r, t);
    if (!n)
...
function D5({
  ...
  function m(b) {
    if (u != null && u.current && (b.buttons === 1 || b.buttons === 3) && u.current.style.pointerEvents !== "none") {
      const x = b.clientX, _ = b.clientY, w = document.elementFromPoint(x, _);
  ...
  const v = ie(() => {
    const b = j(), x = u.current, _ = window.getSelection();
    if (x === null)
      return;
    const w = r.getRootElement();
    if (b !== null && _ !== null && !_.isCollapsed && w !== null && w.contains(_.anchorNode)) {
      const C = N5(_, w);
      O5(
        C,
        x,
...
function R5(r, e) {
  const [t, n] = q(!1), [a, i] = q(!1), [s, o] = q(!1), [l, c] = q(!1), [u, d] = q(!1), [m, g] = q(!1), [v, b] = q(!1), [x, _] = q(!1), [w, C] = q(!1), k = ie(() => {
    r.getEditorState().read(() => {
      if (r.isComposing())
        return;
      const E = j(), T = window.getSelection(), I = r.getRootElement();
      if (T !== null && (!U(E) || I === null || !I.contains(T.anchorNode))) {
        n(!1);
        return;
      }
      if (!U(E))
        return;
      const D = Dn(E);
      o(E.hasFormat("bold")), c(E.hasFormat("italic")), d(E.hasFormat("underline")), g(E.hasFormat("strikethrough")), b(E.hasFormat("subscript")), _(E.hasFormat("superscript")), C(E.hasFormat("code"));
      const M = D.getParent();
      lt(M) || lt(D) ? i(!0) : i(!1), !wo(E.anchor.getNode()) && E.getTextContent() !== "" ? n(_e(D) || qr(D)) : n(!1);
      const F = E.getTextContent().replace(/\n/g, "");
      if (!E.isCollapsed() && F === "") {
        n(!1);
        return;
      }
  ...
  return B(() => (document.addEventListener("selectionchange", k), () => {
...
function L5({ hasCellMerge: r = !0, hasCellBackgroundColor: e = !0, hasTabHandler: t = !0 }) {
  const [n] = se();
  return B(() => (n.hasNodes([or, sr, zn]) || ti(10), Re(n.registerCommand(Ro, ({ columns: a, rows: i, includeHeaders: s }) => {
    const o = sf(Number(i), Number(a), s);
    Ur(o);
    const l = o.getFirstDescendant();
    return _e(l) && l.select(), !0;
  }, ve), n.registerNodeTransform(or, (a) => {
...
function z5({ editor: r }) {
  ...
  B(() => r.registerNodeTransform(or, (D) => {
    ...
    const D = ($) => {
      setTimeout(() => {
        ...
        if (u(v($)), !(t.current && t.current.contains(z)) && e.current !== z) {
          e.current = z;
          const X = js(z);
          X && o !== X ? r.update(() => {
            const Y = Qe(X.elem);
            ...
            e.current = z, n.current = de.getBoundingClientRect(), l(X);
          }) : X == null && g();
        }
      }, 0);
    }, M = () => {
    ...
    }, P = r.registerRootListener(
      ($, z) => {
        z == null || z.removeEventListener("mousemove", D), z == null || z.removeEventListener("mousedown", M), z == null || z.removeEventListener("mouseup", F), $ == null || $.addEventListener("mousemove", D), $ == null || $.addEventListener("mousedown", M), $ == null || $.addEventListener("mouseup", F);
      }
    );
    return () => {
      P();
  ...
  const b = (D) => D === "bottom", x = ie(
    (D) => {
      ...
      r.update(
        () => {
          ...
          if (!ae(M))
            throw new Error("TableCellResizer: Table cell node not found.");
          const F = br(M), P = Io(M) + M.getRowSpan() - 1, $ = F.getChildren();
          if (P >= $.length || P < 0)
            throw new Error("Expected table cell to be inside of table row.");
          const z = $[P];
          if (!nt(z))
    ...
    (D) => {
      const M = (F) => {
        if (F.preventDefault(), F.stopPropagation(), !o)
          throw new Error("TableCellResizer: Expected active cell.");
        if (a.current) {
          const { x: P, y: $ } = a.current, z = Ms(F.target);
          if (b(D)) {
            const X = (F.clientY - $) / z;
            x(X);
          } else {
            const X = (F.clientX - P) / z;
            C(X);
          }
    ...
    if (o) {
      const { height: D, width: M, top: F, left: P } = o.elem.getBoundingClientRect(), $ = Ms(o.elem), z = 10, X = {
        bottom: {
          backgroundColor: "none",
          cursor: "row-resize",
          height: `${z}px`,
          left: `${(window.scrollX || window.pageXOffset) + P}px`,
          top: `${(window.scrollY || window.pageYOffset) + F + D - z / 2}px`,
          width: `${M}px`
        },
        right: {
          backgroundColor: "none",
          cursor: "col-resize",
          height: `${D}px`,
          left: `${(window.scrollX || window.pageXOffset) + P + M - z / 2}px`,
...
function B5() {
  const [r] = se(), e = La();
  return it(
    () => e ? Zt(/* @__PURE__ */ p.jsx(z5, { editor: r }), document.body) : null,
    [r, e]
  );
}
function ys(r) {
...
function $5(r) {
  ...
  _e(e) ? e.select() : ue(e) ? e.selectEnd() : e !== null && e.selectNext();
}
function Xu(r) {
  return r.getEditorState().read(() => {
    const e = j();
...
function H5({
  ...
  B(() => s.registerMutationListener(
    ...
    if (Y != null && re != null && de != null) {
      ...
      if (oe + le.width > window.innerWidth || oe + le.width > J.right) {
        const je = he.left - le.width - Ee;
        oe = (je < 0 ? Ee : je) + window.pageXOffset;
      }
      re.style.left = `${oe + window.pageXOffset}px`;
      let Be = he.top;
      if (Be + le.height > window.innerHeight) {
        const je = he.bottom - le.height;
        Be = (je < 0 ? Ee : je) + window.pageYOffset;
      }
      re.style.top = `${Be + +window.pageYOffset}px`;
    }
  }, [n, o, s]), B(() => {
    function Y(re) {
  ...
  const w = ie(() => {
        ...
        for (let le = 0; le < J.length; le++) {
          ...
          if (ae(Ee))
            if (he === null) {
              ...
              const oe = Vu(Ee);
              let Be;
              oe && qr(Be = Ee.getFirstChild()) && Be.remove();
    ...
    s.update(() => {
      ...
      if (!nt(J))
        throw new Error("Expected table row");
      const he = l.getHeaderStyles() ^ qe.ROW;
      J.getChildren().forEach((le) => {
        if (!ae(le))
          throw new Error("Expected table cell");
        le.setHeaderStyles(he, qe.ROW);
      }), w(), r();
    });
  }, [s, l, w, r]), P = ie(() => {
    s.update(() => {
      ...
      if (re >= J || re < 0)
        throw new Error("Expected table cell to be inside of table row.");
      const he = l.getHeaderStyles() ^ qe.COLUMN;
      for (let le = 0; le < de.length; le++) {
        ...
        if (!ae(Be))
          throw new Error("Expected table cell");
        Be.setHeaderStyles(he, qe.COLUMN);
      }
      w(), r();
    });
  }, [s, l, w, r]), $ = ie(() => {
...
function q5({
  ...
  const [t] = se(), n = Te(null), a = Te(null), [i, s] = q(!1), [o, l] = q(
    ...
    if (U(v) && _ !== null && b !== null && _.contains(b.anchorNode)) {
      const w = of(
        v.anchor.getNode()
      );
      if (w == null) {
  ...
  B(() => t.registerUpdateListener(() => {
    ...
    if (g != null && o != null) {
      ...
      if (v != null) {
        const b = v.getBoundingClientRect(), x = g.getBoundingClientRect(), _ = r.getBoundingClientRect(), w = b.top - _.top + 4, C = b.right - x.width - 10 - _.left;
...
function ws(r, e, t, n = !1) {
  ...
  return e.getEditorState().read(() => {
    ...
    for (; o >= 0 && o < i.length; ) {
      ...
      if (u === null)
        break;
      const d = new jh(t.x, t.y), m = Qr.fromDOM(u), { marginTop: g, marginBottom: v } = $h(u), b = m.generateNewRect({
        bottom: m.bottom + v,
        left: a.left,
        right: a.right,
        top: m.top - g
...
function l3(r, e, t) {
  ...
  B(() => {
    ...
    function d(g) {
      ...
      if (!xs(x))
        return !1;
      const _ = ws(e, r, g, !0), w = i.current;
      return _ === null || w === null ? !1 : (s3(w, _, b, e), g.preventDefault(), !0);
    }
    function m(g) {
      if (!s.current)
        return !1;
      ...
      if (v)
        return !1;
      const { target: b, dataTransfer: x, pageY: _ } = g, w = (x == null ? void 0 : x.getData(Zu)) || "", C = bt(w);
      if (!C || !xs(b))
        return !1;
      const k = ws(e, r, g, !0);
      if (!k)
      ...
      return _ >= T ? E.insertAfter(C) : E.insertBefore(C), l(null), !0;
    }
    return Re(
      r.registerCommand(
        _i,
...
const c3 = ze("UPDATE_AUTO_DATA_COMMAND"), Hh = `\\.,\\+\\*\\?\\$\\@\\|#{}\\(\\)\\^\\-\\[\\]\\\\/!%'"~=<>_:;`, d3 = "\\b[A-Z][^\\s" + Hh + "]", h3 = {
  NAME: d3,
  PUNCTUATION: Hh
}, qh = h3.PUNCTUATION, N0 = ["=\\$a", "=\\$i", "=\\$f"].join("|"), _s = "=$a", m3 = "=$i", f3 = "=$f", Uh = "^(" + N0 + ")\\s|[^" + qh + "\\s]", p3 = "(?:\\.[ |$]| |[" + qh + "]|)", g3 = 75, v3 = new RegExp(
  "((" + N0 + ")((?:" + Uh + p3 + "){0," + g3 + "}))"
), b3 = 50, y3 = new RegExp(
  "((" + N0 + ")((?:" + Uh + "){0," + b3 + "}))"
), x3 = [
...
function _3(r, e, t = "") {
  ...
  return B(() => {
    ...
    if (i !== null) {
      ...
      Ss.set(t + r, null), w3.search(r, e, (s) => {
        Ss.set(t + r, s), a(s);
      });
    }
  }, [r, e, t]), n;
...
function T3({
  ...
  const [n] = se(), [a, i] = q(null), [s, o] = q(), [l, c] = q(), [u, d] = q(!1), [m, g] = q(null), b = _3(a, s === _s ? e : s === f3 ? t : x3, s), x = E0("/", {
    minLength: 0
  }), _ = it(
    () => b.map(
      (k) => {
        const E = Object.keys(k)[0];
        return new k3(s === _s ? "auto" : "after-auto", E, k[E].label, k[E].value, k[E].isMan, k[E].isNumber);
      }
    ),
    [b]
  ), w = ie(
    (k, E, T) => {
      n.update(() => {
        ...
        const D = g0(
          {
            dataMention: s === _s ? "auto" : s == m3 ? "input" : "after-auto",
        ...
        k.fieldName === "inputField" && (d(!0), g(D), T()), E && E.replace(D), T();
      });
    },
    [n, s]
  ), C = ie(
    (k) => {
      if (x(k, n) !== null)
        return null;
      const T = C3(k);
      return T !== null && o(T.replaceableString.replace(T.matchingString, "")), T;
    },
    [x, n]
  );
  return B(() => {
    ...
    const k = () => {
      n.update(() => {
        $1(zr).forEach((T) => {
          if (T.__dataMention === "auto" && T.__step === 2 || T.__dataMention === "after-auto" && T.__step === 3) {
            let I;
            if (T.__dataMention === "auto" ? I = e.find((D) => D[T.__fieldName] && D[T.__fieldName].label === T.__label) : I = t.find((D) => D[T.__fieldName] && D[T.__fieldName].label === T.__label), I) {
              const D = I[T.__fieldName];
              let M = D.value;
              M && D.isMan && (M = parseInt(M.toString()) * 1e4), M && D.isNumber && (M = M.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")), T.setData(M);
            }
          }
        });
      });
    ...
    /* @__PURE__ */ p.jsx(
      T0,
      {
        ...
        triggerFn: C,
        options: _,
        menuRenderFn: (k, { selectedIndex: E, selectOptionAndCleanUp: T, setHighlightedIndex: I }) => k.current && b.length ? da.createPortal(
...
const N3 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : B;
function A3({ ignoreHistoryMergeTagChange: r = !0, ignoreSelectionChange: e = !1, onChange: t }) {
  const [n] = se();
  return N3(() => {
...
var M3 = typeof global == "object" && global && global.Object === Object && global, O3 = typeof self == "object" && self && self.Object === Object && self, Kh = M3 || O3 || Function("return this")(), xi = Kh.Symbol, Wh = Object.prototype, D3 = Wh.hasOwnProperty, R3 = Wh.toString, Qn = xi ? xi.toStringTag : void 0;
function I3(r) {
  var e = D3.call(r, Qn), t = r[Qn];
  try {
    r[Qn] = void 0;
    var n = !0;
  } catch {
...
var F3 = Object.prototype, L3 = F3.toString;
function P3(r) {
  return L3.call(r);
}
var z3 = "[object Null]", B3 = "[object Undefined]", tc = xi ? xi.toStringTag : void 0;
function j3(r) {
  return r == null ? r === void 0 ? B3 : z3 : tc && tc in Object(r) ? I3(r) : P3(r);
}
function $3(r) {
...
function q3(r) {
  return typeof r == "symbol" || $3(r) && j3(r) == H3;
}
var U3 = /\s/;
function K3(r) {
  for (var e = r.length; e-- && U3.test(r.charAt(e)); )
    ;
  return e;
}
var W3 = /^\s+/;
function G3(r) {
  return r && r.slice(0, K3(r) + 1).replace(W3, "");
}
function lo(r) {
  var e = typeof r;
  return r != null && (e == "object" || e == "function");
}
var rc = NaN, Y3 = /^[-+]0x[0-9a-f]+$/i, V3 = /^0b[01]+$/i, X3 = /^0o[0-7]+$/i, J3 = parseInt;
function nc(r) {
  if (typeof r == "number")
    return r;
  if (q3(r))
  ...
  r = G3(r);
  var t = V3.test(r);
  return t || X3.test(r) ? J3(r.slice(2), t ? 2 : 8) : Y3.test(r) ? rc : +r;
}
var Cs = function() {
  return Kh.Date.now();
}, Z3 = "Expected a function", Q3 = Math.max, e6 = Math.min;
function t6(r, e, t) {
  var n, a, i, s, o, l, c = 0, u = !1, d = !1, m = !0;
  if (typeof r != "function")
    throw new TypeError(Z3);
  e = nc(e) || 0, lo(t) && (u = !!t.leading, d = "maxWait" in t, i = d ? Q3(nc(t.maxWait) || 0, e) : i, m = "trailing" in t ? !!t.trailing : m);
  function g(T) {
    var I = n, D = a;
    return n = a = void 0, c = T, s = r.apply(D, I), s;
  }
  function v(T) {
    return c = T, o = setTimeout(_, e), u ? g(T) : s;
  }
  function b(T) {
    var I = T - l, D = T - c, M = e - I;
    return d ? e6(M, i - D) : M;
  }
  function x(T) {
    var I = T - l, D = T - c;
  ...
  function w(T) {
    return o = void 0, m && n ? g(T) : (n = a = void 0, s);
  }
  function C() {
...
function n6({
  ...
  const [e] = se(), t = La(), [n, a] = q(!1), [i, s] = q(!1), [o, l] = q(!1), [c, u] = q({}), d = Te(/* @__PURE__ */ new Set()), m = Te(null), g = r6(
    (x) => {
      const { isOutside: _, tableDOMNode: w } = a6(x);
      if (_) {
        a(!1), s(!1);
        return;
      }
      ...
      if (e.update(() => {
        ...
        if (ae(T)) {
          ...
          if (!We(D))
            return;
          if (E = e.getElementByKey(D == null ? void 0 : D.getKey()), E) {
            const M = D.getChildrenSize(), F = (I = D.getChildAtIndex(0)) == null ? void 0 : I.getChildrenSize(), P = Io(T), $ = rd(T);
            P === M - 1 ? C = T : $ === F - 1 && (k = T);
          }
        }
      }), E) {
        const {
          ...
          bottom: F,
          height: P
        } = E.getBoundingClientRect(), { y: $, left: z } = r.getBoundingClientRect();
        C ? (s(!1), a(!0), u({
          height: ac,
          left: M - z,
          top: F - $ + 5,
  ...
  const b = (x) => {
    e.update(() => {
      if (m.current) {
        ...
        _ == null || _.selectEnd(), x ? (nd(), a(!1)) : (ad(), s(!1));
      }
    });
  };
...
function i6({
  ...
  return La() ? Zt(
    /* @__PURE__ */ p.jsx(n6, { anchorElem: r }),
    r
  ) : null;
}
function A0(r) {
...
function u6({ children: r }) {
  ...
  return B(() => {
    ...
    }), s = n.registerMutationListener(Pn, (l) => {
      n.getEditorState().read(() => {
    ...
    }, { skipInitialization: !0 }), o = n.registerMutationListener(Hr, (l) => {
      n.getEditorState().read(() => {
...
function h6({
  ...
  function l(u, d) {
    s.getEditorState().read(() => {
      ...
      m !== null && (a.current && a.current instanceof HTMLElement ? a.current.scrollTo({
        top: m.offsetTop,
        behavior: "smooth"
      }) : m.scrollIntoView({ behavior: "smooth" }), t(u), i.current = d);
    });
  }
  function c(u) {
    if (u === null)
  ...
  return B(() => {
    ...
    function m(x) {
      if (a.current = x.target, r.length !== 0 && i.current < r.length - 1) {
        let _ = s.getElementByKey(
          r[i.current][0]
        );
        if (_ !== null) {
          if (Es(_)) {
            for (; _ !== null && Es(_) && i.current > 0; ) {
              const C = s.getElementByKey(
                r[i.current - 1][0]
              );
              C !== null && (ri(C) || Es(C)) && i.current--, _ = C;
            }
            const w = r[i.current][0];
            t(w);
          } else if (ri(_)) {
            for (; _ !== null && ri(_) && i.current < r.length - 1; ) {
              const C = s.getElementByKey(
                r[i.current + 1][0]
              );
              C !== null && (d6(C) || ri(C)) && i.current++, _ = C;
            }
            const w = r[i.current][0];
            t(w);
          }
    ...
    function v(x, _) {
      return (w) => {
        clearTimeout(g), g = setTimeout(() => x(w), _);
      };
    }
    function b(x) {
      const _ = x.target, w = o.current.get(_) || 0;
      _.scrollTop !== w && (o.current.set(_, _.scrollTop), v(m, 50)(x));
    }
...
function m6() {
  return /* @__PURE__ */ p.jsx(u6, { children: (r) => /* @__PURE__ */ p.jsx(h6, { tableOfContents: r }) });
}
function f6(r) {
  const {
    step: e,
  ...
  return B(() => {
    ...
    /* @__PURE__ */ p.jsx(z2, { setIsLinkEditMode: c }),
    /* @__PURE__ */ p.jsxs("div", { className: "editor-container", children: [
      ...
      /* @__PURE__ */ p.jsx(V5, {}),
      /* @__PURE__ */ p.jsx(R2, {}),
      /* @__PURE__ */ p.jsx(T3, { step: e, autoData: t, afterAutoData: n }),
      /* @__PURE__ */ p.jsx(y5, {}),
      /* @__PURE__ */ p.jsx(p5, {}),
      /* @__PURE__ */ p.jsx(A3, { ignoreSelectionChange: !0, onChange: a }),
      ...
      u && !m && /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
        ...
        /* @__PURE__ */ p.jsx(i6, { anchorElem: u }),
        /* @__PURE__ */ p.jsx(
          I5,
          {
            anchorElem: u
...
function N6(r) {
  ...
  return /* @__PURE__ */ p.jsxs(V1, { initialConfig: c, children: [
    /* @__PURE__ */ p.jsx(p6, { editorRef: l }),
    /* @__PURE__ */ p.jsx(Gg, { initHistoryState: t, children: /* @__PURE__ */ p.jsx("div", { className: "doc-editor-shell", children: /* @__PURE__ */ p.jsx(
      f6,
      {
        step: o,
        autoAfterMentionData: i,
