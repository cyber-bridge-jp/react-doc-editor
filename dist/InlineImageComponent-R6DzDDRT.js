...
import { O as $, Q as O, H as j, U as E, V as k, W as B, $ as W, Y as y, Z as z, a0 as H, a1 as f, a2 as Q, a3 as V, a4 as Y, a5 as Z, a6 as q, a7 as G, a8 as J, a9 as X, aa as K, ab as ee, ac as te, ad as ae, ae as ne, af as oe, ag as le, ah as re, ai as ie } from "./index-B1XK6w54.js";
import { d as se } from "./LexicalNestedComposer.prod-CUnPetiN.js";
...
function be({
  ...
  const [w, I] = $(), C = T(null), v = T(null), [r, g, u] = O(n), [a] = j(), [P, M] = x(null), F = T(null), N = D(
    (o) => {
      if (r && E(k())) {
        o.preventDefault();
        const t = B(n);
    ...
    (o) => F.current === s || v.current === o.target ? (y(null), a.update(() => {
      g(!0);
