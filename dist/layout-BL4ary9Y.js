import { a as bn, b as Wn, c as L, k as zn, d as Xn, e as Un, g as O, j as gn, l as xn, m as En, t as Hn, n as kn, o as jn, p as Jn, G as x, f as s, h as w, i as g, q as M, v as y, r as G } from "./graph-Bk4gW_oC.js";
import { aG as Kn, aH as X, aI as on } from "./index-Bec-pY47.js";
import { ar as Zn, as as Qn, at as yn, au as S, av as Nn, aw as ne, ax as Ln, ay as j, az as ee, aA as re, aB as J, aC as ie, aD as _n, aE as te, aF as ae, aG as U } from "./index-BU3ShsPI.js";
...
var Cn = Object.prototype, he = Cn.hasOwnProperty, le = yn(function(n, e) {
  n = Object(n);
  var r = -1, i = e.length, t = i > 2 ? e[2] : void 0;
  for (t && S(e[0], e[1], t) && (i = 1); ++r < i; )
    for (var o = e[r], a = Nn(o), u = -1, d = a.length; ++u < d; ) {
      var f = a[u], c = n[f];
      (c === void 0 || ne(c, Cn[f]) && !he.call(n, f)) && (n[f] = o[f]);
    }
  return n;
});
function A(n) {
...
function we(n, e, r) {
  ...
  if (!i)
    return -1;
  var t = r == null ? 0 : ue(r);
  return t < 0 && (t = pe(i + t, 0)), Xn(n, L(e), t);
}
var K = ve(we);
function Rn(n, e) {
  var r = -1, i = Ln(n) ? Array(n.length) : [];
  return Un(n, function(t, o, a) {
    i[++r] = e(t, o, a);
  }), i;
}
function m(n, e) {
...
function V(n, e) {
  var r = {};
  return e = L(e), xn(n, function(i, t, o) {
    re(r, t, e(i, t, o));
  }), r;
}
function Z(n, e, r) {
...
function I(n) {
  return n && n.length ? Z(n, J, In) : void 0;
}
function Q(n, e) {
  return n && n.length ? Z(n, L(e), In) : void 0;
}
function xe(n, e, r, i) {
  if (!on(n))
    return n;
  ...
  for (var t = -1, o = e.length, a = o - 1, u = n; u != null && ++t < o; ) {
    ...
    if (t != a) {
      var c = u[d];
      f = void 0, f === void 0 && (f = on(c) ? c : ie(e[t + 1]) ? [] : {});
    }
    _n(u, d, f), u = u[d];
  }
  return n;
...
var N = Te(), P = yn(function(n, e) {
  if (n == null)
    return [];
  var r = e.length;
  return r > 1 && S(n, e[0], e[1]) ? e = [] : r > 2 && S(e[0], e[1], e[2]) && (e = [e[0]]), Le(n, bn(e), []);
}), Me = 0;
function nn(n) {
  var e = ++Me;
  return Jn(n) + e;
...
function Je(n) {
  var e = n.graph().rankdir.toLowerCase();
  (e === "bt" || e === "rl") && Ke(n), (e === "lr" || e === "rl") && (Ze(n), Pn(n));
}
function Pn(n) {
...
function Bn(n, e, r, i, t) {
  var o = r, a = n.node(i);
  return e[i] = !0, s(n.neighbors(i), function(u) {
    w(e, u) || (r = Bn(n, e, r, u, i));
...
function Rr(n, e) {
  ...
  i.sort(Ir(!!e)), d = pn(o, t, d), s(i, function(c) {
...
function Pr(n) {
  var e = Mn(n), r = wn(n, N(1, e + 1), "inEdges"), i = wn(n, N(e - 1, -1, -1), "outEdges"), t = yr(n);
  mn(n, t);
...
function Or(n, e) {
  var r = new x();
  s(n, function(i) {
    var t = i.graph().root, o = qn(i, t, r, e);
    s(o.vs, function(a, u) {
      i.node(a).order = u;
    }), br(i, r, o.vs);
  });
    ...
    return s(o, function(c, h) {
      ...
      (l || c === f) && (s(o.slice(u, h + 1), function(p) {
        s(n.predecessors(p), function(b) {
          ...
          (an < a || v < an) && !(R.dummy && n.node(p).dummy) && $n(r, b, p);
        });
      }), u = h + 1, a = v);
    }), o;
  }
  ...
  function i(o, a, u, d, f) {
    ...
    s(N(a, u), function(h) {
      c = o[h], n.node(c).dummy && s(n.predecessors(c), function(l) {
        var v = n.node(l);
        v.dummy && (v.order < d || v.order > f) && $n(r, l, c);
      });
    });
  }
  function t(o, a) {
...
function Jr(n) {
  n = Tn(n), Kr(n), be(Ur(n), function(e, r) {
    n.node(r).x = e;
  });
}
function Kr(n) {
