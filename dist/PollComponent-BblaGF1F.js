import { i as k, h as b, s as v, k as S, j as t, B as D, t as g, v as L } from "./index-DA3fcQye.js";
...
function w({
  ...
  const [r] = k.useLexicalComposerContext(), x = R(() => W(c), [c]), [a, C, p] = b.useLexicalNodeSelection(o), [f, _] = V(null), i = O(null), m = y(
    (e) => {
      if (a && P(j())) {
        e.preventDefault();
        const l = E(o);
