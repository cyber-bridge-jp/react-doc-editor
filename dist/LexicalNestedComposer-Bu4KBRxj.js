import { L as K } from "./LexicalCollaborationContext-DcPP_uZR.js";
import { r as k } from "./index-aozLG5N8.js";
import R from "react";
var y = {}, N;
function O() {
  if (N) return y;
  ...
  function x({
    ...
    const [s, {
      ...
      () => {
        const o = C || h() || void 0, b = c.createLexicalComposerContext(i, o);
      ...
      isCollabActive: L,
      yjsDocMap: g
    } = m.useCollaborationContext(), f = _ || u.current || g.has(e.getKey());
    return r.useEffect(() => {
      f && (u.current = !0);
...
function T() {
  ...
  return M.LexicalNestedComposer = function({ initialEditor: e, children: p, initialNodes: l, initialTheme: C, skipCollabChecks: _ }) {
    let u = r.useRef(!1), i = r.useContext(c.LexicalComposerContext);
    i == null && x(9);
    let [s, { getTheme: h }] = i, v = r.useMemo(() => {
      var o = C || h() || void 0;
      ...
      return e._config.namespace = s._config.namespace, e._editable = s._editable, [e, b];
    }, []), { isCollabActive: L, yjsDocMap: g } = m.useCollaborationContext(), f = _ || u.current || g.has(e.getKey());
    return r.useEffect(() => {
      f && (u.current = !0);
    }, [f]), r.useEffect(() => s.registerEditableListener((o) => {
      e.setEditable(o);
    }), [e, s]), r.createElement(c.LexicalComposerContext.Provider, { value: v }, !L || f ? p : null);
  }, M;
}
const E = process.env.NODE_ENV === "development" ? O() : T();
var S = E;
export {
  S as L
};
