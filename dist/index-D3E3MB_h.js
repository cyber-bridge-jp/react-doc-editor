...
var Kh = (r, e, t) => e in r ? Uh(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var re = (r, e, t) => Kh(r, typeof e != "symbol" ? e + "" : e, t);
import * as ft from "react";
import en, { createContext as Qs, useContext as Bu, useMemo as ht, useLayoutEffect as Pr, useEffect as P, useState as U, useCallback as ae, Suspense as Br, useRef as Re, forwardRef as ju } from "react";
import { createEditor as fa, $getRoot as Dt, $createParagraphNode as xe, $getSelection as z, $isElementNode as ge, $isRangeSelection as $, $isTextNode as Se, $isTokenOrSegmented as Bi, $getAdjacentNode as bs, $isDecoratorNode as br, $isRootNode as e0, $getCharacterOffsets as Wh, $isRootOrShadowRoot as zt, $isLineBreakNode as pa, $getPreviousSelection as t0, $splitNode as Gh, TextNode as dn, $applyNodeReplacement as lt, ElementNode as yt, $isTabNode as $u, $createTabNode as r0, $createLineBreakNode as ni, isHTMLElement as wr, isHTMLAnchorElement as Yh, createCommand as $e, $isLeafNode as qu, $isParagraphNode as hn, $createTextNode as Rr, INSERT_PARAGRAPH_COMMAND as oa, COMMAND_PRIORITY_LOW as ve, $isNodeSelection as gt, $createNodeSelection as Vh, $setSelection as Ct, $getNodeByKey as Mt, DecoratorNode as lr, KEY_BACKSPACE_COMMAND as ga, KEY_DELETE_COMMAND as va, CLICK_COMMAND as ba, $cloneWithProperties as Hu, isDocumentFragment as To, ArtificialNode__DO_NOT_USE as Uu, $isBlockElementNode as ai, isBlockDomNode as Ao, isInlineDomNode as Mo, SELECTION_INSERT_CLIPBOARD_NODES_COMMAND as Ku, $parseSerializedNode as Xh, COPY_COMMAND as Wu, COMMAND_PRIORITY_CRITICAL as pt, isSelectionWithinEditor as Jh, $getEditor as Zh, PASTE_COMMAND as Gu, isSelectionCapturedInDecoratorInput as Qh, COMMAND_PRIORITY_EDITOR as ye, CUT_COMMAND as Yu, SELECT_ALL_COMMAND as e1, $selectAll as t1, DRAGOVER_COMMAND as gi, $getNearestNodeFromDOMNode as ot, DRAGSTART_COMMAND as n0, DROP_COMMAND as vi, $createRangeSelection as ya, $normalizeSelection__EXPERIMENTAL as a0, KEY_ESCAPE_COMMAND as Dn, KEY_ENTER_COMMAND as i0, INSERT_LINE_BREAK_COMMAND as Oo, DELETE_CHARACTER_COMMAND as ra, OUTDENT_CONTENT_COMMAND as ii, KEY_ARROW_RIGHT_COMMAND as bi, KEY_ARROW_LEFT_COMMAND as xa, KEY_ARROW_DOWN_COMMAND as mn, KEY_ARROW_UP_COMMAND as fn, INDENT_CONTENT_COMMAND as yi, INSERT_TAB_COMMAND as Vu, $insertNodes as Rn, FORMAT_ELEMENT_COMMAND as er, FORMAT_TEXT_COMMAND as bt, REMOVE_TEXT_COMMAND as r1, CONTROLLED_TEXT_INSERTION_COMMAND as Xu, DELETE_LINE_COMMAND as ys, DELETE_WORD_COMMAND as Ju, COMMAND_PRIORITY_HIGH as At, KEY_TAB_COMMAND as xi, FOCUS_COMMAND as Zu, SELECTION_CHANGE_COMMAND as Jt, $createRangeSelectionFromDom as n1, isCurrentlyReadOnlyMode as a1, $createPoint as Do, CAN_REDO_COMMAND as Jn, CAN_UNDO_COMMAND as Zn, CLEAR_HISTORY_COMMAND as i1, CLEAR_EDITOR_COMMAND as s1, REDO_COMMAND as Qu, UNDO_COMMAND as ec, TEXT_TYPE_TO_FORMAT as Qr, IS_CODE as o1, IS_HIGHLIGHT as l1, IS_SUBSCRIPT as u1, IS_SUPERSCRIPT as c1, IS_BOLD as d1, IS_ITALIC as h1, IS_UNDERLINE as Ro, IS_STRIKETHROUGH as Io, KEY_MODIFIER_COMMAND as m1, COMMAND_PRIORITY_NORMAL as f1, KEY_SPACE_COMMAND as p1, getNearestEditorFromDOMNode as g1 } from "lexical";
import * as la from "react-dom";
import { createPortal as ur, flushSync as v1 } from "react-dom";
...
` + Ee[et].replace(" at new ", " at ");
      ...
      var yn = M ? M.displayName || M.name : "", qr = yn ? He(yn) : "";
      return typeof M == "function" && xt.set(M, qr), qr;
    }
    function we(M, q, Q) {
      return ee(M, !1);
    }
    ...
    function bo(M) {
      if (kh(M))
        return w("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ch(M)), vo(M);
    }
    var Wn = S.ReactCurrentOwner, Eh = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    var Dh = function(M, q, Q, be, De, Le, Ne) {
      var Ee = {
    ...
    function Rh(M, q, Q, be, De) {
      {
        var Le, Ne = {}, Ee = null, _t = null;
        Q !== void 0 && (bo(Q), Ee = "" + Q), Th(q) && (bo(q.key), Ee = "" + q.key), Nh(q) && (_t = q.ref, Ah(q, De));
        for (Le in q)
          Qe.call(q, Le) && !Eh.hasOwnProperty(Le) && (Ne[Le] = q[Le]);
        if (M && M.defaultProps) {
        ...
        if (Ee || _t) {
          ...
          Ee && Mh(Ne, nt), _t && Oh(Ne, nt);
        }
        return Dh(M, Ee, _t, De, be, Wn.current, Ne);
      }
    }
    ...
    function Co(M, q) {
      {
        ...
        So[Q] = !0;
        var be = "";
        M && M._owner && M._owner !== Fi.current && (be = " It was passed a child from " + X(M._owner.type) + "."), bn(M), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', Q, be), bn(null);
      }
    }
    function ko(M, q) {
      {
    ...
    function zh(M) {
      {
        for (var q = Object.keys(M.props), Q = 0; Q < q.length; Q++) {
          ...
          if (be !== "children" && be !== "key") {
            bn(M), w("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", be), bn(null);
            break;
          }
        }
        M.ref !== null && (bn(M), w("Invalid attribute `ref` supplied to `React.Fragment`."), bn(null));
      }
    }
    var Eo = {};
    function No(M, q, Q, be, De, Le) {
      {
        ...
        if (Qe.call(q, "key")) {
          var qr = X(M), Nt = Object.keys(q).filter(function(Hh) {
            return Hh !== "key";
          }), Pi = Nt.length > 0 ? "{key: someKey, " + Nt.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!Eo[qr + Pi]) {
            var qh = Nt.length > 0 ? "{" + Nt.join(": ..., ") + ": ...}" : "{}";
            w(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Pi, qr, qh, qr), Eo[qr + Pi] = !0;
          }
        }
        return M === n ? zh(nt) : Lh(nt), nt;
      }
    }
    function Ph(M, q, Q) {
      return No(M, q, Q, !0);
    ...
    var jh = Bh, $h = Ph;
    Yn.Fragment = n, Yn.jsx = jh, Yn.jsxs = $h;
  }()), Yn;
}
process.env.NODE_ENV === "production" ? xs.exports = b1() : xs.exports = y1();
var p = xs.exports;
function x1(r) {
  return r && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
}
var w1 = x1(function(r) {
...
const rc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, S1 = rc ? Pr : P, Fa = { tag: "history-merge" };
function C1({ initialConfig: r, children: e }) {
  const t = ht(() => {
    const { theme: n, namespace: a, nodes: i, onError: s, editorState: o, html: l } = r, u = _1(null, n), c = fa({ editable: r.editable, html: l, namespace: a, nodes: i, onError: (h) => s(h, c), theme: n });
    return function(h, m) {
      if (m !== null) {
...
function ic(r, e) {
  ...
  if (e.isSelected(r) && !e.isSegmented() && !e.isToken() && t !== null) {
    ...
    if (l || u) {
      const [c, h] = Wh(r), m = s.is(o), g = e.is(i ? o : s), v = e.is(i ? s : o);
      let y, x = 0;
...
function xn(r, e) {
  const t = s0("getStyle" in r ? r.getStyle() : r.style), n = Object.entries(e).reduce((i, [s, o]) => (typeof o == "function" ? i[s] = o(t[s], r) : o === null ? delete i[s] : i[s] = o, i), { ...t }), a = N1(n);
...
function o0(r, e) {
  ...
  const [i, s] = a, o = n - 1;
  let l = t[0], u = t[o];
  if (r.isCollapsed() && $(r)) return void xn(r, e);
  ...
  if (t.length === 1) {
    if (Se(l) && l.canHaveFormat()) {
      ...
      if (Bi(l) || v === 0 && y === c) xn(l, e), l.select(v, y);
      else {
        const C = l.splitText(v, y), E = v === 0 ? C[0] : C[1];
        xn(E, e), E.select(0, y - v);
      }
    }
  } else {
    if (Se(l) && v < l.getTextContentSize() && l.canHaveFormat() && (v === 0 || Bi(l) || (l = l.splitText(v)[1], v = 0, g ? i.set(l.getKey(), v, "text") : s.set(l.getKey(), v, "text")), xn(l, e)), Se(u) && u.canHaveFormat()) {
      const C = u.getTextContent().length;
      u.__key !== w && y !== 0 && (y = C), y === C || Bi(u) || ([u] = u.splitText(y)), y === 0 && S !== "element" || xn(u, e);
    }
    for (let C = 1; C < o; C++) {
      const E = t[C], k = E.getKey();
      Se(E) && E.canHaveFormat() && k !== l.getKey() && k !== u.getKey() && !E.isToken() && xn(E, e);
    }
  }
}
function Xr(r, e) {
...
var D1 = O1(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
const l0 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, R1 = l0 && "documentMode" in document ? document.documentMode : null, I1 = l0 && /^(?!.*Seamonkey)(?=.*Firefox).*/i.test(navigator.userAgent);
!(!l0 || !("InputEvent" in window) || R1) && "getTargetRanges" in new window.InputEvent("input");
function oc(...r) {
  const e = [];
...
const q1 = globalThis.Prism || window.Prism, qo = (r) => {
  try {
    return !!r && q1.languages.hasOwnProperty(r);
  } catch {
    return !1;
  }
};
...
let u0 = class dc extends yt {
  ...
  static importDOM() {
    return { code: (e) => e.textContent != null && (/\r?\n/.test(e.textContent) || cc(e, "BR")) ? { conversion: Ho, priority: 1 } : null, div: () => ({ conversion: U1, priority: 1 }), pre: () => ({ conversion: Ho, priority: 0 }), table: (e) => ji(e) ? { conversion: K1, priority: 3 } : null, td: (e) => {
...
function Ho(r) {
  return { node: tn(r.getAttribute(Qn)) };
}
function U1(r) {
  const e = r, t = Ko(e);
  return t || function(n) {
...
let hc = class mc extends dn {
  ...
  updateDOM(e, t, n) {
    ...
    return i !== s && (i && pn(t, i), s && Je(t, s)), a;
  }
  static importJSON(e) {
...
const Y1 = /* @__PURE__ */ new Set(["http:", "https:", "mailto:", "sms:", "tel:"]);
let In = class vc extends yt {
  ...
  static importDOM() {
    return { a: (e) => ({ conversion: V1, priority: 1 }) };
  }
  static importJSON(e) {
  ...
  sanitizeUrl(e) {
    try {
      const t = new URL(e);
      if (!Y1.has(t.protocol)) return "about:blank";
    } catch {
      return e;
    }
    return e;
...
function Go(r, e) {
  ...
  if (a.setFormat(r.getFormatType()), a.setIndent(r.getIndent()), rn(a, r.getChildren()), ke(t) && e === t.getListType()) return t.append(a), r.remove(), ke(n) && e === n.getListType() && (rn(t, n.getChildren()), n.remove()), t;
...
let Sa = class wc extends yt {
  ...
  static importDOM() {
    return { li: () => ({ conversion: tm, priority: 0 }) };
  }
  static importJSON(e) {
    const t = Pt();
  ...
  setIndent(e) {
    ...
    for (; t !== e; ) t < e ? (Z1(this), t++) : (Q1(this), t--);
    return this;
  }
  canInsertAfter(e) {
    return Fe(e);
...
function Yo(r, e, t) {
  ...
  a.length > 0 && pn(r, ...a), n.length > 0 && Je(r, ...n);
}
function Vo(r, e, t, n) {
...
function tm(r) {
  if (r.classList.contains("task-list-item")) {
    for (const t of r.children) if (t.tagName === "INPUT") return rm(t);
  }
...
function Jo(r) {
  ...
  return e === "ol" ? t = Ot("number", r.start) : e === "ul" && (t = function(n) {
    ...
    return !1;
  }(r) ? Ot("check") : Ot("bullet")), { after: nm, node: t };
}
...
const h0 = $e("INSERT_UNORDERED_LIST_COMMAND"), m0 = $e("INSERT_ORDERED_LIST_COMMAND"), f0 = $e("INSERT_CHECK_LIST_COMMAND"), am = $e("REMOVE_LIST_COMMAND");
function im(r) {
  return Ie(r.registerCommand(m0, () => (Cs(r, "number"), !0), ve), r.registerCommand(h0, () => (Cs(r, "bullet"), !0), ve), r.registerCommand(am, () => (J1(r), !0), ve), r.registerCommand(oa, () => !!em(), ve));
}
let p0 = class Sc extends yt {
  ...
  updateDOM(e, t, n) {
    ...
    return s !== o && (s === 1 ? o === 2 && Je(t, l) : o === 1 && pn(t, l)), !1;
  }
  hasID(e) {
    const t = this.getIDs();
...
let g0 = class Cc extends yt {
  ...
  static transform() {
    return (e) => {
      um(e) || om(204), e.isEmpty() && e.remove();
    };
  }
};
function lm() {
...
function v0(r) {
  ...
  return P(() => {
    ...
    e.update(() => {
      let i = z();
      gt(i) || (i = Vh(), Ct(i)), gt(i) && (a ? i.add(r) : i.delete(r));
    });
  }, [e, r]), ae(() => {
    e.update(() => {
      const a = z();
...
let y0 = class kc extends lr {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: dm, priority: 0 }) };
  }
  exportJSON() {
...
function mm(r, e) {
  ...
  for (let i = 0; i < t.length; i++) {
    const s = t[i];
    if (!Tc.has(s.nodeName)) {
      const o = Ac(s, r, a, !1);
      o !== null && (n = n.concat(o));
    }
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Uu && s.insertAfter(ni());
    for (const s of i) {
...
function Nc(r, e, t, n = null) {
  ...
  for (let g = 0; g < o.length; g++) {
    const v = o[g], y = Nc(r, v, m, n);
    !a && ge(e) && y && e.extractWithChild(v, n, "html") && (a = !0);
  }
  if (a && !i) {
    if ((wr(c) || To(c)) && c.append(m), t.append(c), h) {
      const g = h.call(s, c);
      g && (To(c) ? c.replaceChildren(g) : c.replaceWith(g));
    }
  } else t.append(m);
  return a;
}
const Tc = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Ac(r, e, t, n, a = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (Tc.has(r.nodeName)) return s;
  let o = null;
  ...
  for (let v = 0; v < h.length; v++) m.push(...Ac(h[v], e, t, g, new Map(a), o));
  return c != null && (m = c(m)), Ao(r) && (m = fm(r, m, g ? () => {
    const v = new Uu();
    return t.push(v), v;
  } : xe)), o == null ? m.length > 0 ? s = s.concat(m) : Ao(r) && function(v) {
    return v.nextSibling == null || v.previousSibling == null ? !1 : Mo(v.nextSibling) && Mo(v.previousSibling);
...
const gm = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Mc = (r) => gm ? (r || window).getSelection() : null;
function vm(r, e = z()) {
  return e == null && li(166), $(e) && e.isCollapsed() || e.getNodes().length === 0 ? "" : Ec(r, e);
}
function bm(r, e = z()) {
...
function Oc(r, e, t, n = []) {
  ...
  for (let u = 0; u < o.length; u++) {
    const c = o[u], h = Oc(r, e, c, l.children);
...
async function ks(r, e, t) {
  ...
  const n = r.getRootElement(), a = r._window == null ? window.document : r._window.document, i = Mc(r._window);
  ...
  return o.setStart(s, 0), o.setEnd(s, 1), i.removeAllRanges(), i.addRange(o), new Promise((l, u) => {
    const c = r.registerCommand(Wu, (h) => (vr(h, ClipboardEvent) && (c(), wn !== null && (window.clearTimeout(wn), wn = null), l(nl(r, h, t))), !0), pt);
...
function nl(r, e, t) {
  if (t === void 0) {
    const a = Mc(r._window);
    if (!a) return !1;
    const i = a.anchorNode, s = a.focusNode;
    if (i !== null && s !== null && !Jh(r, i, s)) return !1;
    const o = z();
    if (o === null) return !1;
    t = Dc(o);
  }
...
class Ea extends yt {
  ...
  static importDOM() {
    ...
    }, span: (e) => il(e) ? { conversion: (t) => ({ node: Jr("h1") }), priority: 3 } : null };
  }
  exportDOM(e) {
    const { element: t } = super.exportDOM(e);
    if (t && wr(t)) {
  ...
  insertNewAfter(e, t = !0) {
    const n = e ? e.anchor.offset : 0, a = this.getLastDescendant(), i = !a || e && e.anchor.key === a.getKey() && n === a.getTextContentSize() || !e ? xe() : Jr(this.getTag()), s = this.getDirection();
  ...
  collapseAtStart() {
    const e = this.isEmpty() ? xe() : Jr(this.getTag());
    return this.getChildren().forEach((t) => e.append(t)), this.replace(e), !0;
  }
  extractWithChild() {
    return !0;
...
function _n(r) {
  const e = r.nodeName.toLowerCase();
  let t = null;
  return e !== "h1" && e !== "h2" && e !== "h3" && e !== "h4" && e !== "h5" && e !== "h6" || (t = Jr(e), r.style !== null && t.setFormat(r.style.textAlign)), { node: t };
}
function Mm(r) {
  const e = _i();
...
function Om(r) {
  return Ie(r.registerCommand(ba, (e) => {
    ...
    return !0;
  }, ye), r.registerCommand(e1, () => (t1(), !0), ye), r.registerCommand(Wu, (e) => (ks(r, vr(e, ClipboardEvent) ? e : null), !0), ye), r.registerCommand(Yu, (e) => (async function(t, n) {
    ...
    const [, t, n] = kn(e);
    return t.length > 0 && !n ? (r.dispatchCommand(Es, t), !0) : Qh(e.target) ? !1 : z() !== null && (function(a, i) {
...
const Rc = /^(\d+(?:\.\d+)?)px$/, Ue = { BOTH: 3, COLUMN: 2, NO_STATUS: 0, ROW: 1 };
class sr extends yt {
  static getType() {
    return "tablecell";
  }
...
function ll(r) {
  ...
  let n;
  Rc.test(e.style.width) && (n = parseFloat(e.style.width));
...
function Im(r) {
  const e = r;
  let t;
  return Rc.test(e.style.height) && (t = parseFloat(e.style.height)), { node: ca(t) };
}
function ca(r) {
  return lt(new Ln(r));
}
...
function Fm(r, e, t = !0) {
  ...
  for (let a = 0; a < r; a++) {
    ...
    for (let s = 0; s < e; s++) {
      ...
      const l = Zt(o), u = xe();
      u.append(Rr()), l.append(u), i.append(l);
    }
    n.append(i);
  }
  return n;
...
function Lc(r) {
  return Ic(r).getChildren().findIndex((e) => e.is(r));
}
...
class Si {
  ...
  getNodes() {
    ...
    if (e !== null) return e;
    const t = this.anchor.getNode(), n = this.focus.getNode(), a = fe(t, ne), i = fe(n, ne);
    ne(a) || Ce(152), ne(i) || Ce(154);
    const s = a.getParent();
    Ye(s) || Ce(156);
    const o = s.getParent();
    st(o) || Ce(157);
    ...
    return a1() || (this._cachedNodes = R), R;
  }
  getTextContent() {
    const e = this.getNodes().filter((n) => ne(n));
    let t = "";
...
class Hm {
  ...
  setFocusCellForSelection(e, t = !1) {
    ...
    n.update(() => {
      ...
      if (this.focusX = i, this.focusY = s, this.isHighlightingCells) {
        const o = ot(e.elem);
        if (this.tableSelection != null && this.anchorCellNodeKey != null && ne(o) && a.is(En(o))) {
          const l = o.getKey();
  ...
  formatCells(e) {
    this.editor.update(() => {
      const t = z();
      Te(t) || Ce(11);
      const n = ya(), a = n.anchor, i = n.focus, s = t.getNodes().filter(ne), o = s[0].getFirstChild(), l = hn(o) ? o.getFormatFlags(e, null) : null;
      s.forEach((u) => {
...
const Ts = "__lexicalTableSelection", Pc = (r) => Rm ? (r || window).getSelection() : null;
function Um(r, e, t, n) {
  ...
  e.addEventListener("mousedown", (c) => {
    setTimeout(() => {
      ...
      const h = Ms(c.target);
      h !== null && (Zr(c), i.setAnchorCellForSelection(h));
  ...
  return i.listenersToRemove.add(t.registerCommand(ga, l, pt)), i.listenersToRemove.add(t.registerCommand(va, l, pt)), i.listenersToRemove.add(t.registerCommand(Yu, (c) => {
    ...
    if (h) {
      if (!Te(h) && !$(h)) return !1;
      ks(t, vr(c, ClipboardEvent) ? c : null, Dc(h));
      const m = l(c);
    ...
    if ($(h)) {
      ...
      if (typeof c == "string") {
        const g = ml(t, h, r);
        if (g) return hl(g, r, [Rr(c)]), !0;
      }
    }
    return !1;
  }, pt)), n && i.listenersToRemove.add(t.registerCommand(xi, (c) => {
    const h = z();
    if (!$(h) || !h.isCollapsed() || !Gr(h, r)) return !1;
    const m = Ki(h.anchor.getNode());
    if (m === null) return !1;
    Zr(c);
    const g = r.getCordsFromCellNode(m, i.table);
    return Bc(i, r, g.x, g.y, c.shiftKey ? "backward" : "forward"), !0;
  }, pt)), i.listenersToRemove.add(t.registerCommand(Zu, (c) => r.isSelected(), At)), i.listenersToRemove.add(t.registerCommand(Ku, (c) => {
    const { nodes: h, selection: m } = c, g = m.getStartEndPoints(), v = Te(m), y = $(m) && fe(m.anchor.getNode(), (W) => ne(W)) !== null && fe(m.focus.getNode(), (W) => ne(W)) !== null || v;
    if (h.length !== 1 || !st(h[0]) || !y || g === null) return !1;
    const [x] = g, S = h[0], w = S.getChildren(), C = S.getFirstChildOrThrow().getChildrenSize(), E = S.getChildrenSize(), k = fe(x.getNode(), (W) => ne(W)), A = k && fe(k, (W) => Ye(W)), R = A && fe(A, (W) => st(W));
    if (!ne(k) || !Ye(A) || !st(R)) return !1;
    ...
    const c = z(), h = t0();
    if ($(c)) {
      const { anchor: m, focus: g } = c, v = m.getNode(), y = g.getNode(), x = Ki(v), S = Ki(y), w = !(!x || !r.is(En(x))), C = !(!S || !r.is(En(S))), E = w !== C, k = w && C, A = c.isBackward();
      if (E) {
        const R = c.clone();
        if (C) {
      ...
      const m = Pc(t._window);
      if (m && m.anchorNode && m.focusNode) {
        const g = ot(m.focusNode), v = g && !r.is(En(g)), y = ot(m.anchorNode), x = y && r.is(En(y));
...
function Ba(r, e, t) {
  ...
  S0(e, (a, i) => {
    const s = a.elem;
    n.has(i) ? (a.highlighted = !0, jc(r, a)) : (a.highlighted = !1, $c(r, a), s.getAttribute("style") || s.removeAttribute("style"));
  });
}
function S0(r, e) {
  const { domRows: t } = r;
...
function jc(r, e) {
  ...
  ne(n) || Ce(131), n.getBackgroundColor() === null ? t.style.setProperty("background-color", `rgb(${Ui})`) : t.style.setProperty("background-image", `linear-gradient(to right, rgba(${Ui},0.85), rgba(${Ui},0.85))`), t.style.setProperty("caret-color", "transparent");
}
function $c(r, e) {
  const t = e.elem, n = ot(t);
  ne(n) || Ce(131), n.getBackgroundColor() === null && t.style.removeProperty("background-color"), t.style.removeProperty("background-image"), t.style.removeProperty("caret-color");
}
function Ki(r) {
  const e = fe(r, ne);
  return ne(e) ? e : null;
...
function ea(r, e, t, n, a) {
  ...
  if (!Gr(i, n)) {
    if ($(i)) {
      if (i.isCollapsed() && t === "backward") {
        ...
        return !(!c || !st(c)) && (Zr(e), c.selectEnd(), !0);
      }
  ...
  if ($(i) && i.isCollapsed()) {
    const { anchor: s, focus: o } = i, l = fe(s.getNode(), ne), u = fe(o.getNode(), ne);
    if (!ne(l) || !l.is(u)) return !1;
    const c = En(l);
    if (c !== n && c != null) {
    ...
    if (t === "backward" || t === "forward") {
      ...
      return (E.length !== 1 || !br(E[0])) && !!function(k, A, R, I) {
        ...
        return !V || st(V) ? !1 : (Zr(k), I === "backward" ? V.selectEnd() : V.selectStart(), !0);
      }(e, C, n, t);
    }
    ...
    if (t === "up" ? x.top > g.top - g.height : g.bottom + g.height > x.bottom) {
      ...
      if (!e.shiftKey) return Bc(a, n, S.x, S.y, t);
      {
    ...
    const { anchor: s, focus: o } = i, l = fe(s.getNode(), ne), u = fe(o.getNode(), ne), [c] = i.getNodes(), h = r.getElementByKey(c.getKey());
    if (!ne(l) || !ne(u) || !st(c) || h == null) return !1;
    a.updateTableTableSelection(i);
    const m = na(h), g = n.getCordsFromCellNode(l, m), v = n.getDOMCellFromCordsOrThrow(g.x, g.y, m);
    if (a.setAnchorCellForSelection(v), Zr(e), e.shiftKey) {
...
function ml(r, e, t) {
  ...
  const s = fe(e.anchor.getNode(), (x) => ne(x));
  if (!s) return;
  const o = fe(s, (x) => st(x));
...
function pl(r, e, t) {
  t ? (Je(r, e.theme.tableRowStriping), r.setAttribute("data-lexical-row-striping", "true")) : (pn(r, e.theme.tableRowStriping), r.removeAttribute("data-lexical-row-striping"));
}
class Dr extends yt {
  static getType() {
    return "table";
...
const Xm = ft.lazy(() => import("./ImageComponent-B558QYan.js"));
function Jm(r) {
  const e = r;
...
class Pn extends lr {
  constructor(t, n, a, i, s, o, l, u, c, h, m, g) {
    ...
    re(this, "__height");
    re(this, "__maxWidth");
    re(this, "__showCaption");
    re(this, "__caption");
    // Captions cannot yet be used within editor cells
    re(this, "__captionsEnabled");
    re(this, "__isAbsolute");
    re(this, "__x");
    re(this, "__y");
  ...
  decorate() {
    return /* @__PURE__ */ p.jsx(Br, { fallback: null, children: /* @__PURE__ */ p.jsx(
      Xm,
      {
        src: this.__src,
...
var I0 = 0, ui = 1, Nn = 2, yr = 3, ha = 4, Ut = 5, An = 6, kt = 7, tr = [new Er(I0, 0, !1), new Er(ui, 0, !0), new Er(Nn, 1, !1), new Er(yr, 1, !0), new Er(ha, 2, !1), new Er(Ut, 2, !0), new Er(An, 3, !1), new Er(kt, 3, !0)], xf = [ha, Ut, ha, Ut, An, kt, An, kt], wf = [Ut, Ut, Ut, Ut, kt, kt, kt, kt], _f = [Nn, yr, ha, Ut, An, kt, An, kt], Sf = [yr, yr, Ut, Ut, kt, kt, kt, kt], Cf = [ui, ui, yr, yr, Ut, Ut, kt, kt], kf = [I0, ui, Nn, yr, Nn, yr, Nn, yr], ce = {
  DISPLAY: tr[I0],
  TEXT: tr[Nn],
  SCRIPT: tr[ha],
  SCRIPTSCRIPT: tr[An]
...
function F0(r, e, t) {
  ...
  if (!a && r[0] in yl && (n = yl[r[0]].charCodeAt(0), a = ar[e][n]), !a && t === "text" && Gc(n) && (a = ar[e][77]), a)
    return {
      depth: a[0],
      height: a[1],
      italic: a[2],
...
var Rs = {
  ...
  var t = "<" + e;
  this.classes.length && (t += ' class="' + oe.escape(Ir(this.classes)) + '"');
  var n = "";
...
class Da {
  constructor(e, t, n, a) {
    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, Vc.call(this, e, n, a), this.children = t || [];
  }
  /**
...
class L0 {
  constructor(e, t, n, a) {
    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, Vc.call(this, t, a), this.children = n || [], this.setAttribute("href", e);
  }
  setAttribute(e, t) {
    this.attributes[e] = t;
  }
...
class Gt {
  ...
  toNode() {
    ...
    this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = G(this.italic)), this.classes.length > 0 && (t = t || document.createElement("span"), t.className = Ir(this.classes));
    for (var n in this.style)
  ...
  toMarkup() {
    var e = !1, t = "<span";
    this.classes.length && (e = !0, t += ' class="', t += oe.escape(Ir(this.classes)), t += '"');
    var n = "";
...
for (var Hr = 0; Hr < 10; Hr++) {
  var Nr = Hr.toString();
  pe = String.fromCharCode(55349, 57294 + Hr), d(f, b, ue, Nr, pe), d(B, b, D, Nr, pe), pe = String.fromCharCode(55349, 57314 + Hr), d(f, b, ue, Nr, pe), d(B, b, D, Nr, pe), pe = String.fromCharCode(55349, 57324 + Hr), d(f, b, ue, Nr, pe), d(B, b, D, Nr, pe), pe = String.fromCharCode(55349, 57334 + Hr), d(f, b, ue, Nr, pe), d(B, b, D, Nr, pe);
}
var Fs = "ÐÞþ";
...
var Ua = [
  ...
  if (l) {
    ...
    } else o ? (h = td[l].fontName, m = [l]) : (h = Ka(l, t.fontWeight, t.fontShape), m = [l, t.fontWeight, t.fontShape]);
    if (Ei(i, h, a).metrics)
      return Xt(i, h, a, t, s.concat(m));
    if (Zc.hasOwnProperty(i) && h.slice(0, 10) === "Typewriter") {
  ...
  if (Ir(r.classes) !== Ir(e.classes) || r.skew !== e.skew || r.maxFontSize !== e.maxFontSize)
    return !1;
  ...
  return z0(i), i;
}, Qc = (r, e, t, n) => new Da(r, e, t, n), Zf = function(e, t, n) {
  var a = Tt([e], [], t);
  ...
  var [n, a, i] = rd[e], s = new Fr(n), o = new _r([s], {
    width: G(a),
    height: G(i),
...
class Ht {
  ...
  toNode() {
    ...
    this.classes.length > 0 && (e.className = Ir(this.classes));
    for (var n = 0; n < this.children.length; n++)
  ...
  toMarkup() {
    ...
    this.classes.length > 0 && (e += ' class ="' + oe.escape(Ir(this.classes)) + '"'), e += ">";
    for (var n = 0; n < this.children.length; n++)
      e += this.children[n].toMarkup();
...
var H = {
  ...
  return je[t][e] && je[t][e].replace && e.charCodeAt(0) !== 55349 && !(Zc.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = je[t][e].replace), new H.TextNode(e);
}, P0 = function(e) {
...
var sd = function(e) {
  ...
  var a = sd(n), i = zs(e, a), s = L.makeSpan(["katex"], [i]);
  return od(s, n);
}, pp = {
  widehat: "^",
  widecheck: "ˇ",
...
Z({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, n = md(e.gullet.popToken()), a = e.gullet.popToken(), i = e.gullet.popToken();
...
var ta = function(e, t, n) {
  ...
  var a = ar["Size4-Regular"][e.charCodeAt(0)] ? ar["Size4-Regular"][e.charCodeAt(0)][4] : ar["Size1-Regular"][e.charCodeAt(0)][4], i = new Fr("inner", Ff(e, Math.round(1e3 * t))), s = new _r([i], {
    width: G(a),
    height: G(t),
    // Override CSS rule `.katex svg { width: 100% }`
    style: "width:" + G(a),
  ...
  type: "kern",
  size: -1 * Bs
}, Mp = ["|", "\\lvert", "\\rvert", "\\vert"], Op = ["\\|", "\\lVert", "\\rVert", "\\Vert"], vd = function(e, t, n, a, i, s) {
  var o, l, u, c, h = "", m = 0;
  o = u = c = e, l = null;
  var g = "Size1-Regular";
  ...
  var j = O / 2 - F, V = [];
  if (h.length > 0) {
    var X = O - y - C, J = Math.round(O * 1e3), Y = Lf(h, Math.round(X * 1e3)), he = new Fr(h, Y), ie = (m / 1e3).toFixed(3) + "em", W = (J / 1e3).toFixed(3) + "em", me = new _r([he], {
      width: ie,
      height: W,
      viewBox: "0 0 " + m + " " + J
  ...
  var s = If(e, a, n), o = new Fr(e, s), l = new _r([o], {
  ...
  var n = t.havingBaseSizing(), a = wd("\\surd", e * n.sizeMultiplier, xd, n), i = n.sizeMultiplier, s = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), o, l = 0, u = 0, c = 0, h;
...
}, bd = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"], Rp = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"], yd = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], ia = [0, 1.2, 1.8, 2.4, 3], Ip = function(e, t, n, a, i) {
  if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), oe.contains(bd, e) || oe.contains(yd, e))
    return gd(e, t, !1, n, a, i);
  if (oe.contains(Rp, e))
    return vd(e, ia[t], !1, n, a, i);
  ...
  return n[n.length - 1];
}, _d = function(e, t, n, a, i, s) {
  e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
  var o;
  oe.contains(yd, e) ? o = Fp : oe.contains(bd, e) ? o = xd : o = Lp;
  var l = wd(e, t, o, a);
  return l.type === "small" ? Tp(e, l.style, n, a, i, s) : l.type === "large" ? gd(e, l.size, n, a, i, s) : vd(e, t, n, a, i, s);
...
var H0 = (r, e) => {
  ...
  if (n === "sout")
    ...
    var m = Math.floor(1e3 * h * a), g = Df(m), v = new _r([new Fr("phase", g)], {
      width: "400em",
      height: G(m / 1e3),
...
var dr = function(e, t) {
  ...
  var n = [], a = e.envName.indexOf("at") > -1 ? "alignat" : "align", i = e.envName === "split", s = $r(e.parser, {
    cols: n,
    addJot: !0,
...
cr({
  ...
  handler(r, e) {
    ...
    return $r(r.parser, i, W0(r.envName));
  },
  htmlBuilder: dr,
  mathmlBuilder: hr
});
cr({
  ...
  handler(r) {
    ...
    var i = $r(r.parser, n, W0(r.envName)), s = Math.max(0, ...i.body.map((o) => o.length));
...
cr({
  ...
  handler(r, e) {
    ...
    if (i = $r(r.parser, i, "script"), i.body.length > 0 && i.body[0].length > 1)
      throw new K("{subarray} can contain only one column");
    return i;
  },
  htmlBuilder: dr,
...
var Td = (r, e) => {
  ...
  var t = Td(r.size, e.style), n = t.fracNum(), a = t.fracDen(), i;
  i = e.havingStyle(n);
...
Z({
  ...
  mathmlBuilder: (r, e) => Lr(r.mathml, e)
});
var rs = function(e) {
  if (/^[-+]? *(\d+(\.\d*)?|\.\d+)$/.test(e))
    return {
...
var Md = (r, e, t, n, a, i, s) => {
  ...
  var s = e.style, o = !1;
  s.size === ce.DISPLAY.size && i.symbol && !oe.contains(Od, i.name) && (o = !0);
  var l;
  if (i.symbol) {
  ...
  var x = 0, S = 0;
  return (l instanceof Gt || i.name === "\\oiint" || i.name === "\\oiiint") && !i.suppressBaseShift && (x = (l.height - l.depth) / 2 - e.fontMetrics().axisHeight, S = l.italic), a ? Md(l, t, n, e, s, S, x) : (x && (l.style.position = "relative", l.style.top = G(x)), l);
}, Ra = (r, e) => {
  var t;
  if (r.symbol)
    t = new Ht("mo", [Yt(r.name, r.mode)]), oe.contains(Od, r.name) && t.setAttribute("largeop", "false");
  else if (r.body)
    t = new Ht("mo", Rt(r.body, e));
  else {
    t = new Ht("mi", [new aa(r.name.slice(1))]);
    var n = new Ht("mo", [Yt("⁡", "text")]);
    r.parentIsSupSub ? t = new Ht("mrow", [t, n]) : t = id([t, n]);
  }
  return t;
}, qp = {
  "∏": "\\prod",
...
var Dd = (r, e) => {
  ...
  if (i.body.length > 0) {
    ...
    s = L.makeSpan(["mop"], [], e);
  return a ? Md(s, t, n, e, e.style, 0, 0) : s;
}, Up = (r, e) => {
...
gn({
  ...
  mathmlBuilder(r, e) {
    ...
    return n !== Id[t.type] && t.setAttribute("mathvariant", n), t;
  }
});
gn({
  type: "textord",
  ...
  mathmlBuilder(r, e) {
    ...
    return r.mode === "text" ? a = new H.MathNode("mtext", [t]) : /[0-9]/.test(r.text) ? a = new H.MathNode("mn", [t]) : r.text === "\\prime" ? a = new H.MathNode("mo", [t]) : a = new H.MathNode("mi", [t]), n !== Id[a.type] && a.setAttribute("mathvariant", n), a;
  }
});
var ns = {
  "\\nobreak": "nobreak",
...
gn({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new H.MathNode("mtable", [new H.MathNode("mtr", [ql(), new H.MathNode("mtd", [Lr(r.body, e)]), ql(), new H.MathNode("mtd", [Lr(r.tag, e)])])]);
...
var Wl = (r) => r.body.replace(/ /g, r.star ? "␣" : " "), Mr = nd, Fd = `[ \r
	]`, Yp = "\\\\[a-zA-Z@]+", Vp = "\\\\[^\uD800-\uDFFF]", Xp = "(" + Yp + ")" + Fd + "*", Jp = `\\\\(
|[ \r	]+
?)[ \r	]*`, js = "[̀-ͯ]", Zp = new RegExp(js + "+$"), Qp = "(" + Fd + "+)|" + // whitespace
(Jp + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(js + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
var Ld = G(ar["Main-Regular"][84][1] - 0.7 * ar["Main-Regular"][65][1]);
_("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + Ld + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
_("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + Ld + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
...
class r4 {
   ...
   */
  isDefined(e) {
    return this.macros.has(e) || Mr.hasOwnProperty(e) || je.math.hasOwnProperty(e) || je.text.hasOwnProperty(e) || Pd.hasOwnProperty(e);
  }
  /**
...
class Oi {
  ...
  parseGroup(e, t) {
    ...
    } else if (i = this.parseFunction(t, e) || this.parseSymbol(), i == null && a[0] === "\\" && !Pd.hasOwnProperty(a)) {
  ...
  parseSymbol() {
    ...
    if (je[this.mode][t]) {
      ...
      this.settings.strict && (Gc(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '"' + (" (" + t.charCodeAt(0) + ")"), e)), s = {
        type: "textord",
        mode: "text",
        loc: Lt.range(e),
        text: t
...
typeof document < "u" && document.compatMode !== "CSS1Compat" && (typeof console < "u" && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), Bd = function() {
...
const s4 = ft.lazy(() => import("./EquationComponent-C8hgUYbm.js"));
function Zl(r) {
...
class $n extends lr {
  ...
  exportDOM() {
    ...
    return t.setAttribute("data-lexical-equation", n), t.setAttribute("data-lexical-inline", `${this.__inline}`), $d.render(this.__equation, t, {
...
const o4 = ft.lazy(() => import("./ExcalidrawComponent-DrVtHQ6D.js"));
function l4(r) {
...
class on extends lr {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  decorate(t, n) {
    return /* @__PURE__ */ p.jsx(Br, { fallback: null, children: /* @__PURE__ */ p.jsx(o4, { nodeKey: this.getKey(), data: this.__data }) });
  }
}
function qd() {
  return new on();
...
const u4 = ft.lazy(() => import("./PollComponent-ZUKpvJK_.js"));
function c4() {
...
const h4 = ft.lazy(() => import("./InlineImageComponent-BQZR8l0b.js"));
function m4(r) {
...
const p4 = ft.lazy(() => import("./StickyComponent-Im-EbFs9.js"));
class Mn extends lr {
  ...
  decorate(t, n) {
    return ur(
      /* @__PURE__ */ p.jsx(Br, { fallback: null, children: /* @__PURE__ */ p.jsx(
        p4,
        {
          color: this.__color,
          x: this.__x,
...
function S4(r, e, t) {
  ...
  }(r, e), !0), ye), r.registerCommand(s1, () => (nu(e), !1), ye), r.registerCommand(i1, () => (nu(e), r.dispatchCommand(Jn, !1), r.dispatchCommand(Zn, !1), !0), ye), r.registerUpdateListener(({ editorState: i, prevEditorState: s, dirtyLeaves: o, dirtyElements: l, tags: u }) => {
...
const Kd = Qs({}), k4 = ({
  ...
  return /* @__PURE__ */ p.jsx(Kd.Provider, { value: t, children: r });
}, E4 = () => Bu(Kd), N4 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pr : P;
function T4(r) {
...
function I4(r, e, t, n) {
  const a = (s) => s instanceof t, i = (s) => {
    const o = Rr(s.getTextContent());
    o.setFormat(s.getFormat()), s.replace(o);
  };
  return [r.registerNodeTransform(dn, (s) => {
...
const Us = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pr : P;
function au(r) {
  return r.getEditorState().read(Wd(r.isComposing()));
}
  ...
  const [n] = se(), a = function(i, s) {
    ...
    return Us(() => i.registerDecoratorListener((u) => {
      ...
      for (let h = 0; h < c.length; h++) {
        const m = c[h], g = p.jsx(s, { onError: (y) => i._onError(y), children: p.jsx(Br, { fallback: null, children: o[m] }) }), v = i.getElementByKey(m);
...
function $4(r) {
  return r.registerCommand(xi, (e) => {
    ...
    const n = function(a) {
      const i = a.getNodes();
      if (z1(i, (h) => ai(h) && h.canIndent() ? h : null).length > 0) return !0;
...
const Gd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pr : P;
function K4({ editor: r, ariaActiveDescendant: e, ariaAutoComplete: t, ariaControls: n, ariaDescribedBy: a, ariaExpanded: i, ariaLabel: s, ariaLabelledBy: o, ariaMultiline: l, ariaOwns: u, ariaRequired: c, autoCapitalize: h, className: m, id: g, role: v = "textbox", spellCheck: y = !0, style: x, tabIndex: S, "data-testid": w, ...C }, E) {
  ...
  return Gd(() => (A(r.isEditable()), r.registerEditableListener((O) => {
    A(O);
...
function V4({ content: r, editor: e }) {
  ...
  if (Pr(() => (a(e.isEditable()), e.registerEditableListener((s) => {
    a(s);
  })), [e]), !t) return null;
  let i = null;
...
const Yd = ft.createContext(null), ou = 4;
function Ae({
  children: r,
  className: e,
  onClick: t,
  ...
  const a = Re(null), i = ft.useContext(Yd);
  if (i === null)
...
function Z4({
  ...
  }, [n, i]), /* @__PURE__ */ p.jsx(Yd.Provider, { value: u, children: /* @__PURE__ */ p.jsx("div", { className: "dropdown", ref: e, onKeyDown: l, children: r }) });
}
function cn({
  disabled: r = !1,
  buttonLabel: e,
...
function eg(r, e, t) {
  const n = Qr[e];
  let a = r ^ n;
  return e === "subscript" ? a &= ~Qr.superscript : e === "superscript" && (a &= ~Qr.subscript), a;
}
function ss(r, e) {
...
const tg = en.lazy(() => import("./DataMentionComponent-DK1RPpbp.js"));
function rg(r) {
...
function os(r) {
  return r & o1 ? "code" : r & l1 ? "mark" : r & u1 ? "sub" : r & c1 ? "sup" : null;
}
function ls(r) {
  return r & d1 ? "strong" : r & h1 ? "em" : "span";
}
function Vd(r, e, t, n) {
  const a = t.classList;
  let i = ss(n, "base");
...
class Or extends lr {
  constructor(t, n, a, i, s, o, l, u, c) {
    ...
    re(this, "__format");
    re(this, "__style");
    re(this, "__decoratorSpan");
    re(this, "defaultStep", 1);
    re(this, "autoMentionData", []);
    re(this, "autoAfterMentionData", []);
  ...
  static importJSON(t) {
    ...
    if (c.__dataMention === "auto" && c.__step === 2 || c.__dataMention === "after-auto" && c.__step === 3) {
      let h;
      if (c.__dataMention === "auto" ? h = this.prototype.autoMentionData.find((m) => m[c.__fieldName] && m[c.__fieldName].label === c.__label) : h = this.prototype.autoAfterMentionData.find((m) => m[c.__fieldName] && m[c.__fieldName].label === c.__label), h) {
        const m = h[c.__fieldName];
        let g = m.value;
  ...
  exportDOM() {
    ...
    if (t.setAttribute("data-mention-type", this.__dataMention), t.setAttribute("data-mention-step", this.__step.toString()), t.setAttribute("data-mention-field", this.__fieldName), t.setAttribute("data-mention-label", this.__label), t.setAttribute("data-lexical-data-mention", "true"), this.__dataMention === "input" && this.__value) {
      const n = document.createElement("span");
      this.__value.getEditorState().read(() => {
        var o;
        const s = new DOMParser().parseFromString(
          Ec(this.__value),
          "text/html"
        );
        n.append(...((o = s.body.firstChild) == null ? void 0 : o.childNodes) ?? []);
      }), t.appendChild(n);
    } else
      t.innerHTML = this.__data ? this.__data.toString() : "";
    return { element: t };
  }
  exportJSON() {
    return {
...
const no = ({
  ...
  !a && r === "input" && (a = fa());
  const l = new Or(r, e, t, n, a, i, s, o);
  return lt(l);
}, ag = (r) => r instanceof Or, sa = (r) => r === null || r.getNodes().length !== 1 ? !1 : ag(r.getNodes()[0]), Kr = 8, Wr = 72, ig = 15;
function sg({
  selectionFontSize: r,
  disabled: e = !1,
  editor: t
  ...
  const [n, a] = ft.useState(r), i = (u, c) => {
    ...
    if (u.key === "Enter") {
      u.preventDefault();
      let h = c;
      c > Wr ? h = Wr : c < Kr && (h = Kr), a(String(h)), s(String(h) + "px", null);
    }
  }, l = (u) => {
    if (n !== "") {
      const c = i(
...
function Xd({
  ...
  const [t, n] = U(Cn("hex", r)), [a, i] = U(r), s = Re(null), o = ht(
    () => ({
      x: t.hsv.s / 100 * Vn,
  ...
  return P(() => {
    ...
    "div",
    {
      ...
      ref: s,
      children: [
        /* @__PURE__ */ p.jsx(zr, { label: "Hex", onChange: u, value: a }),
...
function pu({
  ...
  return /* @__PURE__ */ p.jsx(
    cn,
    {
      ...
      children: /* @__PURE__ */ p.jsx(Xd, { color: t, onChange: n })
    }
  );
}
const ao = $e();
...
const yg = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", Qd = document.createElement("img");
Qd.src = yg;
function xg(r) {
  const e = io();
  if (!e)
  ...
  return t ? (t.setData("text/plain", "_"), t.setDragImage(Qd, 0, 0), t.setData(
...
function wg(r) {
  return io() ? (eh(r) || r.preventDefault(), !0) : !1;
}
function _g(r, e) {
  const t = io();
  if (!t)
...
const Og = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", th = document.createElement("img");
th.src = Og;
function Dg(r) {
  const e = oo();
  if (!e)
    return !1;
  const t = r.dataTransfer;
  return t ? (t.setData("text/plain", "_"), t.setDragImage(th, 0, 0), t.setData(
    "application/x-lexical-drag",
    JSON.stringify({
      data: {
        altText: e.__altText,
...
function Rg(r) {
  return oo() ? (rh(r) || r.preventDefault(), !0) : !1;
}
function Ig(r, e) {
  const t = oo();
  if (!t)
...
function ih({
  ...
  const [t, n] = U(""), a = () => {
    r.dispatchCommand(ah, t), e();
  };
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    /* @__PURE__ */ p.jsx(zr, { label: "Question", onChange: n, value: t }),
...
const lh = $e("INSERT_EQUATION_COMMAND");
function uh({
  activeEditor: r,
  onClose: e
}) {
  const t = ae(
    (n, a) => {
      r.dispatchCommand(lh, { equation: n, inline: a }), e();
    },
    [r, e]
  );
...
const vu = "startTransition", Yg = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pr : P;
let Vg = class {
  constructor(e) {
...
function Jg({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ve }) {
  ...
  }, [a, u, g]), P(() => Ie(e.registerCommand(xu, ({ option: v }) => !(!v.ref || v.ref.current == null) && (bu(v.ref.current), !0), l)), [e, g, l]), P(() => Ie(e.registerCommand(mn, (v) => {
    const y = v;
...
function Zg({ options: r, nodeKey: e, onClose: t, onOpen: n, onSelectOption: a, menuRenderFn: i, anchorClassName: s, commandPriority: o = ve, parent: l }) {
  const [u] = se(), [c, h] = U(null), m = function(x, S, w, C = document.body, E = !0) {
    ...
    e ? u.update(() => {
      ...
      var w;
      x != null && S != null && c == null && (w = () => v({ getRect: () => S.getBoundingClientRect() }), vu in en ? en[vu](w) : w());
    }) : e == null && c != null && g();
  }, [g, u, e, v, c]);
  return P(() => {
    y();
      ...
      if (it(Be) || it(dt) ? S(!0) : S(!1), Qe !== null)
        if (ke(qe)) {
          const jt = uc(
            we,
            Ca
          ), vn = jt ? jt.getListType() : qe.getListType();
          n(vn);
        } else {
...
function y2() {
  const [r] = se();
  return P(() => Ie(r.registerCommand(f0, () => (Cs(r, "check"), !0), ve), r.registerCommand(mn, (e) => Cu(e, r, !1), ve), r.registerCommand(fn, (e) => Cu(e, r, !0), ve), r.registerCommand(Dn, (e) => {
    if (Xs() != null) {
      const t = r.getRootElement();
      return t != null && t.focus(), !0;
    }
    return !1;
  }, ve), r.registerCommand(p1, (e) => {
    const t = Xs();
...
function mh(r, e) {
  ...
  const i = t.getBoundingClientRect(), s = r.pageX / B1(t);
  (t.dir === "rtl" ? s < i.right && s > i.right - 20 : s > i.left && s < i.left + 20) && e();
}
function _u(r) {
  mh(r, () => {
    if (r.target instanceof HTMLElement) {
      const e = r.target, t = g1(e);
...
function E2() {
  ...
  return P(() => (ku || (k2(), ku = !0), r.registerCommand(
    ...
    (e) => {
      const t = z();
      return $(t) && fh + C2 > e.timeStamp && Ct(t.clone()), !1;
    },
    S2
  )), [r]), null;
}
...
function vh(r) {
  ...
  return ge(e) && (e = e.getLastDescendant()), e === null || pa(e) || Se(e) && gh(e.getTextContent());
}
function bh(r) {
...
function F2(r, e, t, n) {
  return (r > 0 ? pi(t[r - 1]) : vh(n[0])) ? e < t.length ? pi(t[e]) : bh(n[n.length - 1]) : !1;
}
function L2(r, e, t) {
  const n = [], a = [], i = [];
  let s = 0, o = 0;
...
function z2(r, e, t, n) {
  ...
  if (r.length > 1) {
    ...
    const c = z(), h = c ? c.getNodes().find(Se) : void 0, m = Rr(s.getTextContent());
...
function hs(r, e, t) {
  ...
  const i = r.getTextContent(), s = ph(i, e);
  if (s === null || s.text !== i || !vh(r) || !bh(r)) return ti(r), void t(null, r.getURL());
  const o = r.getURL();
...
function P2(r, e, t) {
  P(() => {
    ...
    return Ie(r.registerNodeTransform(dn, (a) => {
      ...
      if (gr(i) && !i.getIsUnlinked()) hs(i, e, n);
        ...
        (function(o, l, u) {
          ...
          var g;
          !gr(c) || c.getIsUnlinked() || Js(m) && (g = m, !(c.isEmailURI() ? /^\.[a-zA-Z]{2,}/.test(g) : /^\.[a-zA-Z0-9]{1,}/.test(g))) || (c.append(o), hs(c, l, u), u(null, c.getURL())), !gr(h) || h.getIsUnlinked() || gh(m) || (ti(h), hs(h, l, u), u(null, h.getURL()));
        })(a, e, n);
      }
...
function Y2() {
  ...
  const e = ae((n) => Hc(n.getTextContent()), []), t = ae((n) => {
    const a = G2.exec(n);
    if (a === null)
      return null;
...
function J2(r) {
  P(() => {
    ...
    return r.registerNodeTransform(dn, X2);
  }, [r]);
}
function Z2() {
  const [r] = se();
...
const Au = "startTransition", Q2 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pr : P;
class mo {
  constructor(e) {
    this.key = e, this.ref = { current: null }, this.setRefElement = this.setRefElement.bind(this);
  }
...
function t5({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ve }) {
  ...
  return P(() => () => {
    ...
    a === null ? c(null) : u === null && g(0);
  }, [a, u, g]), P(() => Ie(e.registerCommand(Du, ({ option: v }) => !(!v.ref || v.ref.current == null) && (Mu(v.ref.current), !0), l)), [e, g, l]), P(() => Ie(e.registerCommand(mn, (v) => {
    const y = v;
    if (a !== null && a.length && u !== null) {
      const x = u !== a.length - 1 ? u + 1 : 0;
      g(x);
    ...
    const x = c.registerUpdateListener(() => {
      c.getEditorState().read(() => {
        ...
        if (e(k ? k.matchingString : null), k !== null && !function(R, I) {
          ...
          return A = () => y({ getRect: () => w.getBoundingClientRect(), match: k }), void (Au in en ? en[Au](A) : A());
        var A;
        v();
      });
    });
...
function i5(r, e) {
  return [
    ...
    new at("Table", {
      ...
      onSelect: () => e("Insert Table", (t) => /* @__PURE__ */ p.jsx(nh, { activeEditor: r, onClose: t }))
    }),
    ...
    new at("Poll", {
      ...
      keywords: ["poll", "vote"],
      onSelect: () => e("Insert Poll", (t) => /* @__PURE__ */ p.jsx(ih, { activeEditor: r, onClose: t }))
    }),
    ...ho.map(
    ...
    new at("Equation", {
      ...
      onSelect: () => e("Insert Equation", (t) => /* @__PURE__ */ p.jsx(uh, { activeEditor: r, onClose: t }))
    }),
    new at("GIF", {
    ...
    new at("Image", {
      ...
      onSelect: () => e("Insert Image", (t) => /* @__PURE__ */ p.jsx(Zd, { activeEditor: r, onClose: t }))
    }),
    new at("Collapsible", {
    ...
    new at("Columns Layout", {
      ...
      onSelect: () => e("Insert Columns Layout", (t) => /* @__PURE__ */ p.jsx(oh, { activeEditor: r, onClose: t }))
    }),
...
function h5(r, e) {
  const [t, n] = U(!1), [a, i] = U(!1), [s, o] = U(!1), [l, u] = U(!1), [c, h] = U(!1), [m, g] = U(!1), [v, y] = U(!1), [x, S] = U(!1), [w, C] = U(!1), E = ae(() => {
    r.getEditorState().read(() => {
      ...
      const O = I.getParent();
      it(O) || it(I) ? i(!0) : i(!1), !c0(k.anchor.getNode()) && k.getTextContent() !== "" ? n(Se(I) || hn(I)) : n(!1);
...
function p5({ hasCellMerge: r = !0, hasCellBackgroundColor: e = !0, hasTabHandler: t = !0 }) {
  const [n] = se();
  return P(() => (n.hasNodes([Dr, sr, Ln]) || Za(10), Ie(n.registerCommand(w0, ({ columns: a, rows: i, includeHeaders: s }) => {
    const o = Fm(Number(i), Number(a), s);
    jr(o);
    const l = o.getFirstDescendant();
    return Se(l) && l.select(), !0;
  }, ye), n.registerNodeTransform(Dr, (a) => {
    const [i] = zc(a, null, null), s = i.reduce((l, u) => Math.max(l, u.length), 0), o = a.getChildren();
    ...
    const a = /* @__PURE__ */ new Map(), i = (o, l, u) => {
      ...
      a.set(l, [h, c]);
    }, s = n.registerMutationListener(Dr, (o) => {
  ...
  const v = (k) => k === "bottom", y = ae(
    ...
    (k) => {
      ...
      r.update(() => {
        ...
        if (!ne(A))
          throw new Error("TableCellResizer: Table cell node not found.");
        const R = Ar(A), I = Lc(A), O = R.getChildren();
...
function S5({
  ...
  const w = ae(() => {
        ...
        for (let me = 0; me < ie.length; me++) {
          ...
          if (ne(de))
            if (W === null) {
              ...
              const Oe = Ru(de);
              let le;
              Oe && hn(le = de.getFirstChild()) && le.remove();
            } else ne(W) && (Ru(de) || W.append(...de.getChildren()), de.remove());
        }
    ...
    s.update(() => {
      const J = Ar(l), Y = Fc(l), he = J.getChildren();
      if (Y >= he.length || Y < 0)
        throw new Error("Expected table cell to be inside of table row.");
      const ie = he[Y];
      if (!Ye(ie))
    ...
    s.update(() => {
      const J = Ar(l), Y = Lc(l), he = J.getChildren(), ie = Math.max(
    ...
    (J) => {
      s.update(() => {
        ...
        if ($(Y) || Te(Y)) {
          ...
          if (ne(he) && he.setBackgroundColor(J), Te(Y)) {
            const ie = Y.getNodes();
            for (let W = 0; W < ie.length; W++) {
              const me = ie[W];
              ne(me) && me.setBackgroundColor(J);
            }
          }
        }
      });
...
function M5() {
  ...
  const i = ht(
    ...
    (u, c, h) => {
      r.update(() => {
        const m = z();
        !$(m) || u == null || (c && c.remove(), m.insertNodes([Rr(u.emoji)]), h());
      });
    },
    [r]
  );
...
function ps(r, e, t, n = !1) {
  ...
  return e.getEditorState().read(() => {
    ...
    for (; o >= 0 && o < i.length; ) {
      ...
      if (c === null)
        break;
      const h = new yh(t.x, t.y), m = Vr.fromDOM(c), { marginTop: g, marginBottom: v } = xh(c), y = m.generateNewRect({
        bottom: m.bottom + v,
        left: a.left,
        right: a.right,
        top: m.top - g
...
function $5(r, e, t, n) {
  const { top: a, height: i } = e.getBoundingClientRect(), { top: s, width: o } = n.getBoundingClientRect(), { marginTop: l, marginBottom: u } = xh(e);
  let c = a;
  t >= a ? c += i + u / 2 : c -= l / 2;
...
const wh = `\\.,\\+\\*\\?\\$\\@\\|#{}\\(\\)\\^\\-\\[\\]\\\\/!%'"~=<>_:;`, K5 = "\\b[A-Z][^\\s" + wh + "]", W5 = {
  NAME: K5,
  PUNCTUATION: wh
}, _h = W5.PUNCTUATION, go = ["=\\$a", "=\\$i", "=\\$f"].join("|"), gs = "=$a", G5 = "=$i", Y5 = "=$f", Sh = "^(" + go + ")\\s|[^" + _h + "\\s]", V5 = "(?:\\.[ |$]| |[" + _h + "]|)", X5 = 75, J5 = new RegExp(
  "((" + go + ")((?:" + Sh + V5 + "){0," + X5 + "}))"
), Z5 = 50, Q5 = new RegExp(
  "((" + go + ")((?:" + Sh + "){0," + Z5 + "}))"
), e3 = [
  ...
  const [n] = se(), [a, i] = U(null), [s, o] = U(), [l, u] = U(), [c, h] = U(!1), [m, g] = U(null), y = r3(a, s === gs ? e : s === Y5 ? t : e3, s), x = fo("/", {
    ...
    () => y.map(
      (E) => {
        ...
        return new i3(s === gs ? "auto" : "after-auto", k, E[k].label, E[k].value, E[k].isMan, E[k].isNumber);
      }
    ),
    [y]
  ), w = ae(
    (E, k, A) => {
      n.update(() => {
        let R = E.data;
        E.isMan && typeof R == "number" && R && (R = 1e4 * R), E.isNumber && R && (R = R.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
        const I = no(
          {
        ...
        E.fieldName === "inputField" && (h(!0), g(I), A()), k && k.replace(I), A();
      });
    },
    [n, s]
  ), C = ae(
...
const l3 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pr : P;
...
function C3(r) {
  ...
  Or.prototype.defaultStep = s, Or.prototype.autoMentionData = i, Or.prototype.autoAfterMentionData = a;
  const l = {
    editorState: e,
    namespace: "Doc App",
    editable: s === 1,
  ...
  return /* @__PURE__ */ p.jsxs(C1, { initialConfig: l, children: [
