...
function U1() {
  return X0 || (X0 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function F(O) {
      return !!(typeof O == "string" || typeof O == "function" || O === n || O === i || D || O === a || O === c || O === u || I || O === g || T || k || N || typeof O == "object" && O !== null && (O.$$typeof === m || O.$$typeof === d || O.$$typeof === s || O.$$typeof === o || O.$$typeof === l || // This needs to include all possible module reference object
    ...
    var X = Object.assign, Y = 0, re, de, J, he, le, Ne, oe;
    function Pe() {
    }
    ...
    function Be() {
      {
        if (Y === 0) {
          re = console.log, de = console.info, J = console.warn, he = console.error, le = console.group, Ne = console.groupCollapsed, oe = console.groupEnd;
          var O = {
            configurable: !0,
            enumerable: !0,
            value: Pe,
    ...
    function ee(O, K) {
      ...
      try {
        ...
        if (At && ve && typeof At.stack == "string") {
          for (var Ee = At.stack.split(`
`), kt = ve.stack.split(`
`), rt = Ee.length - 1, st = kt.length - 1; rt >= 1 && st >= 0 && Ee[rt] !== kt[st]; )
            st--;
          for (; rt >= 1 && st >= 0; rt--, st--)
            if (Ee[rt] !== kt[st]) {
              if (rt !== 1 || st !== 1)
                do
                  if (rt--, st--, st < 0 || Ee[rt] !== kt[st]) {
                    var $t = `
` + Ee[rt].replace(" at new ", " at ");
      ...
      return typeof O == "function" && St.set(O, Kr), Kr;
    }
    function we(O, K, Q) {
      return ee(O, !1);
    }
          ...
          if (Le(O, Te)) {
            ...
            try {
              if (typeof O[Te] != "function") {
                var kt = Error((ve || "React class") + ": " + Q + " type `" + Te + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof O[Te] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw kt.name = "Invariant Violation", kt;
              }
              Ee = O[Te](K, Te, ve, Q, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (rt) {
              Ee = rt;
            }
    ...
    var r1 = function(O, K, Q, ve, Ie, Le, Te) {
      var Ee = {
    ...
    function n1(O, K, Q, ve, Ie) {
      {
        var Le, Te = {}, Ee = null, kt = null;
        Q !== void 0 && (O0(Q), Ee = "" + Q), Zh(K) && (O0(K.key), Ee = "" + K.key), Jh(K) && (kt = K.ref, Qh(K, Ie));
        for (Le in K)
          tt.call(K, Le) && !Xh.hasOwnProperty(Le) && (Te[Le] = K[Le]);
        if (O && O.defaultProps) {
        ...
        if (Ee || kt) {
          ...
          Ee && e1(Te, st), kt && t1(Te, st);
        }
        return r1(O, Ee, kt, Ie, ve, Yn.current, Te);
      }
    }
    ...
    function j0(O, K, Q, ve, Ie, Le) {
      {
        ...
        if (!Te) {
          ...
          kt ? Ee += kt : Ee += F0();
          var rt;
          O === null ? rt = "null" : Bi(O) ? rt = "array" : O !== void 0 && O.$$typeof === e ? (rt = "<" + (P(O.type) || "Unknown") + " />", Ee = " Did you accidentally export a JSX literal instead of a component?") : rt = typeof O, w("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", rt, Ee);
        }
...
const Cc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Y1 = Cc ? Br : j, Pa = { tag: "history-merge" };
      ...
      if (m !== null) {
        if (m === void 0) d.update(() => {
          ...
          if (g.isEmpty()) {
            ...
            (B() !== null || b !== null && b === d.getRootElement()) && v.select();
          }
        }, Pa);
...
function vo(r) {
  let e = ci.get(r);
  return e === void 0 && (e = Nc(r), ci.set(r, e)), e;
}
function Z1(r) {
  let e = "";
  ...
  if (t.length === 1) {
    if (_e(l) && l.canHaveFormat()) {
      ...
      if (Ki(l) || v === 0 && b === u) xn(l, e), l.select(v, b);
        ...
        const C = l.splitText(v, b), T = v === 0 ? C[0] : C[1];
        xn(T, e), T.select(0, b - v);
      }
    }
  } else {
    ...
    for (let C = 1; C < o; C++) {
      ...
      _e(T) && T.canHaveFormat() && k !== l.getKey() && k !== c.getKey() && !T.isToken() && xn(T, e);
    }
  }
}
function Qr(r, e) {
  ...
  var t = function(n) {
    var a = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, i = 0, s = {}, o = {
      ...
      highlightElement: function(w, C, T) {
        ...
        function F($) {
          M.highlightedCode = $, o.hooks.run("before-insert", M), M.element.innerHTML = M.highlightedCode, o.hooks.run("after-highlight", M), o.hooks.run("complete", M), T && T.call(M.element);
        }
      ...
      tokenize: function(w, C) {
        ...
        var N = new d();
        return m(N, N.head, w), u(w, N, C, N.head, 0), v(N);
      },
      /**
       * @namespace
       * @memberof Prism
      ...
      for (var D in T)
        if (!(!T.hasOwnProperty(D) || !T[D])) {
          ...
          for (var F = 0; F < M.length; ++F) {
            ...
            for (var de = z.pattern || z, J = k.next, he = N; J !== C.tail && !(I && he >= I.reach); he += J.value.length, J = J.next) {
              var le = J.value;
              ...
              if (!(le instanceof l)) {
                ...
                if (X) {
                  ...
                  Ne--, le = w.slice(he, Be), oe.index -= he;
                ...
                var Qt = J.prev;
                Ge && (Qt = m(C, Qt, Ge), he += Ge.length), g(C, Qt, Ne);
                var ee = new l(D, $ ? o.tokenize(Je, $) : Je, Y, Je);
                if (J = m(C, Qt, ee), Rt && m(C, J, Rt), Ne > 1) {
                  var we = {
                    cause: D + "," + F,
                    reach: St
                  };
                  u(w, C, T, J.prev, he, we), I && we.reach > I.reach && (I.reach = we.reach);
                }
              }
            }
          }
...
`), x.hasAttribute("data-start") || x.setAttribute("data-start", String(M + 1));
          ...
          function(N) {
            x.setAttribute(o, u), _.textContent = N;
          }
        );
      }
...
function km(r) {
  if (r.classList.contains("task-list-item")) {
    for (const t of r.children) if (t.tagName === "INPUT") return Nm(t);
  }
...
function Pt(r) {
  return ut(new Na(void 0, r));
}
function Fe(r) {
  return r instanceof Na;
}
let Ea = class Uc extends _t {
  static getType() {
    return "list";
  }
  static clone(e) {
...
function dl(r) {
  ...
  return e === "ol" ? t = Ot("number", r.start) : e === "ul" && (t = function(n) {
    ...
    return !1;
  }(r) ? Ot("check") : Ot("bullet")), { after: Em, node: t };
}
const hl = { ol: "number", ul: "bullet" };
function Ot(r, e = 1) {
  return ut(new Ea(r, e));
}
function ke(r) {
  return r instanceof Ea;
}
const So = Ue("INSERT_UNORDERED_LIST_COMMAND"), Co = Ue("INSERT_ORDERED_LIST_COMMAND"), ko = Ue("INSERT_CHECK_LIST_COMMAND"), Tm = Ue("REMOVE_LIST_COMMAND");
function Am(r) {
  return Re(r.registerCommand(Co, () => (Is(r, "number"), !0), ye), r.registerCommand(So, () => (Is(r, "bullet"), !0), ye), r.registerCommand(Tm, () => (wm(r), !0), ye), r.registerCommand(ca, () => !!Cm(), ye));
}
let No = class Kc extends _t {
  static getType() {
    return "mark";
  }
  static clone(e) {
...
function Im({ nodeKey: r }) {
  ...
  return j(() => Re(e.registerCommand(wa, (s) => {
    const o = e.getElementByKey(r);
    return s.target === o && (s.shiftKey || a(), n(!t), !0);
  }, ye), e.registerCommand(xa, i, ye), e.registerCommand(ya, i, ye)), [a, e, t, r, i, n]), j(() => {
...
function tf(r) {
  return Re(r.registerCommand(wa, (e) => {
    ...
    return t.isCollapsed() && n.offset === 0 && !co(a) && Ei(a).getIndent() > 0 ? r.dispatchCommand(ui, void 0) : r.dispatchCommand(ia, !0);
    ...
    const [, t, n] = kn(e);
    return t.length > 0 && !n ? (r.dispatchCommand(Ls, t), !0) : S1(e.target) ? !1 : B() !== null && (function(a, i) {
  ...
  if (r) {
    ...
    for (let v = 0; v < o; v++) {
      ...
      if (x + b.__rowSpan - 1 <= u) {
        const _ = d[v].cell.__headerState, w = zs(_, He.COLUMN);
    ...
    for (let g = 0; g < o; g++) {
      ...
      if (b === l) {
        const x = u[g].cell.__headerState, _ = zs(x, He.COLUMN);
...
function ad(r = !0) {
  ...
  e: for (let w = 0; w < u; w++) {
    ...
    const C = o[w], T = C[m < 0 ? 0 : m].cell.__headerState, k = zs(T, He.ROW);
    if (m < 0) {
      Fo(x, b(k));
      continue;
    }
...
function lf() {
  ...
  for (let b = d; b >= c; b--) {
    for (let _ = m - 1; _ >= 0; _--) {
      const { cell: w, startRow: C, startColumn: T } = s[b][_];
      if (T === _ && (b === c && C < c && w.setRowSpan(w.__rowSpan - (C - c)), C >= c && C + w.__rowSpan - 1 > d)) if (w.setRowSpan(w.__rowSpan - (d - C + 1)), v === null && Ce(122), _ === 0) Fo(v, w);
      else {
        const { cell: k } = g[_ - 1];
        k.insertAfter(w);
      }
...
function uf() {
  ...
  const b = s.length;
  for (let C = 0; C < b; C++) for (let T = m; T <= g; T++) {
  ...
  if (_ !== void 0) {
    ...
    const C = d < c ? x[d - 1] : x[c - 1], { cell: T } = C;
    fa(T);
  }
...
function cf() {
  ...
  if (s > 1) {
    ...
    for (let x = 1; x < s; x++) {
      ...
      if (C === null) for (let T = i - 1; T >= 0; T--) Fo(b, Jt(m[T] | v[x]).append(xe()));
...
class Ai {
  ...
  getNodes() {
    ...
    for (; m < x || g < _ || v > w || b > C; ) {
      if (m < x) {
        const D = C - _, M = x - 1;
        for (let F = 0; F <= D; F++) T(c[_ + F][M]);
        x = M;
      }
      if (g < _) {
        const D = w - x, M = _ - 1;
        for (let F = 0; F <= D; F++) T(c[M][x + F]);
        _ = M;
      }
      if (v > w) {
        const D = C - _, M = w + 1;
    ...
    return T1() || (this._cachedNodes = I), I;
  }
  getTextContent() {
...
class hf {
  ...
  formatCells(e) {
    this.editor.update(() => {
      const t = B();
      Oe(t) || Ce(11);
      const n = _a(), a = n.anchor, i = n.focus, s = t.getNodes().filter(ae), o = s[0].getFirstChild(), l = Hr(o) ? o.getFormatFlags(e, null) : null;
      s.forEach((c) => {
...
function mf(r, e, t, n) {
  ...
  return i.listenersToRemove.add(t.registerCommand(ya, l, pt)), i.listenersToRemove.add(t.registerCommand(xa, l, pt)), i.listenersToRemove.add(t.registerCommand(pc, (u) => {
    ...
    const [v, b, x] = Kt(r, m, g), _ = Math.max(b.startRow, x.startRow), w = Math.max(b.startColumn, x.startColumn), C = Math.min(b.startRow, x.startRow), T = Math.min(b.startColumn, x.startColumn);
    ...
    return !1;
  }, pt)), n && i.listenersToRemove.add(t.registerCommand(Ni, (u) => {
    const d = B();
    ...
    const [x] = g, _ = d[0], w = _.getChildren(), C = _.getFirstChildOrThrow().getChildrenSize(), T = _.getChildrenSize(), k = me(x.getNode(), (J) => ae(J)), N = k && me(k, (J) => nt(J)), I = N && me(N, (J) => We(J));
    if (!ae(k) || !nt(N) || !We(I)) return !1;
    const D = N.getIndexWithinParent(), M = Math.min(I.getChildrenSize() - 1, D + T - 1), F = k.getIndexWithinParent(), z = Math.min(N.getChildrenSize() - 1, F + C - 1), $ = Math.min(F, z), P = Math.min(D, M), X = Math.max(F, z), Y = Math.max(D, M), re = I.getChildren();
    let de = 0;
    for (let J = P; J <= Y; J++) {
      const he = re[J];
      if (!nt(he)) return !1;
      const le = w[de];
      if (!nt(le)) return !1;
      const Ne = he.getChildren(), oe = le.getChildren();
      let Pe = 0;
      for (let Be = $; Be <= X; Be++) {
        const je = Ne[Be];
        if (!ae(je)) return !1;
    ...
    const u = B(), d = ho();
    if (U(u)) {
      const { anchor: m, focus: g } = u, v = m.getNode(), b = g.getNode(), x = Ji(v), _ = Ji(b), w = !(!x || !r.is(Nn(x))), C = !(!_ || !r.is(Nn(_))), T = w !== C, k = w && C, N = u.isBackward();
      if (T) {
        const I = u.clone();
        if (C) {
        ...
        xt(I), Cl(t, i);
      } else k && (x.is(_) || (i.setAnchorCellForSelection(c(x)), i.setFocusCellForSelection(c(_), !0), i.isSelecting || setTimeout(() => {
      ...
      if (m && m.anchorNode && m.focusNode) {
        const g = Qe(m.focusNode), v = g && !r.is(Nn(g)), b = Qe(m.anchorNode), x = b && r.is(Nn(b));
...
class or extends _t {
  ...
  createDOM(e, t) {
    ...
    return n.appendChild(a), El(n, 0, this.getColumnCount(), this.getColWidths()), et(n, e.theme.table), this.__rowStriping && Tl(n, e, !0), n;
  }
  updateDOM(e, t, n) {
    return e.__rowStriping !== this.__rowStriping && Tl(t, n, this.__rowStriping), El(t, 0, this.getColumnCount(), this.getColWidths()), !1;
  }
  exportDOM(e) {
...
const yf = mt.lazy(() => import("./ImageComponent-CXOFMQtN.js"));
function xf(r) {
  const e = r;
...
function $o({ children: r, format: e, nodeKey: t, className: n }) {
  const [a] = se(), [i, s, o] = To(t), l = Me(null), c = ie((u) => {
    const d = B();
  ...
  return j(() => Re(a.registerCommand(er, (u) => {
    if (i) {
      const d = B();
      if (gt(d)) {
        const m = bt(t);
        ...
        const m = d.getNodes();
        for (const g of m) $s(g) ? g.setFormat(u) : Ei(g).setFormat(u);
      }
      return !0;
    }
    return !1;
...
function kf({
  ...
  const o = Me(null), l = Me(""), [c, u] = q(!1), d = ie(async () => {
    try {
...
var Yo = 0, mi = 1, Tn = 2, _r = 3, pa = 4, Ut = 5, Mn = 6, Et = 7, tr = [new Ar(Yo, 0, !1), new Ar(mi, 0, !0), new Ar(Tn, 1, !1), new Ar(_r, 1, !0), new Ar(pa, 2, !1), new Ar(Ut, 2, !0), new Ar(Mn, 3, !1), new Ar(Et, 3, !0)], Hf = [pa, Ut, pa, Ut, Mn, Et, Mn, Et], qf = [Ut, Ut, Ut, Ut, Et, Et, Et, Et], Uf = [Tn, _r, pa, Ut, Mn, Et, Mn, Et], Kf = [_r, _r, Ut, Ut, Et, Et, Et, Et], Wf = [mi, mi, _r, _r, Ut, Ut, Et, Et], Gf = [Yo, mi, Tn, _r, Tn, _r, Tn, _r], pe = {
  DISPLAY: tr[Yo],
  TEXT: tr[Tn],
  SCRIPT: tr[pa],
  SCRIPTSCRIPT: tr[Mn]
...
var f = "math", H = "text", y = "main", E = "ams", Ye = "accent-token", te = "bin", Tt = "close", $n = "inner", fe = "mathord", ct = "op-token", Bt = "open", Oi = "punct", A = "rel", Tr = "spacing", R = "textord";
h(f, y, A, "≡", "\\equiv", !0);
h(f, y, A, "≺", "\\prec", !0);
h(f, y, A, "≻", "\\succ", !0);
h(f, y, A, "∼", "\\sim", !0);
...
h(f, E, A, "≑", "\\Doteq", !0);
h(f, E, te, "∔", "\\dotplus", !0);
h(f, E, te, "∖", "\\smallsetminus");
h(f, E, te, "⋒", "\\Cap", !0);
h(f, E, te, "⋓", "\\Cup", !0);
h(f, E, te, "⩞", "\\doublebarwedge", !0);
h(f, E, te, "⊟", "\\boxminus", !0);
h(f, E, te, "⊞", "\\boxplus", !0);
h(f, E, te, "⋇", "\\divideontimes", !0);
h(f, E, te, "⋉", "\\ltimes", !0);
h(f, E, te, "⋊", "\\rtimes", !0);
h(f, E, te, "⋋", "\\leftthreetimes", !0);
h(f, E, te, "⋌", "\\rightthreetimes", !0);
h(f, E, te, "⋏", "\\curlywedge", !0);
h(f, E, te, "⋎", "\\curlyvee", !0);
h(f, E, te, "⊝", "\\circleddash", !0);
h(f, E, te, "⊛", "\\circledast", !0);
h(f, E, te, "⋅", "\\centerdot");
h(f, E, te, "⊺", "\\intercal", !0);
h(f, E, te, "⋒", "\\doublecap");
h(f, E, te, "⋓", "\\doublecup");
...
h(H, y, fe, "h", "ℎ");
var ge = "";
for (var Nt = 0; Nt < fi.length; Nt++) {
  var Ze = fi.charAt(Nt);
  ge = String.fromCharCode(55349, 56320 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56372 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56424 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56580 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56684 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56736 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56788 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56840 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56944 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), Nt < 26 && (ge = String.fromCharCode(55349, 56632 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge), ge = String.fromCharCode(55349, 56476 + Nt), h(f, y, fe, Ze, ge), h(H, y, R, Ze, ge));
}
ge = "𝕜";
h(f, y, fe, "k", ge);
h(H, y, R, "k", ge);
...
var Ga = [
  ...
  var k;
  if (d < 0) {
    var N = Mt([], []), I = Mt(["vlist"], [N]);
    I.style.height = V(-d);
    var D = Mt(["vlist-s"], [new Gt("​")]);
    k = [Mt(["vlist-r"], [T, D]), Mt(["vlist-r"], [I])];
  } else
    k = [Mt(["vlist-r"], [T])];
  var M = Mt(["vlist-t"], k);
...
var vi = function(e) {
...
}, Nr = L.makeSpan, Ap = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], Mp = ["rightmost", "mrel", "mclose", "mpunct"], Op = {
  display: pe.DISPLAY,
  text: pe.TEXT,
  script: pe.SCRIPT,
  ...
  return $l(i, (v, b) => {
    ...
    var x = Ws(b), _ = Ws(v), w = x && _ ? v.hasClass("mtight") ? Tp[x][_] : Ep[x][_] : null;
    if (w)
  ...
  for (var s = 0; s < e.length; s++) {
    ...
    c ? n.node = o : i && o.hasClass("newline") && (n.node = Nr(["leftmost"])), n.insertAfter = /* @__PURE__ */ ((d) => (m) => {
      e.splice(d + 1, 0, m), s++;
    })(s);
  }
  a && e.pop();
...
var Ed = function(e) {
  ...
  var a = Ed(n), i = Gs(e, a), s = L.makeSpan(["katex"], [i]);
  return Td(s, n);
}, zp = {
  widehat: "^",
  widecheck: "ˇ",
  ...
  function n() {
    ...
    if (ce.contains(["widehat", "widecheck", "widetilde", "utilde"], l)) {
      ...
      var _ = [], w = Bp[l], [C, T, k] = w, N = k / 1e3, I = C.length, D, M;
      if (I === 1) {
        var F = w[3];
        D = ["hide-tail"], M = [F];
      } else if (I === 2)
...
var t0 = (r, e) => {
  ...
  var t = r.isStretchy ? Er.mathMLnode(r.label) : new W.MathNode("mo", [Yt(r.label, r.mode)]), n = new W.MathNode("mover", [ze(r.base, e), t]);
...
Z({
  ...
  mathmlBuilder: (r, e) => {
    var t = Er.mathMLnode(r.label), n = new W.MathNode("munder", [ze(r.base, e), t]);
...
Z({
  ...
  htmlBuilder(r, e) {
    ...
    var o = Er.svgSpan(r, e), l = -e.fontMetrics().axisHeight + 0.5 * o.height, c = -e.fontMetrics().axisHeight - 0.5 * o.height - 0.111;
...
var aa = function(e, t, n) {
  ...
  var v = aa(o, g, i), b = v.height + v.depth, x = aa(c, g, i), _ = x.height + x.depth, w = aa(u, g, i), C = w.height + w.depth, T = 0, k = 1;
  if (l !== null) {
    var N = aa(l, g, i);
    T = N.height + N.depth, k = 2;
  }
  var I = b + C + T, D = Math.max(0, Math.ceil((t - I) / (k * _))), M = I + D * k * _, F = a.fontMetrics().axisHeight;
...
var n0 = (r, e) => {
  ...
  if (n === "sout")
    ...
    /box/.test(n) ? (_ = Math.max(
      ...
      e.minRuleThickness
      // User override.
    ), b = e.fontMetrics().fboxsep + (n === "colorbox" ? 0 : _), x = b) : n === "angl" ? (_ = Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness), b = 4 * _, x = Math.max(0, 0.25 - t.depth)) : (b = o ? 0.2 : 0, x = b), i = Er.encloseSpan(t, n, b, x, e), /fbox|boxed|fcolorbox/.test(n) ? (i.style.borderStyle = "solid", i.style.borderWidth = V(_)) : n === "angl" && _ !== 0.049 && (i.style.borderTopWidth = V(_), i.style.borderRightWidth = V(_)), s = t.depth + x, r.backgroundColor && (i.style.backgroundColor = r.backgroundColor, r.borderColor && (i.style.borderColor = r.borderColor));
  }
  var w;
...
function Ur(r, e, t) {
  ...
  for (C(), _.push(Gl(r)); ; ) {
    ...
    if (N === "&") {
      ...
      T(), v.length === 1 && k.type === "styling" && k.body[0].body.length === 0 && (b.length > 1 || !u) && b.pop(), _.length < b.length + 1 && _.push([]);
      break;
    } else if (N === "\\\\") {
      r.consume();
      var I = void 0;
      r.gullet.future().text !== " " && (I = r.parseSizeGroup(!0)), x.push(I ? I.value : null), T(), _.push(Gl(r)), v = [], b.push(v), C();
    } else
...
var dr = function(e, t) {
  ...
  for (T(s[0]), n = 0; n < e.body.length; ++n) {
    ...
    F && (z = Xe(F, t), z > 0 && (z += w, I < z && (I = z), z = 0)), e.addJot && (I += b), D.height = N, D.depth = I, C += N, D.pos = C, C += I + z, l[n] = D, T(s[n + 1]);
  }
  var $ = C / 2 + t.fontMetrics().axisHeight, P = e.cols || [], X = [], Y, re, de = [];
  if (e.tags && e.tags.some(($e) => $e))
    for (n = 0; n < i; ++n) {
      var J = l[n], he = J.pos - $, le = e.tags[n], Ne = void 0;
      le === !0 ? Ne = L.makeSpan(["eqn-num"], [], t) : le === !1 ? Ne = L.makeSpan([], [], t) : Ne = L.makeSpan([], ft(le, t, !0), t), Ne.depth = J.depth, Ne.height = J.height, de.push({
        type: "elem",
        elem: Ne,
        shift: he
      });
...
var Vd = (r, e) => {
  ...
  var T;
  t.size === pe.DISPLAY.size ? T = e.fontMetrics().delim1 : t.size === pe.SCRIPTSCRIPT.size ? T = e.havingStyle(pe.SCRIPT).fontMetrics().delim2 : T = e.fontMetrics().delim2;
  var k, N;
  return r.leftDelim == null ? k = ga(e, ["mopen"]) : k = Sr.customSizedDelim(r.leftDelim, T, !0, e.havingStyle(t), r.mode, ["mopen"]), r.continued ? N = L.makeSpan([]) : r.rightDelim == null ? N = ga(e, ["mclose"]) : N = Sr.customSizedDelim(r.rightDelim, T, !0, e.havingStyle(t), r.mode, ["mclose"]), L.makeSpan(["mord"].concat(i.sizingClasses(e)), [k, L.makeSpan(["mfrac"], [x]), N], e);
}, l0 = (r, e) => {
...
var Xd = (r, e) => {
  ...
  var i = De(a.base, e.havingBaseStyle(pe.DISPLAY)), s = Er.svgSpan(a, e), o;
...
var Jd = (r, e, t, n, a, i, s) => {
  ...
  if (r.symbol)
    ...
    r.parentIsSupSub ? t = new qt("mrow", [t, n]) : t = Nd([t, n]);
  }
  return t;
}, cg = {
  "∏": "\\prod",
...
gn({
  ...
  htmlBuilder(r, e) {
    ...
    if (o && l) {
      ...
      var k = c.defaultRuleThickness, N = 4 * k;
      if (u - o.depth - (l.height - d) < N) {
        d = N - (u - o.depth) + l.height;
      ...
      u = Math.max(u, b, o.depth + 0.25 * c.xHeight), T = L.makeVList({
        positionType: "shift",
        positionData: -u,
        children: [{
          type: "elem",
...
const Tg = mt.lazy(() => import("./EquationComponent-Df6vHnId.js"));
function du(r) {
...
const Ag = mt.lazy(() => import("./ExcalidrawComponent-DesJQbot.js"));
function Mg(r) {
...
const Og = mt.lazy(() => import("./PollComponent-Co-NEbMG.js"));
function Dg() {
...
const Ig = mt.lazy(() => import("./InlineImageComponent-CpoK_XCQ.js"));
function Fg(r) {
...
const zg = mt.lazy(() => import("./StickyComponent-CJB-7gCr.js"));
class On extends ur {
...
}, Yg = () => sc(hh), Vg = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : j;
function Xg(r) {
  return { initialValueFn: () => r.isEditable(), subscribe: (e) => r.registerEditableListener(e) };
}
function La() {
  return function(r) {
    const [e] = se(), t = it(() => r(e), [e, r]), n = Me(t.initialValueFn()), [a, i] = q(n.current);
    return Vg(() => {
            ...
            r.update(() => {
              ...
              if (U(b)) {
                ...
                if (_e(_) && c >= 0 && u >= 0 && (w = c, C = c + u, b.setTextNodeRange(_, w, _, C)), w === C && d === "" || (b.insertRawText(d), _ = x.getNode()), _e(_)) {
                  ...
                  w = w > T ? T : w, C = C > T ? T : C, b.setTextNodeRange(_, w, _, C);
                }
...
const eo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : j;
function vu(r) {
...
function u4(r) {
  return r.registerCommand(Ni, (e) => {
    ...
    const n = function(a) {
      ...
      const s = a.anchor, o = a.focus, l = o.isBefore(s) ? o : s, c = l.getNode(), u = Ei(c);
      if (u.canIndent()) {
        const d = u.getKey();
        let m = _a();
...
function d4() {
  const [r] = se();
  return j(() => r.registerCommand(Ao, (e) => {
    const t = B();
    if (!U(t)) return !1;
...
const fh = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : j;
function m4({ editor: r, ariaActiveDescendant: e, ariaAutoComplete: t, ariaControls: n, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: o, ariaLabel: l, ariaLabelledBy: c, ariaMultiline: u, ariaOwns: d, ariaRequired: m, autoCapitalize: g, className: v, id: b, role: x = "textbox", spellCheck: _ = !0, style: w, tabIndex: C, "data-testid": T, ...k }, N) {
...
function Ae({
  ...
  const a = Me(null), i = mt.useContext(ph);
  if (i === null)
...
function dn({
  ...
  const o = Me(null), l = Me(null), [c, u] = q(!1), d = () => {
...
const S4 = tn.lazy(() => import("./DataMentionComponent-DWi--26n.js"));
function C4(r) {
...
class hn extends ur {
  ...
  updateDOM(t, n, a) {
    ...
    if (o === l && c !== u) {
      ...
      T == null && wu(!1, "updateDOM: prevInnerDOM is null or undefined");
...
const g0 = ({
  ...
  return ut(l);
}, N4 = (r) => r instanceof hn, ua = (r) => r === null || r.getNodes().length !== 1 ? !1 : N4(r.getNodes()[0]), Yr = 8, Vr = 72, E4 = 15;
function T4({
  selectionFontSize: r,
  disabled: e = !1,
  editor: t
  ...
  const [n, a] = mt.useState(r), i = (c, u) => {
    ...
    (c, u) => {
      const d = (m) => (m || (m = `${E4}px`), m = m.slice(0, -2), `${i(
        Number(m),
        u
      )}px`);
      t.update(() => {
...
function vh({
  ...
  const [t, n] = q(Cn("hex", r)), [a, i] = q(r), s = Me(null), o = it(
    () => ({
      x: t.hsv.s / 100 * Jn,
...
function Tu({ b: r, g: e, r: t }) {
  return "#" + [t, e, r].map((n) => n.toString(16).padStart(2, "0")).join("");
}
function Cn(r, e) {
  let t = Nu("#121212"), n = Eu(t), a = ps(n);
  return r === "hex" ? (t = Nu(e), n = Eu(t), a = ps(n)) : r === "rgb" ? (n = e, t = Tu(n), a = ps(n)) : r === "hsv" && (a = e, n = R4(a), t = Tu(n)), { hex: t, hsv: a, rgb: n };
}
function Au({
  disabled: r = !1,
...
function J4({
  ...
  const t = Me(!1), [n, a] = q(""), [i, s] = q(""), [o, l] = q(!1), [c, u] = q("left"), d = n === "", m = (x) => {
    l(x.target.checked);
  }, g = (x) => {
    u(x.target.value);
  }, v = (x) => {
...
const Ou = "startTransition", g2 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : j;
let v2 = class {
  constructor(e) {
...
function y2({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ye }) {
  ...
  }, [a, c, g]), j(() => Re(e.registerCommand(Iu, ({ option: v }) => !(!v.ref || v.ref.current == null) && (Du(v.ref.current), !0), l)), [e, g, l]), j(() => Re(e.registerCommand(mn, (v) => {
    const b = v;
...
function x2({ options: r, nodeKey: e, onClose: t, onOpen: n, onSelectOption: a, menuRenderFn: i, anchorClassName: s, commandPriority: o = ye, parent: l }) {
  const [c] = se(), [u, d] = q(null), m = function(x, _, w, C = document.body, T = !0) {
    const [k] = se(), N = Me(document.createElement("div")), I = ie(() => {
      N.current.style.top = N.current.style.bottom;
      const M = k.getRootElement(), F = N.current, z = F.firstChild;
      if (M !== null && x !== null) {
        const { left: $, top: P, width: X, height: Y } = x.getRect(), re = N.current.offsetHeight;
        if (F.style.top = `${P + re + 3 + (T ? window.pageYOffset : 0)}px`, F.style.left = `${$ + window.pageXOffset}px`, F.style.height = `${Y}px`, F.style.width = `${X}px`, z !== null) {
          z.style.top = `${P}`;
          const de = z.getBoundingClientRect(), J = de.height, he = de.width, le = M.getBoundingClientRect();
          $ + he > le.right && (F.style.left = `${le.right - he + window.pageXOffset}px`), (P + J > window.innerHeight || P + J > le.bottom) && P - le.top > J + Y && (F.style.top = `${P - J - Y + (T ? window.pageYOffset : 0)}px`);
        }
    ...
    e ? c.update(() => {
      ...
      var w;
      x != null && _ != null && u == null && (w = () => v({ getRect: () => _.getBoundingClientRect() }), Ou in tn ? tn[Ou](w) : w());
    }) : e == null && u != null && g();
  }, [g, c, e, v, u]);
  return j(() => {
    b();
...
const w2 = /((https?:\/\/(www\.)?)|(www\.))[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)/, S0 = Ue("INSERT_EMBED_COMMAND");
...
function _2({ embedConfigs: r, onOpenEmbedModalForConfig: e, getMenuOptions: t, menuRenderFn: n, menuCommandPriority: a = ye }) {
  ...
  j(() => Re(...[Fn, ka].map((b) => i.registerMutationListener(b, (...x) => ((_, { updateTags: w, dirtyLeaves: C }) => {
    for (const [T, k] of _) k === "created" && w.has("paste") && C.size <= 3 ? d(T) : T === s && u();
  })(...x), { skipInitialization: !0 }))), [d, i, r, s, u]), j(() => i.registerCommand(S0, (b) => {
  ...
  const m = ie(async function() {
    if (l != null && s != null) {
      ...
      if (lt(b)) {
        ...
        x != null && i.update(() => {
          B() || b.selectEnd(), l.insertNode(i, x), b.isAttached() && b.remove();
        });
      }
    }
...
function P2({ setIsLinkEditMode: r }) {
  const [e] = se(), [t, n] = q("paragraph"), [a, i] = q(e), [s, o] = q("15px"), [l, c] = q("#000"), [u, d] = q("#fff"), [m, g] = q('"Noto Sans JP", serif'), [v, b] = q("left"), [x, _] = q(!1), [w, C] = q(!1), [T, k] = q(!1), [N, I] = q(!1), [D, M] = q(!1), [F, z] = q(!1), [$, P] = q(!1), [X, Y] = q(!1), [re, de] = q(!1), [J, he] = q(!1), [le, Ne] = q(!1), [oe, Pe] = q(() => e.isEditable()), [Be, je] = Pi(), dt = ie(() => {
    const ee = B();
    if (ee && ua(ee)) {
      ...
      C(ee.hasFormat("bold")), k(ee.hasFormat("italic")), I(ee.hasFormat("underline")), M(ee.hasFormat("strikethrough")), z(ee.hasFormat("subscript")), P(ee.hasFormat("superscript")), Y(ee.hasFormat("code")), de(Tc(ee));
      ...
      if (lt($e) || lt(ht) ? _(!0) : _(!1), tt !== null)
        if (ke(Ke)) {
          ...
          const jt = En(Ke) ? Ke.getTag() : Ke.getType();
          jt in ao && n(jt);
        }
      o(
    ...
    a.update(() => {
      ...
      if (ee && ua(ee))
        ...
        Ct.forEach((tt, ht) => {
          if (_e(tt)) {
            let $e = tt;
            ht === 0 && we.offset !== 0 && ($e = $e.splitText(we.offset)[1] || $e), ht === Ct.length - 1 && ($e = $e.splitText(Ke.offset)[0] || $e), $e.__style !== "" && $e.setStyle(""), $e.__format !== 0 && ($e.setFormat(0), Ei($e).setFormat("")), tt = $e;
          } else En(tt) || Qm(tt) ? tt.replace(xe(), !0) : $s(tt) && tt.setFormat("");
        });
      }
    });
  }, [a]), Rt = ie(
  ...
  return /* @__PURE__ */ p.jsxs("div", { className: "toolbar", children: [
    ...
    /* @__PURE__ */ p.jsx(Jr, {}),
    /* @__PURE__ */ p.jsx(T4, { selectionFontSize: s.slice(0, -2), editor: a, disabled: !oe }),
    /* @__PURE__ */ p.jsx(Jr, {}),
    /* @__PURE__ */ p.jsx(
      "button",
      {
...
function B2() {
  const [r] = se();
  return j(() => {
    if (!r.hasNodes([Ea, Na])) throw new Error("ListPlugin: ListNode and/or ListItemNode not registered on editor");
  }, [r]), function(e) {
    j(() => Am(e), [e]);
  }(r), null;
}
function j2() {
  const [r] = se();
  return j(() => Re(r.registerCommand(ko, () => (Is(r, "check"), !0), ye), r.registerCommand(mn, (e) => Bu(e, r, !1), ye), r.registerCommand(fn, (e) => Bu(e, r, !0), ye), r.registerCommand(Rn, (e) => {
    if (io() != null) {
...
function G2() {
  const [r] = se();
  return j(() => (ju || (W2(), ju = !0), r.registerCommand(
    xc,
    (e) => {
      const t = B();
...
function X2({
  ...
  const s = Me(null), o = Me(null), [l, c] = q(""), [u, d] = q("https://"), [m, g] = q(
    null
  ), v = ie(() => {
    var N, I;
    const _ = B();
    ...
    } else (!T || T.className !== "link-input") && (k !== null && $u(null, w, n), g(null), i(!1), c(""));
    return !0;
  }, [n, r, i, a, l]);
  j(() => {
...
function Ph(r) {
  ...
  return ue(e) && (e = e.getLastDescendant()), e === null || ba(e) || _e(e) && zh(e.getTextContent());
}
function Bh(r) {
...
function a5(r, e, t, n) {
  ...
  if (r.length > 1) {
    ...
    const u = B(), d = u ? u.getNodes().find(_e) : void 0, m = Ir(s.getTextContent());
        ...
        if (a.isSimpleText() && (so(a.getTextContent()) || !vr(s))) {
          ...
          (function(l, c, u) {
            ...
            for (; (g = Lh(v, c)) && g !== null; ) {
              ...
              if (r5(b + x, b + _, m, d)) {
                const [w, , C, T] = n5(d, b + x, b + _), k = a5(C, b + x - w, b + _ - w, g);
                d = k ? [k, ...T] : T, u(g.url, null), b = 0;
              } else b += _;
              v = v.substring(_);
            }
          })(o, e, n);
...
const Uu = "startTransition", x5 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : j;
class k0 {
  constructor(e) {
    this.key = e, this.ref = { current: null }, this.setRefElement = this.setRefElement.bind(this);
  }
...
function _5({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ye }) {
  ...
  return j(() => () => {
    ...
    a === null ? u(null) : c === null && g(0);
  }, [a, c, g]), j(() => Re(e.registerCommand(Gu, ({ option: v }) => !(!v.ref || v.ref.current == null) && (Ku(v.ref.current), !0), l)), [e, g, l]), j(() => Re(e.registerCommand(mn, (v) => {
    const b = v;
    if (a !== null && a.length && c !== null) {
      const x = c !== a.length - 1 ? c + 1 : 0;
      g(x);
...
function N0(r, { minLength: e = 1, maxLength: t = 75 }) {
  return ie((n) => {
...
function E0({ options: r, onQueryChange: e, onSelectOption: t, onOpen: n, onClose: a, menuRenderFn: i, triggerFn: s, anchorClassName: o, commandPriority: l = ye, parent: c }) {
  const [u] = se(), [d, m] = q(null), g = function(x, _, w, C = document.body, T = !0) {
    const [k] = se(), N = Me(document.createElement("div")), I = ie(() => {
      N.current.style.top = N.current.style.bottom;
      const M = k.getRootElement(), F = N.current, z = F.firstChild;
      if (M !== null && x !== null) {
  ...
  return j(() => {
    const x = u.registerUpdateListener(() => {
      u.getEditorState().read(() => {
        const _ = u._window || window, w = _.document.createRange(), C = B(), T = function(I) {
          let D = null;
        ...
        if (e(k ? k.matchingString : null), k !== null && !function(I, D) {
          ...
          return N = () => b({ getRect: () => w.getBoundingClientRect(), match: k }), void (Uu in tn ? tn[Uu](N) : N());
        var N;
        v();
      });
    });
...
function N5(r, e) {
  return [
    ...
    new ot("Poll", {
      ...
      keywords: ["poll", "vote"],
      onSelect: () => e("Insert Poll", (t) => /* @__PURE__ */ p.jsx(Nh, { activeEditor: r, onClose: t }))
    }),
    ...C0.map(
    ...
    new ot("Columns Layout", {
      ...
      onSelect: () => e("Insert Columns Layout", (t) => /* @__PURE__ */ p.jsx(Th, { activeEditor: r, onClose: t }))
    }),
...
function E5() {
  const [r] = se(), [e, t] = Pi(), [n, a] = q(null), i = N0("/", {
    minLength: 0
  }), s = it(() => {
    const l = N5(r, t);
    if (!n)
...
function D5({
  ...
  const v = ie(() => {
    const b = B(), x = u.current, _ = window.getSelection();
    if (x === null)
      return;
...
function R5(r, e) {
  const [t, n] = q(!1), [a, i] = q(!1), [s, o] = q(!1), [l, c] = q(!1), [u, d] = q(!1), [m, g] = q(!1), [v, b] = q(!1), [x, _] = q(!1), [w, C] = q(!1), T = ie(() => {
    r.getEditorState().read(() => {
      if (r.isComposing())
        return;
      ...
      if (!U(k))
        return;
      const D = Dn(k);
      o(k.hasFormat("bold")), c(k.hasFormat("italic")), d(k.hasFormat("underline")), g(k.hasFormat("strikethrough")), b(k.hasFormat("subscript")), _(k.hasFormat("superscript")), C(k.hasFormat("code"));
      const M = D.getParent();
      lt(M) || lt(D) ? i(!0) : i(!1), !wo(k.anchor.getNode()) && k.getTextContent() !== "" ? n(_e(D) || Hr(D)) : n(!1);
  ...
  return j(() => (document.addEventListener("selectionchange", T), () => {
...
function L5({ hasCellMerge: r = !0, hasCellBackgroundColor: e = !0, hasTabHandler: t = !0 }) {
  const [n] = se();
  return j(() => (n.hasNodes([or, sr, Pn]) || ti(10), Re(n.registerCommand(Ro, ({ columns: a, rows: i, includeHeaders: s }) => {
...
function P5({ editor: r }) {
  const e = Me(null), t = Me(null), n = Me(null), a = Me(null), [i, s] = q(null), [o, l] = q(null), [c, u] = q(!1), [d, m] = q(null), g = ie(() => {
    l(null), e.current = null, m(null), a.current = null, n.current = null;
  }, []), v = (D) => (D.buttons & 1) === 1;
  j(() => r.registerNodeTransform(or, (D) => {
    if (D.getColWidths())
      return D;
...
function H5({
  ...
  const [s] = se(), o = Me(null), [l, c] = q(e), [u, d] = q({
    columns: 1,
    rows: 1
  }), [m, g] = q(!1), [v, b] = q(!1), [x, _] = q(
    () => Xu(s) || ""
  );
  j(() => s.registerMutationListener(
    sr,
    (Y) => {
    ...
    if (Y != null && re != null && de != null) {
      ...
      re.style.opacity = "1";
      const le = re.getBoundingClientRect(), Ne = 5;
      let oe = he.right + Ne;
      if (oe + le.width > window.innerWidth || oe + le.width > J.right) {
        const Be = he.left - le.width - Ne;
        oe = (Be < 0 ? Ne : Be) + window.pageXOffset;
      }
    ...
    s.update(() => {
      ...
      if (Oe(Y)) {
        ...
        for (let le = 0; le < J.length; le++) {
          ...
          if (ae(Ne))
            if (he === null) {
              Ne.setColSpan(re).setRowSpan(de), he = Ne;
              const oe = Vu(Ne);
              let Pe;
              oe && Hr(Pe = Ne.getFirstChild()) && Pe.remove();
            } else ae(he) && (Vu(Ne) || he.append(...Ne.getChildren()), Ne.remove());
        }
...
function q5({
  ...
  const [t] = se(), n = Me(null), a = Me(null), [i, s] = q(!1), [o, l] = q(
    null
  ), [c, u] = Pi(), d = ie(() => {
    const g = n.current, v = B(), b = window.getSelection(), x = document.activeElement;
    if (v == null || g == null) {
      l(null);
      return;
    }
...
function l3(r, e, t) {
  const n = e.parentElement, a = Me(null), i = Me(null), s = Me(!1), [o, l] = q(null);
  j(() => {
    function d(g) {
      const v = g.target;
      if (!xs(v)) {
...
const Hh = `\\.,\\+\\*\\?\\$\\@\\|#{}\\(\\)\\^\\-\\[\\]\\\\/!%'"~=<>_:;`, c3 = "\\b[A-Z][^\\s" + Hh + "]", d3 = {
  NAME: c3,
  PUNCTUATION: Hh
}, qh = d3.PUNCTUATION, T0 = ["=\\$a", "=\\$i", "=\\$f"].join("|"), _s = "=$a", h3 = "=$i", m3 = "=$f", Uh = "^(" + T0 + ")\\s|[^" + qh + "\\s]", f3 = "(?:\\.[ |$]| |[" + qh + "]|)", p3 = 75, g3 = new RegExp(
  "((" + T0 + ")((?:" + Uh + f3 + "){0," + p3 + "}))"
), v3 = 50, b3 = new RegExp(
  "((" + T0 + ")((?:" + Uh + "){0," + v3 + "}))"
), y3 = [
...
function w3(r, e, t = "") {
  ...
  return j(() => {
    ...
    if (i !== null) {
      ...
      Ss.set(t + r, null), x3.search(r, e, (s) => {
        Ss.set(t + r, s), a(s);
      });
    }
  }, [r, e, t]), n;
...
function N3({
  ...
  const [n] = se(), [a, i] = q(null), [s, o] = q(), [l, c] = q(), [u, d] = q(!1), [m, g] = q(null), v = mt.useRef(!0), x = w3(a, s === _s ? e : s === m3 ? t : y3, s), _ = N0("/", {
    minLength: 0
  }), w = it(
    () => x.map(
      (k) => {
        const N = Object.keys(k)[0];
        return new C3(s === _s ? "auto" : "after-auto", N, k[N].label, k[N].value, k[N].isMan, k[N].isNumber);
      }
    ),
    [x]
  ), C = ie(
    (k, N, I) => {
      n.update(() => {
        ...
        const M = g0(
          {
            dataMention: s === _s ? "auto" : s == h3 ? "input" : "after-auto",
  ...
  return j(() => {
    ...
    /* @__PURE__ */ p.jsx(
      E0,
      {
        ...
        triggerFn: T,
        options: w,
        menuRenderFn: (k, { selectedIndex: N, selectOptionAndCleanUp: I, setHighlightedIndex: D }) => k.current && x.length ? da.createPortal(
...
const E3 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Br : j;
function T3({ ignoreHistoryMergeTagChange: r = !0, ignoreSelectionChange: e = !1, onChange: t }) {
  const [n] = se();
  return E3(() => {
...
function e6(r, e, t) {
  ...
  function g(N) {
    var I = n, D = a;
    return n = a = void 0, c = N, s = r.apply(D, I), s;
  }
  function v(N) {
    return c = N, o = setTimeout(_, e), u ? g(N) : s;
  }
  function b(N) {
    var I = N - l, D = N - c, M = e - I;
    return d ? Q3(M, i - D) : M;
  }
  function x(N) {
    var I = N - l, D = N - c;
...
function r6({
  ...
  const [e] = se(), t = La(), [n, a] = q(!1), [i, s] = q(!1), [o, l] = q(!1), [c, u] = q({}), d = Me(/* @__PURE__ */ new Set()), m = Me(null), g = t6(
    (x) => {
      const { isOutside: _, tableDOMNode: w } = n6(x);
      if (_) {
        a(!1), s(!1);
        return;
      }
      ...
      if (e.update(() => {
        ...
        if (ae(N)) {
          ...
          if (k = e.getElementByKey(D == null ? void 0 : D.getKey()), k) {
            const M = D.getChildrenSize(), F = (I = D.getChildAtIndex(0)) == null ? void 0 : I.getChildrenSize(), z = Io(N), $ = rd(N);
            z === M - 1 ? C = N : $ === F - 1 && (T = N);
          }
        }
      }), k) {
...
function l6({ children: r }) {
  ...
  return j(() => {
    ...
    n.getEditorState().read(() => {
      const l = (c) => {
        for (const u of c.getChildren()) En(u) ? a.push([u.getKey(), u.getTextContent(), u.getTag()]) : ue(u) && l(u);
      };
      l(wt()), t(a);
    });
    const i = n.registerUpdateListener(({ editorState: l, dirtyElements: c }) => {
      l.read(() => {
        const u = (d) => {
          for (const m of d.getChildren()) if (En(m)) {
            const g = ks(m);
            a = ic(g, m, a), t(a);
          } else ue(m) && u(m);
        };
...
function d6({
  ...
  const [e, t] = q(""), n = Me(0), [a] = se();
  function i(s, o) {
    a.getEditorState().read(() => {
      const l = a.getElementByKey(s);
      l !== null && (l.scrollIntoView(), t(s), n.current = o);
    });
  }
  return j(() => {
    function s() {
      if (r.length !== 0 && n.current < r.length - 1) {
        let u = a.getElementByKey(
          r[n.current][0]
        );
        if (u !== null) {
          if (Ns(u)) {
            for (; u !== null && Ns(u) && n.current > 0; ) {
              const m = a.getElementByKey(
                r[n.current - 1][0]
              );
              m !== null && (ri(m) || Ns(m)) && n.current--, u = m;
            }
            const d = r[n.current][0];
            t(d);
          } else if (ri(u)) {
            for (; u !== null && ri(u) && n.current < r.length - 1; ) {
              const m = a.getElementByKey(
                r[n.current + 1][0]
              );
              m !== null && (c6(m) || ri(m)) && n.current++, u = m;
            }
            const d = r[n.current][0];
            t(d);
          }
    ...
    let o;
    function l(u, d) {
      clearTimeout(o), o = setTimeout(u, d);
    }
    function c() {
      l(s, 10);
    }
    return document.addEventListener("scroll", c), () => document.removeEventListener("scroll", c);
  }, [r, a]), /* @__PURE__ */ p.jsx("div", { className: "table-of-contents", children: /* @__PURE__ */ p.jsx("ul", { className: "headings", children: r.map(([s, o, l], c) => c === 0 ? /* @__PURE__ */ p.jsxs("div", { className: "normal-heading-wrapper", children: [
    /* @__PURE__ */ p.jsx(
      "div",
      {
        ...
        role: "button",
        tabIndex: 0,
        children: ("" + o).length > 20 ? o.substring(0, 20) + "..." : o
      }
    ),
    /* @__PURE__ */ p.jsx("br", {})
  ] }, s) : /* @__PURE__ */ p.jsx(
    "div",
    {
      className: `normal-heading-wrapper ${e === s ? "selected-heading-wrapper" : ""}`,
      children: /* @__PURE__ */ p.jsx(
        "div",
        {
          onClick: () => i(s, c),
          ...
          children: /* @__PURE__ */ p.jsx(
            "li",
            {
              className: `normal-heading ${e === s ? "selected-heading" : ""}
                    `,
              children: ("" + o).length > 27 ? o.substring(0, 27) + "..." : o
            }
          )
        }
      )
...
function m6(r) {
  ...
  return j(() => {
    ...
    /* @__PURE__ */ p.jsxs("div", { className: "editor-container", children: [
      ...
      /* @__PURE__ */ p.jsx(V5, {}),
      /* @__PURE__ */ p.jsx(R2, {}),
      /* @__PURE__ */ p.jsx(N3, { step: e, autoData: t, afterAutoData: n }),
      /* @__PURE__ */ p.jsx(y5, {}),
      /* @__PURE__ */ p.jsx(p5, {}),
      /* @__PURE__ */ p.jsx(T3, { ignoreSelectionChange: !0, onChange: a }),
