...
const yf = mt.lazy(() => import("./ImageComponent-RBDGduz8.js"));
function xf(r) {
  const e = r;
...
const Ng = mt.lazy(() => import("./EquationComponent-DOyT5ILV.js"));
function du(r) {
...
const Ag = mt.lazy(() => import("./ExcalidrawComponent-B8kC0FqR.js"));
function Mg(r) {
...
const Og = mt.lazy(() => import("./PollComponent-VB6QpWIg.js"));
function Dg() {
...
const Ig = mt.lazy(() => import("./InlineImageComponent-CYT0QMES.js"));
function Fg(r) {
...
const zg = mt.lazy(() => import("./StickyComponent-CmCnVxcL.js"));
class On extends ur {
...
const _4 = tn.lazy(() => import("./DataMentionComponent-VZybCTOg.js"));
function C4(r) {
...
function E3({
  ...
  }, [t, e, n, r]), /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    /* @__PURE__ */ p.jsx(
      T0,
      {
        onQueryChange: i,
...
function d6({
  ...
  return B(() => {
    ...
    function b(x) {
      ...
      S.scrollTop !== w && (o.current.set(S, S.scrollTop), v(m, 50)(x));
    }
