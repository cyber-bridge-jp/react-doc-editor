...
function I1() {
  return U0 || (U0 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(O) {
      {
        for (var W = arguments.length, Q = new Array(W > 1 ? W - 1 : 0), be = 1; be < W; be++)
          Q[be - 1] = arguments[be];
        C("error", O, Q);
      }
    }
    function C(O, W, Q) {
      {
        var be = _.ReactDebugCurrentFrame, Ie = be.getStackAddendum();
    ...
    var k = !1, N = !1, A = !1, I = !1, D = !1, M;
    M = Symbol.for("react.module.reference");
    function F(O) {
      return !!(typeof O == "string" || typeof O == "function" || O === n || O === i || D || O === a || O === u || O === c || I || O === g || k || N || A || typeof O == "object" && O !== null && (O.$$typeof === m || O.$$typeof === d || O.$$typeof === s || O.$$typeof === o || O.$$typeof === l || // This needs to include all possible module reference object
      ...
      if (typeof O == "object")
        switch (O.$$typeof) {
          ...
          case d:
            ...
            return be !== null ? be : P(O.type) || "Memo";
          case m: {
...
` + Je + O;
    ...
    function te(O, W) {
      ...
      var Le;
      Le = dt.current, dt.current = null, Pe();
      try {
        if (W) {
          var Te = function() {
            throw Error();
        ...
        if (Et && be && typeof Et.stack == "string") {
...
` + Ee[rt].replace(" at new ", " at ");
        ...
        Rt = !1, dt.current = Le, Be(), Error.prepareStackTrace = Ie;
      }
      var yn = O ? O.displayName || O.name : "", Wr = yn ? Ge(yn) : "";
      return typeof O == "function" && wt.set(O, Wr), Wr;
    }
    function we(O, W, Q) {
      return te(O, !1);
    }
    ...
    function _t(O, W, Q) {
      ...
      if (typeof O == "object")
        switch (O.$$typeof) {
          ...
          case m: {
            var be = O, Ie = be._payload, Le = be._init;
            try {
              return _t(Le(Ie), W, Q);
            } catch {
            }
    ...
    var tt = Object.prototype.hasOwnProperty, ht = {}, je = _.ReactDebugCurrentFrame;
    function It(O) {
      if (O) {
          ...
          if (Le(O, Te)) {
            ...
            try {
              if (typeof O[Te] != "function") {
                var St = Error((be || "React class") + ": " + Q + " type `" + Te + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof O[Te] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw St.name = "Invariant Violation", St;
              }
              Ee = O[Te](W, Te, be, Q, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (rt) {
              Ee = rt;
            }
            Ee && !(Ee instanceof Error) && (It(Ie), w("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", be || "React class", Q, Te, typeof Ee), It(null)), Ee instanceof Error && !(Ee.message in ht) && (ht[Ee.message] = !0, It(Ie), w("Failed %s type: %s", Q, Ee.message), It(null));
          }
      }
    }
    ...
    var Gh = function(O, W, Q, be, Ie, Le, Te) {
      var Ee = {
    ...
    function Yh(O, W, Q, be, Ie) {
      {
        ...
        return Gh(O, Ee, St, Ie, be, Kn.current, Te);
      }
    }
    ...
    function O0(O, W) {
      {
        ...
        M0[Q] = !0;
        var be = "";
        O && O._owner && O._owner !== Pi.current && (be = " It was passed a child from " + P(O._owner.type) + "."), bn(O), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', Q, be), bn(null);
      }
    }
    function D0(O, W) {
      {
    ...
    function Zh(O) {
      {
        for (var W = Object.keys(O.props), Q = 0; Q < W.length; Q++) {
          ...
          if (be !== "children" && be !== "key") {
            bn(O), w("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", be), bn(null);
            break;
          }
        }
    ...
    function I0(O, W, Q, be, Ie, Le) {
      {
        ...
        if (tt.call(W, "key")) {
          var Wr = P(O), Et = Object.keys(W).filter(function(a1) {
            return a1 !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, $i, Wr, n1, Wr), R0[Wr + $i] = !0;
          }
        }
...
process.env.NODE_ENV === "production" ? Cs.exports = R1() : Cs.exports = I1();
var p = Cs.exports;
function F1(r) {
  return r && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
}
var L1 = F1(function(r) {
...
function oe() {
  const r = Zu(pc);
  return r == null && L1(8), r;
}
const gc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, P1 = gc ? jr : $, za = { tag: "history-merge" };
function B1({ initialConfig: r, children: e }) {
  const t = it(() => {
    const { theme: n, namespace: a, nodes: i, onError: s, editorState: o, html: l } = r, u = z1(null, n), c = pa({ editable: r.editable, html: l, namespace: a, nodes: i, onError: (d) => s(d, c), theme: n });
    return function(d, m) {
      if (m !== null) {
...
function xn(r, e) {
  const t = ho("getStyle" in r ? r.getStyle() : r.style), n = Object.entries(e).reduce((i, [s, o]) => (typeof o == "function" ? i[s] = o(t[s], r) : o === null ? delete i[s] : i[s] = o, i), { ...t }), a = q1(n);
  ...
  if (t.length === 1) {
    if (_e(l) && l.canHaveFormat()) {
      ...
      if (qi(l) || v === 0 && y === c) xn(l, e), l.select(v, y);
        ...
        const C = l.splitText(v, y), k = v === 0 ? C[0] : C[1];
        xn(k, e), k.select(0, y - v);
      }
    }
  } else {
    ...
    for (let C = 1; C < o; C++) {
      const k = t[C], N = k.getKey();
      _e(k) && k.canHaveFormat() && N !== l.getKey() && N !== u.getKey() && !k.isToken() && xn(k, e);
    }
  }
}
function Qr(r, e) {
...
var G1 = K1(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
const fo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Y1 = fo && "documentMode" in document ? document.documentMode : null, V1 = fo && /^(?!.*Seamonkey)(?=.*Firefox).*/i.test(navigator.userAgent);
!(!fo || !("InputEvent" in window) || Y1) && "getTargetRanges" in new window.InputEvent("input");
function wc(...r) {
  const e = [];
  ...
  var t = function(n) {
    var a = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, i = 0, s = {}, o = {
      ...
      util: {
         ...
         * @template T
         */
        clone: function w(C, k) {
          k = k || {};
          var N, A;
          switch (o.util.type(C)) {
            case "Object":
              if (A = o.util.objId(C), k[A])
                return k[A];
              N = /** @type {Record<string, any>} */
              {}, k[A] = N;
              for (var I in C)
                C.hasOwnProperty(I) && (N[I] = w(C[I], k));
              return (
                /** @type {any} */
                N
              );
            case "Array":
              return A = o.util.objId(C), k[A] ? k[A] : (N = [], k[A] = N, /** @type {Array} */
              /** @type {any} */
      ...
      languages: {
         ...
         */
        extend: function(w, C) {
          var k = o.util.clone(o.languages[w]);
          for (var N in C)
            k[N] = C[N];
          return k;
        },
        ...
        insertBefore: function(w, C, k, N) {
          ...
          for (var D in A)
            if (A.hasOwnProperty(D)) {
              if (D == C)
                for (var M in k)
                  k.hasOwnProperty(M) && (I[M] = k[M]);
              k.hasOwnProperty(D) || (I[D] = A[D]);
            }
          var F = N[w];
          return N[w] = I, o.languages.DFS(o.languages, function(z, j) {
            j === F && z != w && (this[z] = I);
          }), I;
        },
        // Traverse a language definition with Depth First Search
        DFS: function w(C, k, N, A) {
          A = A || {};
          var I = o.util.objId;
          for (var D in C)
            if (C.hasOwnProperty(D)) {
              ...
              F === "Object" && !A[I(M)] ? (A[I(M)] = !0, w(M, k, null, A)) : F === "Array" && !A[I(M)] && (A[I(M)] = !0, w(M, k, D, A));
            }
        }
      },
      plugins: {},
       ...
       * @public
       */
      highlightAllUnder: function(w, C, k) {
        var N = {
          callback: k,
          container: w,
        ...
        for (var A = 0, I; I = N.elements[A++]; )
          o.highlightElement(I, C === !0, N.callback);
      },
      /**
       ...
       * @public
       */
      highlightElement: function(w, C, k) {
        var N = o.util.getLanguage(w), A = o.languages[N];
        o.util.setLanguage(w, N);
        var I = w.parentElement;
        I && I.nodeName.toLowerCase() === "pre" && o.util.setLanguage(I, N);
        ...
        function F(j) {
          M.highlightedCode = j, o.hooks.run("before-insert", M), M.element.innerHTML = M.highlightedCode, o.hooks.run("after-highlight", M), o.hooks.run("complete", M), k && k.call(M.element);
        }
        if (o.hooks.run("before-sanity-check", M), I = M.element.parentElement, I && I.nodeName.toLowerCase() === "pre" && !I.hasAttribute("tabindex") && I.setAttribute("tabindex", "0"), !M.code) {
          o.hooks.run("complete", M), k && k.call(M.element);
          return;
        }
       ...
       */
      highlight: function(w, C, k) {
        var N = {
          code: w,
          grammar: C,
          language: k
        };
        if (o.hooks.run("before-tokenize", N), !N.grammar)
          throw new Error('The language "' + N.language + '" has no grammar.');
        return N.tokens = o.tokenize(N.code, N.grammar), o.hooks.run("after-tokenize", N), l.stringify(o.util.encode(N.tokens), N.language);
      },
      /**
    ...
    n.Prism = o;
    function l(w, C, k, N) {
      this.type = w, this.content = C, this.alias = k, this.length = (N || "").length | 0;
    }
    l.stringify = function w(C, k) {
      if (typeof C == "string")
        return C;
      if (Array.isArray(C)) {
        var N = "";
      ...
      var A = {
        type: C.type,
        content: w(C.content, k),
        tag: "span",
        classes: ["token", C.type],
        attributes: {},
        language: k
      }, I = C.alias;
      I && (Array.isArray(I) ? Array.prototype.push.apply(A.classes, I) : A.classes.push(I)), o.hooks.run("wrap", A);
      var D = "";
      for (var M in A.attributes)
        D += " " + M + '="' + (A.attributes[M] || "").replace(/"/g, "&quot;") + '"';
      return "<" + A.tag + ' class="' + A.classes.join(" ") + '"' + D + ">" + A.content + "</" + A.tag + ">";
    };
    function u(w, C, k, N) {
      w.lastIndex = C;
      var A = w.exec(k);
    ...
    function c(w, C, k, N, A, I) {
      for (var D in k)
        if (!(!k.hasOwnProperty(D) || !k[D])) {
          var M = k[D];
          ...
          for (var F = 0; F < M.length; ++F) {
            ...
            for (var ce = z.pattern || z, J = N.next, de = A; J !== C.tail && !(I && de >= I.reach); de += J.value.length, J = J.next) {
              var le = J.value;
              ...
              if (!(le instanceof l)) {
                ...
                if (X) {
                  if (se = u(ce, de, w, P), !se || se.index >= w.length)
                    break;
                  var dt = se.index, Ue = se.index + se[0].length, Pe = de;
                  for (Pe += J.value.length; dt >= Pe; )
                    J = J.next, Pe += J.value.length;
                  if (Pe -= J.value.length, de = Pe, J.value instanceof l)
                    continue;
                  for (var Be = J; Be !== C.tail && (Pe < Ue || typeof Be.value == "string"); Be = Be.next)
                    Ne++, Pe += Be.value.length;
                  Ne--, le = w.slice(de, Pe), se.index -= de;
                ...
                if (J = m(C, Qt, te), Rt && m(C, J, Rt), Ne > 1) {
                  ...
                  c(w, C, k, J.prev, de, we), I && we.reach > I.reach && (I.reach = we.reach);
                }
              }
            }
          }
    ...
    function m(w, C, k) {
      var N = C.next, A = { value: k, prev: C, next: N };
      return C.next = A, N.prev = A, w.length++, A;
    }
    function g(w, C, k) {
      for (var N = C.next, A = 0; A < k && N !== w.tail; A++)
        N = N.next;
      C.next = N, N.prev = C, w.length -= A;
    }
    function v(w) {
      for (var C = [], k = w.head.next; k !== w.tail; )
        C.push(k.value), k = k.next;
      return C;
    }
    if (!n.document)
      return n.addEventListener && (o.disableWorkerMessageHandler || n.addEventListener("message", function(w) {
        var C = JSON.parse(w.data), k = C.language, N = C.code, A = C.immediateClose;
        n.postMessage(o.highlight(N, o.languages[k], k)), A && n.close();
      }, !1)), o;
        ...
        N && N.loadLanguages(C), m(
          ...
          function(A) {
            ...
            if (I) {
              ...
              M < 0 && (M += D.length), M = Math.max(0, Math.min(M - 1, D.length)), F < 0 && (F += D.length), F = Math.max(0, Math.min(F, D.length)), A = D.slice(M, F).join(`
`), x.hasAttribute("data-start") || x.setAttribute("data-start", String(M + 1));
            }
            _.textContent = A, t.highlightElement(_);
          },
          function(A) {
            x.setAttribute(o, c), _.textContent = A;
          }
        );
      }
...
const rm = globalThis.Prism || window.Prism, V0 = (r) => {
  try {
    return !!r && rm.languages.hasOwnProperty(r);
  } catch {
    return !1;
  }
};
...
let po = class kc extends xt {
  ...
  static importDOM() {
    return { code: (e) => e.textContent != null && (/\r?\n/.test(e.textContent) || Cc(e, "BR")) ? { conversion: X0, priority: 1 } : null, div: () => ({ conversion: am, priority: 1 }), pre: () => ({ conversion: X0, priority: 0 }), table: (e) => Hi(e) ? { conversion: im, priority: 3 } : null, td: (e) => {
...
function X0(r) {
  return { node: rn(r.getAttribute(ea)) };
}
function am(r) {
  const e = r, t = Z0(e);
  return t || function(n) {
...
const lm = /* @__PURE__ */ new Set(["http:", "https:", "mailto:", "sms:", "tel:"]);
let In = class Oc extends xt {
  ...
  static importDOM() {
    return { a: (e) => ({ conversion: um, priority: 1 }) };
  }
  static importJSON(e) {
  ...
  sanitizeUrl(e) {
    try {
      const t = new URL(e);
      if (!lm.has(t.protocol)) return "about:blank";
    } catch {
      return e;
    }
    return e;
      ...
      if (U(t)) {
        ...
        if (Ic(o, n)) {
          ...
          if (zt(l)) {
            ...
            nn(u, c.getChildren()), c.replace(u);
          }
          return;
        }
      }
          ...
          if (tc(s)) {
            ...
            for (; o != null; ) {
              ...
              if (ke(o)) {
                if (!a.has(l)) {
                  const u = Mt(e);
                  nn(u, o.getChildren()), o.replace(u), a.add(l);
                }
                break;
              }
              {
  ...
  r.update(() => {
    ...
    if (U(e)) {
      ...
      for (const i of t) {
        ...
        for (const l of o) {
          const u = xe();
          nn(u, l.getChildren()), s.insertAfter(u), s = u, l.__key === e.anchor.key && e.anchor.set(u.getKey(), 0, "element"), l.__key === e.focus.key && e.focus.set(u.getKey(), 0, "element"), l.remove();
        }
        i.remove();
      }
    }
...
function mm(r) {
  ...
  if (ke(t ? t.getParent() : void 0) && Fe(t) && ke(e)) {
    ...
    if (r.is(n)) t.insertBefore(r), e.isEmpty() && t.remove();
      ...
      const l = Pt(), u = Mt(i);
      l.append(u), nn(u, r.getNextSiblings()), t.insertBefore(s), t.insertAfter(l), t.replace(r);
    }
  }
}
function fm() {
...
let Ca = class Fc extends xt {
  ...
  static importDOM() {
    return { li: () => ({ conversion: pm, priority: 0 }) };
  }
  static importJSON(e) {
    const t = Pt();
  ...
  setIndent(e) {
    ...
    for (; t !== e; ) t < e ? (hm(this), t++) : (mm(this), t--);
    return this;
  }
  canInsertAfter(e) {
    return Fe(e);
...
function pm(r) {
  if (r.classList.contains("task-list-item")) {
    for (const t of r.children) if (t.tagName === "INPUT") return gm(t);
  }
...
function al(r) {
  ...
  return e === "ol" ? t = Mt("number", r.start) : e === "ul" && (t = function(n) {
    ...
    return !1;
  }(r) ? Mt("check") : Mt("bullet")), { after: vm, node: t };
}
...
const bo = He("INSERT_UNORDERED_LIST_COMMAND"), yo = He("INSERT_ORDERED_LIST_COMMAND"), xo = He("INSERT_CHECK_LIST_COMMAND"), bm = He("REMOVE_LIST_COMMAND");
function ym(r) {
  return Re(r.registerCommand(yo, () => (As(r, "number"), !0), ve), r.registerCommand(bo, () => (As(r, "bullet"), !0), ve), r.registerCommand(bm, () => (dm(r), !0), ve), r.registerCommand(la, () => !!fm(), ve));
}
...
let _o = class Pc extends xt {
  ...
  static transform() {
    return (e) => {
      Sm(e) || wm(204), e.isEmpty() && e.remove();
    };
  }
};
function _m() {
...
const Co = He("INSERT_HORIZONTAL_RULE_COMMAND");
function Cm({ nodeKey: r }) {
  ...
  }, ve), e.registerCommand(ba, i, ve), e.registerCommand(va, i, ve)), [a, e, t, r, i, n]), $(() => {
    const s = e.getElementByKey(r), o = "selected";
    s !== null && (t ? et(s, o) : pn(s, o));
  }, [e, t, r]), null;
}
let ko = class Bc extends cr {
  static getType() {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: km, priority: 0 }) };
  }
  exportJSON() {
...
`;
  ...
  decorate() {
    return p.jsx(Cm, { nodeKey: this.__key });
  }
};
function km() {
  return { node: No() };
...
function Hc(r, e, t, n, a = /* @__PURE__ */ new Map(), i) {
  ...
  const l = function(v, y) {
    ...
    if (_ !== void 0) for (const C of _) {
      const k = C(v);
      k !== null && (w === null || (w.priority || 0) < (k.priority || 0)) && (w = k);
    }
  ...
  return c != null && (m = c(m)), L0(r) && (m = Tm(r, m, g ? () => {
    const v = new nc();
    return t.push(v), v;
...
var ci = Am(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
const Mm = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Uc = (r) => Mm ? (r || window).getSelection() : null;
function Om(r, e = B()) {
  return e == null && ci(166), U(e) && e.isCollapsed() || e.getNodes().length === 0 ? "" : jc(r, e);
}
function Dm(r, e = B()) {
  return e == null && ci(166), U(e) && e.isCollapsed() || e.getNodes().length === 0 ? null : JSON.stringify(Rm(r, e));
}
function r6(r, e) {
...
function cl(r, e, t) {
  ...
  return n !== null && (Lm(n, t), !0);
}
const Fm = [["text/html", Om], ["application/x-lexical-editor", Dm]];
function Kc(r = B()) {
...
const Fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zm = Fn && "documentMode" in document ? document.documentMode : null, Pm = !(!Fn || !("InputEvent" in window) || zm) && "getTargetRanges" in new window.InputEvent("input"), Bm = Fn && /Version\/[\d.]+.*Safari/.test(navigator.userAgent), jm = Fn && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, $m = Fn && /^(?=.*Chrome).*/i.test(navigator.userAgent), qm = Fn && /AppleWebKit\/[\d.]+/.test(navigator.userAgent) && !$m, Os = He("DRAG_DROP_PASTE_FILE");
class Na extends xt {
  static getType() {
    return "quote";
  }
  ...
  static importDOM() {
    return { blockquote: (e) => ({ conversion: Um, priority: 0 }) };
  }
  exportDOM(e) {
...
class Ea extends xt {
  ...
  static importDOM() {
    ...
    }, span: (e) => hl(e) ? { conversion: (t) => ({ node: en("h1") }), priority: 3 } : null };
  }
  exportDOM(e) {
    const { element: t } = super.exportDOM(e);
    if (t && Cr(t)) {
...
function _n(r) {
  const e = r.nodeName.toLowerCase();
  let t = null;
  return e !== "h1" && e !== "h2" && e !== "h3" && e !== "h4" && e !== "h5" && e !== "h6" || (t = en(e), r.style !== null && (dc(r, t), t.setFormat(r.style.textAlign))), { node: t };
}
function Um(r) {
  const e = ki();
...
function Wm(r) {
  return Re(r.registerCommand(ya, (e) => {
  ...
  }, ye), r.registerCommand(cc, (e) => {
    const t = B();
    return !!U(t) && (t.deleteWord(e), !0);
  }, ye), r.registerCommand(Ss, (e) => {
    const t = B();
    return !!U(t) && (t.deleteLine(e), !0);
  }, ye), r.registerCommand(uc, (e) => {
    const t = B();
    ...
    return !0;
  }, ye), r.registerCommand(P0, (e) => {
    const t = B();
    return !!U(t) && (t.insertLineBreak(e), !0);
  }, ye), r.registerCommand(la, () => {
    const e = B();
    return !!U(e) && (e.insertParagraph(), !0);
  }, ye), r.registerCommand(lc, () => (Rn([oo()]), !0), ye), r.registerCommand(_i, () => fl((e) => {
    const t = e.getIndent();
    e.setIndent(t + 1);
  }), ye), r.registerCommand(oi, () => fl((e) => {
    const t = e.getIndent();
    t > 0 && e.setIndent(t - 1);
  }), ye), r.registerCommand(fn, (e) => {
    const t = B();
    if (gt(t) && !ja(e.target)) {
      const n = t.getNodes();
  ...
  }, ye), r.registerCommand(ba, (e) => {
    if (ja(e.target)) return !1;
    const t = B();
    return !!U(t) && (e.preventDefault(), r.dispatchCommand(na, !1));
  }, ye), r.registerCommand(co, (e) => {
    const t = B();
    if (!U(t)) return !1;
    if (e !== null) {
      if ((jm || Bm || qm) && Pm) return !1;
    ...
    const n = B();
    return !!U(n);
  }, ye), r.registerCommand(lo, (e) => {
    const [t] = kn(e), n = B();
    return !(t && !U(n));
  }, ye), r.registerCommand(yi, (e) => {
    const [t] = kn(e), n = B();
    if (t && !U(n)) return !1;
    const a = dl(e.clientX, e.clientY);
    if (a !== null) {
    ...
    return !0;
  }, ye), r.registerCommand(p1, () => (g1(), !0), ye), r.registerCommand(ic, (e) => (Ms(r, xr(e, ClipboardEvent) ? e : null), !0), ye), r.registerCommand(oc, (e) => (async function(t, n) {
    await Ms(n, xr(t, ClipboardEvent) ? t : null), n.update(() => {
      const a = B();
      U(a) ? a.removeText() : gt(a) && a.getNodes().forEach((i) => i.remove());
    });
  }(e, r), !0), ye), r.registerCommand(sc, (e) => {
    const [, t, n] = kn(e);
...
const Eo = /^(\d+(?:\.\d+)?)px$/, $e = { BOTH: 3, COLUMN: 2, NO_STATUS: 0, ROW: 1 };
class or extends xt {
  static getType() {
    return "tablecell";
  }
  static clone(e) {
    return new or(e.__headerState, e.__colSpan, e.__width, e.__key);
  }
  afterCloneFrom(e) {
  ...
  constructor(e = $e.NO_STATUS, t = 1, n, a) {
  ...
  hasHeader() {
    return this.getLatest().__headerState !== $e.NO_STATUS;
  }
  updateDOM(e) {
...
function pl(r) {
  ...
  const a = Jt(t === "th" ? $e.ROW : $e.NO_STATUS, e.colSpan, n);
...
function Jt(r, e = 1, t) {
  return ut(new or(r, e, t));
}
function ae(r) {
  return r instanceof or;
}
const To = He("INSERT_TABLE_COMMAND");
function Km(r) {
  return r && r.__esModule && Object.prototype.hasOwnProperty.call(r, "default") ? r.default : r;
}
var Ce = Km(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
const Gm = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0;
class Ln extends xt {
  static getType() {
    return "tablerow";
  }
  ...
  static importDOM() {
    return { tr: (e) => ({ conversion: Ym, priority: 0 }) };
  }
  static importJSON(e) {
    return da(e.height);
  }
...
function Vm(r, e, t = !0) {
  ...
  for (let a = 0; a < r; a++) {
    ...
    for (let s = 0; s < e; s++) {
      let o = $e.NO_STATUS;
      typeof t == "object" ? (a === 0 && t.rows && (o |= $e.ROW), s === 0 && t.columns && (o |= $e.COLUMN)) : t && (a === 0 && (o |= $e.ROW), s === 0 && (o |= $e.COLUMN));
      const l = Jt(o), u = xe();
      u.append(Fr()), l.append(u), i.append(l);
    }
    n.append(i);
  }
  return n;
...
function Ao(r) {
  const e = Gc(r);
  return yr(e).getChildren().findIndex((t) => t.is(e));
}
function Yc(r) {
  return Gc(r).getChildren().findIndex((e) => e.is(r));
}
const Ds = (r, e) => r === $e.BOTH || r === e ? e : $e.NO_STATUS;
function Vc(r = !0) {
  const e = B();
  U(e) || Me(e) || Ce(188);
  ...
  if (r) {
    ...
    for (let v = 0; v < o; v++) {
      ...
      if (x + y.__rowSpan - 1 <= c) {
        const _ = d[v].cell.__headerState, w = Ds(_, $e.COLUMN);
    ...
    for (let g = 0; g < o; g++) {
      ...
      if (y === l) {
        const x = c[g].cell.__headerState, _ = Ds(x, $e.COLUMN);
...
function Xc(r = !0) {
  ...
  e: for (let w = 0; w < c; w++) {
    ...
    const C = o[w], k = C[m < 0 ? 0 : m].cell.__headerState, N = Ds(k, $e.ROW);
    if (m < 0) {
      Mo(x, y(N));
      continue;
    }
    const { cell: A, startColumn: I, startRow: D } = C[m];
    if (I + A.__colSpan - 1 <= m) {
      let M = A, F = D, z = m;
      for (; F !== w && M.__rowSpan > 1; ) {
        if (z -= A.__colSpan, !(z >= 0)) {
          x.append(y(N));
          continue e;
        }
        {
  ...
  if (_) {
    const w = [..._], C = m < 0 ? 0 : m, k = w[C];
    w.splice(C, 0, k), s.setColWidths(w);
  }
  return v;
}
function Jm() {
  ...
  for (let y = d; y >= u; y--) {
    for (let _ = m - 1; _ >= 0; _--) {
      const { cell: w, startRow: C, startColumn: k } = s[y][_];
      if (k === _ && (y === u && C < u && w.setRowSpan(w.__rowSpan - (C - u)), C >= u && C + w.__rowSpan - 1 > d)) if (w.setRowSpan(w.__rowSpan - (d - C + 1)), v === null && Ce(122), _ === 0) Mo(v, w);
      else {
        const { cell: N } = g[_ - 1];
        N.insertAfter(w);
      }
...
function Zm() {
  ...
  const y = s.length;
  for (let C = 0; C < y; C++) for (let k = m; k <= g; k++) {
    const { cell: N, startColumn: A } = s[C][k];
    if (A < m) {
      if (k === m) {
        const I = m - A;
        N.setColSpan(N.__colSpan - Math.min(v, N.__colSpan - I));
      }
    } else if (A + N.__colSpan - 1 > g) {
      if (k === g) {
        const I = g - A + 1;
        N.setColSpan(N.__colSpan - I);
      }
    } else N.remove();
  }
  ...
  if (_ !== void 0) {
    ...
    const C = d < u ? x[d - 1] : x[u - 1], { cell: k } = C;
    ha(k);
  }
...
function Qm() {
  ...
  if (i === 1 && s === 1) return;
  const [o, l] = Wt(a, t, t), { startColumn: u, startRow: c } = l, d = t.__headerState & $e.COLUMN, m = Array.from({ length: i }, (y, x) => {
    let _ = d;
    for (let w = 0; _ !== 0 && w < o.length; w++) _ &= o[w][x + u].cell.__headerState;
    return _;
  }), g = t.__headerState & $e.ROW, v = Array.from({ length: s }, (y, x) => {
    let _ = g;
  ...
  if (s > 1) {
    ...
    for (let x = 1; x < s; x++) {
      ...
      let C = null;
      for (let k = 0; k < u; k++) {
        const N = w[k], A = N.cell;
        N.startRow === _ && (C = A), A.__colSpan > 1 && (k += A.__colSpan - 1);
      }
      if (C === null) for (let k = i - 1; k >= 0; k--) Mo(y, Jt(m[k] | v[x]).append(xe()));
      else for (let k = i - 1; k >= 0; k--) C.insertAfter(Jt(m[k] | v[x]).append(xe()));
    }
    t.setRowSpan(1);
  }
}
...
class Ni {
  ...
  getNodes() {
    ...
    for (; m < x || g < _ || v > w || y > C; ) {
      if (m < x) {
        const D = C - _, M = x - 1;
        for (let F = 0; F <= D; F++) k(u[_ + F][M]);
        x = M;
      }
      if (g < _) {
        const D = w - x, M = _ - 1;
        for (let F = 0; F <= D; F++) k(u[M][x + F]);
        _ = M;
      }
      if (v > w) {
        const D = C - _, M = w + 1;
    ...
    const N = /* @__PURE__ */ new Map([[o.getKey(), o]]);
    let A = null;
    for (let D = g; D <= y; D++) for (let M = m; M <= v; M++) {
      const { cell: F } = u[D][M], z = F.getParent();
      nt(z) || Ce(160), z !== A && N.set(z.getKey(), z), N.set(F.getKey(), F);
      for (const j of ef(F)) N.set(j.getKey(), j);
      A = z;
    }
...
class tf {
  ...
  clearHighlight() {
    ...
    this.isHighlightingCells = !1, this.anchorX = -1, this.anchorY = -1, this.focusX = -1, this.focusY = -1, this.tableSelection = null, this.anchorCellNodeKey = null, this.focusCellNodeKey = null, this.anchorCell = null, this.focusCell = null, this.hasHijackedSelectionStyles = !1, this.enableHighlightStyle(), e.update(() => {
      ...
      if (!t) throw new Error("Expected to find TableElement in DOM");
      const n = aa(t);
      $a(e, n, null), yt(null), e.dispatchCommand(ar, void 0);
    });
  }
    ...
    n.update(() => {
      ...
      if (this.focusX = i, this.focusY = s, this.isHighlightingCells) {
        ...
        if (this.tableSelection != null && this.anchorCellNodeKey != null && ae(o) && a.is(Nn(o))) {
          const l = o.getKey();
          this.tableSelection = this.tableSelection.clone() || vl(), this.focusCellNodeKey = l, this.tableSelection.set(this.tableNodeKey, this.anchorCellNodeKey, this.focusCellNodeKey), yt(this.tableSelection), n.dispatchCommand(ar, void 0), $a(n, this.table, this.tableSelection);
        }
      }
    });
  }
  ...
  formatCells(e) {
    this.editor.update(() => {
      const t = B();
      Me(t) || Ce(11);
      const n = xa(), a = n.anchor, i = n.focus, s = t.getNodes().filter(ae), o = s[0].getFirstChild(), l = qr(o) ? o.getFormatFlags(e, null) : null;
      s.forEach((u) => {
        a.set(u.getKey(), 0, "element"), i.set(u.getKey(), u.getChildrenSize(), "element"), n.formatText(e, l);
      }), yt(t), this.editor.dispatchCommand(ar, void 0);
    });
  }
  clearText() {
    const e = this.editor;
    e.update(() => {
      ...
      }), $a(e, this.table, null), yt(null), e.dispatchCommand(ar, void 0)) : (t.selectPrevious(), t.remove(), Ot().selectStart());
    });
  }
}
const Rs = "__lexicalTableSelection", Jc = (r) => Gm ? (r || window).getSelection() : null;
function rf(r, e, t, n) {
  const a = t.getRootElement();
  if (a === null) throw new Error("No root element.");
  const i = new tf(t, r.getKey()), s = t._window || window;
  (function(c, d) {
  ...
  e.addEventListener("mousedown", (c) => {
    setTimeout(() => {
      ...
      const d = Fs(c.target);
      d !== null && (gr(c), i.setAnchorCellForSelection(d));
    ...
    if (Me(d)) {
      ...
      if (ae(m)) return gr(c), m.selectEnd(), !0;
    }
    return !1;
  ...
  return i.listenersToRemove.add(t.registerCommand(va, l, pt)), i.listenersToRemove.add(t.registerCommand(ba, l, pt)), i.listenersToRemove.add(t.registerCommand(oc, (c) => {
    ...
    const d = B();
    if (!Me(d) || !Xr(d, r)) return !1;
    const m = d.anchor.getNode(), g = d.focus.getNode();
    if (!ae(m) || !ae(g)) return !1;
    const [v, y, x] = Wt(r, m, g), _ = Math.max(y.startRow, x.startRow), w = Math.max(y.startColumn, x.startColumn), C = Math.min(y.startRow, x.startRow), k = Math.min(y.startColumn, x.startColumn);
    for (let N = C; N <= _; N++) for (let A = k; A <= w; A++) {
      const I = v[N][A].cell;
      I.setFormat(c);
    ...
    const [x] = g, _ = d[0], w = _.getChildren(), C = _.getFirstChildOrThrow().getChildrenSize(), k = _.getChildrenSize(), N = he(x.getNode(), (J) => ae(J)), A = N && he(N, (J) => nt(J)), I = A && he(A, (J) => Ke(J));
    if (!ae(N) || !nt(A) || !Ke(I)) return !1;
    const D = A.getIndexWithinParent(), M = Math.min(I.getChildrenSize() - 1, D + k - 1), F = N.getIndexWithinParent(), z = Math.min(A.getChildrenSize() - 1, F + C - 1), j = Math.min(F, z), P = Math.min(D, M), X = Math.max(F, z), Y = Math.max(D, M), ee = I.getChildren();
    let ce = 0;
    for (let J = P; J <= Y; J++) {
      const de = ee[J];
      if (!nt(de)) return !1;
      ...
      let Ue = 0;
      for (let Pe = j; Pe <= X; Pe++) {
        const Be = Ne[Pe];
        if (!ae(Be)) return !1;
        const dt = se[Ue];
        if (!ae(dt)) return !1;
        const Je = Be.getChildren();
        dt.getChildren().forEach((Ge) => {
          _e(Ge) && xe().append(Ge), Be.append(Ge);
        }), Je.forEach((Ge) => Ge.remove()), Ue++;
      }
      ce++;
    }
    return !0;
  }, pt)), i.listenersToRemove.add(t.registerCommand(ar, () => {
    const c = B(), d = so();
    if (U(c)) {
      const { anchor: m, focus: g } = c, v = m.getNode(), y = g.getNode(), x = Yi(v), _ = Yi(y), w = !(!x || !r.is(Nn(x))), C = !(!_ || !r.is(Nn(_))), k = w !== C, N = w && C, A = c.isBackward();
      if (k) {
        const I = c.clone();
        if (C) {
          const [D] = Wt(r, _, _), M = D[0][0].cell, F = D[D.length - 1].at(-1).cell;
          I.focus.set(A ? M.getKey() : F.getKey(), A ? M.getChildrenSize() : F.getChildrenSize(), "element");
        } else if (w) {
          const [D] = Wt(r, x, x), M = D[0][0].cell, F = D[D.length - 1].at(-1).cell;
          I.anchor.set(A ? F.getKey() : M.getKey(), A ? F.getChildrenSize() : 0, "element");
        }
        yt(I), bl(t, i);
      } else N && (x.is(_) || (i.setAnchorCellForSelection(u(x)), i.setFocusCellForSelection(u(_), !0), i.isSelecting || setTimeout(() => {
    ...
    const c = B();
    if (!U(c) || !c.isCollapsed() || !Xr(c, r)) return !1;
    const d = xl(t, c, r);
    return !!d && (yl(d, r), !0);
  }, pt)), i;
}
  ...
  if (!Xr(i, n)) {
    if (U(i)) {
      if (i.isCollapsed() && t === "backward") {
        ...
        return !(!c || !Ke(c)) && (gr(e), c.selectEnd(), !0);
      }
      if (e.shiftKey && (t === "up" || t === "down")) {
        ...
        if (!i.isCollapsed() && (t === "up" && !i.isBackward() || t === "down" && i.isBackward())) {
          ...
          const d = i.clone();
          return d.focus.set(c.getKey(), u, _e(c) ? "text" : "element"), yt(d), gr(e), !0;
        }
        if (zt(s)) {
        ...
        }
        {
          ...
          if (Ke(l) && a.tableNodeKey === l.getKey()) {
            ...
            return g.focus.set((t === "up" ? d : m).getKey(), t === "up" ? 0 : m.getChildrenSize(), "element"), gr(e), yt(g), !0;
          }
        }
      }
    }
  ...
  if (U(i) && i.isCollapsed()) {
    ...
    if (t === "backward" || t === "forward") {
      ...
      return (k.length !== 1 || !wr(k[0])) && !!function(N, A, I, D) {
        ...
        return !j || Ke(j) ? !1 : (gr(N), D === "backward" ? j.selectEnd() : j.selectStart(), !0);
      }(e, C, n, t);
    }
    ...
    if (a.setAnchorCellForSelection(v), gr(e), e.shiftKey) {
      const y = n.getCordsFromCellNode(u, m);
      return nf(a, c, y.x, y.y, t);
    }
...
class lr extends xt {
  ...
  static importDOM() {
    return { table: (e) => ({ conversion: af, priority: 1 }) };
  }
  static importJSON(e) {
    const t = Ro();
...
`;
  ...
  decorate() {
    return /* @__PURE__ */ p.jsx(sf, { nodeKey: this.__key });
  }
}
function of() {
  return { node: Io() };
...
const uf = ft.lazy(() => import("./ImageComponent-DRYVBcxQ.js"));
function cf(r) {
  const e = r;
...
class Pn extends cr {
  ...
  decorate() {
    return /* @__PURE__ */ p.jsx($r, { fallback: null, children: /* @__PURE__ */ p.jsx(
      uf,
      {
        src: this.__src,
...
function Lo({ children: r, format: e, nodeKey: t, className: n }) {
  ...
  return $(() => Re(a.registerCommand(er, (c) => {
    ...
    return !1;
  }, ve), a.registerCommand(ya, (c) => c.target === l.current && (c.preventDefault(), c.shiftKey || o(), s(!i), !0), ve), a.registerCommand(ba, u, ve), a.registerCommand(va, u, ve)), [o, a, i, t, u, s]), p.jsx("div", { className: [n.base, i ? n.focus : null].filter(Boolean).join(" "), ref: l, style: { textAlign: e || void 0 }, children: r });
}
function hf({
  className: r,
  format: e,
...
const mf = "https://platform.twitter.com/widgets.js";
function ff(r) {
  ...
  return $(() => {
    ...
    if (s !== l.current) {
      if (c(!0), Sl) {
        ...
        g.src = mf, g.async = !0, (m = document.body) == null || m.appendChild(g), g.onload = d, a && (g.onerror = a);
      } else
        d();
      l && (l.current = s);
    }
...
var wf = function(e, t) {
  ...
  return e === void 0 ? t : e;
}, Sf = /([A-Z])/g, Cf = function(e) {
  return e.replace(Sf, "-$1").toLowerCase();
}, kf = {
  "&": "&amp;",
  ">": "&gt;",
  "<": "&lt;",
...
function Ef(r) {
  return String(r).replace(Nf, (e) => kf[e]);
}
var id = function r(e) {
  ...
  constructor(e) {
    ...
    for (var t in ti)
      if (ti.hasOwnProperty(t)) {
        var n = ti[t];
        this[t] = e[t] !== void 0 ? n.processor ? n.processor(e[t]) : e[t] : Of(n);
      }
  }
  /**
...
var Ho = 0, di = 1, En = 2, _r = 3, ma = 4, Ut = 5, An = 6, kt = 7, tr = [new Ar(Ho, 0, !1), new Ar(di, 0, !0), new Ar(En, 1, !1), new Ar(_r, 1, !0), new Ar(ma, 2, !1), new Ar(Ut, 2, !0), new Ar(An, 3, !1), new Ar(kt, 3, !0)], Df = [ma, Ut, ma, Ut, An, kt, An, kt], Rf = [Ut, Ut, Ut, Ut, kt, kt, kt, kt], If = [En, _r, ma, Ut, An, kt, An, kt], Ff = [_r, _r, Ut, Ut, kt, kt, kt, kt], Lf = [di, di, _r, _r, Ut, Ut, kt, kt], zf = [Ho, di, En, _r, En, _r, En, _r], fe = {
  DISPLAY: tr[Ho],
  TEXT: tr[En],
  SCRIPT: tr[ma],
  SCRIPTSCRIPT: tr[An]
...
function Uo(r, e, t) {
  ...
  var n = r.charCodeAt(0), a = ir[e][n];
  if (!a && r[0] in Nl && (n = Nl[r[0]].charCodeAt(0), a = ir[e][n]), !a && t === "text" && sd(n) && (a = ir[e][77]), a)
    return {
      depth: a[0],
      height: a[1],
      italic: a[2],
...
var Jf = [
  ...
  return t.size < 2 ? e : Jf[e - 1][t.size - 1];
};
class vr {
   ...
   */
  constructor(e) {
    this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || vr.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = El[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0;
  }
  /**
  ...
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = Tl(vr.BASESIZE, e);
    return this.size === t && this.textSize === vr.BASESIZE && this.style === e ? this : this.extend({
      style: e,
      size: t
    });
  }
...
var Ps = {
  ...
  return typeof e != "string" && (e = e.unit), e in Ps || e in Zf || e === "ex";
}, Xe = function(e, t) {
  var n;
  if (e.unit in Ps)
  ...
  var t = "<" + e;
  this.classes.length && (t += ' class="' + ue.escape(Lr(this.classes)) + '"');
  var n = "";
...
class Gt {
  constructor(e, t, n, a, i, s, o, l) {
    ...
    var u = Pf(this.text.charCodeAt(0));
    u && this.classes.push(u + "_fallback"), /[îïíì]/.test(this.text) && (this.text = ep[this.text]);
  }
  hasClass(e) {
    return ue.contains(this.classes, e);
  }
  ...
  toNode() {
    ...
    this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = V(this.italic)), this.classes.length > 0 && (t = t || document.createElement("span"), t.className = Lr(this.classes));
    for (var n in this.style)
  ...
  toMarkup() {
    var e = !1, t = "<span";
    this.classes.length && (e = !0, t += ' class="', t += ue.escape(Lr(this.classes)), t += '"');
    var n = "";
...
var f = "math", q = "text", b = "main", E = "ams", Ye = "accent-token", re = "bin", Nt = "close", Bn = "inner", me = "mathord", ct = "op-token", Bt = "open", Ti = "punct", T = "rel", Tr = "spacing", R = "textord";
h(f, b, T, "≡", "\\equiv", !0);
h(f, b, T, "≺", "\\prec", !0);
h(f, b, T, "≻", "\\succ", !0);
h(f, b, T, "∼", "\\sim", !0);
...
h(f, b, T, "⋈", "\\bowtie", !0);
h(f, b, T, "⌣", "\\smile", !0);
h(f, b, T, "⊑", "\\sqsubseteq", !0);
h(f, b, T, "⊒", "\\sqsupseteq", !0);
h(f, b, T, "≐", "\\doteq", !0);
h(f, b, T, "⌢", "\\frown", !0);
h(f, b, T, "∋", "\\ni", !0);
h(f, b, T, "∝", "\\propto", !0);
...
h(f, b, re, "⨿", "\\amalg");
h(f, b, re, "&", "\\And");
h(f, b, T, "⟵", "\\longleftarrow", !0);
h(f, b, T, "⇐", "\\Leftarrow", !0);
h(f, b, T, "⟸", "\\Longleftarrow", !0);
h(f, b, T, "⟶", "\\longrightarrow", !0);
h(f, b, T, "⇒", "\\Rightarrow", !0);
h(f, b, T, "⟹", "\\Longrightarrow", !0);
h(f, b, T, "↔", "\\leftrightarrow", !0);
h(f, b, T, "⟷", "\\longleftrightarrow", !0);
h(f, b, T, "⇔", "\\Leftrightarrow", !0);
h(f, b, T, "⟺", "\\Longleftrightarrow", !0);
h(f, b, T, "↦", "\\mapsto", !0);
h(f, b, T, "⟼", "\\longmapsto", !0);
h(f, b, T, "↗", "\\nearrow", !0);
h(f, b, T, "↩", "\\hookleftarrow", !0);
h(f, b, T, "↪", "\\hookrightarrow", !0);
h(f, b, T, "↘", "\\searrow", !0);
h(f, b, T, "↼", "\\leftharpoonup", !0);
h(f, b, T, "⇀", "\\rightharpoonup", !0);
h(f, b, T, "↙", "\\swarrow", !0);
h(f, b, T, "↽", "\\leftharpoondown", !0);
h(f, b, T, "⇁", "\\rightharpoondown", !0);
h(f, b, T, "↖", "\\nwarrow", !0);
h(f, b, T, "⇌", "\\rightleftharpoons", !0);
h(f, E, T, "≮", "\\nless", !0);
h(f, E, T, "", "\\@nleqslant");
h(f, E, T, "", "\\@nleqq");
h(f, E, T, "⪇", "\\lneq", !0);
...
h(f, E, T, "⋬", "\\ntrianglelefteq", !0);
h(f, E, T, "⊊", "\\subsetneq", !0);
h(f, E, T, "", "\\@varsubsetneq");
h(f, E, T, "⫋", "\\subsetneqq", !0);
h(f, E, T, "", "\\@varsubsetneqq");
h(f, E, T, "≯", "\\ngtr", !0);
h(f, E, T, "", "\\@ngeqslant");
h(f, E, T, "", "\\@ngeqq");
h(f, E, T, "⪈", "\\gneq", !0);
...
h(f, E, T, "⋡", "\\nsucceq", !0);
h(f, E, T, "⋩", "\\succnsim", !0);
h(f, E, T, "⪺", "\\succnapprox", !0);
h(f, E, T, "≆", "\\ncong", !0);
h(f, E, T, "", "\\@nshortparallel");
h(f, E, T, "∦", "\\nparallel", !0);
h(f, E, T, "⊯", "\\nVDash", !0);
h(f, E, T, "⋫", "\\ntriangleright");
h(f, E, T, "⋭", "\\ntrianglerighteq", !0);
h(f, E, T, "", "\\@nsupseteqq");
h(f, E, T, "⊋", "\\supsetneq", !0);
h(f, E, T, "", "\\@varsupsetneq");
h(f, E, T, "⫌", "\\supsetneqq", !0);
h(f, E, T, "", "\\@varsupsetneqq");
h(f, E, T, "⊮", "\\nVdash", !0);
h(f, E, T, "⪵", "\\precneqq", !0);
h(f, E, T, "⪶", "\\succneqq", !0);
h(f, E, T, "", "\\@nsubseteqq");
...
h(f, E, T, "≦", "\\leqq", !0);
h(f, E, T, "⩽", "\\leqslant", !0);
h(f, E, T, "⪕", "\\eqslantless", !0);
h(f, E, T, "≲", "\\lesssim", !0);
h(f, E, T, "⪅", "\\lessapprox", !0);
h(f, E, T, "≊", "\\approxeq", !0);
h(f, E, re, "⋖", "\\lessdot");
h(f, E, T, "⋘", "\\lll", !0);
h(f, E, T, "≶", "\\lessgtr", !0);
h(f, E, T, "⋚", "\\lesseqgtr", !0);
h(f, E, T, "⪋", "\\lesseqqgtr", !0);
h(f, E, T, "≑", "\\doteqdot");
h(f, E, T, "≓", "\\risingdotseq", !0);
h(f, E, T, "≒", "\\fallingdotseq", !0);
h(f, E, T, "∽", "\\backsim", !0);
h(f, E, T, "⋍", "\\backsimeq", !0);
h(f, E, T, "⫅", "\\subseteqq", !0);
h(f, E, T, "⋐", "\\Subset", !0);
h(f, E, T, "⊏", "\\sqsubset", !0);
h(f, E, T, "≼", "\\preccurlyeq", !0);
h(f, E, T, "⋞", "\\curlyeqprec", !0);
h(f, E, T, "≾", "\\precsim", !0);
h(f, E, T, "⪷", "\\precapprox", !0);
h(f, E, T, "⊲", "\\vartriangleleft");
h(f, E, T, "⊴", "\\trianglelefteq");
h(f, E, T, "⊨", "\\vDash", !0);
h(f, E, T, "⊪", "\\Vvdash", !0);
h(f, E, T, "⌣", "\\smallsmile");
h(f, E, T, "⌢", "\\smallfrown");
...
h(f, E, T, "⋑", "\\Supset", !0);
h(f, E, T, "⊐", "\\sqsupset", !0);
h(f, E, T, "≽", "\\succcurlyeq", !0);
h(f, E, T, "⋟", "\\curlyeqsucc", !0);
h(f, E, T, "≿", "\\succsim", !0);
h(f, E, T, "⪸", "\\succapprox", !0);
h(f, E, T, "⊳", "\\vartriangleright");
h(f, E, T, "⊵", "\\trianglerighteq");
h(f, E, T, "⊩", "\\Vdash", !0);
h(f, E, T, "∣", "\\shortmid");
h(f, E, T, "∥", "\\shortparallel");
h(f, E, T, "≬", "\\between", !0);
h(f, E, T, "⋔", "\\pitchfork", !0);
h(f, E, T, "∝", "\\varpropto");
h(f, E, T, "◀", "\\blacktriangleleft");
h(f, E, T, "∴", "\\therefore", !0);
h(f, E, T, "∍", "\\backepsilon");
h(f, E, T, "▶", "\\blacktriangleright");
h(f, E, T, "∵", "\\because", !0);
h(f, E, T, "⋘", "\\llless");
h(f, E, T, "⋙", "\\gggtr");
h(f, E, re, "⊲", "\\lhd");
...
h(f, E, re, "⋓", "\\doublecup");
h(f, E, re, "⊠", "\\boxtimes", !0);
h(f, E, T, "⇢", "\\dashrightarrow", !0);
h(f, E, T, "⇠", "\\dashleftarrow", !0);
h(f, E, T, "⇇", "\\leftleftarrows", !0);
h(f, E, T, "⇆", "\\leftrightarrows", !0);
h(f, E, T, "⇚", "\\Lleftarrow", !0);
h(f, E, T, "↞", "\\twoheadleftarrow", !0);
h(f, E, T, "↢", "\\leftarrowtail", !0);
h(f, E, T, "↫", "\\looparrowleft", !0);
h(f, E, T, "⇋", "\\leftrightharpoons", !0);
h(f, E, T, "↶", "\\curvearrowleft", !0);
h(f, E, T, "↺", "\\circlearrowleft", !0);
h(f, E, T, "↰", "\\Lsh", !0);
h(f, E, T, "⇈", "\\upuparrows", !0);
h(f, E, T, "↿", "\\upharpoonleft", !0);
h(f, E, T, "⇃", "\\downharpoonleft", !0);
h(f, b, T, "⊶", "\\origof", !0);
h(f, b, T, "⊷", "\\imageof", !0);
h(f, E, T, "⊸", "\\multimap", !0);
h(f, E, T, "↭", "\\leftrightsquigarrow", !0);
h(f, E, T, "⇉", "\\rightrightarrows", !0);
h(f, E, T, "⇄", "\\rightleftarrows", !0);
h(f, E, T, "↠", "\\twoheadrightarrow", !0);
h(f, E, T, "↣", "\\rightarrowtail", !0);
h(f, E, T, "↬", "\\looparrowright", !0);
h(f, E, T, "↷", "\\curvearrowright", !0);
h(f, E, T, "↻", "\\circlearrowright", !0);
h(f, E, T, "↱", "\\Rsh", !0);
h(f, E, T, "⇊", "\\downdownarrows", !0);
h(f, E, T, "↾", "\\upharpoonright", !0);
h(f, E, T, "⇂", "\\downharpoonright", !0);
h(f, E, T, "⇝", "\\rightsquigarrow", !0);
h(f, E, T, "⇝", "\\leadsto");
h(f, E, T, "⇛", "\\Rrightarrow", !0);
h(f, E, T, "↾", "\\restriction");
h(f, b, R, "‘", "`");
h(f, b, R, "$", "\\$");
h(q, b, R, "$", "\\$");
...
h(f, b, me, "k", ge);
h(q, b, R, "k", ge);
for (var Kr = 0; Kr < 10; Kr++) {
  var Mr = Kr.toString();
  ge = String.fromCharCode(55349, 57294 + Kr), h(f, b, me, Mr, ge), h(q, b, R, Mr, ge), ge = String.fromCharCode(55349, 57314 + Kr), h(f, b, me, Mr, ge), h(q, b, R, Mr, ge), ge = String.fromCharCode(55349, 57324 + Kr), h(f, b, me, Mr, ge), h(q, b, R, Mr, ge), ge = String.fromCharCode(55349, 57334 + Kr), h(f, b, me, Mr, ge), h(q, b, R, Mr, ge);
}
var js = "ÐÞþ";
...
var Ka = [
  ...
  return a === void 0 && (a = []), n.font === "boldsymbol" && Ai(e, "Main-Bold", t).metrics ? Xt(e, "Main-Bold", t, n, a.concat(["mathbf"])) : e === "\\" || qe[t][e].font === "main" ? Xt(e, "Main-Regular", t, n, a) : Xt(e, "AMS-Regular", t, n, a.concat(["amsrm"]));
}, sp = function(e, t, n, a, i) {
  ...
  if (i.charCodeAt(0) === 55349 && ([u, c] = ap(i, a)), u.length > 0)
  ...
  if (Lr(r.classes) !== Lr(e.classes) || r.skew !== e.skew || r.maxFontSize !== e.maxFontSize)
    return !1;
  ...
  for (var e = 0; e < r.length - 1; e++) {
    var t = r[e], n = r[e + 1];
    t instanceof Gt && n instanceof Gt && lp(t, n) && (t.text += n.text, t.height = Math.max(t.height, n.height), t.depth = Math.max(t.depth, n.depth), t.italic = n.italic, r.splice(e + 1, 1), e--);
  }
  return r;
}, Ko = function(e) {
  ...
  return Ko(i), i;
}, hd = (r, e, t, n) => new Ra(r, e, t, n), cp = function(e, t, n) {
  var a = Tt([e], [], t);
  ...
  var N;
  if (d < 0) {
    var A = Tt([], []), I = Tt(["vlist"], [A]);
    I.style.height = V(-d);
    var D = Tt(["vlist-s"], [new Gt("​")]);
    N = [Tt(["vlist-r"], [k, D]), Tt(["vlist-r"], [I])];
  } else
    N = [Tt(["vlist-r"], [k])];
  var M = Tt(["vlist-t"], N);
  return N.length === 2 && M.classes.push("vlist-t2"), M.height = m, M.depth = -d, M;
}, pp = (r, e) => {
  ...
  var [n, a, i] = pd[e], s = new zr(n), o = new kr([s], {
    width: V(a),
    height: V(i),
...
var pi = function(e) {
...
}, Nr = L.makeSpan, yp = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], xp = ["rightmost", "mrel", "mclose", "mpunct"], wp = {
  display: fe.DISPLAY,
  text: fe.TEXT,
  script: fe.SCRIPT,
  ...
  if (e.length === 1) {
    var c = e[0];
    c.type === "sizing" ? u = t.havingSize(c.size) : c.type === "styling" && (u = t.havingStyle(wp[c.style]));
  }
  var d = Nr([a[0] || "leftmost"], [], t), m = Nr([a[1] || "rightmost"], [], t), g = n === "root";
  return Fl(i, (v, y) => {
    var x = y.classes[0], _ = v.classes[0];
    x === "mbin" && ue.contains(xp, _) ? y.classes[0] = "mord" : _ === "mbin" && ue.contains(yp, x) && (v.classes[0] = "mord");
  }, {
    node: d
  }, m, g), Fl(i, (v, y) => {
    var x = $s(y), _ = $s(v), w = x && _ ? v.hasClass("mtight") ? bp[x][_] : vp[x][_] : null;
    if (w)
  ...
  return e ? (t && (e = Sp(e, t)), _p[e.classes[0]] || null) : null;
}, fa = function(e, t) {
...
function qs(r, e) {
  ...
  var u;
  t ? (u = Ya(mt(t, e, !0)), u.classes = ["tag"], i.push(u)) : a && i.push(a);
...
class Ht {
  ...
  toNode() {
    ...
    this.classes.length > 0 && (e.className = Lr(this.classes));
    for (var n = 0; n < this.children.length; n++)
  ...
  toMarkup() {
    ...
    this.classes.length > 0 && (e += ' class ="' + ue.escape(Lr(this.classes)) + '"'), e += ">";
    for (var n = 0; n < this.children.length; n++)
      e += this.children[n].toMarkup();
...
var K = {
  ...
  return qe[t][e] && qe[t][e].replace && e.charCodeAt(0) !== 55349 && !(dd.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = qe[t][e].replace), new K.TextNode(e);
}, Go = function(e) {
...
var yd = function(e) {
  ...
  var t = new K.MathNode("mo", [new K.TextNode(Ep[e.replace(/^\\/, "")])]);
  ...
  function n() {
    ...
    if (ue.contains(["widehat", "widecheck", "widetilde", "utilde"], l)) {
      ...
      var _ = [], w = Ap[l], [C, k, N] = w, A = N / 1e3, I = C.length, D, M;
      if (I === 1) {
        var F = w[3];
        D = ["hide-tail"], M = [F];
      } else if (I === 2)
...
function Mi(r) {
  return r && (r.type === "atom" || np.hasOwnProperty(r.type)) ? r : null;
}
var Xo = (r, e) => {
  var t, n, a;
  r && r.type === "supsub" ? (n = Se(r.base, "accent"), t = n.base, r.base = t, a = tp(De(r, e)), r.base = n) : (n = Se(r, "accent"), t = n.base);
...
}, Rp = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r) => "\\" + r).join("|"));
Z({
  type: "accent",
  ...
  handler: (r, e) => {
    var t = pi(e[0]), n = !Rp.test(r.funcName), a = !n || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: r.parser.mode,
      label: r.funcName,
...
var Fp = {
  ...
  mode: "math",
  style: "display"
}), Pl = (r) => r.type === "textord" && r.text === "@", Lp = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function zp(r, e, t) {
  var n = Fp[r];
  switch (n) {
    case "\\\\cdrightarrow":
...
var ra = function(e, t, n) {
  var a = qe.math[e] && qe.math[e].replace, i = Uo(a || e, t, n);
  if (!i)
  ...
  var o = $p(e, t, i, a), l = Jo(L.makeSpan(["delimsizing", "size" + t], [o], a), fe.TEXT, a, s);
  ...
  var a = ir["Size4-Regular"][e.charCodeAt(0)] ? ir["Size4-Regular"][e.charCodeAt(0)][4] : ir["Size1-Regular"][e.charCodeAt(0)][4], i = new zr("inner", Gf(e, Math.round(1e3 * t))), s = new kr([i], {
    width: V(a),
    height: V(t),
    // Override CSS rule `.katex svg { width: 100% }`
    style: "width:" + V(a),
  ...
  type: "kern",
  size: -1 * Us
}, qp = ["|", "\\lvert", "\\rvert", "\\vert"], Hp = ["\\|", "\\lVert", "\\rVert", "\\Vert"], Md = function(e, t, n, a, i, s) {
  var o, l, u, c, d = "", m = 0;
  o = u = c = e, l = null;
  var g = "Size1-Regular";
  e === "\\uparrow" ? u = c = "⏐" : e === "\\Uparrow" ? u = c = "‖" : e === "\\downarrow" ? o = u = "⏐" : e === "\\Downarrow" ? o = u = "‖" : e === "\\updownarrow" ? (o = "\\uparrow", u = "⏐", c = "\\downarrow") : e === "\\Updownarrow" ? (o = "\\Uparrow", u = "‖", c = "\\Downarrow") : ue.contains(qp, e) ? (u = "∣", d = "vert", m = 333) : ue.contains(Hp, e) ? (u = "∥", d = "doublevert", m = 556) : e === "[" || e === "\\lbrack" ? (o = "⎡", u = "⎢", c = "⎣", g = "Size4-Regular", d = "lbrack", m = 667) : e === "]" || e === "\\rbrack" ? (o = "⎤", u = "⎥", c = "⎦", g = "Size4-Regular", d = "rbrack", m = 667) : e === "\\lfloor" || e === "⌊" ? (u = o = "⎢", c = "⎣", g = "Size4-Regular", d = "lfloor", m = 667) : e === "\\lceil" || e === "⌈" ? (o = "⎡", u = c = "⎢", g = "Size4-Regular", d = "lceil", m = 667) : e === "\\rfloor" || e === "⌋" ? (u = o = "⎥", c = "⎦", g = "Size4-Regular", d = "rfloor", m = 667) : e === "\\rceil" || e === "⌉" ? (o = "⎤", u = c = "⎥", g = "Size4-Regular", d = "rceil", m = 667) : e === "(" || e === "\\lparen" ? (o = "⎛", u = "⎜", c = "⎝", g = "Size4-Regular", d = "lparen", m = 875) : e === ")" || e === "\\rparen" ? (o = "⎞", u = "⎟", c = "⎠", g = "Size4-Regular", d = "rparen", m = 875) : e === "\\{" || e === "\\lbrace" ? (o = "⎧", l = "⎨", c = "⎩", u = "⎪", g = "Size4-Regular") : e === "\\}" || e === "\\rbrace" ? (o = "⎫", l = "⎬", c = "⎭", u = "⎪", g = "Size4-Regular") : e === "\\lgroup" || e === "⟮" ? (o = "⎧", c = "⎩", u = "⎪", g = "Size4-Regular") : e === "\\rgroup" || e === "⟯" ? (o = "⎫", c = "⎭", u = "⎪", g = "Size4-Regular") : e === "\\lmoustache" || e === "⎰" ? (o = "⎧", c = "⎭", u = "⎪", g = "Size4-Regular") : (e === "\\rmoustache" || e === "⎱") && (o = "⎫", c = "⎩", u = "⎪", g = "Size4-Regular");
  var v = ra(o, g, i), y = v.height + v.depth, x = ra(u, g, i), _ = x.height + x.depth, w = ra(c, g, i), C = w.height + w.depth, k = 0, N = 1;
  if (l !== null) {
    var A = ra(l, g, i);
    k = A.height + A.depth, N = 2;
  }
  var I = y + C + k, D = Math.max(0, Math.ceil((t - I) / (N * _))), M = I + D * N * _, F = a.fontMetrics().axisHeight;
  n && (F *= a.sizeMultiplier);
  var z = M / 2 - F, j = [];
  if (d.length > 0) {
    var P = M - y - C, X = Math.round(M * 1e3), Y = Yf(d, Math.round(P * 1e3)), ee = new zr(d, Y), ce = (m / 1e3).toFixed(3) + "em", J = (X / 1e3).toFixed(3) + "em", de = new kr([ee], {
      width: ce,
      height: J,
      viewBox: "0 0 " + m + " " + X
    ...
    if (j.push(es(c, g, i)), j.push(Xa), l === null) {
      ...
      var se = (M - y - C - k) / 2 + 2 * Us;
      j.push(ts(u, se, a)), j.push(Xa), j.push(es(l, g, i)), j.push(Xa), j.push(ts(u, se, a));
    }
    j.push(Xa), j.push(es(o, g, i));
  }
  var Ue = a.havingBaseStyle(fe.TEXT), Pe = L.makeVList({
    positionType: "bottom",
    positionData: z,
    children: j
  }, Ue);
  return Jo(L.makeSpan(["delimsizing", "mult"], [Pe], Ue), fe.TEXT, a, s);
}, rs = 80, ns = 0.08, as = function(e, t, n, a, i) {
  var s = Kf(e, a, n), o = new zr(e, s), l = new kr([o], {
...
}, Od = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"], Wp = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"], Dd = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], sa = [0, 1.2, 1.8, 2.4, 3], Kp = function(e, t, n, a, i) {
  ...
  for (var i = Math.min(2, 3 - a.style.size), s = i; s < n.length && n[s].type !== "stack"; s++) {
    var o = ra(e, Vp(n[s]), "math"), l = o.height + o.depth;
    if (n[s].type === "small") {
  ...
  var o;
  ue.contains(Dd, e) ? o = Gp : ue.contains(Od, e) ? o = Rd : o = Yp;
  var l = Id(e, t, o, a);
  return l.type === "small" ? jp(e, l.style, n, a, i, s) : l.type === "large" ? Ad(e, l.size, n, a, i, s) : Md(e, t, n, a, i, s);
...
}, Jp = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
function Di(r, e) {
  var t = Mi(r);
  if (t && ue.contains(Jp, t.text))
    return t;
...
var Zo = (r, e) => {
  ...
  if (n === "sout")
    ...
    var m = Math.floor(1e3 * d * a), g = Uf(m), v = new kr([new zr("phase", g)], {
      width: "400em",
      height: V(m / 1e3),
...
function Ur(r, e, t) {
  ...
  for (C(), _.push($l(r)); ; ) {
    ...
    if (A === "&") {
      ...
      k(), v.length === 1 && N.type === "styling" && N.body[0].body.length === 0 && (y.length > 1 || !c) && y.pop(), _.length < y.length + 1 && _.push([]);
      break;
    } else if (A === "\\\\") {
      r.consume();
      var I = void 0;
      r.gullet.future().text !== " " && (I = r.parseSizeGroup(!0)), x.push(I ? I.value : null), k(), _.push($l(r)), v = [], y.push(v), C();
    } else
...
var hr = function(e, t) {
  ...
  for (k(s[0]), n = 0; n < e.body.length; ++n) {
    var N = e.body[n], A = _, I = w;
    o < N.length && (o = N.length);
    var D = new Array(N.length);
    for (a = 0; a < N.length; ++a) {
      var M = De(N[a], t);
      I < M.depth && (I = M.depth), A < M.height && (A = M.height), D[a] = M;
    }
    var F = e.rowGaps[n], z = 0;
    F && (z = Xe(F, t), z > 0 && (z += w, I < z && (I = z), z = 0)), e.addJot && (I += y), D.height = A, D.depth = I, C += A, D.pos = C, C += I + z, l[n] = D, k(s[n + 1]);
  }
  ...
  if (e.tags && e.tags.some((je) => je))
    for (n = 0; n < i; ++n) {
      ...
      le === !0 ? Ne = L.makeSpan(["eqn-num"], [], t) : le === !1 ? Ne = L.makeSpan([], [], t) : Ne = L.makeSpan([], mt(le, t, !0), t), Ne.depth = J.depth, Ne.height = J.height, ce.push({
        type: "elem",
        elem: Ne,
        shift: de
      });
  ...
  for (
    ...
    for (var se = P[ee] || {}, Ue = !0; se.type === "separator"; ) {
      if (Ue || (Y = L.makeSpan(["arraycolsep"], []), Y.style.width = V(t.fontMetrics().doubleRuleSep), X.push(Y)), se.separator === "|" || se.separator === ":") {
        var Pe = se.separator === "|" ? "solid" : "dashed", Be = L.makeSpan(["vertical-separator"], [], t);
        Be.style.height = V(C), Be.style.borderRightWidth = V(c), Be.style.borderRightStyle = Pe, Be.style.margin = "0 " + V(-c / 2);
        var dt = C - j;
        dt && (Be.style.verticalAlign = V(-dt)), X.push(Be);
      } else
  ...
  if (e.cols && e.cols.length > 0) {
    ...
    for (var C = _; C < w; C++)
      v[C].type === "align" ? (g += Zp[v[C].align], x && (y += "none "), x = !0) : v[C].type === "separator" && x && (y += v[C].separator === "|" ? "solid " : "dashed ", x = !1);
    c.setAttribute("columnalign", g.trim()), /[sd]/.test(y) && c.setAttribute("columnlines", y.trim());
  }
  if (e.colSeparationType === "align") {
    for (var k = e.cols || [], N = "", A = 1; A < k.length; A++)
      N += A % 2 ? "0em " : "1em ";
    c.setAttribute("columnspacing", N.trim());
  ...
  s.body.forEach(function(_) {
    for (var w = 1; w < _.length; w += 2) {
      var C = Se(_[w], "styling"), k = Se(C.body[0], "ordgroup");
      k.body.unshift(u);
    }
    if (g)
      ...
      var N = _.length / 2;
      if (o < N)
        throw new G("Too many math in a row: " + ("expected " + o + ", but got " + N), _[0]);
    }
  });
  for (var v = 0; v < l; ++v) {
    var y = "r", x = 0;
...
dr({
  ...
  handler(r, e) {
    ...
    return Ur(r.parser, i, t0(r.envName));
  },
  htmlBuilder: hr,
  mathmlBuilder: mr
});
dr({
  ...
  handler(r) {
    ...
    var i = Ur(r.parser, n, t0(r.envName)), s = Math.max(0, ...i.body.map((o) => o.length));
...
var $d = (r, e) => {
  ...
  var k;
  t.size === fe.DISPLAY.size ? k = e.fontMetrics().delim1 : t.size === fe.SCRIPTSCRIPT.size ? k = e.havingStyle(fe.SCRIPT).fontMetrics().delim2 : k = e.fontMetrics().delim2;
  var N, A;
  return r.leftDelim == null ? N = fa(e, ["mopen"]) : N = Sr.customSizedDelim(r.leftDelim, k, !0, e.havingStyle(t), r.mode, ["mopen"]), r.continued ? A = L.makeSpan([]) : r.rightDelim == null ? A = fa(e, ["mclose"]) : A = Sr.customSizedDelim(r.rightDelim, k, !0, e.havingStyle(t), r.mode, ["mclose"]), L.makeSpan(["mord"].concat(i.sizingClasses(e)), [N, L.makeSpan(["mfrac"], [x]), A], e);
}, n0 = (r, e) => {
...
Z({
  ...
  handler: (r, e) => {
    var {
      parser: t,
      funcName: n
    } = r, a = e[0], i = Af(Se(e[1], "infix").size), s = e[2], o = i.number > 0;
    return {
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
Z({
  ...
  mathmlBuilder: (r, e) => Pr(r.mathml, e)
});
var is = function(e) {
  if (/^[-+]? *(\d+(\.\d*)?|\.\d+)$/.test(e))
    return {
...
gn({
  ...
  htmlBuilder(r, e) {
    ...
    if (o && l) {
      ...
      var N = u.defaultRuleThickness, A = 4 * N;
      if (c - o.depth - (l.height - d) < A) {
        d = A - (c - o.depth) + l.height;
      ...
      c = Math.max(c, y, o.depth + 0.25 * u.xHeight), k = L.makeVList({
        positionType: "shift",
        positionData: -c,
        children: [{
          type: "elem",
    ...
    return L.makeSpan([F], [s, L.makeSpan(["msupsub"], [k])], e);
  },
  mathmlBuilder(r, e) {
    var t = !1, n, a;
...
gn({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new K.MathNode("mtable", [new K.MathNode("mtr", [Vl(), new K.MathNode("mtd", [Pr(r.body, e)]), Vl(), new K.MathNode("mtd", [Pr(r.tag, e)])])]);
...
var Ql = (r) => r.body.replace(/ /g, r.star ? "␣" : " "), Dr = gd, Yd = `[ \r
	]`, s4 = "\\\\[a-zA-Z@]+", o4 = "\\\\[^\uD800-\uDFFF]", l4 = "(" + s4 + ")" + Yd + "*", u4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, Ws = "[̀-ͯ]", c4 = new RegExp(Ws + "+$"), d4 = "(" + Yd + "+)|" + // whitespace
(u4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(Ws + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
S("\\dots", function(r) {
  ...
  return t in ru ? e = ru[t] : (t.slice(0, 4) === "\\not" || t in qe.math && ue.contains(["bin", "rel"], qe.math[t].group)) && (e = "\\dotsb"), e;
});
var i0 = {
...
var Vd = V(ir["Main-Regular"][84][1] - 0.7 * ir["Main-Regular"][65][1]);
...
class f4 {
  constructor(e, t, n) {
    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new h4(m4, t.macros), this.mode = n, this.stack = [];
  }
  /**
   ...
   */
  isDefined(e) {
    return this.macros.has(e) || Dr.hasOwnProperty(e) || qe.math.hasOwnProperty(e) || qe.text.hasOwnProperty(e) || Jd.hasOwnProperty(e);
  }
  /**
...
class Ii {
  constructor(e, t) {
    this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new f4(e, t, this.mode), this.settings = t, this.leftrightDepth = 0;
  }
  /**
  ...
  parseSymbol() {
    ...
    au.hasOwnProperty(t[0]) && !qe[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = au[t[0]] + t.slice(1));
    var i = c4.exec(t);
    ...
    if (qe[this.mode][t]) {
      ...
      var o = qe[this.mode][t].group, l = Ft.range(e), u;
      if (rp.hasOwnProperty(o)) {
        var c = o;
        u = {
          type: "atom",
          mode: this.mode,
...
const b4 = ft.lazy(() => import("./EquationComponent-Bgfr9SYo.js"));
function iu(r) {
...
const y4 = ft.lazy(() => import("./ExcalidrawComponent-BMDJxWTT.js"));
function x4(r) {
...
class ln extends cr {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  decorate(t, n) {
    return /* @__PURE__ */ p.jsx($r, { fallback: null, children: /* @__PURE__ */ p.jsx(y4, { nodeKey: this.getKey(), data: this.__data }) });
  }
}
function th() {
  return new ln();
...
const w4 = ft.lazy(() => import("./PollComponent-eTFANxER.js"));
function _4() {
...
const C4 = ft.lazy(() => import("./InlineImageComponent-D7cnAm7Z.js"));
function k4(r) {
...
const E4 = ft.lazy(() => import("./StickyComponent-BZHNqmFv.js"));
class Mn extends cr {
  ...
  decorate(t, n) {
    return Zt(
      /* @__PURE__ */ p.jsx($r, { fallback: null, children: /* @__PURE__ */ p.jsx(
        E4,
        {
          color: this.__color,
          x: this.__x,
...
const A4 = [
  ...
  Mn,
  _o
], Qa = 0, Gs = 1, Ys = 2, Vt = 0, M4 = 1, uu = 2, O4 = 3, D4 = 4;
function R4(r, e, t, n, a) {
  ...
  return x === 1 && y === v - 1 ? uu : x === -1 && y === v + 1 ? O4 : x === -1 && y === v ? D4 : Vt;
}
function I4(r, e) {
  let t = Date.now(), n = Vt;
  return (a, i, s, o, l, u) => {
    ...
    const d = R4(a, i, o, l, r.isComposing()), m = (() => {
      ...
      return o.size > 0 || l.size > 0 ? v === !1 && d !== Vt && d === n && c < t + e && g || o.size === 1 && function(x, _, w) {
        const C = _._nodeMap.get(x), k = w._nodeMap.get(x), N = _._selection, A = w._selection;
        return !(U(N) && U(A) && N.anchor.type === "element" && N.focus.type === "element" && A.anchor.type === "text" && A.focus.type === "text" || !_e(C) || !_e(k) || C.__parent !== k.__parent) && JSON.stringify(_.read(() => C.exportJSON())) === JSON.stringify(w.read(() => k.exportJSON()));
...
function F4(r, e, t) {
  ...
  }(r, e), !0), ye), r.registerCommand(mc, () => (function(i, s) {
    const o = s.redoStack, l = s.undoStack;
    if (o.length !== 0) {
      const u = s.current;
  ...
  }(r, e), !0), ye), r.registerCommand(w1, () => (cu(e), !1), ye), r.registerCommand(x1, () => (cu(e), r.dispatchCommand(Zn, !1), r.dispatchCommand(Qn, !1), !0), ye), r.registerUpdateListener(({ editorState: i, prevEditorState: s, dirtyLeaves: o, dirtyElements: l, tags: u }) => {
...
function L4({ delay: r, externalHistoryState: e }) {
  const [t] = oe();
...
}, P4 = () => Zu(ah), B4 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : $;
function j4(r) {
...
function K4(r, e, t, n) {
  ...
  return [r.registerNodeTransform(hn, (s) => {
    ...
    for (; ; ) {
      ...
      o.start === 0 ? [m, c] = c.splitText(o.end) : [, m, c] = c.splitText(o.start + d, o.end + d), m === void 0 && W4(165, "nodeToReplace");
      const v = n(m);
            ...
            r.update(() => {
              ...
              if (U(y)) {
                ...
                if (_e(_) && u >= 0 && c >= 0 && (w = u, C = u + c, y.setTextNodeRange(_, w, _, C)), w === C && d === "" || (y.insertRawText(d), _ = x.getNode()), _e(_)) {
                  w = m, C = m + g;
                  const k = _.getTextContentSize();
                  w = w > k ? k : w, C = C > k ? k : C, y.setTextNodeRange(_, w, _, C);
                }
...
const Vs = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : $;
function du(r) {
  return r.getEditorState().read(ih(r.isComposing()));
}
function Y4({ contentEditable: r, placeholder: e = null, ErrorBoundary: t }) {
  const [n] = oe(), a = function(i, s) {
    ...
    return Vs(() => i.registerDecoratorListener((u) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const m = c[d], g = p.jsx(s, { onError: (y) => i._onError(y), children: p.jsx($r, { fallback: null, children: o[m] }) }), v = i.getElementByKey(m);
  ...
  return function(i) {
    Vs(() => Re(Wm(i), G4(i)), [i]);
  }(n), p.jsxs(p.Fragment, { children: [r, p.jsx(V4, { content: e }), a] });
}
function V4({ content: r }) {
...
var hu = { error: null }, X4 = function(r) {
  var e, t;
  function n() {
...
function J4({ children: r, onError: e }) {
  return p.jsx(X4, { fallback: p.jsx("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: r });
}
function Z4({ defaultSelection: r }) {
  const [e] = oe();
  return $(() => {
    e.focus(() => {
...
function Q4(r) {
  return r.registerCommand(Si, (e) => {
    ...
    const n = function(a) {
      const i = a.getNodes();
      if (Z1(i, (d) => si(d) && d.canIndent() ? d : null).length > 0) return !0;
...
const sh = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : $;
function ng({ editor: r, ariaActiveDescendant: e, ariaAutoComplete: t, ariaControls: n, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: o, ariaLabel: l, ariaLabelledBy: u, ariaMultiline: c, ariaOwns: d, ariaRequired: m, autoCapitalize: g, className: v, id: y, role: x = "textbox", spellCheck: _ = !0, style: w, tabIndex: C, "data-testid": k, ...N }, A) {
  ...
  return sh(() => (D(r.isEditable()), r.registerEditableListener((z) => {
    D(z);
  })), [r]), p.jsx("div", { ...N, "aria-activedescendant": I ? e : void 0, "aria-autocomplete": I ? t : "none", "aria-controls": I ? n : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": I && x === "combobox" ? !!s : void 0, ...o != null ? { "aria-invalid": o } : {}, "aria-label": l, "aria-labelledby": u, "aria-multiline": c, "aria-owns": I ? d : void 0, "aria-readonly": !I || void 0, "aria-required": m, autoCapitalize: g, className: v, contentEditable: I, "data-testid": k, id: y, ref: F, role: I ? x : void 0, spellCheck: _, style: w, tabIndex: C });
}
const ag = Qu(ng);
function mu(r) {
  return r.getEditorState().read(ih(r.isComposing()));
...
function sg(r, e) {
  ...
  return p.jsxs(p.Fragment, { children: [p.jsx(ag, { editor: a, ...n, ref: e }), t != null && p.jsx(og, { editor: a, content: t })] });
}
function og({ content: r, editor: e }) {
  const t = function(s) {
    const [o, l] = H(() => mu(s));
    return sh(() => {
      function u() {
  ...
  if (jr(() => (a(e.isEditable()), e.registerEditableListener((s) => {
    a(s);
  })), [e]), !t) return null;
  let i = null;
...
function lg({
  ...
  return /* @__PURE__ */ p.jsx(ig, { className: r || "content-editable__root" });
}
const Un = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", ug = Un && "documentMode" in document ? document.documentMode : null, Or = Un && /Mac|iPod|iPhone|iPad/.test(navigator.platform);
Un && "InputEvent" in window && !ug && "getTargetRanges" in new window.InputEvent("input");
const oh = ft.createContext(null), fu = 4;
function Ae({
  children: r,
  className: e,
  onClick: t,
  ...
  const a = Oe(null), i = ft.useContext(oh);
  if (i === null)
...
function dn({
  ...
  return $(() => {
    ...
    u && Zt(
      /* @__PURE__ */ p.jsx(cg, { dropDownRef: o, onClose: d, children: i }),
      document.body
    )
  ] });
}
...
function hg(r, e, t) {
  const n = Ir[e];
  let a = r ^ n;
  return e === "subscript" ? a &= ~Ir.superscript : e === "superscript" && (a &= ~Ir.subscript), a;
}
function us(r, e) {
...
const mg = tn.lazy(() => import("./DataMentionComponent-Ch6qt9dJ.js"));
function fg(r) {
  ...
  return t !== null && n !== null && a !== null && i !== null ? {
    node: d0({ dataMention: t, fieldName: n, label: a, data: e, step: parseInt(i) })
  } : null;
}
function cs(r) {
...
class Rr extends cr {
  constructor(t, n, a, i, s, o, l, u, c) {
    ...
    ne(this, "autoMentionData", []);
    ne(this, "autoAfterMentionData", []);
  ...
  updateDOM(t, n, a) {
    ...
    if (v && v.nodeType !== Node.TEXT_NODE ? n.appendChild(v) : v = null, d !== m)
      return !0;
    if (o === l && u !== c) {
      const k = n.firstChild;
      k == null && pu(!1, "updateDOM: prevInnerDOM is null or undefined");
      const N = document.createElement(c);
      return gu(
        N,
        s,
        a
      ), n.replaceChild(N, k), v && N.appendChild(v), !1;
    }
    let y = n;
  ...
  static importJSON(t) {
    ...
    if (c.__dataMention === "auto" && c.__step === 2 || c.__dataMention === "after-auto" && c.__step === 3) {
      let d;
      if (c.__dataMention === "auto" ? d = this.prototype.autoMentionData.find((m) => m[c.__fieldName] && m[c.__fieldName].label === c.__label) : d = this.prototype.autoAfterMentionData.find((m) => m[c.__fieldName] && m[c.__fieldName].label === c.__label), d) {
        const m = d[c.__fieldName];
        let g = m.value;
        g && m.isMan && (g = parseInt(g.toString()) * 1e4), g && m.isNumber && (g = g.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")), c.setData(g);
      }
    }
    return c;
  }
  exportDOM() {
    const t = document.createElement("span");
    if (t.setAttribute("data-mention-type", this.__dataMention), t.setAttribute("data-mention-step", this.__step.toString()), t.setAttribute("data-mention-field", this.__fieldName), t.setAttribute("data-mention-label", this.__label), t.setAttribute("data-lexical-data-mention", "true"), this.__dataMention === "input" && this.__value) {
      const n = document.createElement("span");
  ...
  setFormat(t) {
    if (this.isInput())
      return this;
    const n = this.getWritable();
    return n.__format = typeof t == "string" ? Ir[t] : t, n;
  }
  setStyle(t) {
    if (this.isInput())
      return this;
  ...
  toggleFormat(t) {
    if (this.isInput())
      return this;
    const n = this.getFormat(), a = hg(n, t);
  ...
  remove(t) {
    this.__dataMention !== "input" && this.__decoratorSpan && pg(this.__decoratorSpan), super.remove(t);
  }
}
const d0 = ({
  dataMention: r,
  ...
  !a && r === "input" && (a = pa());
  const l = new Rr(r, e, t, n, a, i, s, o);
  return ut(l);
}, gg = (r) => r instanceof Rr, oa = (r) => r === null || r.getNodes().length !== 1 ? !1 : gg(r.getNodes()[0]), Yr = 8, Vr = 72, vg = 15;
function bg({
  selectionFontSize: r,
  disabled: e = !1,
  editor: t
  ...
  const [n, a] = ft.useState(r), i = (u, c) => {
    ...
    (u, c) => {
      const d = (m) => (m || (m = `${vg}px`), m = m.slice(0, -2), `${i(
        Number(m),
        c
      )}px`);
      t.update(() => {
    ...
    if (u.key === "Enter") {
      u.preventDefault();
      let d = c;
      c > Vr ? d = Vr : c < Yr && (d = Yr), a(String(d)), s(String(d) + "px", null);
    }
  }, l = (u) => {
    if (n !== "") {
      const c = i(
...
function uh({
  ...
  return $(() => {
    ...
    "div",
    {
      ...
      ref: s,
      children: [
        /* @__PURE__ */ p.jsx(Br, { label: "Hex", onChange: u, value: a }),
        /* @__PURE__ */ p.jsx("div", { className: "color-picker-basic-color", children: _g.map((m) => /* @__PURE__ */ p.jsx(
          "button",
          {
...
function Cn(r, e) {
  ...
  return r === "hex" ? (t = xu(e), n = wu(t), a = hs(n)) : r === "rgb" ? (n = e, t = _u(n), a = hs(n)) : r === "hsv" && (a = e, n = Sg(a), t = _u(n)), { hex: t, hsv: a, rgb: n };
}
function Su({
  disabled: r = !1,
...
const Eg = (r) => Un ? (r || window).getSelection() : null, La = He("INSERT_IMAGE_COMMAND");
function Tg({
  onClick: r
}) {
...
function dh({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    ...
    t === "url" && /* @__PURE__ */ p.jsx(Tg, { onClick: i }),
    t === "file" && /* @__PURE__ */ p.jsx(Ag, { onClick: i })
  ] });
}
function Mg({
  captionsEnabled: r
...
const Og = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", hh = document.createElement("img");
hh.src = Og;
function Dg(r) {
  const e = m0();
  if (!e)
...
function Lg(r) {
  let e;
  const t = r.target, n = t == null ? null : t.nodeType === 9 ? t.defaultView : t.ownerDocument.defaultView, a = Eg(n);
...
const jg = (r) => Un ? (r || window).getSelection() : null, f0 = He("INSERT_INLINE_IMAGE_COMMAND");
function $g({
  activeEditor: r,
  onClose: e
}) {
...
const Hg = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", fh = document.createElement("img");
fh.src = Hg;
function Ug(r) {
  const e = p0();
  if (!e)
...
function Yg(r) {
  let e;
  const t = r.target, n = t == null ? null : t.nodeType === 9 ? t.defaultView : t.ownerDocument.defaultView, a = jg(n);
  if (document.caretRangeFromPoint)
    e = document.caretRangeFromPoint(r.clientX, r.clientY);
  else if (r.rangeParent && a !== null)
    a.collapse(r.rangeParent, r.rangeOffset || 0), e = a.getRangeAt(0);
...
function gh({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    ...
    /* @__PURE__ */ p.jsx(Wn, { "data-test-id": "table-model-confirm-insert", children: /* @__PURE__ */ p.jsx(ur, { disabled: s, onClick: l, children: "Confirm" }) })
  ] });
}
const vh = He(
  "INSERT_POLL_COMMAND"
...
function bh({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    /* @__PURE__ */ p.jsx(Br, { label: "Question", onChange: n, value: t }),
    /* @__PURE__ */ p.jsx(Wn, { children: /* @__PURE__ */ p.jsx(ur, { disabled: t.trim() === "", onClick: a, children: "Confirm" }) })
  ] });
}
function Xg() {
  const [r] = oe();
...
function xh({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    ...
    /* @__PURE__ */ p.jsx(ur, { onClick: i, children: "Insert" })
  ] });
}
function Zs(r, e) {
...
var e2 = function(e, t) {
  ...
  return t.reset = function() {
    ...
    if (s !== null && i.error !== null && e2(a.resetKeys, o)) {
      var l, u;
...
function n2({
  ...
  return /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
    ...
    /* @__PURE__ */ p.jsx("div", { className: "KatexEquationAlterer_centerRow", children: /* @__PURE__ */ p.jsx(t2, { onError: (u) => t._onError(u), fallback: null, children: /* @__PURE__ */ p.jsx(
      r2,
      {
        equation: n,
        inline: !1,
    ...
    /* @__PURE__ */ p.jsx("div", { className: "KatexEquationAlterer_dialogActions", children: /* @__PURE__ */ p.jsx(ur, { onClick: o, children: "Confirm" }) })
  ] });
}
const wh = He("INSERT_EQUATION_COMMAND");
function _h({
  activeEditor: r,
  onClose: e
}) {
  ...
  return /* @__PURE__ */ p.jsx(n2, { onConfirm: t });
}
function a2() {
  const [r] = oe();
  return $(() => {
    ...
    return Re(
      ...
      r.registerCommand(
        ...
        () => {
          ...
          return !pr(s) || s.getOpen() ? !1 : (s.setOpen(!0), !0);
        },
        ve
      ),
...
const ku = "startTransition", s2 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : $;
let o2 = class {
  constructor(e) {
...
const Tu = He("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
function u2({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ve }) {
  ...
  const m = ie((v) => {
    e.update(() => {
      const y = n.match != null && o ? function(x) {
        ...
        const k = w.offset, N = C.getTextContent().slice(0, k), A = x.replaceableString.length, I = k - function(M, F, z) {
          let j = z;
          for (let P = j; P <= F.length; P++) M.substr(-P) === F.substr(0, P) && (j = P);
          return j;
        }(N, x.matchingString, A);
        if (I < 0) return null;
        let D;
        return I === 0 ? [D] = C.splitText(k) : [, D] = C.splitText(I, k), D;
      }(n.match) : null;
...
function c2({ options: r, nodeKey: e, onClose: t, onOpen: n, onSelectOption: a, menuRenderFn: i, anchorClassName: s, commandPriority: o = ve, parent: l }) {
  const [u] = oe(), [c, d] = H(null), m = function(x, _, w, C = document.body, k = !0) {
    const [N] = oe(), A = Oe(document.createElement("div")), I = ie(() => {
      A.current.style.top = A.current.style.bottom;
      const M = N.getRootElement(), F = A.current, z = F.firstChild;
      if (M !== null && x !== null) {
        const { left: j, top: P, width: X, height: Y } = x.getRect(), ee = A.current.offsetHeight;
        if (F.style.top = `${P + ee + 3 + (k ? window.pageYOffset : 0)}px`, F.style.left = `${j + window.pageXOffset}px`, F.style.height = `${Y}px`, F.style.width = `${X}px`, z !== null) {
          z.style.top = `${P}`;
          const ce = z.getBoundingClientRect(), J = ce.height, de = ce.width, le = M.getBoundingClientRect();
          j + de > le.right && (F.style.left = `${le.right - de + window.pageXOffset}px`), (P + J > window.innerHeight || P + J > le.bottom) && P - le.top > J + Y && (F.style.top = `${P - J - Y + (k ? window.pageYOffset : 0)}px`);
        }
        F.isConnected || (w != null && (F.className = w), F.setAttribute("aria-label", "Typeahead menu"), F.setAttribute("id", "typeahead-menu"), F.setAttribute("role", "listbox"), F.style.display = "block", F.style.position = "absolute", C.append(F)), A.current = F, M.setAttribute("aria-controls", "typeahead-menu");
      }
    }, [N, x, k, w, C]);
    $(() => {
    ...
    e ? u.update(() => {
      ...
      var w;
      x != null && _ != null && c == null && (w = () => v({ getRect: () => _.getBoundingClientRect() }), ku in tn ? tn[ku](w) : w());
    }) : e == null && c != null && g();
  }, [g, u, e, v, c]);
  return $(() => {
    y();
  ...
  }, [u, y, e]), c === null || u === null ? null : p.jsx(u2, { close: g, resolution: c, editor: u, anchorElementRef: m, options: r, menuRenderFn: i, onSelectOption: a, commandPriority: o });
}
const d2 = /((https?:\/\/(www\.)?)|(www\.))[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)/, b0 = He("INSERT_EMBED_COMMAND");
let Au = class extends o2 {
  constructor(e, t) {
    super(e), this.title = e, this.onSelect = t.onSelect.bind(this);
  }
};
function h2({ embedConfigs: r, onOpenEmbedModalForConfig: e, getMenuOptions: t, menuRenderFn: n, menuCommandPriority: a = ve }) {
  ...
  $(() => Re(...[In, Sa].map((y) => i.registerMutationListener(y, (...x) => ((_, { updateTags: w, dirtyLeaves: C }) => {
    for (const [k, N] of _) N === "created" && w.has("paste") && C.size <= 3 ? d(k) : k === s && c();
  ...
  return s != null ? p.jsx(c2, { nodeKey: s, onClose: c, onSelectOption: v, options: g, menuRenderFn: n, commandPriority: a }) : null;
}
const Sh = He(
...
function S2() {
  const [r, e] = Fi(), t = (a) => {
    e(`Embed ${a.contentName}`, (i) => /* @__PURE__ */ p.jsx(_2, { embedConfig: a, onClose: i }));
  }, n = (a, i, s) => [
    new Au("Dismiss", {
      onSelect: s
    }),
...
function E2({
  ...
  return /* @__PURE__ */ p.jsx(
    dn,
    {
      ...
      buttonAriaLabel: i,
      children: (t === "font-family" ? C2 : k2).map(
        ([s, o]) => /* @__PURE__ */ p.jsx(
          Ae,
          {
...
function A2({ setIsLinkEditMode: r }) {
  const [e] = oe(), [t, n] = H("paragraph"), [a, i] = H(e), [s, o] = H("15px"), [l, u] = H("#000"), [c, d] = H("#fff"), [m, g] = H("Arial"), [v, y] = H("left"), [x, _] = H(!1), [w, C] = H(!1), [k, N] = H(!1), [A, I] = H(!1), [D, M] = H(!1), [F, z] = H(!1), [j, P] = H(!1), [X, Y] = H(!1), [ee, ce] = H(!1), [J, de] = H(!1), [le, Ne] = H(!1), [se, Ue] = H(() => e.isEditable()), [Pe, Be] = Fi(), dt = ie(() => {
    const te = B();
    if (te && oa(te)) {
      const we = te.getNodes()[0];
      C(we.hasFormat("bold")), N(we.hasFormat("italic")), I(we.hasFormat("underline")), M(we.hasFormat("strikethrough")), z(we.hasFormat("subscript")), P(we.hasFormat("superscript")), Y(we.hasFormat("code")), o(we.getStyleValue("font-size", "15px")), u(we.getStyleValue("color", "#000")), d(we.getStyleValue("background-color", "#fff")), g(we.getStyleValue("font-family", "Arial"));
    } else if (U(te)) {
      ...
      C(te.hasFormat("bold")), N(te.hasFormat("italic")), I(te.hasFormat("underline")), M(te.hasFormat("strikethrough")), z(te.hasFormat("subscript")), P(te.hasFormat("superscript")), Y(te.hasFormat("code")), ce(xc(te));
      const ht = On(te), je = ht.getParent();
      if (lt(je) || lt(ht) ? _(!0) : _(!1), tt !== null)
        if (ke(We)) {
          const jt = Sc(
            we,
            ka
      ...
      lt(je) && (It = he(
        ...
        pe(It) ? It.getFormatType() : pe(ht) ? ht.getFormatType() : (je == null ? void 0 : je.getFormatType()) || "left"
      );
    }
  }, [a]);
  $(() => e.registerCommand(
    ...
    (te) => {
      ...
      if (We === "KeyK" && (_t || tt)) {
        we.preventDefault();
        let ht;
        return x ? (r(!1), ht = null) : (r(!0), ht = gi("https://")), a.dispatchCommand(sr, ht);
      }
      return !1;
    },
    A1
  ...
  const Je = ie(
    ...
    a.update(() => {
      ...
      if (te && oa(te))
        ...
        _t.forEach((tt, ht) => {
          if (_e(tt)) {
            let je = tt;
            ht === 0 && we.offset !== 0 && (je = je.splitText(we.offset)[1] || je), ht === _t.length - 1 && (je = je.splitText(We.offset)[0] || je), je.__style !== "" && je.setStyle(""), je.__format !== 0 && (je.setFormat(0), Ci(je).setFormat("")), tt = je;
          } else ml(tt) || Hm(tt) ? tt.replace(xe(), !0) : Ls(tt) && tt.setFormat("");
        });
      }
    });
  }, [a]), Rt = ie(
    ...
    x ? (r(!1), e.dispatchCommand(sr, null)) : (r(!0), e.dispatchCommand(sr, gi("https://")));
  }, [e, x, r]);
  return /* @__PURE__ */ p.jsxs("div", { className: "toolbar", children: [
    ...
    /* @__PURE__ */ p.jsx(Jr, {}),
    /* @__PURE__ */ p.jsx(bg, { selectionFontSize: s.slice(0, -2), editor: e, disabled: !se }),
    /* @__PURE__ */ p.jsx(Jr, {}),
    /* @__PURE__ */ p.jsx(
      "button",
      {
      ...
      dn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                Be("Insert Image", (te) => /* @__PURE__ */ p.jsx(
                  dh,
                  {
                    activeEditor: a,
                    onClose: te
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                Be("Insert Inline Image", (te) => /* @__PURE__ */ p.jsx(
                  $g,
                  {
                    activeEditor: a,
                    onClose: te
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                Be("Insert Table", (te) => /* @__PURE__ */ p.jsx(
                  gh,
                  {
                    activeEditor: a,
                    onClose: te
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                Be("Insert Poll", (te) => /* @__PURE__ */ p.jsx(
                  bh,
                  {
                    activeEditor: a,
                    onClose: te
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                Be("Insert Columns Layout", (te) => /* @__PURE__ */ p.jsx(
                  xh,
                  {
                    activeEditor: a,
                    onClose: te
          ...
          /* @__PURE__ */ p.jsxs(
            ...
            {
              onClick: () => {
                Be("Insert Equation", (te) => /* @__PURE__ */ p.jsx(
                  _h,
                  {
                    activeEditor: a,
                    onClose: te
...
function O2() {
  const [r] = oe();
  return $(() => Re(r.registerCommand(xo, () => (As(r, "check"), !0), ve), r.registerCommand(mn, (e) => Du(e, r, !1), ve), r.registerCommand(fn, (e) => Du(e, r, !0), ve), r.registerCommand(Dn, (e) => {
    if (eo() != null) {
      const t = r.getRootElement();
      return t != null && t.focus(), !0;
    }
    return !1;
  }, ve), r.registerCommand(M1, (e) => {
    const t = eo();
    return !(t == null || !r.isEditable()) && (r.update(() => {
      const n = Qe(t);
      Fe(n) && (e.preventDefault(), n.toggleChecked());
    }), !0);
  }, ve), r.registerCommand(wa, (e) => r.getEditorState().read(() => {
    const t = B();
...
function P2() {
  const [r] = oe();
  return $(() => (Ru || (z2(), Ru = !0), r.registerCommand(
    hc,
    (e) => {
      const t = B();
      return U(t) && Eh + L2 > e.timeStamp && yt(t.clone()), !1;
    },
    F2
  )), [r]), null;
}
const B2 = 10, j2 = 5;
function Iu(r, e, t, n = B2, a = j2) {
...
function $2({
  ...
  const s = Oe(null), o = Oe(null), [l, u] = H(""), [c, d] = H("https://"), [m, g] = H(
    ...
    const w = s.current, C = window.getSelection(), k = document.activeElement;
    if (w === null)
      return;
    const N = r.getRootElement();
    if (_ !== null && C !== null && N !== null && N.contains(C.anchorNode) && r.isEditable()) {
      const D = (I = (A = C.focusNode) == null ? void 0 : A.parentElement) == null ? void 0 : I.getBoundingClientRect();
      D && (D.y += 40, Iu(D, w, n)), g(_);
    } else (!k || k.className !== "link-input") && (N !== null && Iu(null, w, n), g(null), i(!1), u(""));
    return !0;
  }, [n, r, i, a, l]);
  $(() => {
  ...
  const y = (_) => {
    ...
    m !== null && (l !== "" && (r.dispatchCommand(sr, gi(c)), r.update(() => {
      const _ = B();
      if (U(_)) {
...
function V2(r, e, t, n) {
  ...
  if (r.length > 1) {
    ...
    const c = B(), d = c ? c.getNodes().find(_e) : void 0, m = Fr(s.getTextContent());
...
function X2(r, e, t) {
  $(() => {
    ...
    return Re(r.registerNodeTransform(hn, (a) => {
      ...
      if (br(i) && !i.getIsUnlinked()) ps(i, e, n);
      else if (!lt(i)) {
        if (a.isSimpleText() && (to(a.getTextContent()) || !br(s))) {
          const o = function(l) {
            const u = [l];
          ...
          (function(l, u, c) {
            ...
            for (; (g = Th(v, u)) && g !== null; ) {
              ...
              if (G2(y + x, y + _, m, d)) {
                const [w, , C, k] = Y2(d, y + x, y + _), N = V2(C, y + x - w, y + _ - w, g);
                d = N ? [N, ...k] : k, c(g.url, null), y = 0;
              } else y += _;
              v = v.substring(_);
            }
          })(o, e, n);
        ...
        (function(o, l, u) {
          ...
          var g;
          !br(c) || c.getIsUnlinked() || to(m) && (g = m, !(c.isEmailURI() ? /^\.[a-zA-Z]{2,}/.test(g) : /^\.[a-zA-Z0-9]{1,}/.test(g))) || (c.append(o), ps(c, l, u), u(null, c.getURL())), !br(d) || d.getIsUnlinked() || Ah(m) || (ni(d), ps(d, l, u), u(null, d.getURL()));
        })(a, e, n);
      }
    }), r.registerCommand(sr, (a) => {
      const i = B();
      return a !== null || !U(i) || i.extract().forEach((s) => {
        const o = s.getParent();
        if (br(o)) return o.setIsUnlinked(!o.getIsUnlinked()), o.markDirty(), !0;
      }), !1;
    }, ve));
  }, [r, e, t]);
}
function J2({ matchers: r, onChange: e }) {
  const [t] = oe();
  return X2(t, r, e), null;
}
const Z2 = /((https?:\/\/(www\.)?)|(www\.))[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)/, Q2 = /(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))/, e5 = [
  Fu(Z2, (r) => r.startsWith("http") ? r : `https://${r}`),
  Fu(Q2, (r) => `mailto:${r}`)
];
function t5() {
  return /* @__PURE__ */ p.jsx(J2, { matchers: e5 });
}
function r5({ validateUrl: r, attributes: e }) {
  const [t] = oe();
  return $(() => {
    if (!t.hasNodes([In])) throw new Error("LinkPlugin: LinkNode not registered on editor");
    return Re(t.registerCommand(sr, (n) => {
...
function u5(r) {
  $(() => {
    ...
    return r.registerNodeTransform(hn, l5);
  }, [r]);
}
function c5() {
  const [r] = oe();
...
const zu = "startTransition", d5 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : $;
class x0 {
  constructor(e) {
    this.key = e, this.ref = { current: null }, this.setRefElement = this.setRefElement.bind(this);
  }
...
const ju = He("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
function m5({ close: r, editor: e, anchorElementRef: t, resolution: n, options: a, menuRenderFn: i, onSelectOption: s, shouldSplitNodeWithQuery: o = !1, commandPriority: l = ve }) {
  const [u, c] = H(null), d = n.match && n.match.matchingString;
  $(() => {
    c(0);
  }, [d]);
...
const f5 = `\\.,\\+\\*\\?\\$\\@\\|#{}\\(\\)\\^\\-\\[\\]\\\\/!%'"~=<>_:;`;
He("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
function w0(r, { minLength: e = 1, maxLength: t = 75 }) {
  return ie((n) => {
    const a = new RegExp("(^|\\s|\\()([" + r + "]((?:" + ("[^" + r + f5 + "\\s]") + "){0," + t + "}))$").exec(n);
    if (a !== null) {
      const i = a[1], s = a[3];
...
function _0({ options: r, onQueryChange: e, onSelectOption: t, onOpen: n, onClose: a, menuRenderFn: i, triggerFn: s, anchorClassName: o, commandPriority: l = ve, parent: u }) {
  const [c] = oe(), [d, m] = H(null), g = function(x, _, w, C = document.body, k = !0) {
    const [N] = oe(), A = Oe(document.createElement("div")), I = ie(() => {
      A.current.style.top = A.current.style.bottom;
      const M = N.getRootElement(), F = A.current, z = F.firstChild;
      if (M !== null && x !== null) {
  ...
  return $(() => {
    const x = c.registerUpdateListener(() => {
      c.getEditorState().read(() => {
        const _ = c._window || window, w = _.document.createRange(), C = B(), k = function(I) {
          let D = null;
        ...
        if (!U(C) || !C.isCollapsed() || k === null || w === null) return void v();
        const N = s(k, c);
        if (e(N ? N.matchingString : null), N !== null && !function(I, D) {
          ...
          return !0;
        }(N.leadOffset, w, _) !== null)
          return A = () => y({ getRect: () => w.getBoundingClientRect(), match: N }), void (zu in tn ? tn[zu](A) : A());
        var A;
        v();
      });
    });
  ...
  }, [c, s, e, d, v, y]), d === null || c === null ? null : p.jsx(m5, { close: v, resolution: d, editor: c, anchorElementRef: g, options: r, menuRenderFn: i, shouldSplitNodeWithQuery: !0, onSelectOption: t, commandPriority: l });
}
class ot extends x0 {
  constructor(t, n) {
    super(t);
...
const x5 = 10, w5 = 5;
function _5(r, e, t, n = !1, a = x5, i = w5) {
...
function S5({
  ...
  const c = Oe(null), d = ie(() => {
    t ? r.dispatchCommand(sr, null) : r.dispatchCommand(sr, "https://");
  }, [r, t]);
  function m(y) {
...
function C5(r, e) {
  const [t, n] = H(!1), [a, i] = H(!1), [s, o] = H(!1), [l, u] = H(!1), [c, d] = H(!1), [m, g] = H(!1), [v, y] = H(!1), [x, _] = H(!1), [w, C] = H(!1), k = ie(() => {
    r.getEditorState().read(() => {
      if (r.isComposing())
        return;
      const N = B(), A = window.getSelection(), I = r.getRootElement();
      if (A !== null && (!U(N) || I === null || !I.contains(A.anchorNode))) {
        n(!1);
        return;
      }
      if (!U(N))
        return;
      const D = On(N);
      o(N.hasFormat("bold")), u(N.hasFormat("italic")), d(N.hasFormat("underline")), g(N.hasFormat("strikethrough")), y(N.hasFormat("subscript")), _(N.hasFormat("superscript")), C(N.hasFormat("code"));
      const M = D.getParent();
      lt(M) || lt(D) ? i(!0) : i(!1), !go(N.anchor.getNode()) && N.getTextContent() !== "" ? n(_e(D) || qr(D)) : n(!1);
      const F = N.getTextContent().replace(/\n/g, "");
      if (!N.isCollapsed() && F === "") {
        n(!1);
        return;
      }
  ...
  return $(() => (document.addEventListener("selectionchange", k), () => {
...
var ei = N5(function(r) {
  const e = new URLSearchParams();
  e.append("code", r);
  for (let t = 1; t < arguments.length; t++) e.append("v", arguments[t]);
  throw Error(`Minified Lexical error #${r}; visit https://lexical.dev/docs/error?${e} for the full message or use the non-minified dev environment for full errors and additional helpful warnings.`);
});
function E5({ hasCellMerge: r = !0, hasCellBackgroundColor: e = !0, hasTabHandler: t = !0 }) {
  const [n] = oe();
  return $(() => (n.hasNodes([lr, or, Ln]) || ei(10), Re(n.registerCommand(To, ({ columns: a, rows: i, includeHeaders: s }) => {
    const o = Vm(Number(i), Number(a), s);
    Hr(o);
    const l = o.getFirstDescendant();
    return _e(l) && l.select(), !0;
  }, ye), n.registerNodeTransform(lr, (a) => {
    ...
    const a = /* @__PURE__ */ new Map(), i = (o, l, u) => {
      const c = u, d = rf(o, c, n, t);
      a.set(l, [d, c]);
    }, s = n.registerMutationListener(lr, (o) => {
    ...
    if (!r) return n.registerNodeTransform(or, (a) => {
    ...
    if (!e) return n.registerNodeTransform(or, (a) => {
      a.getBackgroundColor() !== null && a.setBackgroundColor(null);
    });
  }, [n, e, r]), null;
}
const T5 = 33, $u = 92;
function A5({ editor: r }) {
      ...
      setTimeout(() => {
        ...
        if (c(v(j)), !(t.current && t.current.contains(P)) && e.current !== P) {
          ...
          X && o !== X ? r.update(() => {
            ...
            const ee = yr(Y), ce = r.getElementByKey(ee.getKey());
            if (!ce)
  ...
  const y = (D) => D === "bottom", x = ie(
    (D) => {
      ...
      r.update(
        () => {
          ...
          if (!ae(M))
            throw new Error("TableCellResizer: Table cell node not found.");
          const F = yr(M), z = Ao(M) + M.getRowSpan() - 1, j = F.getChildren();
          if (z >= j.length || z < 0)
            throw new Error("Expected table cell to be inside of table row.");
          const P = j[z];
          if (!nt(P))
    ...
    (D) => (M) => {
      ...
      a.current = {
        x: M.clientX,
        y: M.clientY
      }, s(a.current), m(D), document.addEventListener("mouseup", k(D));
    },
    [o, k]
  ), I = ie(() => {
    if (o) {
...
function M5() {
  const [r] = oe(), e = Fa();
  return it(
    () => e ? Zt(/* @__PURE__ */ p.jsx(A5, { editor: r }), document.body) : null,
    [r, e]
  );
}
function gs(r) {
...
function R5({
  ...
  $(() => s.registerMutationListener(
    ...
    if (Y != null && ee != null && ce != null) {
      ...
      if (se + le.width > window.innerWidth || se + le.width > J.right) {
        const Pe = de.left - le.width - Ne;
        se = (Pe < 0 ? Ne : Pe) + window.pageXOffset;
      }
      ee.style.left = `${se + window.pageXOffset}px`;
      let Ue = de.top;
      if (Ue + le.height > window.innerHeight) {
        const Pe = de.bottom - le.height;
        Ue = (Pe < 0 ? Ne : Pe) + window.pageYOffset;
      }
      ee.style.top = `${Ue + +window.pageYOffset}px`;
    }
  }, [n, o, s]), $(() => {
    function Y(ee) {
  ...
  const w = ie(() => {
    s.update(() => {
      if (l.isAttached()) {
        const ee = yr(l), ce = s.getElementByKey(
          ee.getKey()
        );
        if (!ce)
        ...
        for (let le = 0; le < J.length; le++) {
          ...
          if (ae(Ne))
            if (de === null) {
              ...
              const se = qu(Ne);
              let Ue;
              se && qr(Ue = Ne.getFirstChild()) && Ue.remove();
            } else ae(de) && (qu(Ne) || de.append(...Ne.getChildren()), Ne.remove());
        }
        de !== null && (de.getChildrenSize() === 0 && de.append(xe()), D5(de)), r();
      }
    });
  }, k = () => {
    s.update(() => {
    ...
    s.update(() => {
      const Y = yr(l), ee = Ao(l), ce = Y.getChildren();
      if (ee >= ce.length || ee < 0)
        throw new Error("Expected table cell to be inside of table row.");
      const J = ce[ee];
      if (!nt(J))
        throw new Error("Expected table row");
      const de = l.getHeaderStyles() ^ $e.ROW;
      J.getChildren().forEach((le) => {
        if (!ae(le))
          throw new Error("Expected table cell");
        le.setHeaderStyles(de, $e.ROW);
      }), w(), r();
    });
  }, [s, l, w, r]), z = ie(() => {
    s.update(() => {
      const Y = yr(l), ee = Yc(l), ce = Y.getChildren(), J = Math.max(
        ...ce.map((le) => le.getChildren().length)
      );
      if (ee >= J || ee < 0)
        throw new Error("Expected table cell to be inside of table row.");
      const de = l.getHeaderStyles() ^ $e.COLUMN;
      for (let le = 0; le < ce.length; le++) {
        ...
        if (!ae(Ue))
          throw new Error("Expected table cell");
        Ue.setHeaderStyles(de, $e.COLUMN);
      }
      w(), r();
    });
  }, [s, l, w, r]), j = ie(() => {
        ...
        children: [
          ...
          /* @__PURE__ */ p.jsx(
            "button",
            {
              ...
              onClick: () => F(),
              children: /* @__PURE__ */ p.jsxs("span", { className: "text", children: [
                (l.__headerState & $e.ROW) === $e.ROW ? "Remove" : "Add",
                " ",
                "row header"
              ] })
            }
          ...
          /* @__PURE__ */ p.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ p.jsxs("span", { className: "text", children: [
                (l.__headerState & $e.COLUMN) === $e.COLUMN ? "Remove" : "Add",
                " ",
                "column header"
              ] })
            }
...
function j5() {
  ...
  const i = it(
    () => n != null ? n.map(
      ({ emoji: u, aliases: c, tags: d }) => new z5(c[0], u, {
        keywords: [...c, ...d]
      })
    ) : [],
    [n]
  ...
  ) : !1 : i).slice(0, B5), [i, e]), l = ie(
    (u, c, d) => {
      r.update(() => {
        const m = B();
        !U(m) || u == null || (c && c.remove(), m.insertNodes([Fr(u.emoji)]), d());
      });
    },
    [r]
  );
...
const ro = 4, q5 = 2, H5 = "draggable-block-menu", Wu = "application/x-lexical-drag-block", Ku = 28, U5 = 1, W5 = -1, Gu = 0;
let ai = 1 / 0;
function K5(r) {
...
function bs(r, e, t, n = !1) {
  const a = r.getBoundingClientRect(), i = G5(e);
  let s = null;
  return e.getEditorState().read(() => {
    ...
    let o = K5(i.length), l = Gu;
    for (; o >= 0 && o < i.length; ) {
      const u = i[o], c = e.getElementByKey(u);
      if (c === null)
        break;
      const d = new Dh(t.x, t.y), m = Zr.fromDOM(c), { marginTop: g, marginBottom: v } = Rh(c), y = m.generateNewRect({
        bottom: m.bottom + v,
        left: a.left,
        right: a.right,
        top: m.top - g
...
function Q5(r, e, t) {
  ...
  $(() => {
    ...
    function d(g) {
      ...
      return _ === null || w === null ? !1 : (J5(w, _, y, e), g.preventDefault(), !0);
    }
    function m(g) {
      if (!s.current)
        return !1;
      ...
      if (N === C)
        return !0;
      const A = k.getBoundingClientRect().top;
      return _ >= A ? N.insertAfter(C) : N.insertBefore(C), l(null), !0;
    }
    return Re(
      r.registerCommand(
        yi,
...
function e3({
  ...
  const [e] = oe();
  return Q5(e, r, e._editable);
}
const Ih = `\\.,\\+\\*\\?\\$\\@\\|#{}\\(\\)\\^\\-\\[\\]\\\\/!%'"~=<>_:;`, t3 = "\\b[A-Z][^\\s" + Ih + "]", r3 = {
  NAME: t3,
  PUNCTUATION: Ih
}, Fh = r3.PUNCTUATION, S0 = ["=\\$a", "=\\$i", "=\\$f"].join("|"), ys = "=$a", n3 = "=$i", a3 = "=$f", Lh = "^(" + S0 + ")\\s|[^" + Fh + "\\s]", i3 = "(?:\\.[ |$]| |[" + Fh + "]|)", s3 = 75, o3 = new RegExp(
  "((" + S0 + ")((?:" + Lh + i3 + "){0," + s3 + "}))"
), l3 = 50, u3 = new RegExp(
  "((" + S0 + ")((?:" + Lh + "){0," + l3 + "}))"
), c3 = [
...
function h3(r, e, t = "") {
  ...
  return $(() => {
    ...
    if (i !== null) {
      ...
      xs.set(t + r, null), d3.search(r, e, (s) => {
        xs.set(t + r, s), a(s);
      });
    }
  }, [r, e, t]), n;
...
function v3({
  ...
  const [n] = oe(), [a, i] = H(null), [s, o] = H(), [l, u] = H(), [c, d] = H(!1), [m, g] = H(null), y = h3(a, s === ys ? e : s === a3 ? t : c3, s), x = w0("/", {
    minLength: 0
  }), _ = it(
    () => y.map(
      (k) => {
        const N = Object.keys(k)[0];
        return new p3(s === ys ? "auto" : "after-auto", N, k[N].label, k[N].value, k[N].isMan, k[N].isNumber);
      }
    ),
    [y]
  ), w = ie(
    (k, N, A) => {
      n.update(() => {
        let I = k.data;
        k.isMan && typeof I == "number" && I && (I = 1e4 * I), k.isNumber && I && (I = I.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
        const D = d0(
          {
            dataMention: s === ys ? "auto" : s == n3 ? "input" : "after-auto",
        ...
        k.fieldName === "inputField" && (d(!0), g(D), A()), N && N.replace(D), A();
      });
    },
    [n, s]
  ), C = ie(
  ...
  return $(() => {
    r === 2 && n.registerCommand(
      ...
      (k, N) => {
        var A, I;
        return ((A = N.getRootElement()) == null ? void 0 : A.className) === "DataMention__contentEditable" && !n.isEditable() ? (n.setEditable(!0), N.focus()) : ((I = N.getRootElement()) == null ? void 0 : I.className) !== "DataMention__contentEditable" && n.isEditable() && n.setEditable(!1), !0;
      },
      ve
    );
    ...
    /* @__PURE__ */ p.jsx(
      _0,
      {
        ...
        triggerFn: C,
        options: _,
        menuRenderFn: (k, { selectedIndex: N, selectOptionAndCleanUp: A, setHighlightedIndex: I }) => k.current && y.length ? ua.createPortal(
          /* @__PURE__ */ p.jsx("div", { className: "typeahead-popover mentions-menu", children: /* @__PURE__ */ p.jsx("ul", { children: _.map((D, M) => /* @__PURE__ */ p.jsx(
            g3,
            {
              index: M,
              isSelected: N === M,
...
const b3 = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jr : $;
function y3({ ignoreHistoryMergeTagChange: r = !0, ignoreSelectionChange: e = !1, onChange: t }) {
  const [n] = oe();
  return b3(() => {
...
var x3 = typeof global == "object" && global && global.Object === Object && global, w3 = typeof self == "object" && self && self.Object === Object && self, zh = x3 || w3 || Function("return this")(), bi = zh.Symbol, Ph = Object.prototype, _3 = Ph.hasOwnProperty, S3 = Ph.toString, Jn = bi ? bi.toStringTag : void 0;
function C3(r) {
  var e = _3.call(r, Jn), t = r[Jn];
  try {
    r[Jn] = void 0;
    var n = !0;
  } catch {
...
var k3 = Object.prototype, N3 = k3.toString;
function E3(r) {
  return N3.call(r);
}
var T3 = "[object Null]", A3 = "[object Undefined]", Yu = bi ? bi.toStringTag : void 0;
function M3(r) {
  return r == null ? r === void 0 ? A3 : T3 : Yu && Yu in Object(r) ? C3(r) : E3(r);
}
function O3(r) {
  return r != null && typeof r == "object";
}
var D3 = "[object Symbol]";
function R3(r) {
  return typeof r == "symbol" || O3(r) && M3(r) == D3;
}
var I3 = /\s/;
function F3(r) {
  for (var e = r.length; e-- && I3.test(r.charAt(e)); )
    ;
  return e;
}
var L3 = /^\s+/;
function z3(r) {
  return r && r.slice(0, F3(r) + 1).replace(L3, "");
}
function no(r) {
  var e = typeof r;
  return r != null && (e == "object" || e == "function");
}
var Vu = NaN, P3 = /^[-+]0x[0-9a-f]+$/i, B3 = /^0b[01]+$/i, j3 = /^0o[0-7]+$/i, $3 = parseInt;
function Xu(r) {
  if (typeof r == "number")
    return r;
  if (R3(r))
  ...
  r = z3(r);
  var t = B3.test(r);
  return t || j3.test(r) ? $3(r.slice(2), t ? 2 : 8) : P3.test(r) ? Vu : +r;
}
var ws = function() {
  return zh.Date.now();
}, q3 = "Expected a function", H3 = Math.max, U3 = Math.min;
function W3(r, e, t) {
  var n, a, i, s, o, l, u = 0, c = !1, d = !1, m = !0;
  if (typeof r != "function")
    throw new TypeError(q3);
  e = Xu(e) || 0, no(t) && (c = !!t.leading, d = "maxWait" in t, i = d ? H3(Xu(t.maxWait) || 0, e) : i, m = "trailing" in t ? !!t.trailing : m);
  function g(A) {
    var I = n, D = a;
    return n = a = void 0, u = A, s = r.apply(D, I), s;
  }
  function v(A) {
    return u = A, o = setTimeout(_, e), c ? g(A) : s;
  }
  function y(A) {
    var I = A - l, D = A - u, M = e - I;
    return d ? U3(M, i - D) : M;
  }
  function x(A) {
    var I = A - l, D = A - u;
  ...
  function w(A) {
    return o = void 0, m && n ? g(A) : (n = a = void 0, s);
  }
  function C() {
...
function G3({
  ...
  const [e] = oe(), t = Fa(), [n, a] = H(!1), [i, s] = H(!1), [o, l] = H(!1), [u, c] = H({}), d = Oe(/* @__PURE__ */ new Set()), m = Oe(null), g = K3(
    (x) => {
      const { isOutside: _, tableDOMNode: w } = Y3(x);
      if (_) {
        a(!1), s(!1);
        return;
      }
      ...
      if (e.update(() => {
        ...
        if (ae(A)) {
          ...
          if (!Ke(D))
            return;
          if (N = e.getElementByKey(D == null ? void 0 : D.getKey()), N) {
            const M = D.getChildrenSize(), F = (I = D.getChildAtIndex(0)) == null ? void 0 : I.getChildrenSize(), z = Ao(A), j = Yc(A);
            z === M - 1 ? C = A : j === F - 1 && (k = A);
          }
        }
      }), N) {
        const {
          ...
          bottom: F,
          height: z
        } = N.getBoundingClientRect(), { y: j, left: P } = r.getBoundingClientRect();
        C ? (s(!1), a(!0), c({
          height: Ju,
          left: M - P,
          top: F - j + 5,
          ...
          for (const [_, w] of x) {
            ...
            switch (w) {
              case "created":
                ...
                break;
              case "destroyed":
                d.current.delete(_), l(d.current.size > 0), v.disconnect(), d.current.forEach((k) => {
                  const N = e.getElementByKey(k);
                  N && v.observe(N);
                });
                break;
            }
...
function V3({
  ...
  return Fa() ? Zt(
    /* @__PURE__ */ p.jsx(G3, { anchorElem: r }),
    r
  ) : null;
}
function X3(r) {
  const { step: e, autoMentionData: t, autoAfterMentionData: n, onChange: a = () => {
  } } = r, { historyState: i } = P4(), s = /* @__PURE__ */ p.jsx(rg, { children: "Enter text..." }), [o, l] = H(null), [u, c] = H(!1), [d, m] = H(!1), g = (v) => {
    v !== null && l(v);
  };
  return $(() => {
    const v = () => {
    ...
    /* @__PURE__ */ p.jsx(A2, { setIsLinkEditMode: m }),
    /* @__PURE__ */ p.jsxs("div", { className: "editor-container", children: [
      ...
      /* @__PURE__ */ p.jsx(j5, {}),
      /* @__PURE__ */ p.jsx(S2, {}),
      /* @__PURE__ */ p.jsx(v3, { step: e, autoData: t, afterAutoData: n }),
      /* @__PURE__ */ p.jsx(c5, {}),
      /* @__PURE__ */ p.jsx(s5, {}),
      /* @__PURE__ */ p.jsx(y3, { ignoreSelectionChange: !0, onChange: a }),
      /* @__PURE__ */ p.jsx(L4, { externalHistoryState: i }),
      /* @__PURE__ */ p.jsx(t5, {}),
      /* @__PURE__ */ p.jsx(
        Y4,
        {
          contentEditable: /* @__PURE__ */ p.jsx("div", { className: "editor-scroller", children: /* @__PURE__ */ p.jsx("div", { className: "editor", ref: g, children: /* @__PURE__ */ p.jsx(lg, {}) }) }),
          placeholder: s,
          ErrorBoundary: J4
        }
      ),
      ...
      o && !u && /* @__PURE__ */ p.jsxs(p.Fragment, { children: [
        ...
        /* @__PURE__ */ p.jsx(V3, { anchorElem: o }),
        /* @__PURE__ */ p.jsx(
          k5,
          {
            anchorElem: o
...
function c6(r) {
  ...
  Rr.prototype.defaultStep = s, Rr.prototype.autoMentionData = i, Rr.prototype.autoAfterMentionData = a;
  const l = {
    editorState: e,
    namespace: "Doc App",
    editable: s === 1,
  ...
  return /* @__PURE__ */ p.jsxs(B1, { initialConfig: l, children: [
    /* @__PURE__ */ p.jsx(J3, { editorRef: o }),
    /* @__PURE__ */ p.jsx(z4, { initHistoryState: t, children: /* @__PURE__ */ p.jsx("div", { className: "editor-shell", children: /* @__PURE__ */ p.jsx(X3, { step: s, autoAfterMentionData: a, autoMentionData: i, onChange: n }) }) })
  ] });
}
export {
  gg as $,
