import { aI as Se, aN as Ve, aO as te, aK as Li, aP as zc, aa as Wc, af as Yc } from "./index-C14StzBP.js";
import { J as Hc } from "./ExcalidrawComponent-BJxV53Ze.js";
...
const v1 = Math.abs, S1 = Math.atan2, k1 = Math.cos, w1 = Math.max, A1 = Math.min, B1 = Math.sin, E1 = Math.sqrt, ks = 1e-12, Qn = Math.PI, ws = Qn / 2, L1 = 2 * Qn;
function F1(t) {
...
const Tl = (t) => (u0(), We.sanitize(t)), zs = (t, e) => {
  ...
  const { default: i } = await import("./index-C14StzBP.js").then((r) => r.aT);
...
const jr = (t, e) => {
  ...
  const { diagram: t } = await import("./c4Diagram-3d4e48cf-CXWHaP7R.js");
  ...
  const { diagram: t } = await import("./flowDiagram-66a62f08-Dz7SGQb7.js");
  ...
  const { diagram: t } = await import("./flowDiagram-v2-96b9c2cf-BAovbiQa.js");
  ...
  const { diagram: t } = await import("./erDiagram-9861fffd-Cck6l_N5.js");
  ...
  const { diagram: t } = await import("./gitGraphDiagram-72cf32ee-4uJwJoVF.js");
  ...
  const { diagram: t } = await import("./ganttDiagram-c361ad54-B3lk8Xpz.js");
  ...
  const { diagram: t } = await import("./infoDiagram-f8f76790-CVSEfTE2.js");
  ...
  const { diagram: t } = await import("./pieDiagram-8a3498a8-C7N-kkQT.js");
  ...
  const { diagram: t } = await import("./quadrantDiagram-120e2f19-BrY16YEC.js");
  ...
  const { diagram: t } = await import("./xychartDiagram-e933f94c-CcMAmH4I.js");
  ...
  const { diagram: t } = await import("./requirementDiagram-deff3bca-Ck8b2p-l.js");
  ...
  const { diagram: t } = await import("./sequenceDiagram-704730f1-VMU_Zf8d.js");
  return { id: Zl, diagram: t };
}, a_ = {
  id: Zl,
  detector: o_,
  ...
  const { diagram: t } = await import("./classDiagram-70f12bd4-DnZk6pZg.js");
  return { id: Jl, diagram: t };
}, u_ = {
  id: Jl,
  detector: c_,
  ...
  const { diagram: t } = await import("./classDiagram-v2-f2320105-B5NWxoIy.js");
  return { id: Ql, diagram: t };
}, g_ = {
  id: Ql,
  detector: f_,
  ...
  const { diagram: t } = await import("./stateDiagram-587899a1-Bs5P6JDz.js");
  ...
  const { diagram: t } = await import("./stateDiagram-v2-d93cdb3a-B49mzeLN.js");
  ...
  const { diagram: t } = await import("./journeyDiagram-49397b02-B0ITEpa0.js");
...
`);
  ...
  setAccTitle: D_,
  setDiagramTitle: q_
}, Symbol.toStringTag, { value: "Module" })), Y_ = $, H_ = so, mo = Wt, P1 = Nl, q1 = Ue, j_ = (t) => Ai(t, mo()), U_ = F_, X_ = () => W_, br = {}, Tr = (t, e, i) => {
  var r;
  if (br[t])
...
`);
  ...
  const { diagram: t } = await import("./flowchart-elk-definition-4a651766-OmXfaTdV.js");
  ...
  const { diagram: t } = await import("./timeline-definition-85554ec2-OXNXdrmE.js");
  ...
  const { diagram: t } = await import("./mindmap-definition-fc14e90a-B6rwVKo7.js");
  ...
  const { diagram: t } = await import("./sankeyDiagram-04a897e0-e1DuspKp.js");
  ...
  const { diagram: t } = await import("./blockDiagram-38ab4fdb-BG7joGxV.js");
